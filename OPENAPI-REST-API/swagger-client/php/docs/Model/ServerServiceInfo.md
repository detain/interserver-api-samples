...
**serverDiscount** | [****](.md) | Discount information for the server. | [optional] 
...
**serverLocation** | [****](.md) | The location of the server. | [optional] 
...
**serverDedicatedHd2** | [****](.md) | The size of the second dedicated hard drive. | [optional] 
...
**serverDedicatedCp** | [****](.md) | The control panel of the server. | [optional] 
