...
> \Interserver\MyAdmin\Model\SuccessTextResponse addAccountCreditCard($name, $address, $city, $state, $country, $zip, $cc, $ccExp, $ccCcv2)
...
$apiInstance = new Interserver\MyAdmin\Api\BillingApi(
...
$ccExp = "ccExp_example"; // string | 
$ccCcv2 = "ccCcv2_example"; // string | 

try {
    $result = $apiInstance->addAccountCreditCard($name, $address, $city, $state, $country, $zip, $cc, $ccExp, $ccCcv2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addAccountCreditCard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **addAccountCreditCard**
> \Interserver\MyAdmin\Model\SuccessTextResponse addAccountCreditCard($body)
...
$body = new \Interserver\MyAdmin\Model\BillingAddCcRequest(); // \Interserver\MyAdmin\Model\BillingAddCcRequest | 

try {
    $result = $apiInstance->addAccountCreditCard($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addAccountCreditCard: ', $e->getMessage(), PHP_EOL;
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\BillingAddCcRequest**](../Model/BillingAddCcRequest.md)|  |
...
> \Interserver\MyAdmin\Model\SuccessTextResponse addBillingCreditCard($body)
...
try {
    $result = $apiInstance->addBillingCreditCard($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingCreditCard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **addBillingCreditCard**
> \Interserver\MyAdmin\Model\SuccessTextResponse addBillingCreditCard($name, $address, $city, $state, $country, $zip, $cc, $ccExp, $ccCcv2)
...
try {
    $result = $apiInstance->addBillingCreditCard($name, $address, $city, $state, $country, $zip, $cc, $ccExp, $ccCcv2);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingCreditCard: ', $e->getMessage(), PHP_EOL;
}
...
# **addBillingPrepay**
> \Interserver\MyAdmin\Model\SuccessTextResponse addBillingPrepay($body)
...
$body = new \Interserver\MyAdmin\Model\BillingPrepayRequest(); // \Interserver\MyAdmin\Model\BillingPrepayRequest | 

try {
    $result = $apiInstance->addBillingPrepay($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingPrepay: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\BillingPrepayRequest**](../Model/BillingPrepayRequest.md)|  |
...
# **addBillingPrepay**
> \Interserver\MyAdmin\Model\SuccessTextResponse addBillingPrepay($module, $amount, $automaticUse)
...
$amount = 1.2; // float | 
$automaticUse = "automaticUse_example"; // string | 

try {
    $result = $apiInstance->addBillingPrepay($module, $amount, $automaticUse);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->addBillingPrepay: ', $e->getMessage(), PHP_EOL;
}
...
> \Interserver\MyAdmin\Model\SuccessTextResponse deleteBillingCreditCard($id)
...
try {
    $result = $apiInstance->deleteBillingCreditCard($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->deleteBillingCreditCard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Interserver\MyAdmin\Model\SuccessTextResponse deleteBillingInvoice($id)
...
try {
    $result = $apiInstance->deleteBillingInvoice($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->deleteBillingInvoice: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **deleteBillingPrepay**
> \Interserver\MyAdmin\Model\SuccessTextResponse deleteBillingPrepay($id)
...
try {
    $result = $apiInstance->deleteBillingPrepay($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->deleteBillingPrepay: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getAffiliateBanners**
> \Interserver\MyAdmin\Model\AffiliateBannerRow[] getAffiliateBanners()
...
try {
    $result = $apiInstance->getAffiliateBanners();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateBanners: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Interserver\MyAdmin\Model\AffiliateBannerRow[]**](../Model/AffiliateBannerRow.md)
...
> \Interserver\MyAdmin\Model\TextResponse getAffiliateRichReport()
...
try {
    $result = $apiInstance->getAffiliateRichReport();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateRichReport: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Interserver\MyAdmin\Model\StatusMonthlyBreakdown getAffiliateSalesGraph($days)
...
$days = 56; // int | Number of days of sales history to include in the graph data. Determines the time window for the returned data points.

try {
    $result = $apiInstance->getAffiliateSalesGraph($days);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateSalesGraph: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Interserver\MyAdmin\Model\StatusMonthlyBreakdown**](../Model/StatusMonthlyBreakdown.md)
...
> \Interserver\MyAdmin\Model\TextResponse getAffiliateSalesReport()
...
try {
    $result = $apiInstance->getAffiliateSalesReport();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateSalesReport: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Interserver\MyAdmin\Model\MonthlyCounts getAffiliateTrafficGraph($days)
...
$days = 56; // int | Number of days of traffic history to include in the graph data. Determines the time window for the returned data points.

try {
    $result = $apiInstance->getAffiliateTrafficGraph($days);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateTrafficGraph: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Interserver\MyAdmin\Model\MonthlyCounts**](../Model/MonthlyCounts.md)
...
> \Interserver\MyAdmin\Model\AffiliateTrafficRow[] getAffiliateWebTraffic()
...
try {
    $result = $apiInstance->getAffiliateWebTraffic();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getAffiliateWebTraffic: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Interserver\MyAdmin\Model\AffiliateTrafficRow[]**](../Model/AffiliateTrafficRow.md)
...
> \Interserver\MyAdmin\Model\SuccessTextResponse getBillingCreditCardVerify($id)
...
try {
    $result = $apiInstance->getBillingCreditCardVerify($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->getBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **getBillingInvoice**
> \Interserver\MyAdmin\Model\BillingInvoiceDetail getBillingInvoice($id)
...
try {
    $result = $apiInstance->getBillingInvoice($id);
    print_r($result);
} catch (Exception $e) {
...
[**\Interserver\MyAdmin\Model\BillingInvoiceDetail**](../Model/BillingInvoiceDetail.md)
...
# **getBillingInvoices**
> \Interserver\MyAdmin\Model\BillingInvoiceList getBillingInvoices()
...
try {
    $result = $apiInstance->getBillingInvoices();
    print_r($result);
} catch (Exception $e) {
...
[**\Interserver\MyAdmin\Model\BillingInvoiceList**](../Model/BillingInvoiceList.md)
...
# **getInvoices**
> \Interserver\MyAdmin\Model\Invoice[] getInvoices($searchString, $skip, $limit)
...
try {
    $result = $apiInstance->getInvoices($searchString, $skip, $limit);
    print_r($result);
} catch (Exception $e) {
...
[**\Interserver\MyAdmin\Model\Invoice[]**](../Model/Invoice.md)
...
# **initiatePayment**
> \Interserver\MyAdmin\Model\InlineResponse2009 initiatePayment($method, $invoices)
...
try {
    $result = $apiInstance->initiatePayment($method, $invoices);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->initiatePayment: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\Interserver\MyAdmin\Model\InlineResponse2009**](../Model/InlineResponse2009.md)
...
> \Interserver\MyAdmin\Model\SuccessTextResponse postBillingCreditCardVerify($body, $id)
...
$body = new \Interserver\MyAdmin\Model\BillingVerifyCcRequest(); // \Interserver\MyAdmin\Model\BillingVerifyCcRequest | 
$id = 56; // int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

try {
    $result = $apiInstance->postBillingCreditCardVerify($body, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->postBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\BillingVerifyCcRequest**](../Model/BillingVerifyCcRequest.md)|  |
 **id** | **int**| The credit card ID to verify. Use the ID returned from &#x60;POST /billing/creditcards&#x60;. |
...
# **postBillingCreditCardVerify**
> \Interserver\MyAdmin\Model\SuccessTextResponse postBillingCreditCardVerify($idx, $ccCcv2, $ccAmount1, $ccAmount2, $terms, $id)
...
$idx = 56; // int | 
$ccCcv2 = "ccCcv2_example"; // string | 
$ccAmount1 = "ccAmount1_example"; // string | 
$ccAmount2 = "ccAmount2_example"; // string | 
$terms = true; // bool | 
$id = 56; // int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

try {
    $result = $apiInstance->postBillingCreditCardVerify($idx, $ccCcv2, $ccAmount1, $ccAmount2, $terms, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->postBillingCreditCardVerify: ', $e->getMessage(), PHP_EOL;
}
...
> \Interserver\MyAdmin\Model\TextResponse updateAffiliateDockSetup($affiliateDockTitle, $affiliateDockDescription, $referrerCoupon)
...
$affiliateDockTitle = "affiliateDockTitle_example"; // string | 
$affiliateDockDescription = "affiliateDockDescription_example"; // string | 
$referrerCoupon = "referrerCoupon_example"; // string | 

try {
    $result = $apiInstance->updateAffiliateDockSetup($affiliateDockTitle, $affiliateDockDescription, $referrerCoupon);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliateDockSetup: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **updateAffiliateDockSetup**
> \Interserver\MyAdmin\Model\TextResponse updateAffiliateDockSetup($body)
...
$body = new \Interserver\MyAdmin\Model\AffiliateDockSetup(); // \Interserver\MyAdmin\Model\AffiliateDockSetup | 

try {
    $result = $apiInstance->updateAffiliateDockSetup($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliateDockSetup: ', $e->getMessage(), PHP_EOL;
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\AffiliateDockSetup**](../Model/AffiliateDockSetup.md)|  |
...
> \Interserver\MyAdmin\Model\TextResponse updateAffiliateLandingPage($affiliateDockTitle, $affiliateDockDescription, $referrerCoupon)
...
try {
    $result = $apiInstance->updateAffiliateLandingPage($affiliateDockTitle, $affiliateDockDescription, $referrerCoupon);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliateLandingPage: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **updateAffiliateLandingPage**
> \Interserver\MyAdmin\Model\TextResponse updateAffiliateLandingPage($body)
...
try {
    $result = $apiInstance->updateAffiliateLandingPage($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliateLandingPage: ', $e->getMessage(), PHP_EOL;
}
...
> \Interserver\MyAdmin\Model\TextResponse updateAffiliatePaymentSetup($affiliatePaypal, $affiliatePaymentMethod)
...
$affiliatePaypal = "affiliatePaypal_example"; // string | 
$affiliatePaymentMethod = "affiliatePaymentMethod_example"; // string | 

try {
    $result = $apiInstance->updateAffiliatePaymentSetup($affiliatePaypal, $affiliatePaymentMethod);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliatePaymentSetup: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **updateAffiliatePaymentSetup**
> \Interserver\MyAdmin\Model\TextResponse updateAffiliatePaymentSetup($body)
...
$body = new \Interserver\MyAdmin\Model\AffiliatePaymentSetup(); // \Interserver\MyAdmin\Model\AffiliatePaymentSetup | 

try {
    $result = $apiInstance->updateAffiliatePaymentSetup($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateAffiliatePaymentSetup: ', $e->getMessage(), PHP_EOL;
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\AffiliatePaymentSetup**](../Model/AffiliatePaymentSetup.md)|  |
...
> \Interserver\MyAdmin\Model\SuccessTextResponse updateBillingCreditCard($id)
...
try {
    $result = $apiInstance->updateBillingCreditCard($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateBillingCreditCard: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \Interserver\MyAdmin\Model\SuccessTextResponse updateBillingPaymentMethod($body)
...
$body = new \Interserver\MyAdmin\Model\BillingPaymentMethodRequest(); // \Interserver\MyAdmin\Model\BillingPaymentMethodRequest | 

try {
    $result = $apiInstance->updateBillingPaymentMethod($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateBillingPaymentMethod: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\BillingPaymentMethodRequest**](../Model/BillingPaymentMethodRequest.md)|  |
...
# **updateBillingPaymentMethod**
> \Interserver\MyAdmin\Model\SuccessTextResponse updateBillingPaymentMethod($paymentMethod, $ccAuto)
...
$ccAuto = "ccAuto_example"; // string | 

try {
    $result = $apiInstance->updateBillingPaymentMethod($paymentMethod, $ccAuto);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling BillingApi->updateBillingPaymentMethod: ', $e->getMessage(), PHP_EOL;
}
