...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\DnsNewDomain**](../Model/DnsNewDomain.md)|  |
...
------------- | ------------- | ------------- | -------------
 **name** | **string**|  |
 **type** | [**\Interserver\MyAdmin\Model\DnsRecordType**](../Model/.md)|  |
 **content** | **string**|  |
 **ttl** | **int**|  |
 **prio** | **int**|  |
...
$body = new \Interserver\MyAdmin\Model\DnsNewRecord(); // \Interserver\MyAdmin\Model\DnsNewRecord | 
$id = "id_example"; // string | The DNS Domain ID.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\DnsNewRecord**](../Model/DnsNewRecord.md)|  |
 **id** | **string**| The DNS Domain ID. |
...
# **getDnsDomain**
> \Interserver\MyAdmin\Model\DnsRecord[] getDnsDomain($id)
...
# **getDnsList**
> \Interserver\MyAdmin\Model\DnsListItem[] getDnsList()
...
$body = new \Interserver\MyAdmin\Model\DnsUpdateRecord(); // \Interserver\MyAdmin\Model\DnsUpdateRecord | The request data to update a dns record.
$domainId = 56; // int | The DNS domain ID. Use the `id` from `GET /dns` to identify the domain.
$recordId = 56; // int | The DNS record ID within the domain. Use the record `id` from `GET /dns/{id}` to identify the record.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\DnsUpdateRecord**](../Model/DnsUpdateRecord.md)| The request data to update a dns record. |
 **domainId** | **int**| The DNS domain ID. Use the &#x60;id&#x60; from &#x60;GET /dns&#x60; to identify the domain. |
 **recordId** | **int**| The DNS record ID within the domain. Use the record &#x60;id&#x60; from &#x60;GET /dns/{id}&#x60; to identify the record. |
