...
# **deleteQsBackup**
> \Interserver\MyAdmin\Model\SuccessTextResponse deleteQsBackup($id, $file, $all)
...
# **doQsBlockSmtp**
> \Interserver\MyAdmin\Model\QueueResponse doQsBlockSmtp($id)
...
# **doQsDisableCd**
> \Interserver\MyAdmin\Model\QueueResponse doQsDisableCd($id)
...
# **doQsDisableQuota**
> \Interserver\MyAdmin\Model\QueueResponse doQsDisableQuota($id)
...
# **doQsEjectCd**
> \Interserver\MyAdmin\Model\QueueResponse doQsEjectCd($id)
...
# **doQsEnableQuota**
> \Interserver\MyAdmin\Model\QueueResponse doQsEnableQuota($id)
...
# **doQsRestart**
> \Interserver\MyAdmin\Model\QueueResponse doQsRestart($id)
...
# **doQsStart**
> \Interserver\MyAdmin\Model\QueueResponse doQsStart($id)
...
# **doQsStop**
> \Interserver\MyAdmin\Model\QueueResponse doQsStop($id)
...
# **downloadQsBackup**
> \Interserver\MyAdmin\Model\InlineResponse20011 downloadQsBackup($body, $id, $all)
...
$body = new \Interserver\MyAdmin\Model\IdBackupsBody(); // \Interserver\MyAdmin\Model\IdBackupsBody | 
$id = 56; // int | QuickServer ID number
$all = "all_example"; // string | Set to `1` to list all backups across all services, not just the ones for the given QuickServer.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\IdBackupsBody**](../Model/IdBackupsBody.md)|  |
 **id** | **int**| QuickServer ID number |
 **all** | **string**| Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given QuickServer. | [optional]
...
# **downloadQsBackup**
> \Interserver\MyAdmin\Model\InlineResponse20011 downloadQsBackup($file, $id, $all)
...
# **getNewQs**
> \Interserver\MyAdmin\Model\QuickserverOrder getNewQs()
...
# **getQsBackups**
> \Interserver\MyAdmin\Model\VpsBackupRows getQsBackups($id, $all)
...
# **getQsInfo**
> \Interserver\MyAdmin\Model\Quickserver getQsInfo($id)
...
# **getQsInvoices**
> \Interserver\MyAdmin\Model\ChargeInvoiceRows getQsInvoices($id)
...
# **getQsList**
> \Interserver\MyAdmin\Model\QuickserverRow[] getQsList()
...
# **getQsReinstallOs**
> \Interserver\MyAdmin\Model\VpsTemplatesList getQsReinstallOs($id)
...
# **getQsReverseDns**
> \Interserver\MyAdmin\Model\ReverseDnsEntries getQsReverseDns($id)
...
# **getQsWelcomeEmail**
> \Interserver\MyAdmin\Model\TextResponse getQsWelcomeEmail($id)
...
# **postQsBackup**
> \Interserver\MyAdmin\Model\QueueResponse postQsBackup($id)
...
> \Interserver\MyAdmin\Model\QueueResponse postQsChangeHostname($id)
...
> \Interserver\MyAdmin\Model\QueueResponse postQsChangeRootPassword($id)
...
> \Interserver\MyAdmin\Model\QueueResponse postQsChangeTimezone($timezone, $id)
...
# **postQsChangeTimezone**
> \Interserver\MyAdmin\Model\QueueResponse postQsChangeTimezone($body, $id)
...
> \Interserver\MyAdmin\Model\QueueResponse postQsChangeWebuzoPassword($id)
...
# **postQsInsertCd**
> \Interserver\MyAdmin\Model\QueueResponse postQsInsertCd($id)
...
# **postQsReinstallOs**
> \Interserver\MyAdmin\Model\QueueResponse postQsReinstallOs($id)
...
# **postQsResetPassword**
> \Interserver\MyAdmin\Model\QueueResponse postQsResetPassword($id)
...
# **postQsReverseDns**
> \Interserver\MyAdmin\Model\TextResponse postQsReverseDns($body, $id)
...
# **postQsReverseDns**
> \Interserver\MyAdmin\Model\TextResponse postQsReverseDns($ips, $id)
...
# **postQsSetupVnc**
> \Interserver\MyAdmin\Model\QueueResponse postQsSetupVnc($id)
...
> \Interserver\MyAdmin\Model\QueueResponse postQuickServerRestore($body, $id)
...
$body = new \Interserver\MyAdmin\Model\RestoreRequest(); // \Interserver\MyAdmin\Model\RestoreRequest | QuickServer Restore request
$id = 56; // int | QuickServer ID number
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Interserver\MyAdmin\Model\RestoreRequest**](../Model/RestoreRequest.md)| QuickServer Restore request |
 **id** | **int**| QuickServer ID number |
...
# **postQuickServerRestore**
> \Interserver\MyAdmin\Model\QueueResponse postQuickServerRestore($backup, $password, $id)
...
# **quickserversCancel**
> \Interserver\MyAdmin\Model\InlineResponse20010 quickserversCancel($id)
...
[**\Interserver\MyAdmin\Model\InlineResponse20010**](../Model/InlineResponse20010.md)
