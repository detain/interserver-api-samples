...
# **addMail**
> \Interserver\MyAdmin\Model\ServiceOrderPostResponse addMail()
...
# **updateMailInfo**
> \Interserver\MyAdmin\Model\SuccessTextResponse updateMailInfo($id)
...
try {
    $result = $apiInstance->updateMailInfo($id);
    print_r($result);
} catch (Exception $e) {
...
# **viewMailLog**
> \Interserver\MyAdmin\Model\MailLog viewMailLog($id, $id, $origin, $mx, $from, $to, $subject, $mailid, $messageId, $replyto, $headerfrom, $delivered, $skip, $limit, $startDate, $endDate, $sort, $dir, $groupby)
...
$startDate = new \Interserver\MyAdmin\Model\StartDate(); // \Interserver\MyAdmin\Model\StartDate | Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-15` or `last monday`.  Messages with a `time` value **greater than or equal to** this value will be included.
$endDate = new \Interserver\MyAdmin\Model\EndDate(); // \Interserver\MyAdmin\Model\EndDate | Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-31` or `yesterday`. Messages with a `time` value **less than or equal to** this value will be included.
...
try {
    $result = $apiInstance->viewMailLog($id, $id, $origin, $mx, $from, $to, $subject, $mailid, $messageId, $replyto, $headerfrom, $delivered, $skip, $limit, $startDate, $endDate, $sort, $dir, $groupby);
    print_r($result);
} catch (Exception $e) {
 ...
 **startDate** | [**\Interserver\MyAdmin\Model\StartDate**](../Model/.md)| Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-15&#x60; or &#x60;last monday&#x60;.  Messages with a &#x60;time&#x60; value **greater than or equal to** this value will be included. | [optional]
 **endDate** | [**\Interserver\MyAdmin\Model\EndDate**](../Model/.md)| Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-31&#x60; or &#x60;yesterday&#x60;. Messages with a &#x60;time&#x60; value **less than or equal to** this value will be included. | [optional]
