 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BuyItNowRow implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BuyItNowRow';
    ...
    protected static $swaggerTypes = [
        'serverId' => 'string',
        'cpu' => '\Interserver\MyAdmin\Model\OneOfBuyItNowRowCpuItems[]',
        'memory' => 'string',
     ...
     * Sets serverId
     *
     * @param string $serverId Unique server ID. Use this as `server_id` in `POST /servers/order/buy_now_server`.
     *
     * @return $this
     */
     ...
     * Gets cpu
     *
     * @return \Interserver\MyAdmin\Model\OneOfBuyItNowRowCpuItems[]
     */
     ...
     * Sets cpu
     *
     * @param \Interserver\MyAdmin\Model\OneOfBuyItNowRowCpuItems[] $cpu cpu
     *
     * @return $this
     */
     ...
     * Sets disk
     *
     * @param map[string,string] $disk disk
     *
     * @return $this
     */
