...
namespace Example
{
    public class DownloadQsBackupExample
    {
        public void main()
        {
            ...
            {
                // Download QuickServer Backup
                InlineResponse20011 result = apiInstance.DownloadQsBackup(body, id, all);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
...
namespace Example
{
    public class PostQsBackupExample
    {
        public void main()
        {
            // Configure API key authorization: apiKeyAuth
            ...
            {
                Debug.Print("Exception when calling QuickServersApi.PostQsBackup: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class QuickserversCancelExample
    {
        public void main()
        {
            ...
            {
                // Cancel QuickServer Order
                InlineResponse20010 result = apiInstance.QuickserversCancel(id);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
