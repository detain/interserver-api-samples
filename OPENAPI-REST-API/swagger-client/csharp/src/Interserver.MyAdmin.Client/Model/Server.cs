...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class Server :  IEquatable<Server>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="ipmiAuth">ipmiAuth (required).</param>
        ...
        /// <param name="networkInfo">networkInfo (required).</param>
        /// <param name="extraInfoTables">extraInfoTables (required).</param>
        /// <param name="serviceInfo">serviceInfo (required).</param>
        public Server(bool? ipmiAuth = default(bool?), List<ServerClientLink> clientLinks = default(List<ServerClientLink>), ServerBillingDetails billingDetails = default(ServerBillingDetails), string custCurrency = default(string), string custCurrencySymbol = default(string), string package = default(string), List<string> serviceExtra = default(List<string>), ServerLocations locations = default(ServerLocations), ServerNetworkInfo networkInfo = default(ServerNetworkInfo), ServerExtraInfoTables extraInfoTables = default(ServerExtraInfoTables), ServerServiceInfo serviceInfo = default(ServerServiceInfo))
        {
            // to ensure "ipmiAuth" is required (not null)
            if (ipmiAuth == null)
            {
                throw new InvalidDataException("ipmiAuth is a required property for Server and cannot be null");
            }
            else
            {
            ...
            if (clientLinks == null)
            {
                throw new InvalidDataException("clientLinks is a required property for Server and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("billingDetails is a required property for Server and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("custCurrency is a required property for Server and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("custCurrencySymbol is a required property for Server and cannot be null");
            }
            else
            {
            ...
            if (package == null)
            {
                throw new InvalidDataException("package is a required property for Server and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serviceExtra is a required property for Server and cannot be null");
            }
            else
            {
            ...
            if (locations == null)
            {
                throw new InvalidDataException("locations is a required property for Server and cannot be null");
            }
            else
            {
                this.locations = locations;
            }
            // to ensure "networkInfo" is required (not null)
            if (networkInfo == null)
            {
                throw new InvalidDataException("networkInfo is a required property for Server and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("extraInfoTables is a required property for Server and cannot be null");
            }
            else
            {
            ...
            if (serviceInfo == null)
            {
                throw new InvalidDataException("serviceInfo is a required property for Server and cannot be null");
            }
            else
            {
        ...
        public List<ServerClientLink> client_links { get; set; }
        ...
        public bool Equals(Server input)
        {
            ...
            return 
                (
                    this.ipmiAuth == input.ipmiAuth ||
                    (this.ipmiAuth != null &&
                    this.ipmiAuth.Equals(input.ipmiAuth))
                ) && 
                (
                ...
                (
                    this.networkInfo == input.networkInfo ||
                    (this.networkInfo != null &&
                    this.networkInfo.Equals(input.networkInfo))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ipmiAuth != null)
                    hashCode = hashCode * 59 + this.ipmiAuth.GetHashCode();
                ...
                if (this.networkInfo != null)
                    hashCode = hashCode * 59 + this.networkInfo.GetHashCode();
