...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BackupsOrder :  IEquatable<BackupsOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupsOrder" /> class.
        /// </summary>
        /// <param name="packageCosts">packageCosts (required).</param>
        /// <param name="serviceTypes">serviceTypes (required).</param>
        public BackupsOrder(BackupsOrderPackageCosts packageCosts = default(BackupsOrderPackageCosts), BackupsOrderServiceTypes serviceTypes = default(BackupsOrderServiceTypes))
        {
            // to ensure "packageCosts" is required (not null)
            if (packageCosts == null)
            {
                throw new InvalidDataException("packageCosts is a required property for BackupsOrder and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("serviceTypes is a required property for BackupsOrder and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BackupsOrder);
        }

        /// <summary>
        /// Returns true if BackupsOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of BackupsOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackupsOrder input)
        {
            if (input == null)
                return false;
