...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainContactDetails :  IEquatable<DomainContactDetails>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainContactDetails" /> class.
        /// </summary>
        /// <param name="status">Contact status reported by the registrar..</param>
        /// <param name="state">State or region for the contact address..</param>
        /// <param name="orgName">Organization name for the contact..</param>
        /// <param name="country">Two-letter country code for the contact..</param>
        /// <param name="postalCode">Postal or ZIP code for the contact address..</param>
        /// <param name="email">Email address for the contact..</param>
        /// <param name="fax">Fax number for the contact, if available..</param>
        /// <param name="address2">Secondary street address line..</param>
        /// <param name="address3">Tertiary street address line..</param>
        /// <param name="address1">Primary street address line..</param>
        /// <param name="city">City for the contact address..</param>
        /// <param name="phone">Phone number for the contact..</param>
        /// <param name="firstName">First name for the contact..</param>
        /// <param name="lastName">Last name for the contact..</param>
        public DomainContactDetails(string status = default(string), string state = default(string), string orgName = default(string), string country = default(string), string postalCode = default(string), string email = default(string), string fax = default(string), string address2 = default(string), string address3 = default(string), string address1 = default(string), string city = default(string), string phone = default(string), string firstName = default(string), string lastName = default(string))
        {
            this.status = status;
            this.state = state;
        ...
        {
            return this.Equals(input as DomainContactDetails);
        }

        /// <summary>
        /// Returns true if DomainContactDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainContactDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainContactDetails input)
        {
            if (input == null)
                return false;
