...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigIds :  IEquatable<ConfigIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigIds" /> class.
        /// </summary>
        /// <param name="memory">Configuration ID for the selected memory option..</param>
        /// <param name="hd">Configuration ID for the selected hard drive option..</param>
        /// <param name="bandwidth">Configuration ID for the selected bandwidth option..</param>
        /// <param name="ips">Configuration ID for the selected IP block option..</param>
        /// <param name="os">Configuration ID for the selected operating system..</param>
        /// <param name="cp">Configuration ID for the selected control panel..</param>
        /// <param name="raid">Configuration ID for the selected RAID option..</param>
        public ConfigIds(int? memory = default(int?), int? hd = default(int?), int? bandwidth = default(int?), int? ips = default(int?), int? os = default(int?), int? cp = default(int?), int? raid = default(int?))
        {
            this.memory = memory;
            this.hd = hd;
        ...
        {
            return this.Equals(input as ConfigIds);
        }

        /// <summary>
        /// Returns true if ConfigIds instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigIds input)
        {
            if (input == null)
                return false;
