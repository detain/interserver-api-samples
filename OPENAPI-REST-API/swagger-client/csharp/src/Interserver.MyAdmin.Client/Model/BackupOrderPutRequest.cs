...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BackupOrderPutRequest :  IEquatable<BackupOrderPutRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BackupOrderPutRequest" /> class.
        /// </summary>
        /// <param name="validateOnly">validateOnly.</param>
        /// <param name="serviceType">serviceType.</param>
        /// <param name="coupon">coupon.</param>
        public BackupOrderPutRequest(bool? validateOnly = default(bool?), int? serviceType = default(int?), string coupon = default(string))
        {
        ...
        {
            return this.Equals(input as BackupOrderPutRequest);
        }

        /// <summary>
        /// Returns true if BackupOrderPutRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BackupOrderPutRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackupOrderPutRequest input)
        {
            if (input == null)
                return false;
