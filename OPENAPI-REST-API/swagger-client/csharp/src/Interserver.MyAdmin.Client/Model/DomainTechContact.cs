...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainTechContact :  IEquatable<DomainTechContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainTechContact" /> class.
        /// </summary>
        ...
        public DomainTechContact(string state = default(string), string status = default(string), string orgName = default(string), string country = default(string), string postalCode = default(string), string fax = default(string), string email = default(string), string address2 = default(string), string address3 = default(string), string address1 = default(string), string city = default(string), string phone = default(string), string firstName = default(string), string lastName = default(string))
        {
            this.state = state;
            this.status = status;
        ...
        {
            return this.Equals(input as DomainTechContact);
        }

        /// <summary>
        /// Returns true if DomainTechContact instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainTechContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainTechContact input)
        {
            if (input == null)
                return false;
