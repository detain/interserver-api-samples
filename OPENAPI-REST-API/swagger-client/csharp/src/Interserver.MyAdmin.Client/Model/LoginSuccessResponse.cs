...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class LoginSuccessResponse :  IEquatable<LoginSuccessResponse>, IValidatableObject
    {
        ...
        public LoginSuccessResponse(string sessionId = default(string), int? accountId = default(int?), string accountLid = default(string), string ima = default(string), string gravatar = default(string))
        {
