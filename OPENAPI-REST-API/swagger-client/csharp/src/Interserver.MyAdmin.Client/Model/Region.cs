...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class Region :  IEquatable<Region>, IValidatableObject
    {
        ...
        public Region(int? regionId = default(int?), string regionName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  region_name: ").Append(region_name).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(Region input)
        {
            ...
            return 
                (
                    ...
                    (this.region_id != null &&
                    this.region_id.Equals(input.region_id))
                ) && 
                (
                    this.region_name == input.region_name ||
                    (this.region_name != null &&
                    this.region_name.Equals(input.region_name))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.region_id != null)
                    hashCode = hashCode * 59 + this.region_id.GetHashCode();
                if (this.region_name != null)
                    hashCode = hashCode * 59 + this.region_name.GetHashCode();
                return hashCode;
            }
        }
