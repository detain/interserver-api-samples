...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServerOrderConfigIds :  IEquatable<ServerOrderConfigIds>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerOrderConfigIds" /> class.
        /// </summary>
        /// <param name="memory">Memory configuration ID for the server order..</param>
        /// <param name="bandwidth">Bandwidth configuration ID for the server order..</param>
        /// <param name="ips">IPs configuration ID for the server order..</param>
        /// <param name="os">Operating System configuration ID for the server order..</param>
        /// <param name="cp">Control Panel configuration ID for the server order..</param>
        /// <param name="raid">RAID configuration ID for the server order..</param>
        /// <param name="hd">Hard Drives configuration ID for the server order..</param>
        public ServerOrderConfigIds(int? memory = default(int?), string bandwidth = default(string), string ips = default(string), string os = default(string), int? cp = default(int?), string raid = default(string), string hd = default(string))
        {
            this.memory = memory;
        ...
        {
            return this.Equals(input as ServerOrderConfigIds);
        }

        /// <summary>
        /// Returns true if ServerOrderConfigIds instances are equal
        /// </summary>
        /// <param name="input">Instance of ServerOrderConfigIds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerOrderConfigIds input)
        {
            if (input == null)
                return false;
