...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainAdminContact :  IEquatable<DomainAdminContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainAdminContact" /> class.
        /// </summary>
        ...
        public DomainAdminContact(string status = default(string), string state = default(string), string orgName = default(string), string country = default(string), string postalCode = default(string), string email = default(string), string fax = default(string), string address2 = default(string), string address3 = default(string), string address1 = default(string), string city = default(string), string phone = default(string), string firstName = default(string), string lastName = default(string))
        {
            this.status = status;
            this.state = state;
        ...
        {
            return this.Equals(input as DomainAdminContact);
        }

        /// <summary>
        /// Returns true if DomainAdminContact instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainAdminContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainAdminContact input)
        {
            if (input == null)
                return false;
