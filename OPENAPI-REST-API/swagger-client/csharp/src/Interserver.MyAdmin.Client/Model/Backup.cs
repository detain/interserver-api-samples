...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class Backup :  IEquatable<Backup>, IValidatableObject
    {
        ...
        /// <param name="custCurrencySymbol">Customer&#x27;s currency symbol..</param>
        ...
        public Backup(BackupServiceInfo serviceInfo = default(BackupServiceInfo), List<BackupClientLink> clientLinks = default(List<BackupClientLink>), BackupBillingDetails billingDetails = default(BackupBillingDetails), string custCurrency = default(string), string custCurrencySymbol = default(string), BackupServiceMaster serviceMaster = default(BackupServiceMaster), string package = default(string), string serviceExtra = default(string), BackupExtraInfoTables extraInfoTables = default(BackupExtraInfoTables))
        {
        ...
        public List<BackupClientLink> client_links { get; set; }
