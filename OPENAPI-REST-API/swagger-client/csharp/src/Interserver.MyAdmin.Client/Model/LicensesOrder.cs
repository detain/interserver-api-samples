...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LicensesOrder :  IEquatable<LicensesOrder>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LicensesOrder" /> class.
        /// </summary>
        /// <param name="serviceCategories">serviceCategories.</param>
        /// <param name="packageCosts">packageCosts.</param>
        /// <param name="serviceTypes">serviceTypes.</param>
        public LicensesOrder(LicensesOrderServiceCategories serviceCategories = default(LicensesOrderServiceCategories), LicensesOrderPackageCosts packageCosts = default(LicensesOrderPackageCosts), LicensesOrderServiceTypes serviceTypes = default(LicensesOrderServiceTypes))
        {
        ...
        {
            return this.Equals(input as LicensesOrder);
        }

        /// <summary>
        /// Returns true if LicensesOrder instances are equal
        /// </summary>
        /// <param name="input">Instance of LicensesOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LicensesOrder input)
        {
            if (input == null)
                return false;
