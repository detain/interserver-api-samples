...
namespace Interserver.MyAdmin.Client.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RestoreRequest :  IEquatable<RestoreRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RestoreRequest(string backup = default(string), string password = default(string))
        {
            this.backup = backup;
        ...
        /// <summary>
        /// Returns true if RestoreRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RestoreRequest to be compared</param>
        /// <returns>Boolean</returns>
