...
namespace Interserver.MyAdmin.Client.Model
{
        ...
        public partial class InlineResponse20022 :  IEquatable<InlineResponse20022>, IValidatableObject
    {
        ...
        public InlineResponse20022(bool? success = default(bool?), string text = default(string))
        {
            // to ensure "success" is required (not null)
            if (success == null)
            {
                throw new InvalidDataException("success is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
            ...
            if (text == null)
            {
                throw new InvalidDataException("text is a required property for InlineResponse20022 and cannot be null");
            }
            else
            {
                this.text = text;
