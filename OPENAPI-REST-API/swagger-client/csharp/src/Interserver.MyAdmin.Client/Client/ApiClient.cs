...
namespace Interserver.MyAdmin.Client.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Interserver.MyAdmin.Client.Client.Configuration.Default;
            RestClient = new RestClient("https://my.interserver.net/apiv2");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://my.interserver.net/apiv2).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Interserver.MyAdmin.Client.Client.Configuration.Default;
