...
//import io.swagger.client.api.BackupsApi;
...
BackupsApi apiInstance = new BackupsApi();
BackupOrderPutRequest body = new BackupOrderPutRequest(); // BackupOrderPutRequest | 
try {
    BackupOrderPostResponse result = apiInstance.addBackup(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling BackupsApi#addBackup");
    e.printStackTrace();
...
BackupOrderPutRequest body = new BackupOrderPutRequest(); // BackupOrderPutRequest | 
try {
    BackupOrderPutResponse result = apiInstance.validateBackupOrder(body);
    System.out.println(result);
} catch (ApiException e) {
    System.err.println("Exception when calling BackupsApi#validateBackupOrder");
    e.printStackTrace();
