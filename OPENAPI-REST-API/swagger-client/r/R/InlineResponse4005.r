  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse4005Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse4005Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse4005Json) {
      ...
      if (!is.null(InlineResponse4005Object$`success`)) {
        self$`success` <- InlineResponse4005Object$`success`
      }
      if (!is.null(InlineResponse4005Object$`text`)) {
        self$`text` <- InlineResponse4005Object$`text`
      }
    },
