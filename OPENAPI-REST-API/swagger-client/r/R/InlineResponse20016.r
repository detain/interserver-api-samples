  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse20016Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse20016Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse20016Json) {
      ...
      if (!is.null(InlineResponse20016Object$`success`)) {
        self$`success` <- InlineResponse20016Object$`success`
      }
      if (!is.null(InlineResponse20016Object$`text`)) {
        self$`text` <- InlineResponse20016Object$`text`
      }
    },
