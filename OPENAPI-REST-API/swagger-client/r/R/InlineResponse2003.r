  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse2003Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse2003Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse2003Json) {
      ...
      if (!is.null(InlineResponse2003Object$`success`)) {
        self$`success` <- InlineResponse2003Object$`success`
      }
      if (!is.null(InlineResponse2003Object$`text`)) {
        self$`text` <- InlineResponse2003Object$`text`
      }
    },
