  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse20015Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse20015Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse20015Json) {
      ...
      if (!is.null(InlineResponse20015Object$`success`)) {
        self$`success` <- InlineResponse20015Object$`success`
      }
      if (!is.null(InlineResponse20015Object$`text`)) {
        self$`text` <- InlineResponse20015Object$`text`
      }
    },
