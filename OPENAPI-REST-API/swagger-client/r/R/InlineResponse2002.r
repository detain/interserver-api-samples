  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse2002Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse2002Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse2002Json) {
      ...
      if (!is.null(InlineResponse2002Object$`success`)) {
        self$`success` <- InlineResponse2002Object$`success`
      }
      if (!is.null(InlineResponse2002Object$`text`)) {
        self$`text` <- InlineResponse2002Object$`text`
      }
    },
