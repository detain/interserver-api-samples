  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse400Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse400Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse400Json) {
      ...
      if (!is.null(InlineResponse400Object$`success`)) {
        self$`success` <- InlineResponse400Object$`success`
      }
      if (!is.null(InlineResponse400Object$`text`)) {
        self$`text` <- InlineResponse400Object$`text`
      }
    },
