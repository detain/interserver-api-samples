  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse500Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse500Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse500Json) {
      ...
      if (!is.null(InlineResponse500Object$`success`)) {
        self$`success` <- InlineResponse500Object$`success`
      }
      if (!is.null(InlineResponse500Object$`text`)) {
        self$`text` <- InlineResponse500Object$`text`
      }
    },
