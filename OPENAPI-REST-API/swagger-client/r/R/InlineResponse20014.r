  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse20014Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse20014Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse20014Json) {
      ...
      if (!is.null(InlineResponse20014Object$`success`)) {
        self$`success` <- InlineResponse20014Object$`success`
      }
      if (!is.null(InlineResponse20014Object$`text`)) {
        self$`text` <- InlineResponse20014Object$`text`
      }
    },
