  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse2004Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse2004Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse2004Json) {
      ...
      if (!is.null(InlineResponse2004Object$`success`)) {
        self$`success` <- InlineResponse2004Object$`success`
      }
      if (!is.null(InlineResponse2004Object$`text`)) {
        self$`text` <- InlineResponse2004Object$`text`
      }
    },
