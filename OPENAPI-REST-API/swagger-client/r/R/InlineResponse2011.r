  ...
  public = list(
    ...
    toJSON = function() {
      ...
      if (!is.null(self$`success`)) {
        InlineResponse2011Object[['success']] <- self$`success`
      }
      if (!is.null(self$`text`)) {
        InlineResponse2011Object[['text']] <- self$`text`
      }
    ...
    fromJSON = function(InlineResponse2011Json) {
      ...
      if (!is.null(InlineResponse2011Object$`success`)) {
        self$`success` <- InlineResponse2011Object$`success`
      }
      if (!is.null(InlineResponse2011Object$`text`)) {
        self$`text` <- InlineResponse2011Object$`text`
      }
    },
