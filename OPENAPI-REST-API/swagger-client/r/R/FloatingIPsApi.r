...
#' @description myadmin-client-r.FloatingIPs
#'
...
FloatingIPsApi <- R6::R6Class(
  ...
  public = list(
    ...
    floating_ips_cancel = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      urlPath <- "/floating_ips/{id}"
      if (!missing(`id`)) {
    ...
    get_floating_ip_info = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    get_floating_ip_invoices = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      urlPath <- "/floating_ips/{id}/invoices"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    get_floating_ips_list = function(...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
    ...
    get_floating_ips_welcome_email = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()

      urlPath <- "/floating_ips/{id}/welcome_email"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    post_floating_ips_change_ip = function(ip, body, id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
      ...
      urlPath <- "/floating_ips/{id}/change_ip"
      if (!missing(`id`)) {
        urlPath <- gsub(paste0("\\{", "id", "\\}"), `id`, urlPath)
      }
    ...
    update_floating_ip_info = function(id, ...){
      args <- list(...)
      queryParams <- list()
      headerParams <- character()
