...
public class MailApiServiceImpl implements MailApi {
     ...
     *
     */
    public MailLog viewMailLog(Integer id, Long id, String origin, String mx, String from, String to, String subject, String mailid, Integer skip, Integer limit, Long startDate, Long endDate, String delivered) {
        // TODO: Implement...
