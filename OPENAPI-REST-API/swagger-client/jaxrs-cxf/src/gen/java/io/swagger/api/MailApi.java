...
public interface MailApi  {
    ...
    @Operation(summary = "Place Mail Order", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create Deny Rule", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    public GenericResponse addRule(@Valid DenyRuleNew body, @PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create Mail Alert", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public SuccessTextResponse createMailAlert(@Valid MailAlertRequest body, @PathParam("id") Integer id);
    ...
    @Path("/mail/{id}/alerts")
    @Produces({ "application/json" })
    @Operation(summary = "Delete Mail Alert", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public SuccessTextResponse deleteMailAlert(@PathParam("id") Integer id, @QueryParam("alert_id") @NotNull Integer alertId);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Delete Deny Rule", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Remove Email Address from Block List", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public GenericResponse delistBlock(@Valid EmailAddress body, @PathParam("id") Integer id);
    ...
    @Path("/mail/{id}/alerts")
    @Produces({ "application/json" })
    @Operation(summary = "List Mail Alerts", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/blocks")
    @Produces({ "application/json" })
    @Operation(summary = "List Blocked Email Addresses", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/delist")
    @Produces({ "application/json" })
    @Operation(summary = "Get Delist Status", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Deliverability Metrics", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get Mail Order", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Mail Invoices", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail")
    @Produces({ "application/json" })
    @Operation(summary = "List Mail Orders", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend Mail Welcome Email", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/mail/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get Mail Ordering Information", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/rules")
    @Produces({ "application/json" })
    @Operation(summary = "List Deny Rules", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}/stats")
    @Produces({ "application/json" })
    @Operation(summary = "Get Mail Usage Statistics", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel Mail", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Delist a Blocked Sender", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public SuccessTextResponse postMailDelist(@Valid MailDelistRequest body, @PathParam("id") Integer id);
    ...
    @Path("/mail/order")
    @Produces({ "application/json" })
    @Operation(summary = "Validate Mail Order", tags={ "Mail" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Reset Mail Password", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Consumes({ "application/json", "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @Operation(summary = "Send Email with Advanced Options", tags={ "Mail" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public GenericResponse sendAdvMail(@Valid SendMailAdv body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "application/x-www-form-urlencoded" })
    @Produces({ "application/json" })
    @Operation(summary = "Send Email", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Email queued successfully.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = GenericResponse.class))),
        @ApiResponse(responseCode = "400", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public GenericResponse sendMail(@Valid SendMail body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "Update Mail Alert", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public SuccessTextResponse updateMailAlert(@Valid MailAlertUpdateRequest body, @PathParam("id") Integer id);
    ...
    @Path("/mail/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update Mail Order", tags={ "Mail" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    ...
    @Path("/mail/{id}/log")
    @Produces({ "application/json" })
    @Operation(summary = "View Mail Log", tags={ "Mail" })
    @ApiResponses(value = { 
