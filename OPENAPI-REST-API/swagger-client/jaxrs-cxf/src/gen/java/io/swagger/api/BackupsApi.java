...
public interface BackupsApi  {
    ...
    @Operation(summary = "Place Backup Order", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    public BackupOrderPostResponse addBackup(@Valid BackupOrderPutRequest body);
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel Backup Service", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get Backup Service Details", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Backup Order Invoices", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Backup Storage Panel Login", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups")
    @Produces({ "application/json" })
    @Operation(summary = "List Backup Services", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend Backup Welcome Email", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get Backup Order Form Data", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @Path("/backups/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update Backup Information", tags={ "Backups" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    ...
    @Consumes({ "multipart/form-data", "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Validate Backup Order", tags={ "Backups" })
    @ApiResponses(value = { 
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Backup Order Response", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BackupOrderPutResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public BackupOrderPutResponse validateBackupOrder(@Valid BackupOrderPutRequest body);
}
