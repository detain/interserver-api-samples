...
public interface PublicApi  {
    ...
    @Operation(summary = "Get Captcha Challenge", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Countries", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Path("/info")
    @Produces({ "application/json" })
    @Operation(summary = "Get Server Info", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Path("/login")
    @Produces({ "application/json" })
    @Operation(summary = "Get Login Info", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Path("/oauth")
    @Produces({ "application/json" })
    @Operation(summary = "Get OAuth Redirect URL", tags={ "Public" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2005 getOauthRedirect(@QueryParam("provider") @NotNull String provider);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Available Timezones", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Complete OAuth Two-Factor Verification", tags={ "Public" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2007 patchOauthTwoFactor(@Valid OauthBody2 body);
    ...
    @Path("/ping")
    @Produces({ "application/json" })
    @Operation(summary = "Ping Server", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json", "multipart/form-data" })
    @Produces({ "application/json" })
    @Operation(summary = "OAuth Callback", tags={ "Public" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2006 postOauthCallback(@QueryParam("provider") @NotNull String provider, @Valid OauthBody body);
    ...
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "OAuth callback result.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2006.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public InlineResponse2006 postOauthCallback(@QueryParam("provider") @NotNull String provider, @Multipart(value = "provider", required = false)  String provider2);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Submit Login Information", tags={ "Public" })
    @ApiResponses(value = { 
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "402", description = "Error response to a login request.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LoginErrorResponse.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    public LoginSuccessResponse submitLogin(@Valid LoginSubmissionExample body);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Submit Signup Information", tags={ "Public" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Account created successfully."),
        @ApiResponse(responseCode = "402", description = "Error response to a login request.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = LoginErrorResponse.class))) })
    public void submitSignup(@Valid LoginSubmissionExample body);
}
