...
public interface SslCertificatesApi  {
    ...
    @Operation(summary = "Place SSL Cert Order", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/order")
    @Produces({ "application/json" })
    @Operation(summary = "SSL Cert Ordering Information", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get SSL Cert Info", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get SSL Cert Invoices", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl")
    @Produces({ "application/json" })
    @Operation(summary = "List SSL Certs", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend SSL Welcome Email", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/order")
    @Produces({ "application/json" })
    @Operation(summary = "Validate SSL Cert Order", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel SSL Certificate Service", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
    ...
    @Path("/ssl/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Update SSL Cert Order", tags={ "SSL-Certificates" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
