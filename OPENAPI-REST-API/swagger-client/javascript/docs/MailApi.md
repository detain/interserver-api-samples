...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.DenyRuleNew(); // DenyRuleNew | These are the fields needed to create a new email deny rule.
...
apiInstance.addRule(body, user, type, data, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.MailAlertRequest(); // MailAlertRequest | 
let type = "type_example"; // String | 
let value = "value_example"; // String | 
let to = "to_example"; // String | 
let enabled = "enabled_example"; // String | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.

apiInstance.createMailAlert(body, type, value, to, enabled, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let body = new InterServerManagementApi.EmailAddress(); // EmailAddress | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.

apiInstance.delistBlock(email, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.MailDelistRequest(); // MailDelistRequest | 
let unblock = "unblock_example"; // String | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.

apiInstance.postMailDelist(body, unblock, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.SendMailAdv(); // SendMailAdv | 
let subject = "subject_example"; // String | 
let body = "body_example"; // String | 
let from = new InterServerManagementApi.EmailAddressName(); // EmailAddressName | 
let to = [new InterServerManagementApi.EmailAddressName()]; // [EmailAddressName] | 
let replyto = [new InterServerManagementApi.EmailAddressName()]; // [EmailAddressName] | 
let cc = [new InterServerManagementApi.EmailAddressName()]; // [EmailAddressName] | 
let bcc = [new InterServerManagementApi.EmailAddressName()]; // [EmailAddressName] | 
let attachments = [new InterServerManagementApi.MailAttachment()]; // [MailAttachment] | 
let id = 789; // Number | 
let id = 56; // Number | The mail service ID. Use `mail_id` from `GET /mail`.

apiInstance.sendAdvMail(body, subject, body, from, to, replyto, cc, bcc, attachments, id, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.SendMail(); // SendMail | 
let to = "to_example"; // String | 
...
apiInstance.sendMail(body, to, from, subject, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
# **updateMailAlert**
> SuccessTextResponse updateMailAlert(body, alert_id, type, value, to, enabled, id)
...
let apiInstance = new InterServerManagementApi.MailApi();
let body = new InterServerManagementApi.MailAlertUpdateRequest(); // MailAlertUpdateRequest | 
let alert_id = 56; // Number | 
let type = "type_example"; // String | 
let value = "value_example"; // String | 
let to = "to_example"; // String | 
let enabled = "enabled_example"; // String | 
...
apiInstance.updateMailAlert(body, alert_id, type, value, to, enabled, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let opts = { 
  ...
  'messageId': "messageId_example", // String | Filter by the `Message-ID` email header using a substring (case-insensitive) match.  The `Message-ID` is assigned by the sending mail client and is visible in the `messageId` field of `MailLogEntry`.
  ...
  'startDate': new InterServerManagementApi.StartDate(), // StartDate | Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-15` or `last monday`.  Messages with a `time` value **greater than or equal to** this value will be included.
  'endDate': new InterServerManagementApi.EndDate(), // EndDate | Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by `strtotime()` such as `2024-01-31` or `yesterday`.  Messages with a `time` value **less than or equal to** this value will be included.
