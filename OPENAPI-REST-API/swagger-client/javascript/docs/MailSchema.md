# InterServerManagementApi.MailSchema

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**serviceInfo** | [**MailServiceInfo**](MailServiceInfo.md) |  | 
**client_links** | [**[MailClientLink]**](MailClientLink.md) | Links related to the mail service for clients. | 
...
**_package** | **String** | The package of the mail service. | 
