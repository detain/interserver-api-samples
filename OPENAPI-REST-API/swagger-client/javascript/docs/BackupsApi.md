# InterServerManagementApi.BackupsApi
...
let apiInstance = new InterServerManagementApi.BackupsApi();
let validateOnly = true; // Boolean | 
let serviceType = 56; // Number | 
let coupon = "coupon_example"; // String | 
let body = new InterServerManagementApi.BackupOrderPutRequest(); // BackupOrderPutRequest | 

apiInstance.addBackup(validateOnly, serviceType, coupon, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.cancelBackup(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getBackupInfo(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getBackupInvoices(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getBackupLogin(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.BackupsApi();
apiInstance.getBackupsList((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getBackupsWelcomeEmail(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.BackupsApi();
apiInstance.getNewBackup((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.updateBackupInfo(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.validateBackupOrder(validateOnly, serviceType, coupon, body, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
