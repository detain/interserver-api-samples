...
let opts = { 
  'body': new InterServerManagementApi.VpsOrderPostRequest(), // VpsOrderPostRequest | 
...
# **downloadVpsBackup**
> InlineResponse20011 downloadVpsBackup(body, file, id, opts)
...
let apiInstance = new InterServerManagementApi.VPSApi();
let body = new InterServerManagementApi.IdBackupsBody2(); // IdBackupsBody2 | 
let file = "file_example"; // String | 
let id = 56; // Number | VPS ID number
let opts = { 
  'all': "all_example" // String | Set to `1` to list all backups across all services, not just the ones for the given VPS.
};
apiInstance.downloadVpsBackup(body, file, id, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let body = new InterServerManagementApi.HostnameObject(); // HostnameObject | 
let id = 56; // Number | VPS ID number

apiInstance.postVpsChangeHostname(hostname, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.postVpsChangeRootPassword(password, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.postVpsChangeTimezone(timezone, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.postVpsChangeWebuzoPassword(password, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let body = new InterServerManagementApi.UrlRequest(); // UrlRequest | 
let id = 56; // Number | VPS ID number

apiInstance.postVpsInsertCd(url, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let password = "password_example"; // String | 
let localPassword = "localPassword_example"; // String | 
let body = new InterServerManagementApi.TemplateRequest(); // TemplateRequest | 
let id = 56; // Number | VPS ID number

apiInstance.postVpsReinstallOs(template, password, localPassword, body, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.VPSApi();
let body = new InterServerManagementApi.RestoreRequest(); // RestoreRequest | VPS Restore request
let backup = "backup_example"; // String | 
let password = "password_example"; // String | 
let id = 56; // Number | VPS ID number

apiInstance.postVpsRestore(body, backup, password, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.postVpsReverseDns(body, ips, id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.VPSApi();
let opts = { 
  'body': new InterServerManagementApi.VpsOrderPutRequest(), // VpsOrderPutRequest | 
  'osDistro': "osDistro_example", // String | 
  'slices': 56, // Number | 
  'vpsPlatform': "vpsPlatform_example", // String | 
  'controlpanel': "controlpanel_example", // String | 
