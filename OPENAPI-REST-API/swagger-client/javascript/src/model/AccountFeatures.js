 ...
 * @version 0.9.0
 */
export default class AccountFeatures {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('disable_reset'))
        obj.disable_reset = ApiClient.convertToType(data['disable_reset'], 'Number');
      if (data.hasOwnProperty('disable_reinstall'))
        obj.disable_reinstall = ApiClient.convertToType(data['disable_reinstall'], 'Number');
    }
    return obj;
  }
}
...
/**
 * @member {Number} disable_reset
 */
AccountFeatures.prototype.disable_reset = undefined;

/**
 * @member {Number} disable_reinstall
 */
AccountFeatures.prototype.disable_reinstall = undefined;
