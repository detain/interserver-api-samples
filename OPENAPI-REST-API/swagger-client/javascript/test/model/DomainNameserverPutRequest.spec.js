  ...
  describe('(package)', function() {
    describe('DomainNameserverPutRequest', function() {
      ...
      it('should create an instance of DomainNameserverPutRequest', function() {
        // TODO: update the code to test DomainNameserverPutRequest
      ...
      it('should have the property nameserver (base name: "nameserver")', function() {
        // TODO: update the code to test the property nameserver
        expect(instance).to.have.property('nameserver');
        // expect(instance.nameserver).to.be(expectedValueLiteral);
      });
