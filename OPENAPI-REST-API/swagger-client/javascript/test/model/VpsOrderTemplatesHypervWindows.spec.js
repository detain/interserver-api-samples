  ...
  describe('(package)', function() {
    describe('VpsOrderTemplatesHypervWindows', function() {
      ...
      it('should create an instance of VpsOrderTemplatesHypervWindows', function() {
        // TODO: update the code to test VpsOrderTemplatesHypervWindows
      ...
      it('should have the property Windows2019Standard (base name: "Windows2019Standard")', function() {
        // TODO: update the code to test the property Windows2019Standard
        expect(instance).to.have.property('Windows2019Standard');
        // expect(instance.Windows2019Standard).to.be(expectedValueLiteral);
      });

      it('should have the property Windows2022 (base name: "Windows2022")', function() {
        // TODO: update the code to test the property Windows2022
        expect(instance).to.have.property('Windows2022');
        // expect(instance.Windows2022).to.be(expectedValueLiteral);
      });
