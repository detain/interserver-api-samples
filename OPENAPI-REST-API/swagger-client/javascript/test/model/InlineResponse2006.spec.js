...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2006', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.InlineResponse2006();
      });

      it('should create an instance of InlineResponse2006', function() {
        // TODO: update the code to test InlineResponse2006
        expect(instance).to.be.a(InterServerManagementApi.InlineResponse2006);
      });
      ...
      it('should have the property signup (base name: "signup")', function() {
        // TODO: update the code to test the property signup
        expect(instance).to.have.property('signup');
        // expect(instance.signup).to.be(expectedValueLiteral);
      });
