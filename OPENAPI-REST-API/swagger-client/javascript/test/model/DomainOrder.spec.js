  ...
  describe('(package)', function() {
    describe('DomainOrder', function() {
      ...
      it('should create an instance of DomainOrder', function() {
        // TODO: update the code to test DomainOrder
      ...
      it('should have the property whoisPrivacyCost (base name: "whoisPrivacyCost")', function() {
        // TODO: update the code to test the property whoisPrivacyCost
        expect(instance).to.have.property('whoisPrivacyCost');
        // expect(instance.whoisPrivacyCost).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property tldServices (base name: "tldServices")', function() {
        // TODO: update the code to test the property tldServices
        expect(instance).to.have.property('tldServices');
        // expect(instance.tldServices).to.be(expectedValueLiteral);
      });
