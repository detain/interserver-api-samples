...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdBuyIpBody1', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.IdBuyIpBody1();
      });

      it('should create an instance of IdBuyIpBody1', function() {
        // TODO: update the code to test IdBuyIpBody1
        expect(instance).to.be.a(InterServerManagementApi.IdBuyIpBody1);
      });
