...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DnsRecord', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.DnsRecord();
      });

      it('should create an instance of DnsRecord', function() {
        // TODO: update the code to test DnsRecord
        expect(instance).to.be.a(InterServerManagementApi.DnsRecord);
      });
      ...
      it('should have the property prio (base name: "prio")', function() {
        // TODO: update the code to test the property prio
        expect(instance).to.have.property('prio');
        // expect(instance.prio).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property ordername (base name: "ordername")', function() {
        // TODO: update the code to test the property ordername
        expect(instance).to.have.property('ordername');
        // expect(instance.ordername).to.be(expectedValueLiteral);
      });
