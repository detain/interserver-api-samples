...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OauthBody1', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.OauthBody1();
      });

      it('should create an instance of OauthBody1', function() {
        // TODO: update the code to test OauthBody1
        expect(instance).to.be.a(InterServerManagementApi.OauthBody1);
      });
