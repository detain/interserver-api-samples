...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfigIds', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.ConfigIds();
      });

      it('should create an instance of ConfigIds', function() {
        // TODO: update the code to test ConfigIds
        expect(instance).to.be.a(InterServerManagementApi.ConfigIds);
      });
