...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VpsClientLink', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.VpsClientLink();
      });

      it('should create an instance of VpsClientLink', function() {
        // TODO: update the code to test VpsClientLink
        expect(instance).to.be.a(InterServerManagementApi.VpsClientLink);
      });
