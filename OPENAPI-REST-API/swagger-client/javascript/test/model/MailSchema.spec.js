  ...
  describe('(package)', function() {
    describe('MailSchema', function() {
      ...
      it('should create an instance of MailSchema', function() {
        // TODO: update the code to test MailSchema
      ...
      it('should have the property usage_count (base name: "usage_count")', function() {
        // TODO: update the code to test the property usage_count
        expect(instance).to.have.property('usage_count');
        // expect(instance.usage_count).to.be(expectedValueLiteral);
      });
