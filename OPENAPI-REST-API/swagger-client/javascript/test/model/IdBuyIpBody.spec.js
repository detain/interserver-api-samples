...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IdBuyIpBody', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.IdBuyIpBody();
      });

      it('should create an instance of IdBuyIpBody', function() {
        // TODO: update the code to test IdBuyIpBody
        expect(instance).to.be.a(InterServerManagementApi.IdBuyIpBody);
      });
