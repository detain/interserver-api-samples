  ...
  describe('(package)', function() {
    describe('MailDelistRequest', function() {
      ...
      it('should create an instance of MailDelistRequest', function() {
        // TODO: update the code to test MailDelistRequest
      ...
      it('should have the property unblock (base name: "unblock")', function() {
        // TODO: update the code to test the property unblock
        expect(instance).to.have.property('unblock');
        // expect(instance.unblock).to.be(expectedValueLiteral);
      });
