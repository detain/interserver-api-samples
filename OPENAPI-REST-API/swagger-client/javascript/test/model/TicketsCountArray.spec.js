  ...
  describe('(package)', function() {
    describe('TicketsCountArray', function() {
      ...
      it('should create an instance of TicketsCountArray', function() {
        // TODO: update the code to test TicketsCountArray
      ...
      it('should have the property On_Hold (base name: "On Hold")', function() {
        // TODO: update the code to test the property On_Hold
        expect(instance).to.have.property('On_Hold');
        // expect(instance.On_Hold).to.be(expectedValueLiteral);
      });
