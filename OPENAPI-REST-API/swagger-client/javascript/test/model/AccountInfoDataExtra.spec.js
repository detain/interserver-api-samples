  ...
  describe('(package)', function() {
    describe('AccountInfoDataExtra', function() {
      ...
      it('should create an instance of AccountInfoDataExtra', function() {
        // TODO: update the code to test AccountInfoDataExtra
      ...
      it('should have the property private_whois (base name: "private_whois")', function() {
        // TODO: update the code to test the property private_whois
        expect(instance).to.have.property('private_whois');
        // expect(instance.private_whois).to.be(expectedValueLiteral);
      });
