  ...
  describe('(package)', function() {
    describe('ViewTicketResponse', function() {
      ...
      it('should create an instance of ViewTicketResponse', function() {
        // TODO: update the code to test ViewTicketResponse
      ...
      it('should have the property ticket_custom_fields (base name: "ticket_custom_fields")', function() {
        // TODO: update the code to test the property ticket_custom_fields
        expect(instance).to.have.property('ticket_custom_fields');
        // expect(instance.ticket_custom_fields).to.be(expectedValueLiteral);
      });

      it('should have the property ticket_posts (base name: "ticket_posts")', function() {
        // TODO: update the code to test the property ticket_posts
        expect(instance).to.have.property('ticket_posts');
        // expect(instance.ticket_posts).to.be(expectedValueLiteral);
      });
