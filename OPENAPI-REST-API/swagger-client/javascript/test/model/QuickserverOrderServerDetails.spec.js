  ...
  describe('(package)', function() {
    describe('QuickserverOrderServerDetails', function() {
      ...
      it('should create an instance of QuickserverOrderServerDetails', function() {
        // TODO: update the code to test QuickserverOrderServerDetails
      ...
      it('should have the property _381 (base name: "381")', function() {
        // TODO: update the code to test the property _381
        expect(instance).to.have.property('_381');
        // expect(instance._381).to.be(expectedValueLiteral);
      });
