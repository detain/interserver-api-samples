  ...
  describe('(package)', function() {
    describe('WebsitesOrder', function() {
      ...
      it('should create an instance of WebsitesOrder', function() {
        // TODO: update the code to test WebsitesOrder
      ...
      it('should have the property enableDomainRegistering (base name: "enableDomainRegistering")', function() {
        // TODO: update the code to test the property enableDomainRegistering
        expect(instance).to.have.property('enableDomainRegistering');
        // expect(instance.enableDomainRegistering).to.be(expectedValueLiteral);
      });

      it('should have the property jsonServices (base name: "jsonServices")', function() {
        // TODO: update the code to test the property jsonServices
        expect(instance).to.have.property('jsonServices');
        // expect(instance.jsonServices).to.be(expectedValueLiteral);
      });

      it('should have the property jsonServiceOffers (base name: "jsonServiceOffers")', function() {
        // TODO: update the code to test the property jsonServiceOffers
        expect(instance).to.have.property('jsonServiceOffers');
        // expect(instance.jsonServiceOffers).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property serviceOffers (base name: "serviceOffers")', function() {
        // TODO: update the code to test the property serviceOffers
        expect(instance).to.have.property('serviceOffers');
        // expect(instance.serviceOffers).to.be(expectedValueLiteral);
      });

      it('should have the property packges (base name: "packges")', function() {
        // TODO: update the code to test the property packges
        expect(instance).to.have.property('packges');
        // expect(instance.packges).to.be(expectedValueLiteral);
      });
