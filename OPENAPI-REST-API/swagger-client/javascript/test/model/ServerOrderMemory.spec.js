  ...
  describe('(package)', function() {
    describe('ServerOrderMemory', function() {
      ...
      it('should create an instance of ServerOrderMemory', function() {
        // TODO: update the code to test ServerOrderMemory
      ...
      it('should have the property drive_type (base name: "drive_type")', function() {
        // TODO: update the code to test the property drive_type
        expect(instance).to.have.property('drive_type');
        // expect(instance.drive_type).to.be(expectedValueLiteral);
      });
