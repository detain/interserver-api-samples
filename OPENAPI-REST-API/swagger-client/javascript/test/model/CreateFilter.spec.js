  ...
  describe('(package)', function() {
    describe('CreateFilter', function() {
      ...
      it('should create an instance of CreateFilter', function() {
        // TODO: update the code to test CreateFilter
      ...
      it('should have the property filter_type (base name: "filter_type")', function() {
        // TODO: update the code to test the property filter_type
        expect(instance).to.have.property('filter_type');
        // expect(instance.filter_type).to.be(expectedValueLiteral);
      });
