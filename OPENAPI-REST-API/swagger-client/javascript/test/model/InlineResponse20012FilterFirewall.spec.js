...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse20012FilterFirewall', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.InlineResponse20012FilterFirewall();
      });

      it('should create an instance of InlineResponse20012FilterFirewall', function() {
        // TODO: update the code to test InlineResponse20012FilterFirewall
        expect(instance).to.be.a(InterServerManagementApi.InlineResponse20012FilterFirewall);
      });
      ...
      it('should have the property scrub_enabled (base name: "scrub_enabled")', function() {
        // TODO: update the code to test the property scrub_enabled
        expect(instance).to.have.property('scrub_enabled');
        // expect(instance.scrub_enabled).to.be(expectedValueLiteral);
      });
