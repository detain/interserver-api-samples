  ...
  describe('(package)', function() {
    describe('BillingPrepayRequest', function() {
      ...
      it('should create an instance of BillingPrepayRequest', function() {
        // TODO: update the code to test BillingPrepayRequest
      ...
      it('should have the property automatic_use (base name: "automatic_use")', function() {
        // TODO: update the code to test the property automatic_use
        expect(instance).to.have.property('automatic_use');
        // expect(instance.automatic_use).to.be(expectedValueLiteral);
      });
