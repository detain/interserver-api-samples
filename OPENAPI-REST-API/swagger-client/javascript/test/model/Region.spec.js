  ...
  describe('(package)', function() {
    describe('Region', function() {
      ...
      it('should have the property region_name (base name: "region_name")', function() {
        // TODO: update the code to test the property region_name
        expect(instance).to.have.property('region_name');
        // expect(instance.region_name).to.be(expectedValueLiteral);
      });
