...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServerOrderFormValues', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.ServerOrderFormValues();
      });

      it('should create an instance of ServerOrderFormValues', function() {
        // TODO: update the code to test ServerOrderFormValues
        expect(instance).to.be.a(InterServerManagementApi.ServerOrderFormValues);
      });
