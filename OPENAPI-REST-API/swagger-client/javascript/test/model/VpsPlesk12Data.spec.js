  ...
  describe('(package)', function() {
    describe('VpsPlesk12Data', function() {
      ...
      it('should create an instance of VpsPlesk12Data', function() {
        // TODO: update the code to test VpsPlesk12Data
      ...
      it('should have the property pro (base name: "pro")', function() {
        // TODO: update the code to test the property pro
        expect(instance).to.have.property('pro');
        // expect(instance.pro).to.be(expectedValueLiteral);
      });
