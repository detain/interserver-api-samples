...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DomainProvProcessPending', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.DomainProvProcessPending();
      });

      it('should create an instance of DomainProvProcessPending', function() {
        // TODO: update the code to test DomainProvProcessPending
        expect(instance).to.be.a(InterServerManagementApi.DomainProvProcessPending);
      });
