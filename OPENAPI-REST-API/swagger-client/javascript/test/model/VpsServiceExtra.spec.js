  ...
  describe('(package)', function() {
    describe('VpsServiceExtra', function() {
      ...
      it('should create an instance of VpsServiceExtra', function() {
        // TODO: update the code to test VpsServiceExtra
      ...
      it('should have the property spice (base name: "spice")', function() {
        // TODO: update the code to test the property spice
        expect(instance).to.have.property('spice');
        // expect(instance.spice).to.be(expectedValueLiteral);
      });
