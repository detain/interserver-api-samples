...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DomainContactDetails', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.DomainContactDetails();
      });

      it('should create an instance of DomainContactDetails', function() {
        // TODO: update the code to test DomainContactDetails
        expect(instance).to.be.a(InterServerManagementApi.DomainContactDetails);
      });
