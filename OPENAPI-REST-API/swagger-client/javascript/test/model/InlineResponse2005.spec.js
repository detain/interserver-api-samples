...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2005', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.InlineResponse2005();
      });

      it('should create an instance of InlineResponse2005', function() {
        // TODO: update the code to test InlineResponse2005
        expect(instance).to.be.a(InterServerManagementApi.InlineResponse2005);
      });

      it('should have the property redirect_url (base name: "redirect_url")', function() {
        // TODO: update the code to test the property redirect_url
        expect(instance).to.have.property('redirect_url');
        // expect(instance.redirect_url).to.be(expectedValueLiteral);
      });
