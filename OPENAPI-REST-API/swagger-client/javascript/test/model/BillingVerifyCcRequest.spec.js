  ...
  describe('(package)', function() {
    describe('BillingVerifyCcRequest', function() {
      ...
      it('should create an instance of BillingVerifyCcRequest', function() {
        // TODO: update the code to test BillingVerifyCcRequest
      ...
      it('should have the property cc_ccv2 (base name: "cc_ccv2")', function() {
        // TODO: update the code to test the property cc_ccv2
        expect(instance).to.have.property('cc_ccv2');
        // expect(instance.cc_ccv2).to.be(expectedValueLiteral);
      });

      it('should have the property cc_amount1 (base name: "cc_amount1")', function() {
        // TODO: update the code to test the property cc_amount1
        expect(instance).to.have.property('cc_amount1');
        // expect(instance.cc_amount1).to.be(expectedValueLiteral);
      });

      it('should have the property cc_amount2 (base name: "cc_amount2")', function() {
        // TODO: update the code to test the property cc_amount2
        expect(instance).to.have.property('cc_amount2');
        // expect(instance.cc_amount2).to.be(expectedValueLiteral);
      });
