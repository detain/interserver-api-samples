  ...
  describe('(package)', function() {
    describe('VpsDALicense', function() {
      ...
      it('should create an instance of VpsDALicense', function() {
        // TODO: update the code to test VpsDALicense
      ...
      it('should have the property sub_name (base name: "sub_name")', function() {
        // TODO: update the code to test the property sub_name
        expect(instance).to.have.property('sub_name');
        // expect(instance.sub_name).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property img_disabled (base name: "img_disabled")', function() {
        // TODO: update the code to test the property img_disabled
        expect(instance).to.have.property('img_disabled');
        // expect(instance.img_disabled).to.be(expectedValueLiteral);
      });

      it('should have the property img_active (base name: "img_active")', function() {
        // TODO: update the code to test the property img_active
        expect(instance).to.have.property('img_active');
        // expect(instance.img_active).to.be(expectedValueLiteral);
      });
