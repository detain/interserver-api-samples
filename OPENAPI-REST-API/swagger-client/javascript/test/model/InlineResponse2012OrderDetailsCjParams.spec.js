...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2012OrderDetailsCjParams', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.InlineResponse2012OrderDetailsCjParams();
      });

      it('should create an instance of InlineResponse2012OrderDetailsCjParams', function() {
        // TODO: update the code to test InlineResponse2012OrderDetailsCjParams
        expect(instance).to.be.a(InterServerManagementApi.InlineResponse2012OrderDetailsCjParams);
      });
