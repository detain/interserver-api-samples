...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OauthBody', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.OauthBody();
      });

      it('should create an instance of OauthBody', function() {
        // TODO: update the code to test OauthBody
        expect(instance).to.be.a(InterServerManagementApi.OauthBody);
      });
