  ...
  describe('(package)', function() {
    describe('QuickserverOrder', function() {
      ...
      it('should create an instance of QuickserverOrder', function() {
        // TODO: update the code to test QuickserverOrder
      ...
      it('should have the property server_details (base name: "server_details")', function() {
        // TODO: update the code to test the property server_details
        expect(instance).to.have.property('server_details');
        // expect(instance.server_details).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property distro_sel (base name: "distro_sel")', function() {
        // TODO: update the code to test the property distro_sel
        expect(instance).to.have.property('distro_sel');
        // expect(instance.distro_sel).to.be(expectedValueLiteral);
      });
