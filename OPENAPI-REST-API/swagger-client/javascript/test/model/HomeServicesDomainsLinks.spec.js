  ...
  describe('(package)', function() {
    describe('HomeServicesDomainsLinks', function() {
      ...
      it('should create an instance of HomeServicesDomainsLinks', function() {
        // TODO: update the code to test HomeServicesDomainsLinks
      ...
      it('should have the property _376114 (base name: "376114")', function() {
        // TODO: update the code to test the property _376114
        expect(instance).to.have.property('_376114');
        // expect(instance._376114).to.be(expectedValueLiteral);
      });

      it('should have the property _376503 (base name: "376503")', function() {
        // TODO: update the code to test the property _376503
        expect(instance).to.have.property('_376503');
        // expect(instance._376503).to.be(expectedValueLiteral);
      });

      it('should have the property _592337 (base name: "592337")', function() {
        // TODO: update the code to test the property _592337
        expect(instance).to.have.property('_592337');
        // expect(instance._592337).to.be(expectedValueLiteral);
      });
