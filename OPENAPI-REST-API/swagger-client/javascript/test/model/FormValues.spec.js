...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FormValues', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.FormValues();
      });

      it('should create an instance of FormValues', function() {
        // TODO: update the code to test FormValues
        expect(instance).to.be.a(InterServerManagementApi.FormValues);
      });
