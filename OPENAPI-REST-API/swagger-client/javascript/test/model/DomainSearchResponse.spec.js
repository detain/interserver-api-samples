  ...
  describe('(package)', function() {
    describe('DomainSearchResponse', function() {
      ...
      it('should create an instance of DomainSearchResponse', function() {
        // TODO: update the code to test DomainSearchResponse
      ...
      it('should have the property response_time (base name: "response_time")', function() {
        // TODO: update the code to test the property response_time
        expect(instance).to.have.property('response_time');
        // expect(instance.response_time).to.be(expectedValueLiteral);
      });

      it('should have the property lookup (base name: "lookup")', function() {
        // TODO: update the code to test the property lookup
        expect(instance).to.have.property('lookup');
        // expect(instance.lookup).to.be(expectedValueLiteral);
      });

      it('should have the property suggest (base name: "suggest")', function() {
        // TODO: update the code to test the property suggest
        expect(instance).to.have.property('suggest');
        // expect(instance.suggest).to.be(expectedValueLiteral);
      });

      it('should have the property tlds (base name: "tlds")', function() {
        // TODO: update the code to test the property tlds
        expect(instance).to.have.property('tlds');
        // expect(instance.tlds).to.be(expectedValueLiteral);
      });
