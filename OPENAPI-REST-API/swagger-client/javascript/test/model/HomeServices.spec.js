  ...
  describe('(package)', function() {
    describe('HomeServices', function() {
      ...
      it('should create an instance of HomeServices', function() {
        // TODO: update the code to test HomeServices
      ...
      it('should have the property webhosting (base name: "webhosting")', function() {
        // TODO: update the code to test the property webhosting
        expect(instance).to.have.property('webhosting');
        // expect(instance.webhosting).to.be(expectedValueLiteral);
      });
