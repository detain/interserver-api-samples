  ...
  describe('(package)', function() {
    describe('TicketNewResponse', function() {
      ...
      it('should create an instance of TicketNewResponse', function() {
        // TODO: update the code to test TicketNewResponse
      ...
      it('should have the property ticket_id (base name: "ticket_id")', function() {
        // TODO: update the code to test the property ticket_id
        expect(instance).to.have.property('ticket_id');
        // expect(instance.ticket_id).to.be(expectedValueLiteral);
      });
