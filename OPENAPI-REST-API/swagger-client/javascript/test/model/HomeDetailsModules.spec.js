  ...
  describe('(package)', function() {
    describe('HomeDetailsModules', function() {
      ...
      it('should create an instance of HomeDetailsModules', function() {
        // TODO: update the code to test HomeDetailsModules
      ...
      it('should have the property quickservers (base name: "quickservers")', function() {
        // TODO: update the code to test the property quickservers
        expect(instance).to.have.property('quickservers');
        // expect(instance.quickservers).to.be(expectedValueLiteral);
      });
