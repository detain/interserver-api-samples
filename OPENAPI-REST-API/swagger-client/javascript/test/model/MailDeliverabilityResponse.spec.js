  ...
  describe('(package)', function() {
    describe('MailDeliverabilityResponse', function() {
      ...
      it('should create an instance of MailDeliverabilityResponse', function() {
        // TODO: update the code to test MailDeliverabilityResponse
      ...
      it('should have the property table_data (base name: "table_data")', function() {
        // TODO: update the code to test the property table_data
        expect(instance).to.have.property('table_data');
        // expect(instance.table_data).to.be(expectedValueLiteral);
      });
