...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DomainAdminContact', function() {
      beforeEach(function() {
        instance = new InterServerManagementApi.DomainAdminContact();
      });

      it('should create an instance of DomainAdminContact', function() {
        // TODO: update the code to test DomainAdminContact
        expect(instance).to.be.a(InterServerManagementApi.DomainAdminContact);
      });
