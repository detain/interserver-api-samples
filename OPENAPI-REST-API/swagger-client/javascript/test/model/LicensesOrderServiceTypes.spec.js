  ...
  describe('(package)', function() {
    describe('LicensesOrderServiceTypes', function() {
      ...
      it('should create an instance of LicensesOrderServiceTypes', function() {
        // TODO: update the code to test LicensesOrderServiceTypes
      ...
      it('should have the property LicensesOrderServiceTypes11482 (base name: "LicensesOrderServiceTypes11482")', function() {
        // TODO: update the code to test the property LicensesOrderServiceTypes11482
        expect(instance).to.have.property('LicensesOrderServiceTypes11482');
        // expect(instance.LicensesOrderServiceTypes11482).to.be(expectedValueLiteral);
      });
