...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response addBackup(MultipartFormDataInput input,@Parameter(description = "" ,required=true) BackupOrderPutRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response cancelBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getBackupInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getBackupInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getBackupLogin( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getBackupsList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getBackupsWelcomeEmail( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response getNewBackup(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response updateBackupInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response validateBackupOrder(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("validateOnly")  Boolean validateOnly,@Parameter(description = "", required=true)@FormParam("serviceType")  Integer serviceType,@Parameter(description = "", required=true)@FormParam("coupon")  String coupon,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    Response validateBackupOrder(MultipartFormDataInput input,@Parameter(description = "" ,required=true) BackupOrderPutRequest body,@Context SecurityContext securityContext);
