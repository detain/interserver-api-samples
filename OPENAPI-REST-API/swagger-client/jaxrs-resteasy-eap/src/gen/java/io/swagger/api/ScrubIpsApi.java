...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response cancelScrubIp( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response createFilter(@Parameter(description = "" ,required=true) CreateFilter body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response createGeoRule(@Parameter(description = "" ,required=true) CreateGeoFirewallRule body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response createRule(@Parameter(description = "" ,required=true) CreateFirewallRule body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response deleteFilter(@Parameter(description = "" ,required=true) CreateFilter body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response disableScrub( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response enableScrub( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getOrderDetail(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getScrubIpDetails( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getScrubIpFilterTypes(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getScrubIpInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getScrubIpLogs( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response getScrubIpsList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response placeScrubOrder(@Parameter(description = "" ,required=true) ScrubIpPlaceOrder body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response scrubIpsDeleteGeoRule(@Parameter(description = "" ,required=true) DeleteGeoFirewallRule body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    Response scrubIpsDeleteRule(@Parameter(description = "" ,required=true) DeleteFirewallRule body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
