...
public class Domain   {
  ...
  private Map<String, DomainServiceType> serviceTypes = new HashMap<String, DomainServiceType>();
  private List<DomainClientLink> clientLinks = new ArrayList<DomainClientLink>();
  ...
  private List<String> domainLogs = new ArrayList<String>();
