...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response addQs(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response deleteQsBackup( @PathParam("id") Integer id, @NotNull @QueryParam("file") String file, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsBlockSmtp( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsDisableCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsDisableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsEjectCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsEnableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsRestart( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsStart( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response doQsStop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response downloadQsBackup(@Parameter(description = "" ,required=true) IdBackupsBody body, @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response downloadQsBackup(@Parameter(description = "", required=true)@FormParam("file")  String file, @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getNewQs(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsBackups( @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsChangeHostname( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsChangeRootPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsChangeTimezone( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsChangeWebuzoPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsInsertCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsReinstallOs( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsResetPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsReverseDns( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsTrafficUsage( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response getQsWelcomeEmail( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsChangeHostname( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsChangeRootPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsChangeTimezone(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("timezone")  String timezone, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsChangeTimezone(MultipartFormDataInput input,@Parameter(description = "" ,required=true) TimezoneUpdate body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsChangeWebuzoPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsInsertCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsReinstallOs( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsResetPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsReverseDns(@Parameter(description = "" ,required=true) ReverseDnsEntries body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsReverseDns(@Parameter(description = "", required=true)@FormParam("ips")  Map<String, Object> ips, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsTrafficUsage( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQuickServerRestore(@Parameter(description = "QuickServer Restore request" ,required=true) RestoreRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response postQuickServerRestore(@Parameter(description = "", required=true)@FormParam("backup")  String backup,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response putQs(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response quickserversCancel( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "QuickServers" })
    ...
    Response updateQsInfo( @PathParam("id") String id,@Context SecurityContext securityContext);
