...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response getOauthRedirect( @NotNull @QueryParam("provider") String provider,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response patchOauthTwoFactor(@Parameter(description = "" ,required=true) OauthBody2 body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response patchOauthTwoFactor(@Parameter(description = "", required=true)@FormParam("account_id")  Integer accountId,@Parameter(description = "", required=true)@FormParam("code")  String code,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response postOauthCallback( @NotNull @QueryParam("provider") String provider,@Parameter(description = "" ) OauthBody body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response postOauthCallback( @NotNull @QueryParam("provider") String provider,@Parameter(description = "")@FormParam("provider")  String provider2,@Context SecurityContext securityContext);
