...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response addBillingCreditCard(@Parameter(description = "" ,required=true) BillingAddCcRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response addBillingPrepay(@Parameter(description = "" ,required=true) BillingPrepayRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response addBillingPrepay(@Parameter(description = "", required=true)@FormParam("module")  String module,@Parameter(description = "", required=true)@FormParam("amount")  BigDecimal amount,@Parameter(description = "", required=true)@FormParam("automatic_use")  String automaticUse,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response deleteBillingCreditCard( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response deleteBillingInvoice( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response deleteBillingPrepay( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getBillingCart(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getBillingCreditCardVerify( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getBillingInvoice( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getBillingInvoices(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getBillingPrePays(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response postBillingCreditCardVerify(@Parameter(description = "" ,required=true) BillingVerifyCcRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response updateBillingCreditCard( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response updateBillingPaymentMethod(@Parameter(description = "" ,required=true) BillingPaymentMethodRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response updateBillingPaymentMethod(@Parameter(description = "", required=true)@FormParam("payment_method")  String paymentMethod,@Parameter(description = "", required=true)@FormParam("cc_auto")  String ccAuto,@Context SecurityContext securityContext);
