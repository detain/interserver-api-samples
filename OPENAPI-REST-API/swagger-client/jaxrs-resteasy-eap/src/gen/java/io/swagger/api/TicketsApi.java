...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response addNewTicket(@Parameter(description = "" ,required=true) TicketNew body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response closeTicket( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response deleteTicketInfo( @PathParam("id") BigDecimal id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response getNewTicket(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response getTicketInfo( @PathParam("id") BigDecimal id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response getTicketsList( @QueryParam("page") Integer page, @QueryParam("period") String period, @QueryParam("view") String view,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response postTicketInfo( @PathParam("id") BigDecimal id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response postTicketsList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response putTicketInfo( @PathParam("id") BigDecimal id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response replyTicket( @PathParam("id") BigDecimal id,@Parameter(description = "" ) ReplyTicketRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response replyTicket( @PathParam("id") BigDecimal id,@Parameter(description = "")@FormParam("content")  String content,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response updateTicketInfo( @PathParam("id") BigDecimal id,@Parameter(description = "" ) UpdateTicket body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    ...
    Response updateTicketInfo( @PathParam("id") BigDecimal id,@Parameter(description = "")@FormParam("ip")  String ip,@Parameter(description = "")@FormParam("ip_address")  String ipAddress,@Parameter(description = "", schema=@Schema(allowableValues={ "y", "n" })
