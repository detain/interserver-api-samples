...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response addAccountCreditCard(MultipartFormDataInput input,@Parameter(description = "" ,required=true) BillingAddCcRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response changeAccountUsername(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response deleteAccountCreditCard( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response deleteAccountOauthName( @PathParam("name") String name,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response deleteAccountTfa(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response deleteIpLimit(@Parameter(description = "" ) IpLimitRange body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response getAccountInfo(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response getAccountTfaSetup(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response getCountries( @QueryParam("fetch_by") String fetchBy,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    Response getTimezones(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response logoutAccountOauth( @PathParam("name") String name,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountApiKey(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response updateAccountCreditCard( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountFeatures(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("disable_reset")  Integer disableReset,@Parameter(description = "", required=true)@FormParam("disable_reinstall")  Integer disableReinstall,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountFeatures(MultipartFormDataInput input,@Parameter(description = "" ,required=true) AccountFeatures body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountInfo(MultipartFormDataInput input,@Parameter(description = "" ,required=true) AccountInfoPost body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountIpLimits(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("start")  String start,@Parameter(description = "", required=true)@FormParam("end")  String end,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountIpLimits(MultipartFormDataInput input,@Parameter(description = "The lower and upper bounds of an ip range." ,required=true) IpLimitRange body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountPassword(MultipartFormDataInput input,@Parameter(description = "" ,required=true) PasswordRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountSshKey(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("ssh_key")  String sshKey,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountSshKey(MultipartFormDataInput input,@Parameter(description = "" ,required=true) AccountSshKey body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountTfa(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("2fa_google_code")  String _2faGoogleCode,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    Response updateAccountTfa(MultipartFormDataInput input,@Parameter(description = "" ,required=true) Account2faBody1 body,@Context SecurityContext securityContext);
