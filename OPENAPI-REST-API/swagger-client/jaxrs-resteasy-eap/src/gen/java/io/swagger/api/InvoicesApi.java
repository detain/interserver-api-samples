...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    Response getInvoices( @QueryParam("searchString") String searchString, @Min(0) @QueryParam("skip") Integer skip, @Min(0) @Max(50) @QueryParam("limit") Integer limit,@Context SecurityContext securityContext);
