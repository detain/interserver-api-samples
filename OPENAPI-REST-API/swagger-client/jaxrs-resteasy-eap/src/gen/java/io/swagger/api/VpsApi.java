...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response addVps(@Parameter(description = "" ) VpsOrderPostRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response addVps(@Parameter(description = "")@FormParam("osDistro")  String osDistro,@Parameter(description = "", schema=@Schema(allowableValues={ "32", "1" }, minimum="1", maximum="32")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response deleteVpsBackup( @PathParam("id") Integer id, @NotNull @QueryParam("file") String file, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsBlockSmtp( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsDisableCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsDisableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsEjectCd( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsEnableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsRestart( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsStart( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response doVpsStop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response downloadVpsBackup(@Parameter(description = "" ,required=true) IdBackupsBody2 body, @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response downloadVpsBackup(@Parameter(description = "", required=true)@FormParam("file")  String file, @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getNewVps(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsBackups( @PathParam("id") Integer id, @QueryParam("all") String all,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsBuyHdSpace( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsBuyIp( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsChangeTimezone( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsReinstallOs( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsReverseDns( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsSlices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsTrafficUsage( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response getVpsWelcomeEmail( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsBuyHdSpace( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsBuyIp( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeHostname(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("hostname")  String hostname, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeHostname(MultipartFormDataInput input,@Parameter(description = "" ,required=true) HostnameObject body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeRootPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeRootPassword(MultipartFormDataInput input,@Parameter(description = "" ,required=true) PasswordRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeTimezone(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("timezone")  String timezone, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeTimezone(MultipartFormDataInput input,@Parameter(description = "" ,required=true) TimezoneUpdate body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeWebuzoPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsChangeWebuzoPassword(MultipartFormDataInput input,@Parameter(description = "" ,required=true) PasswordRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsInsertCd(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("url")  String url, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsInsertCd(MultipartFormDataInput input,@Parameter(description = "" ,required=true) UrlRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsReinstallOs(MultipartFormDataInput input,@Parameter(description = "" ,required=true) TemplateRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsResetPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsRestore(@Parameter(description = "VPS Restore request" ,required=true) RestoreRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsRestore(@Parameter(description = "", required=true)@FormParam("backup")  String backup,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsReverseDns(@Parameter(description = "" ,required=true) ReverseDnsEntries body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsReverseDns(@Parameter(description = "", required=true)@FormParam("ips")  Map<String, Object> ips, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsSlices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response postVpsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response putVps(@Parameter(description = "" ) VpsOrderPutRequest body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response putVps(@Parameter(description = "")@FormParam("osDistro")  String osDistro,@Parameter(description = "", schema=@Schema(allowableValues={ "32", "1" }, minimum="1", maximum="32")
)@FormParam("slices")  Integer slices,@Parameter(description = "", schema=@Schema(allowableValues={ "kvm", "hyperv", "kvmstorage" })
)@FormParam("vpsPlatform")  String vpsPlatform,@Parameter(description = "", schema=@Schema(allowableValues={ "none", "cpanel", "da" })
)@FormParam("controlpanel")  String controlpanel,@Parameter(description = "", schema=@Schema(allowableValues={ "12", "1" }, minimum="1", maximum="12")
)@FormParam("period")  Integer period,@Parameter(description = "", schema=@Schema(allowableValues={ "3", "1" }, minimum="1", maximum="3")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response updateVpsInfo( @PathParam("id") String id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    Response vPSCancel( @PathParam("id") Integer id,@Context SecurityContext securityContext);
