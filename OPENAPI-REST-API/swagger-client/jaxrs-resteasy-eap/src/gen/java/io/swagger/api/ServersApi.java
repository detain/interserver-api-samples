...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response addServer(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response buyItNowServerOrder(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getNewServer(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getServerInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getServerInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getServerList(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getServerReverseDns( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response getServersWelcomeEmail( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response placeBuyNowServer(@Parameter(description = "" ) OrderBuyNowServerBody body,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response postServerReverseDns(@Parameter(description = "" ,required=true) ReverseDnsEntries body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response postServerReverseDns(@Parameter(description = "", required=true)@FormParam("ips")  Map<String, Object> ips, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response putServers(@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiLiveGet( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiLivePost(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("asset")  Integer asset,@Parameter(description = "", required=true)@FormParam("ip")  String ip, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiLivePost(MultipartFormDataInput input,@Parameter(description = "" ,required=true) ServerIpmiLiveRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiPowerGet( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiPowerPost(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("asset")  Integer asset,@Parameter(description = "", required=true, schema=@Schema(allowableValues={ "cycle", "reset", "on", "off", "soft" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serverIpmiPowerPost(MultipartFormDataInput input,@Parameter(description = "" ,required=true) ServerIpmiPowerRequest body, @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response serversCancel( @PathParam("id") Integer id,@Context SecurityContext securityContext);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Servers" })
    ...
    Response updateServerInfo( @PathParam("id") String id,@Context SecurityContext securityContext);
