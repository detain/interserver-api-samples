...
case class LicensesOrder (
  serviceCategories: Option[LicensesOrder_serviceCategories] = None,
  packageCosts: Option[LicensesOrder_packageCosts] = None,
  serviceTypes: Option[LicensesOrder_serviceTypes] = None
)
