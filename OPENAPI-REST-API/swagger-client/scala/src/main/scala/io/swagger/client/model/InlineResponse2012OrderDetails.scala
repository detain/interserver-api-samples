 ...
 * @param cj_params 
 */
case class InlineResponse2012OrderDetails (
  total_cost: Option[Integer] = None,
  service_id: Option[Integer] = None,
  invoice_id: Option[Integer] = None,
  invoice_description: Option[String] = None,
  cj_params: Option[inline_response_201_2_order_details_cj_params] = None
)
