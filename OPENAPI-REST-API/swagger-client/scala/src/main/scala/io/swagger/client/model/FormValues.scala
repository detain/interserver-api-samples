...
case class FormValues (
  ...
  bandwidth: Option[Integer] = None,
  ips: Option[Integer] = None,
  os: Option[Integer] = None,
  cp: Option[Integer] = None,
  raid: Option[Integer] = None,
  hd: Option[Integer] = None,
  region: Option[Integer] = None
)
