...
case class ServerOrderFieldLabels (
  bandwidth: Option[AllOfServerOrderFieldLabelsBandwidth] = None,
  ips: Option[AllOfServerOrderFieldLabelsIps] = None,
  os: Option[AllOfServerOrderFieldLabelsOs] = None,
  cp: Option[AllOfServerOrderFieldLabelsCp] = None,
  raid: Option[AllOfServerOrderFieldLabelsRaid] = None,
  memory: Option[AllOfServerOrderFieldLabelsMemory] = None,
  hd: Option[AllOfServerOrderFieldLabelsHd] = None
)
