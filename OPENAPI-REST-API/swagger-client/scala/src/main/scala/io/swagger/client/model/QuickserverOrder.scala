...
case class QuickserverOrder (
  ...
  server_details: Option[QuickserverOrder_server_details] = None,
  templates: Option[QuickserverOrder_templates] = None,
  version: Option[QuickserverOrder_version] = None,
  distro_sel: Option[QuickserverOrder_distro_sel] = None
)
