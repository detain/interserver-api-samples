...
open class WebhostingAPI {
  ...
  "jsonServices" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getWebsiteBuyIp(_id: Int, completion: @escaping ((_ data: InlineResponse20023?,_ error: Error?) -> Void)) {
  ...
  "ips" : {
     ...
     */
    open class func getWebsiteBuyIpWithRequestBuilder(_id: Int) -> RequestBuilder<InlineResponse20023> {
    ...
    open class func getWebsiteInfo(_id: Int, completion: @escaping ((_ data: Website?,_ error: Error?) -> Void)) {
        getWebsiteInfoWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "custCurrency" : "USD"
     ...
     */
    open class func getWebsiteInfoWithRequestBuilder(_id: Int) -> RequestBuilder<Website> {
    ...
    open class func getWebsiteInvoices(_id: Int, completion: @escaping ((_ data: ChargeInvoiceRows?,_ error: Error?) -> Void)) {
        getWebsiteInvoicesWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "invoices" : {
     ...
     */
    open class func getWebsiteInvoicesWithRequestBuilder(_id: Int) -> RequestBuilder<ChargeInvoiceRows> {
  ...
  "website_comment" : ""
    ...
    open class func getWebsitesBackups(_id: Int, completion: @escaping ((_ data: WebsiteBackups?,_ error: Error?) -> Void)) {
        getWebsitesBackupsWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "name" : "name"
     ...
     */
    open class func getWebsitesBackupsWithRequestBuilder(_id: Int) -> RequestBuilder<WebsiteBackups> {
    ...
    open class func getWebsitesLogin(_id: Int, completion: @escaping ((_ data: WebsiteLoginResponse?,_ error: Error?) -> Void)) {
        getWebsitesLoginWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "location" : "https://www.site.com/"
     ...
     */
    open class func getWebsitesLoginWithRequestBuilder(_id: Int) -> RequestBuilder<WebsiteLoginResponse> {
    ...
    open class func getWebsitesWelcomeEmail(_id: Int, completion: @escaping ((_ data: SuccessTextResponse?,_ error: Error?) -> Void)) {
        getWebsitesWelcomeEmailWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     */
    open class func getWebsitesWelcomeEmailWithRequestBuilder(_id: Int) -> RequestBuilder<SuccessTextResponse> {
    ...
    open class func gettWebsiteReverseDns(_id: Int, completion: @escaping ((_ data: ReverseDnsEntries?,_ error: Error?) -> Void)) {
        gettWebsiteReverseDnsWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "ips" : {
     ...
     */
    open class func gettWebsiteReverseDnsWithRequestBuilder(_id: Int) -> RequestBuilder<ReverseDnsEntries> {
    ...
    /**
     ...
     - parameter body: (body)       - parameter _id: (path) The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsiteBuyIp(body: IdBuyIpBody, _id: Int, completion: @escaping ((_ data: InlineResponse20024?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     */
    open class func postWebsiteBuyIpWithRequestBuilder(body: IdBuyIpBody, _id: Int) -> RequestBuilder<InlineResponse20024> {
        var path = "/websites/{id}/buy_ip"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     Update Website IP DNS
     - parameter ips: (form)       - parameter _id: (path) The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsiteBuyIp(ips: [String:String], _id: Int, completion: @escaping ((_ data: InlineResponse20024?,_ error: Error?) -> Void)) {
  ...
  "message" : "message"
     ...
     - returns: RequestBuilder<InlineResponse20024> 
     */
    open class func postWebsiteBuyIpWithRequestBuilder(ips: [String:String], _id: Int) -> RequestBuilder<InlineResponse20024> {
        var path = "/websites/{id}/buy_ip"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsiteMigration(body: IdMigrationBody, _id: Int, completion: @escaping ((_ data: InlineResponse20025?,_ error: Error?) -> Void)) {
  ...
  "text" : "text"
     ...
     */
    open class func postWebsiteMigrationWithRequestBuilder(body: IdMigrationBody, _id: Int) -> RequestBuilder<InlineResponse20025> {
    ...
    /**
     Request Website Migration
     - parameter custPortal: (form)       - parameter regEmail: (form)       - parameter password: (form)       - parameter ctrlPanel: (form)       - parameter ftpUsername: (form)       - parameter ftpPassword: (form)       - parameter siteBusyMig: (form)       - parameter splReqMig: (form)       - parameter domainReg: (form)       - parameter dataMig: (form)       - parameter domainRegPortal: (form)       - parameter domainRegEmail: (form)       - parameter domainRegPassword: (form)       - parameter _id: (path) The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsiteMigration(custPortal: String, regEmail: String, password: String, ctrlPanel: String, ftpUsername: String, ftpPassword: String, siteBusyMig: String, splReqMig: String, domainReg: String, dataMig: String, domainRegPortal: String, domainRegEmail: String, domainRegPassword: String, _id: Int, completion: @escaping ((_ data: InlineResponse20025?,_ error: Error?) -> Void)) {
  ...
  "text" : "text"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsitesReverseDns(body: ReverseDnsEntries, _id: Int, completion: @escaping ((_ data: TextResponse?,_ error: Error?) -> Void)) {
        postWebsitesReverseDnsWithRequestBuilder(body: body, _id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "You were successfull."
     ...
     */
    open class func postWebsitesReverseDnsWithRequestBuilder(body: ReverseDnsEntries, _id: Int) -> RequestBuilder<TextResponse> {
        var path = "/websites/{id}/reverse_dns"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postWebsitesReverseDns(ips: [String:Any], _id: Int, completion: @escaping ((_ data: TextResponse?,_ error: Error?) -> Void)) {
        postWebsitesReverseDnsWithRequestBuilder(ips: ips, _id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "You were successfull."
     ...
     - returns: RequestBuilder<TextResponse> 
     */
    open class func postWebsitesReverseDnsWithRequestBuilder(ips: [String:Any], _id: Int) -> RequestBuilder<TextResponse> {
        var path = "/websites/{id}/reverse_dns"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateWebsiteInfo(_id: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        updateWebsiteInfoWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateWebsiteInfoWithRequestBuilder(_id: String) -> RequestBuilder<Void> {
        var path = "/websites/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func webhostingCancel(_id: String, completion: @escaping ((_ data: InlineResponse20022?,_ error: Error?) -> Void)) {
  ...
  "text" : "Website is canceled."
     ...
     */
    open class func webhostingCancelWithRequestBuilder(_id: String) -> RequestBuilder<InlineResponse20022> {
        var path = "/websites/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
