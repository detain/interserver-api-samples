...
open class LicensesAPI {
    ...
    open class func getLicenseInfo(_id: Int, completion: @escaping ((_ data: License?,_ error: Error?) -> Void)) {
        getLicenseInfoWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
  ...
  "license_key" : ""
     ...
     */
    open class func getLicenseInfoWithRequestBuilder(_id: Int) -> RequestBuilder<License> {
    ...
    open class func getLicenseInvoices(_id: Int, completion: @escaping ((_ data: ChargeInvoiceRows?,_ error: Error?) -> Void)) {
        getLicenseInvoicesWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "invoices" : {
     ...
     */
    open class func getLicenseInvoicesWithRequestBuilder(_id: Int) -> RequestBuilder<ChargeInvoiceRows> {
  ...
  "invoices_date" : "2019-08-28T14:27:22.000Z"
    ...
    open class func getLicensesWelcomeEmail(_id: Int, completion: @escaping ((_ data: SuccessTextResponse?,_ error: Error?) -> Void)) {
        getLicensesWelcomeEmailWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     */
    open class func getLicensesWelcomeEmailWithRequestBuilder(_id: Int) -> RequestBuilder<SuccessTextResponse> {
  ...
  "text" : "License is canceled."
    ...
    /**
     Change License IP
     - parameter body: (body)       - parameter _id: (path) The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postLicenseChangeIp(body: IpObject, _id: Int, completion: @escaping ((_ data: SuccessTextResponse?,_ error: Error?) -> Void)) {
        postLicenseChangeIpWithRequestBuilder(body: body, _id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func postLicenseChangeIpWithRequestBuilder(body: IpObject, _id: Int) -> RequestBuilder<SuccessTextResponse> {
    ...
    /**
     Change License IP
     - parameter ip: (form)       - parameter _id: (path) The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postLicenseChangeIp(ip: String, _id: Int, completion: @escaping ((_ data: SuccessTextResponse?,_ error: Error?) -> Void)) {
        postLicenseChangeIpWithRequestBuilder(ip: ip, _id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "text" : "Ok"
     ...
     - returns: RequestBuilder<SuccessTextResponse> 
     */
    open class func postLicenseChangeIpWithRequestBuilder(ip: String, _id: Int) -> RequestBuilder<SuccessTextResponse> {
        var path = "/licenses/{id}/change_ip"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func updateLicenseInfo(_id: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        updateLicenseInfoWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func updateLicenseInfoWithRequestBuilder(_id: String) -> RequestBuilder<Void> {
        var path = "/licenses/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
