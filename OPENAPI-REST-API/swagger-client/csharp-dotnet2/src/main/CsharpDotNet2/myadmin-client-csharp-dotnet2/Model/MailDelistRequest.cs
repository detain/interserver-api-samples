...
namespace IO.Swagger.Model {
  ...
  public class MailDelistRequest {
    ...
    /// </summary>
    /// <value>Email address to delist.</value>
    [DataMember(Name="unblock", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "unblock")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  Unblock: ").Append(Unblock).Append("\n");
      sb.Append("}\n");
      return sb.ToString();
    }
