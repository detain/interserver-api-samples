...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/order",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<ServiceOrderPostResponse> addDomain();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/dnssec",
        produces = { "application/json" }, 
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> addDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/nameservers",
        produces = { "application/json" }, 
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    ResponseEntity<TextResponse> addDomainNameserver(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    ResponseEntity<InlineResponse2002> cancelDomain(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/dnssec",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<SuccessTextResponse> deleteDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<TextResponse> deleteDomainNameserver(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/contact",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainContactDetails> getDomainContact(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/dnssec",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainDnssecRecords> getDomainDnssec(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Domain> getDomainInfo(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/invoices",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ChargeInvoiceRows> getDomainInvoices(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/lookup/{name}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainLookupResponse> getDomainLookup(@Parameter(in = ParameterIn.PATH, description = "The full domain name to look up (for example `example.com`).", required=true, schema=@Schema()) @PathVariable("name") String name
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainNameserverGetResponse> getDomainNameservers(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/order/{domain}/{regType}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Void> getDomainOrderFields(@Parameter(in = ParameterIn.PATH, description = "The fully qualified domain name (e.g. `example.com`).", required=true, schema=@Schema()) @PathVariable("domain") String domain
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/order/{domain}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Void> getDomainOrderSearchResults(@Parameter(in = ParameterIn.PATH, description = "The fully qualified domain name to look up (e.g. `example.com`).", required=true, schema=@Schema()) @PathVariable("domain") String domain
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/renew",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<SuccessTextResponse> getDomainRenewal(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/search/{name}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainSearchResponse> getDomainSearch(@Parameter(in = ParameterIn.PATH, description = "The base domain name to search (for example `example` or `example.com`).", required=true, schema=@Schema()) @PathVariable("name") String name
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/transfer",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<SuccessTextResponse> getDomainTransfer(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/whois",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<SuccessTextResponse> getDomainWhoisPrivacy(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<DomainRow>> getDomainsList();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    @RequestMapping(value = "/domains/{id}/welcome_email",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<SuccessTextResponse> getDomainsWelcomeEmail(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/order",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<DomainOrder> getNewDomain();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    ResponseEntity<Void> patchDomains();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/renew",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> postDomainRenewal(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/transfer",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> postDomainTransfer(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    ResponseEntity<Void> putDomains();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/contact",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> updateDomainContact(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> updateDomainInfo(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") String id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/nameservers",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.PUT)
    ResponseEntity<TextResponse> updateDomainNameservers(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Domains" })
    ...
    @RequestMapping(value = "/domains/{id}/whois",
        ...
        consumes = { "application/json", "multipart/form-data" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> updateDomainWhoisPrivacy(@Parameter(in = ParameterIn.PATH, description = "The domain service ID. Use `domain_id` from `GET /domains`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
