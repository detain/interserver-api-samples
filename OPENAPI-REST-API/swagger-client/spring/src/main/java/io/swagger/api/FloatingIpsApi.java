...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    ResponseEntity<ServiceOrderPostResponse> addFloatingIp();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    ResponseEntity<Object> getFloatingIpInfo(@Parameter(in = ParameterIn.PATH, description = "The Floating IP service ID. Use the ID from `GET /floating_ips`.", required=true, schema=@Schema()) @PathVariable("id") Integer id
);
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    @RequestMapping(value = "/floating_ips/order",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Object> getNewFloatingIp();
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    @RequestMapping(value = "/floating_ips/{id}",
        produces = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<SuccessTextResponse> updateFloatingIpInfo(@Parameter(in = ParameterIn.PATH, description = "The Floating IP service ID. Use the ID from `GET /floating_ips`.", required=true, schema=@Schema()) @PathVariable("id") String id
);
