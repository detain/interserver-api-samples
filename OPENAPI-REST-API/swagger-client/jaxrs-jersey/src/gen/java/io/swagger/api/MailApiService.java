...
public abstract class MailApiService {
    ...
    public abstract Response getMailAlerts(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailBlocks(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailDelist(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailDeliverability(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailInfo(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailInvoices(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailList(SecurityContext securityContext) throws NotFoundException;
    public abstract Response getMailWelcomeEmail(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getNewMail(SecurityContext securityContext) throws NotFoundException;
    public abstract Response getRules(Integer id,SecurityContext securityContext) throws NotFoundException;
    public abstract Response getStats(Integer id, String time,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response sendMail(SendMail body,Integer id,SecurityContext securityContext) throws NotFoundException;
