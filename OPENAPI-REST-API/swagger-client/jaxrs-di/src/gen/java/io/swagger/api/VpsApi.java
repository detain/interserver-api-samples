...
public class VpsApi  {
   ...
   private VpsApiService delegate;

   protected VpsApi() {
   }

   @javax.inject.Inject
   public VpsApi(VpsApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response downloadVpsBackup(@Parameter(description = "", required=true)  @FormParam("file")  String file,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Parameter(in = ParameterIn.QUERY, description = "Set to `1` to list all backups across all services, not just the ones for the given VPS.", schema=@Schema(allowableValues={ "0", "1" })
) @QueryParam("all") String all,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeHostname(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) HostnameObject body
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeRootPassword(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) PasswordRequest body
,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeTimezone(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) TimezoneUpdate body
,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeWebuzoPassword(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) PasswordRequest body
,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsInsertCd(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) UrlRequest body
,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsReinstallOs(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) TemplateRequest body
,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsRestore(@Parameter(description = "", required=true)  @FormParam("backup")  String backup,@Parameter(description = "", required=true)  @FormParam("password")  String password,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsReverseDns(@Parameter(description = "", required=true)  @FormParam("ips")  Map<String, Object> ips,@Parameter(in = ParameterIn.PATH, description = "VPS ID number",required=true) @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
