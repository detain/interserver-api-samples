...
public class TicketsApi  {
   ...
   private TicketsApiService delegate;

   protected TicketsApi() {
   }

   @javax.inject.Inject
   public TicketsApi(TicketsApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response replyTicket(@Parameter(in = ParameterIn.PATH, description = "The ticket ID number.",required=true) @PathParam("id") BigDecimal id,@Parameter(description = "")  @FormParam("content")  String content,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Tickets" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response updateTicketInfo(@Parameter(in = ParameterIn.PATH, description = "The ticket ID number.",required=true) @PathParam("id") BigDecimal id,@Parameter(description = "")  @FormParam("ip")  String ip,@Parameter(description = "")  @FormParam("ip_address")  String ipAddress,@Parameter(description = "", schema=@Schema(allowableValues={ "y", "n" })
