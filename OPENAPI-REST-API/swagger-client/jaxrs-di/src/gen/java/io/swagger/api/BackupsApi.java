...
public class BackupsApi  {
   ...
   private BackupsApiService delegate;

   protected BackupsApi() {
   }

   @javax.inject.Inject
   public BackupsApi(BackupsApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response addBackup(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) BackupOrderPutRequest body
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response validateBackupOrder(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) BackupOrderPutRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
