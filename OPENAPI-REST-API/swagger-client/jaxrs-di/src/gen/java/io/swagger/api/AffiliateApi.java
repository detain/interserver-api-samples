...
public class AffiliateApi  {
   ...
   private AffiliateApiService delegate;

   protected AffiliateApi() {
   }

   @javax.inject.Inject
   public AffiliateApi(AffiliateApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliateDockSetup(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) AffiliateDockSetup body
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliateLandingPage(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) AffiliateDockSetup body
,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliatePaymentSetup(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) AffiliatePaymentSetup body
,@Context SecurityContext securityContext)
    throws NotFoundException {
