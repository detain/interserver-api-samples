...
public class DnsApi  {
   ...
   private DnsApiService delegate;

   protected DnsApi() {
   }

   @javax.inject.Inject
   public DnsApi(DnsApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "DNS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response addDnsDomain(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) DnsNewDomain body
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "DNS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response addDnsRecord(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) DnsNewRecord body
,@Parameter(in = ParameterIn.PATH, description = "The DNS Domain ID.",required=true) @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "DNS" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response updateDnsRecord(@Parameter(in = ParameterIn.DEFAULT, description = "The request data to update a dns record." ,required=true) DnsUpdateRecord body
