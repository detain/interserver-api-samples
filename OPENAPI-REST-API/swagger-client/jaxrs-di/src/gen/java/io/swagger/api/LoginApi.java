...
public class LoginApi  {
   ...
   private LoginApiService delegate;

   protected LoginApi() {
   }

   @javax.inject.Inject
   public LoginApi(LoginApiService delegate) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response submitLogin(@Parameter(in = ParameterIn.DEFAULT, description = "" ,required=true) LoginSubmissionExample body
