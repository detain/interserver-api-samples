...
data class DomainDnssecRequest (
    ...
    val algorithm: kotlin.Array<kotlin.Int>? = null,
    /* List of digest type IDs for each record. */
    val digestType: kotlin.Array<kotlin.Int>? = null,
    /* List of hex digests for each record. */
    val digest: kotlin.Array<kotlin.String>? = null,
    /* List of key tag values corresponding to each record. */
    val keyTag: kotlin.Array<kotlin.Int>? = null
) {
}