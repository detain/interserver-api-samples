...
**mac** | [**kotlin.String**](.md) | MAC address associated with the asset. |  [optional]
...
**ipmiAdminUsername** | [**kotlin.String**](.md) | IPMI admin username associated with the asset. |  [optional]
**ipmiAdminPassword** | [**kotlin.String**](.md) | IPMI admin password associated with the asset. |  [optional]
**ipmiClientUsername** | [**kotlin.String**](.md) | IPMI client username associated with the asset. |  [optional]
**ipmiClientPassword** | [**kotlin.String**](.md) | IPMI client password associated with the asset. |  [optional]
**ipmiUpdated** | [**kotlin.String**](.md) | IPMI update status associated with the asset. |  [optional]
...
**createTimestamp** | [**kotlin.String**](.md) | Timestamp of asset creation. |  [optional]
**updateTimestamp** | [**kotlin.String**](.md) | Timestamp of asset update. |  [optional]
...
**comment** | [**kotlin.String**](.md) | Comment associated with the asset. |  [optional]
