...
// APIClient manages communication with the InterServer Management API API v0.9.0
...
type APIClient struct {
	...
	QuickServersApi *QuickServersApiService

	SSLCertificatesApi *SSLCertificatesApiService

	ScrubIpsApi *ScrubIpsApiService
	...
	WebhostingApi *WebhostingApiService
}
