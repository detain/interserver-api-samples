...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class VpsTrafficUsageResponse : IEquatable<VpsTrafficUsageResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VpsTrafficUsageResponse)obj);
        }

        /// <summary>
        /// Returns true if VpsTrafficUsageResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of VpsTrafficUsageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VpsTrafficUsageResponse other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Peak != null)
                    hashCode = hashCode * 59 + Peak.GetHashCode();
                    if (Average != null)
        ...
        public static bool operator ==(VpsTrafficUsageResponse left, VpsTrafficUsageResponse right)
        {
