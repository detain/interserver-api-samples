        ...
        public bool Equals(ServiceType other)
        {
            ...
            return 
                (
                    StId == other.StId ||
                    StId != null &&
                    StId.Equals(other.StId)
                ) && 
                (
                    StName == other.StName ||
                    StName != null &&
                    StName.Equals(other.StName)
                ) && 
                (
                    StCategory == other.StCategory ||
                    StCategory != null &&
                    StCategory.Equals(other.StCategory)
                ) && 
                (
                    StModule == other.StModule ||
                    StModule != null &&
                    StModule.Equals(other.StModule)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (StId != null)
                    hashCode = hashCode * 59 + StId.GetHashCode();
                    if (StName != null)
                    hashCode = hashCode * 59 + StName.GetHashCode();
                    if (StCategory != null)
                    hashCode = hashCode * 59 + StCategory.GetHashCode();
                    if (StModule != null)
                    hashCode = hashCode * 59 + StModule.GetHashCode();
                return hashCode;
            }
        }
