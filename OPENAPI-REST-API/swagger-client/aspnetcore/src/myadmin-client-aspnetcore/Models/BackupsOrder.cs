...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BackupsOrder : IEquatable<BackupsOrder>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BackupsOrder)obj);
        }

        /// <summary>
        /// Returns true if BackupsOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of BackupsOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackupsOrder other)
        {
        ...
        public static bool operator ==(BackupsOrder left, BackupsOrder right)
        {
