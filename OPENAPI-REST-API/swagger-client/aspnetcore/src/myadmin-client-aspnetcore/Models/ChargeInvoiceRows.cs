...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChargeInvoiceRows : IEquatable<ChargeInvoiceRows>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ChargeInvoiceRows)obj);
        }

        /// <summary>
        /// Returns true if ChargeInvoiceRows instances are equal
        /// </summary>
        /// <param name="other">Instance of ChargeInvoiceRows to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChargeInvoiceRows other)
        {
        ...
        public static bool operator ==(ChargeInvoiceRows left, ChargeInvoiceRows right)
        {
