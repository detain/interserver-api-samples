...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Backup : IEquatable<Backup>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Backup)obj);
        }

        /// <summary>
        /// Returns true if Backup instances are equal
        /// </summary>
        /// <param name="other">Instance of Backup to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(Backup left, Backup right)
        {
