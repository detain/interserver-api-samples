...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class LoginServiceCounts : IEquatable<LoginServiceCounts>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LoginServiceCounts)obj);
        }

        /// <summary>
        /// Returns true if LoginServiceCounts instances are equal
        /// </summary>
        /// <param name="other">Instance of LoginServiceCounts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoginServiceCounts other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (Websites != null)
                    hashCode = hashCode * 59 + Websites.GetHashCode();
                    if (Servers != null)
        ...
        public static bool operator ==(LoginServiceCounts left, LoginServiceCounts right)
        {
