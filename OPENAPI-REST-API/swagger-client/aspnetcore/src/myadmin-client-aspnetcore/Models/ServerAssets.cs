...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServerAssets : IEquatable<ServerAssets>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ServerAssets)obj);
        }

        /// <summary>
        /// Returns true if ServerAssets instances are equal
        /// </summary>
        /// <param name="other">Instance of ServerAssets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServerAssets other)
        {
        ...
        public static bool operator ==(ServerAssets left, ServerAssets right)
        {
