...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DomainOrder : IEquatable<DomainOrder>
    { 
        /// <summary>
        ...
        [DataMember(Name="whoisPrivacyCost")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DomainOrder)obj);
        }

        /// <summary>
        /// Returns true if DomainOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of DomainOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainOrder other)
        {
            ...
            return 
                (
                    WhoisPrivacyCost == other.WhoisPrivacyCost ||
                    WhoisPrivacyCost != null &&
                    WhoisPrivacyCost.Equals(other.WhoisPrivacyCost)
                ) && 
                (
                ...
                (
                    TldServices == other.TldServices ||
                    TldServices != null &&
                    TldServices.Equals(other.TldServices)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + WhoisPrivacyCost.GetHashCode();
                    if (Services != null)
                    hashCode = hashCode * 59 + Services.GetHashCode();
                    if (TldServices != null)
                    hashCode = hashCode * 59 + TldServices.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(DomainOrder left, DomainOrder right)
        {
