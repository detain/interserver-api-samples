...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Modules : Dictionary<String, ModuleSettings>, IEquatable<Modules>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Modules)obj);
        }

        /// <summary>
        /// Returns true if Modules instances are equal
        /// </summary>
        /// <param name="other">Instance of Modules to be compared</param>
        /// <returns>Boolean</returns>
