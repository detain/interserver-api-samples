...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class LicensesOrder : IEquatable<LicensesOrder>
    { 
        /// <summary>
        /// Gets or Sets ServiceCategories
        /// </summary>

        [DataMember(Name="serviceCategories")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LicensesOrder)obj);
        }

        /// <summary>
        /// Returns true if LicensesOrder instances are equal
        /// </summary>
        /// <param name="other">Instance of LicensesOrder to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LicensesOrder other)
        {
            ...
            return 
                (
                    ...
                    ServiceCategories.Equals(other.ServiceCategories)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ServiceCategories.GetHashCode();
        ...
        public static bool operator ==(LicensesOrder left, LicensesOrder right)
        {
