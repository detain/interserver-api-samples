...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BackupOrderPostResponse : IEquatable<BackupOrderPostResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BackupOrderPostResponse)obj);
        }

        /// <summary>
        /// Returns true if BackupOrderPostResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of BackupOrderPostResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BackupOrderPostResponse other)
        {
            ...
            return 
                ...
                (
                    CjParams == other.CjParams ||
                    CjParams != null &&
                    CjParams.Equals(other.CjParams)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (CjParams != null)
                    hashCode = hashCode * 59 + CjParams.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(BackupOrderPostResponse left, BackupOrderPostResponse right)
        {
