...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class VpsCPData : IEquatable<VpsCPData>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VpsCPData)obj);
        }

        /// <summary>
        /// Returns true if VpsCPData instances are equal
        /// </summary>
        /// <param name="other">Instance of VpsCPData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VpsCPData other)
        {
        ...
        public static bool operator ==(VpsCPData left, VpsCPData right)
        {
