...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class VpsOrderPostRequest : IEquatable<VpsOrderPostRequest>
    { 
        /// <summary>
        /// OS Distribution
        /// </summary>
        ...
        public enum VpsPlatformEnum
        {
            ...
            HypervEnum = 1,
            /// <summary>
            /// Enum KvmstorageEnum for kvmstorage
            /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VpsOrderPostRequest)obj);
        }

        /// <summary>
        /// Returns true if VpsOrderPostRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of VpsOrderPostRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VpsOrderPostRequest other)
        {
            ...
            return 
                (
                    OsDistro == other.OsDistro ||
                    OsDistro != null &&
                    OsDistro.Equals(other.OsDistro)
                ) && 
                (
                    Slices == other.Slices ||
                    Slices != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (OsDistro != null)
                    hashCode = hashCode * 59 + OsDistro.GetHashCode();
                    if (Slices != null)
        ...
        public static bool operator ==(VpsOrderPostRequest left, VpsOrderPostRequest right)
        {
