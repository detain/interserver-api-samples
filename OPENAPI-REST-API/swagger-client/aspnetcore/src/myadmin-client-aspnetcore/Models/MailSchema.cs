...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailSchema : IEquatable<MailSchema>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MailSchema)obj);
        }

        /// <summary>
        /// Returns true if MailSchema instances are equal
        /// </summary>
        /// <param name="other">Instance of MailSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailSchema other)
        {
        ...
        public static bool operator ==(MailSchema left, MailSchema right)
        {
