...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class MailDeliverabilityResponse : IEquatable<MailDeliverabilityResponse>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((MailDeliverabilityResponse)obj);
        }

        /// <summary>
        /// Returns true if MailDeliverabilityResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of MailDeliverabilityResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MailDeliverabilityResponse other)
        {
            ...
            return 
                ...
                (
                    ...
                    TableData != null &&
                    TableData.SequenceEqual(other.TableData)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TableData != null)
                    hashCode = hashCode * 59 + TableData.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(MailDeliverabilityResponse left, MailDeliverabilityResponse right)
        {
