...
namespace myadmin-client-aspnetcore.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class BillingPrepayRequest : IEquatable<BillingPrepayRequest>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BillingPrepayRequest)obj);
        }

        /// <summary>
        /// Returns true if BillingPrepayRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of BillingPrepayRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BillingPrepayRequest other)
        {
            ...
            return 
                ...
                (
                    AutomaticUse == other.AutomaticUse ||
                    AutomaticUse != null &&
                    AutomaticUse.Equals(other.AutomaticUse)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + AutomaticUse.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(BillingPrepayRequest left, BillingPrepayRequest right)
        {
