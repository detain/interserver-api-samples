...
namespace myadmin-client-aspnetcore.Models
{
    ...
    { 
        ...
        public bool Equals(Server other)
        {
            ...
            return 
                (
                    IpmiAuth == other.IpmiAuth ||
                    IpmiAuth != null &&
                    IpmiAuth.Equals(other.IpmiAuth)
                ) && 
                (
                ...
                (
                    ...
                    NetworkInfo != null &&
                    NetworkInfo.Equals(other.NetworkInfo)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (IpmiAuth != null)
                    hashCode = hashCode * 59 + IpmiAuth.GetHashCode();
                    if (ClientLinks != null)
                    ...
                    if (NetworkInfo != null)
                    hashCode = hashCode * 59 + NetworkInfo.GetHashCode();
