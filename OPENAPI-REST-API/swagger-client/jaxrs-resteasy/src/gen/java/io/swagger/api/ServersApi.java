...
public class ServersApi  {
    ...
    @Inject ServersApiService service;
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.addServer(securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.buyItNowServerOrder(securityContext);
    }
    @GET
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getNewServer(securityContext);
    }
    @GET
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getServerInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getServerInfo(id,securityContext);
    }
    @GET
    @Path("/{id}/invoices")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getServerInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getServerInvoices(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getServerList(securityContext);
    }
    @GET
    @Path("/{id}/reverse_dns")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getServerReverseDns( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getServerReverseDns(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getServersWelcomeEmail( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getServersWelcomeEmail(id,securityContext);
    }
    @POST
    @Path("/order/buy_now_server")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response placeBuyNowServer(
@Parameter(description = "" ) OrderBuyNowServerBody body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.placeBuyNowServer(body,securityContext);
    }
    @POST
    @Path("/{id}/reverse_dns")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postServerReverseDns(
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postServerReverseDns(body,id,securityContext);
    }
    @POST
    @Path("/{id}/reverse_dns")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postServerReverseDns(@Parameter(description = "", required=true)@FormParam("ips")  Map<String, Object> ips, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postServerReverseDns(ips,id,securityContext);
    }
    @PUT
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.putServers(securityContext);
    }
    @GET
    @Path("/{id}/ipmi_live")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response serverIpmiLiveGet( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiLiveGet(id,securityContext);
    }
    @POST
    @Path("/{id}/ipmi_live")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverIpmiLivePost(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("asset")  Integer asset,@Parameter(description = "", required=true)@FormParam("ip")  String ip, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiLivePost(input,asset,ip,id,securityContext);
    }
    @POST
    @Path("/{id}/ipmi_live")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "404", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverIpmiLivePost(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) ServerIpmiLiveRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiLivePost(input,body,id,securityContext);
    }
    @GET
    @Path("/{id}/ipmi_power")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverIpmiPowerGet( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiPowerGet(id,securityContext);
    }
    @POST
    @Path("/{id}/ipmi_power")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response serverIpmiPowerPost(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("asset")  Integer asset,@Parameter(description = "", required=true, schema=@Schema(allowableValues={ "cycle", "reset", "on", "off", "soft" })
)@FormParam("action")  String action, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiPowerPost(input,asset,action,id,securityContext);
    }
    @POST
    @Path("/{id}/ipmi_power")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "400", description = "The specified resource was not found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serverIpmiPowerPost(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) ServerIpmiPowerRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serverIpmiPowerPost(input,body,id,securityContext);
    }
    @DELETE
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response serversCancel( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.serversCancel(id,securityContext);
    }
    @POST
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateServerInfo( @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateServerInfo(id,securityContext);
    }
}
