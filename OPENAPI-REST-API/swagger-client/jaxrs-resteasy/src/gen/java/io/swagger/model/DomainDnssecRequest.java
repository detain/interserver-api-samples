...
public class DomainDnssecRequest   {
  private List<Integer> algorithm = new ArrayList<Integer>();  private List<Integer> digestType = new ArrayList<Integer>();  private List<String> digest = new ArrayList<String>();  private List<Integer> keyTag = new ArrayList<Integer>();
