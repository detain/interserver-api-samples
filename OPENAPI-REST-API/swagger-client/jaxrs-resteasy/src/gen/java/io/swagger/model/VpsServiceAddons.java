...
public class VpsServiceAddons   {
  private Boolean hasCpanel = null;  private Boolean hasDirectadmin = null;  private Boolean hasFantastico = null;  private Boolean hasSoftaculous = null;  private Boolean hasHdspace = null;  private Boolean dedicatedIp = null;  private List<String> extraIps = new ArrayList<String>();  private List<String> extraIps6 = new ArrayList<String>();  private List<String> unpaidIps = new ArrayList<String>();  private List<String> ips = new ArrayList<String>();  private List<String> ips6 = new ArrayList<String>();  private Integer cpanelId = null;  private Integer cost = null;  private List<String> ids = new ArrayList<String>();  private List<String> rdata = new ArrayList<String>();
