...
public interface MailApiService {
      ...
      Response viewMailLog(Integer id,Long id,String origin,String mx,String from,String to,String subject,String mailid,Integer skip,Integer limit,Long startDate,Long endDate,String delivered,SecurityContext securityContext) throws NotFoundException;
}
