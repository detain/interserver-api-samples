...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addVps(body,securityContext);
    }
    @POST
    @Path("/order")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response addVps(@Parameter(description = "")@FormParam("osDistro")  String osDistro,@Parameter(description = "", schema=@Schema(allowableValues={ "32", "1" }, minimum="1", maximum="32")
)@FormParam("slices")  Integer slices,@Parameter(description = "", schema=@Schema(allowableValues={ "kvm", "hyperv", "kvmstorage" })
)@FormParam("vpsPlatform")  String vpsPlatform,@Parameter(description = "", schema=@Schema(allowableValues={ "none", "cpanel", "da" })
)@FormParam("controlpanel")  String controlpanel,@Parameter(description = "", schema=@Schema(allowableValues={ "12", "1" }, minimum="1", maximum="12")
)@FormParam("period")  Integer period,@Parameter(description = "", schema=@Schema(allowableValues={ "3", "1" }, minimum="1", maximum="3")
)@FormParam("location")  Integer location,@Parameter(description = "")@FormParam("osVersion")  String osVersion,@Parameter(description = "")@FormParam("hostname")  String hostname,@Parameter(description = "")@FormParam("coupon")  String coupon,@Parameter(description = "")@FormParam("rootpass")  String rootpass,@Parameter(description = "")@FormParam("comment")  String comment,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addVps(osDistro,slices,vpsPlatform,controlpanel,period,location,osVersion,hostname,coupon,rootpass,comment,securityContext);
    }
    @DELETE
    @Path("/{id}/backups")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteVpsBackup( @PathParam("id") Integer id, @NotNull  @QueryParam("file") String file,  @QueryParam("all") String all,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteVpsBackup(id,file,all,securityContext);
    }
    @GET
    @Path("/{id}/block_smtp")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsBlockSmtp( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsBlockSmtp(id,securityContext);
    }
    @GET
    @Path("/{id}/disable_cd")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsDisableCd( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsDisableCd(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsDisableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsDisableQuota(id,securityContext);
    }
    @GET
    @Path("/{id}/eject_cd")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsEjectCd( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsEjectCd(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsEnableQuota( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsEnableQuota(id,securityContext);
    }
    @GET
    @Path("/{id}/restart")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsRestart( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsRestart(id,securityContext);
    }
    @GET
    @Path("/{id}/start")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsStart( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsStart(id,securityContext);
    }
    @GET
    @Path("/{id}/stop")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response doVpsStop( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.doVpsStop(id,securityContext);
    }
    @PATCH
    @Path("/{id}/backups")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,  @QueryParam("all") String all,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.downloadVpsBackup(body,id,all,securityContext);
    }
    @PATCH
    @Path("/{id}/backups")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response downloadVpsBackup(@Parameter(description = "", required=true)@FormParam("file")  String file, @PathParam("id") Integer id,  @QueryParam("all") String all,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.downloadVpsBackup(file,id,all,securityContext);
    }
    @GET
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getNewVps(securityContext);
    }
    @GET
    @Path("/{id}/backups")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsBackups( @PathParam("id") Integer id,  @QueryParam("all") String all,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsBackups(id,all,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsBuyHdSpace( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsBuyHdSpace(id,securityContext);
    }
    @GET
    @Path("/{id}/buy_ip")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsBuyIp( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsBuyIp(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsChangeTimezone( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsChangeTimezone(id,securityContext);
    }
    @GET
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsInfo(id,securityContext);
    }
    @GET
    @Path("/{id}/invoices")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsInvoices(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getVpsList(securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsReinstallOs( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsReinstallOs(id,securityContext);
    }
    @GET
    @Path("/{id}/reverse_dns")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsReverseDns( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsReverseDns(id,securityContext);
    }
    @GET
    @Path("/{id}/setup_vnc")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsSetupVnc(id,securityContext);
    }
    @GET
    @Path("/{id}/slices")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsSlices( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsSlices(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsTrafficUsage( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsTrafficUsage(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsViewDesktop(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getVpsWelcomeEmail( @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getVpsWelcomeEmail(id,securityContext);
    }
    @GET
    @Path("/{id}/backup")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsBackup( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsBackup(id,securityContext);
    }
    @POST
    @Path("/{id}/buy_hd_space")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsBuyHdSpace( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsBuyHdSpace(id,securityContext);
    }
    @POST
    @Path("/{id}/buy_ip")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsBuyIp( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsBuyIp(id,securityContext);
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeHostname(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("hostname")  String hostname, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeHostname(input,hostname,id,securityContext);
    }
    @POST
    @Path("/{id}/change_hostname")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeHostname(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) HostnameObject body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeHostname(input,body,id,securityContext);
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeRootPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeRootPassword(input,password,id,securityContext);
    }
    @POST
    @Path("/{id}/change_root_password")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeRootPassword(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) PasswordRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeRootPassword(input,body,id,securityContext);
    }
    @POST
    @Path("/{id}/change_timezone")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeTimezone(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("timezone")  String timezone, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeTimezone(input,timezone,id,securityContext);
    }
    @POST
    @Path("/{id}/change_timezone")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeTimezone(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) TimezoneUpdate body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeTimezone(input,body,id,securityContext);
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeWebuzoPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeWebuzoPassword(input,password,id,securityContext);
    }
    @POST
    @Path("/{id}/change_webuzo_password")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsChangeWebuzoPassword(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) PasswordRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsChangeWebuzoPassword(input,body,id,securityContext);
    }
    @POST
    @Path("/{id}/insert_cd")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsInsertCd(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("url")  String url, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsInsertCd(input,url,id,securityContext);
    }
    @POST
    @Path("/{id}/insert_cd")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsInsertCd(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) UrlRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsInsertCd(input,body,id,securityContext);
    }
    @POST
    @Path("/{id}/reinstall_os")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsReinstallOs(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("template")  String template,@Parameter(description = "", required=true)@FormParam("password")  String password,@Parameter(description = "", required=true)@FormParam("localPassword")  String localPassword, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsReinstallOs(input,template,password,localPassword,id,securityContext);
    }
    @POST
    @Path("/{id}/reinstall_os")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsReinstallOs(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) TemplateRequest body
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsReinstallOs(input,body,id,securityContext);
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsResetPassword( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsResetPassword(id,securityContext);
    }
    @POST
    @Path("/{id}/restore")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsRestore(body,id,securityContext);
    }
    @POST
    @Path("/{id}/restore")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsRestore(@Parameter(description = "", required=true)@FormParam("backup")  String backup,@Parameter(description = "", required=true)@FormParam("password")  String password, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsRestore(backup,password,id,securityContext);
    }
    @POST
    @Path("/{id}/reverse_dns")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsReverseDns(body,id,securityContext);
    }
    @POST
    @Path("/{id}/reverse_dns")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsReverseDns(@Parameter(description = "", required=true)@FormParam("ips")  Map<String, Object> ips, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsReverseDns(ips,id,securityContext);
    }
    @POST
    @Path("/{id}/setup_vnc")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsSetupVnc( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsSetupVnc(id,securityContext);
    }
    @POST
    @Path("/{id}/slices")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsSlices( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsSlices(id,securityContext);
    }
    @POST
    @Path("/{id}/view_desktop")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postVpsViewDesktop( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postVpsViewDesktop(id,securityContext);
    }
    @PUT
    @Path("/order")
    @Consumes({ "application/json", "multipart/form-data" })
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putVps(body,securityContext);
    }
    @PUT
    @Path("/order")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response putVps(@Parameter(description = "")@FormParam("osDistro")  String osDistro,@Parameter(description = "", schema=@Schema(allowableValues={ "32", "1" }, minimum="1", maximum="32")
)@FormParam("slices")  Integer slices,@Parameter(description = "", schema=@Schema(allowableValues={ "kvm", "hyperv", "kvmstorage" })
)@FormParam("vpsPlatform")  String vpsPlatform,@Parameter(description = "", schema=@Schema(allowableValues={ "none", "cpanel", "da" })
)@FormParam("controlpanel")  String controlpanel,@Parameter(description = "", schema=@Schema(allowableValues={ "12", "1" }, minimum="1", maximum="12")
)@FormParam("period")  Integer period,@Parameter(description = "", schema=@Schema(allowableValues={ "3", "1" }, minimum="1", maximum="3")
    ...
    throws NotFoundException {
        return service.putVps(osDistro,slices,vpsPlatform,controlpanel,period,location,osVersion,hostname,coupon,rootpass,comment,securityContext);
    }
    @POST
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateVpsInfo( @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateVpsInfo(id,securityContext);
    }
    @DELETE
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response vPSCancel( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.vPSCancel(id,securityContext);
    }
}
