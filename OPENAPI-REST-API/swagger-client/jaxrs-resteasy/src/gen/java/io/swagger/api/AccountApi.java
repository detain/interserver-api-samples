...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response addAccountCreditCard(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) BillingAddCcRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addAccountCreditCard(input,body,securityContext);
    }
    @POST
    @Path("/username")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.changeAccountUsername(securityContext);
    }
    @DELETE
    @Path("/creditcards/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteAccountCreditCard( @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteAccountCreditCard(id,securityContext);
    }
    @DELETE
    @Path("/oauth/{name}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteAccountOauthName( @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteAccountOauthName(name,securityContext);
    }
    @DELETE
    @Path("/2fa")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.deleteAccountTfa(securityContext);
    }
    @PATCH
    @Path("/iplimits")
...
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteIpLimit(body,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAccountInfo(securityContext);
    }
    @GET
    @Path("/2fa")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAccountTfaSetup(securityContext);
    }
    @GET
    @Path("/countries")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getCountries(  @QueryParam("fetch_by") String fetchBy,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getCountries(fetchBy,securityContext);
    }
    @GET
    @Path("/timezones")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getTimezones(securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response logoutAccountOauth( @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.logoutAccountOauth(name,securityContext);
    }
    @POST
    @Path("/apikey")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.updateAccountApiKey(securityContext);
    }
    @POST
    @Path("/creditcards/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAccountCreditCard( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountCreditCard(id,securityContext);
    }
    @POST
    @Path("/features")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response updateAccountFeatures(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("disable_reset")  Integer disableReset,@Parameter(description = "", required=true)@FormParam("disable_reinstall")  Integer disableReinstall,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountFeatures(input,disableReset,disableReinstall,securityContext);
    }
    @POST
    @Path("/features")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "422", description = "Request was valid but did not contain updatable values.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))) })
    public Response updateAccountFeatures(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AccountFeatures body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountFeatures(input,body,securityContext);
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "422", description = "Validation error while updating account data.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))) })
    public Response updateAccountInfo(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AccountInfoPost body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountInfo(input,body,securityContext);
    }
    @POST
    @Path("/iplimits")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response updateAccountIpLimits(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("start")  String start,@Parameter(description = "", required=true)@FormParam("end")  String end,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountIpLimits(input,start,end,securityContext);
    }
    @POST
    @Path("/iplimits")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "422", description = "IP limit payload contains an invalid address.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))) })
    public Response updateAccountIpLimits(MultipartFormDataInput input,
@Parameter(description = "The lower and upper bounds of an ip range." ,required=true) IpLimitRange body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountIpLimits(input,body,securityContext);
    }
    @POST
    @Path("/password")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAccountPassword(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("password")  String password,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountPassword(input,password,securityContext);
    }
    @POST
    @Path("/password")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAccountPassword(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) PasswordRequest body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountPassword(input,body,securityContext);
    }
    @POST
    @Path("/sshkey")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAccountSshKey(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("ssh_key")  String sshKey,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountSshKey(input,sshKey,securityContext);
    }
    @POST
    @Path("/sshkey")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAccountSshKey(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AccountSshKey body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountSshKey(input,body,securityContext);
    }
    @POST
    @Path("/2fa")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response updateAccountTfa(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("2fa_google_code")  String _2faGoogleCode,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountTfa(input,_2faGoogleCode,securityContext);
    }
    @POST
    @Path("/2fa")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "422", description = "Provided two-factor verification code was invalid.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TextResponse.class))) })
    public Response updateAccountTfa(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) Account2faBody1 body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAccountTfa(input,body,securityContext);
    }
}
