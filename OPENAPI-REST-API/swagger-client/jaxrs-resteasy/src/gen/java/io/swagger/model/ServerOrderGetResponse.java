...
public class ServerOrderGetResponse   {
  private FormValues formValues = null;  private ConfigIds configIds = null;  private Integer cpu = null;  private Map<String, Cpu> cpuLi = new HashMap<String, Cpu>();  private ConfigLists configLi = null;  private Map<String, FieldLabel> fieldLabel = new HashMap<String, FieldLabel>();  private Map<String, Map<String, CpuWithDefaults>> cpuCores = new HashMap<String, Map<String, CpuWithDefaults>>();  private Integer frequency = null;  private String currency = null;  private String currencySymbol = null;  private String country = null;  private Integer custid = null;  private String ima = null;  private String step = null;  private List<Region> regions = new ArrayList<Region>();  private List<AssetServer> assetServers = new ArrayList<AssetServer>();  private List<Object> buyItServers = new ArrayList<Object>();  private String displayShowmore = null;  private BigDecimal custDiscount = null;
