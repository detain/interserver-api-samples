...
public class ConfigLists   {
  private Map<String, Cpu> cpuLi = new HashMap<String, Cpu>();  private Map<String, Map<String, MemoryOption>> memoryLi = new HashMap<String, Map<String, MemoryOption>>();  private Map<String, Map<String, HardDrive>> hdLi = new HashMap<String, Map<String, HardDrive>>();  private Map<String, Bandwidth> bandwidthLi = new HashMap<String, Bandwidth>();  private Map<String, IpBlock> ipsLi = new HashMap<String, IpBlock>();  private Map<String, OperatingSystem> osLi = new HashMap<String, OperatingSystem>();  private Map<String, ControlPanel> cpLi = new HashMap<String, ControlPanel>();  private List<RaidOption> raidLi = new ArrayList<RaidOption>();
