...
public class AffiliateApi  {
    ...
    @Inject AffiliateApiService service;
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAffiliateBanners(securityContext);
    }
    @GET
    @Path("/rich_report")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAffiliateRichReport(securityContext);
    }
    @GET
    @Path("/sales_graph")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateSalesGraph(  @QueryParam("days") Integer days,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getAffiliateSalesGraph(days,securityContext);
    }
    @GET
    @Path("/sales_report")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAffiliateSalesReport(securityContext);
    }
    @GET
    @Path("/traffic_graph")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getAffiliateTrafficGraph(  @QueryParam("days") Integer days,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getAffiliateTrafficGraph(days,securityContext);
    }
    @GET
    @Path("/web_traffic")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getAffiliateWebTraffic(securityContext);
    }
    @POST
    @Path("/dock_setup")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliateDockSetup(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AffiliateDockSetup body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAffiliateDockSetup(input,body,securityContext);
    }
    @POST
    @Path("/landing_pg")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliateLandingPage(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("affiliate_dock_title")  String affiliateDockTitle,@Parameter(description = "", required=true)@FormParam("affiliate_dock_description")  String affiliateDockDescription,@Parameter(description = "", required=true)@FormParam("referrer_coupon")  String referrerCoupon,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAffiliateLandingPage(input,affiliateDockTitle,affiliateDockDescription,referrerCoupon,securityContext);
    }
    @POST
    @Path("/landing_pg")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliateLandingPage(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AffiliateDockSetup body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAffiliateLandingPage(input,body,securityContext);
    }
    @POST
    @Path("/payment_setup")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliatePaymentSetup(MultipartFormDataInput input,@Parameter(description = "", required=true)@FormParam("affiliate_paypal")  String affiliatePaypal,@Parameter(description = "", required=true)@FormParam("affiliate_payment_method")  String affiliatePaymentMethod,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAffiliatePaymentSetup(input,affiliatePaypal,affiliatePaymentMethod,securityContext);
    }
    @POST
    @Path("/payment_setup")
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateAffiliatePaymentSetup(MultipartFormDataInput input,
@Parameter(description = "" ,required=true) AffiliatePaymentSetup body
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateAffiliatePaymentSetup(input,body,securityContext);
    }
}
