...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response initiatePayment( @PathParam("method") String method, @PathParam("invoices") String invoices,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.initiatePayment(method,invoices,securityContext);
    }
}
