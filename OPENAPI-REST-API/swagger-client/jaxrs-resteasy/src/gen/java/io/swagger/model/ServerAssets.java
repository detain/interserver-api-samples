...
public class ServerAssets   {
  private String title = null;  private Integer size = null;  private String type = null;  private List<String> header = new ArrayList<String>();  private List<List<String>> rows = new ArrayList<List<String>>();
