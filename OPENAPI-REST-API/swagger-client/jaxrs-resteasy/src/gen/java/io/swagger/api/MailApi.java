...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response viewMailLog( @PathParam("id") Integer id,  @QueryParam("id") Long id,  @QueryParam("origin") String origin,  @QueryParam("mx") String mx,  @QueryParam("from") String from,  @QueryParam("to") String to,  @QueryParam("subject") String subject,  @QueryParam("mailid") String mailid, @Min(0)  @DefaultValue("0") @QueryParam("skip") Integer skip, @Min(1) @Max(10000)  @DefaultValue("100") @QueryParam("limit") Integer limit, @Min(0L) @Max(9999999999L)  @QueryParam("startDate") Long startDate, @Min(0L) @Max(9999999999L)  @QueryParam("endDate") Long endDate,  @QueryParam("delivered") String delivered,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.viewMailLog(id,id,origin,mx,from,to,subject,mailid,skip,limit,startDate,endDate,delivered,securityContext);
    }
}
