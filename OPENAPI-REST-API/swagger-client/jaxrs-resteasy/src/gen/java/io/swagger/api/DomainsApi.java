...
public class DomainsApi  {
    ...
    @Inject DomainsApiService service;
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response addDomain(@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addDomain(securityContext);
    }
    @POST
    @Path("/{id}/dnssec")
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addDomainDnssec(body,id,securityContext);
    }
    @POST
    @Path("/{id}/dnssec")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addDomainNameserver(body,id,securityContext);
    }
    @POST
    @Path("/{id}/nameservers")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response addDomainNameserver(@Parameter(description = "", required=true)@FormParam("name")  String name,@Parameter(description = "", required=true)@FormParam("ipAddress")  String ipAddress, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.addDomainNameserver(name,ipAddress,id,securityContext);
    }
    @DELETE
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response cancelDomain( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.cancelDomain(id,securityContext);
    }
    @DELETE
    @Path("/{id}/dnssec")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteDomainDnssec( @PathParam("id") Integer id, @NotNull  @QueryParam("action") String action,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteDomainDnssec(id,action,securityContext);
    }
    @DELETE
    @Path("/{id}/nameservers")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response deleteDomainNameserver( @PathParam("id") Integer id, @NotNull  @QueryParam("index") Integer index,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.deleteDomainNameserver(id,index,securityContext);
    }
    @GET
    @Path("/{id}/contact")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainContact( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainContact(id,securityContext);
    }
    @GET
    @Path("/{id}/dnssec")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainDnssec( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainDnssec(id,securityContext);
    }
    @GET
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainInfo( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainInfo(id,securityContext);
    }
    @GET
    @Path("/{id}/invoices")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainInvoices( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainInvoices(id,securityContext);
    }
    @GET
    @Path("/lookup/{name}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response getDomainLookup( @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainLookup(name,securityContext);
    }
    @GET
    @Path("/{id}/nameservers")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainNameservers( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainNameservers(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainOrderFields( @PathParam("domain") String domain, @PathParam("regType") String regType,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainOrderFields(domain,regType,securityContext);
    }
    @GET
    @Path("/order/{domain}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainOrderSearchResults( @PathParam("domain") String domain,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainOrderSearchResults(domain,securityContext);
    }
    @GET
    @Path("/{id}/renew")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainRenewal( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainRenewal(id,securityContext);
    }
    @GET
    @Path("/search/{name}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    public Response getDomainSearch( @PathParam("name") String name,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainSearch(name,securityContext);
    }
    @GET
    @Path("/{id}/transfer")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainTransfer( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainTransfer(id,securityContext);
    }
    @GET
    @Path("/{id}/whois")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainWhoisPrivacy( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainWhoisPrivacy(id,securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getDomainsList(securityContext);
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getDomainsWelcomeEmail( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.getDomainsWelcomeEmail(id,securityContext);
    }
    @GET
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    throws NotFoundException {
        return service.getNewDomain(securityContext);
    }
    @PATCH
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response patchDomains(@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.patchDomains(securityContext);
    }
    @POST
    @Path("/{id}/renew")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postDomainRenewal( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postDomainRenewal(id,securityContext);
    }
    @POST
    @Path("/{id}/transfer")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response postDomainTransfer( @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.postDomainTransfer(id,securityContext);
    }
    @PUT
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response putDomains(@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.putDomains(securityContext);
    }
    @POST
    @Path("/{id}/contact")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateDomainContact(body,id,securityContext);
    }
    @POST
    @Path("/{id}/contact")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateDomainInfo( @PathParam("id") String id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateDomainInfo(id,securityContext);
    }
    @PUT
    @Path("/{id}/nameservers")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateDomainNameservers(body,id,securityContext);
    }
    @PUT
    @Path("/{id}/nameservers")
    @Consumes({ "application/json", "multipart/form-data" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response updateDomainNameservers(@Parameter(description = "", required=true)@FormParam("nameserver")  List<String> nameserver, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateDomainNameservers(nameserver,id,securityContext);
    }
    @POST
    @Path("/{id}/whois")
    @Consumes({ "application/json", "multipart/form-data" })
...
, @PathParam("id") Integer id,@Context SecurityContext securityContext)
    throws NotFoundException {
        return service.updateDomainWhoisPrivacy(body,id,securityContext);
    }
    @POST
    @Path("/{id}/whois")
    @Consumes({ "application/json", "multipart/form-data" })
