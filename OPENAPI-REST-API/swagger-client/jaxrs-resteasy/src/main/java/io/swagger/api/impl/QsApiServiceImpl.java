...
public class QsApiServiceImpl implements QsApiService {
      ...
      public Response deleteQsBackup(Integer id,String file,String all,SecurityContext securityContext)
      throws NotFoundException {
      // do some magic!
      return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
  }
      ...
      public Response postQsChangeTimezone(MultipartFormDataInput input,String timezone,Integer id,SecurityContext securityContext)
      throws NotFoundException {
      // do some magic!
      return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
  }
      public Response postQsChangeTimezone(MultipartFormDataInput input,TimezoneUpdate body,Integer id,SecurityContext securityContext)
      throws NotFoundException {
      // do some magic!
      return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
  }
