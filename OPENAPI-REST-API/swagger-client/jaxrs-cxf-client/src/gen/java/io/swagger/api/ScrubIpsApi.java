...
public interface ScrubIpsApi  {
    ...
    @Operation(summary = "Cancel Scrub IP Service", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Create Traffic Filter", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse2011 createFilter(CreateFilter body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Create Geo Firewall Rule", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse201 createGeoRule(CreateGeoFirewallRule body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Create Firewall Rule", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "201", description = "Create firewall rule for scrub ip", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse201.class))),
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse5002.class))) })
    public InlineResponse201 createRule(CreateFirewallRule body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete Traffic Filter", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse20017 deleteFilter(CreateFilter body, @PathParam("id") Integer id);
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Disable Scrub Protection", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Enable Scrub Protection", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Scrub IP Ordering Information", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/scrub_ips/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Get Scrub IP Details", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "List Scrub Filter Types", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get ScrubIp Invoices", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get Scrub IP Logs", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/scrub_ips")
    @Produces({ "application/json" })
    @Operation(summary = "List Scrub IP Services", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Place Scrub IP Order", tags={  })
    @ApiResponses(value = { 
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete Geo Firewall Rule", tags={  })
    @ApiResponses(value = { 
    ...
    public InlineResponse20016 scrubIpsDeleteGeoRule(DeleteGeoFirewallRule body, @PathParam("id") Integer id);
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @Operation(summary = "Delete Firewall Rule", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Delete firewall rule for scrub ip", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse20016.class))),
        @ApiResponse(responseCode = "400", description = "Bad Request", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse4002.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "500", description = "Internal Server Error", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse5003.class))) })
    public InlineResponse20016 scrubIpsDeleteRule(DeleteFirewallRule body, @PathParam("id") Integer id);
}
