...
public interface LicensesApi  {
    ...
    @Operation(summary = "Place License Order", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get License Invoices", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/licenses")
    @Produces({ "application/json" })
    @Operation(summary = "List Licenses", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Get License Order Information for Category", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Resend License Welcome Email", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/licenses/order")
    @Produces({ "application/json" })
    @Operation(summary = "Get License Order Information", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/licenses/{id}")
    @Produces({ "application/json" })
    @Operation(summary = "Cancel License", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @Operation(summary = "Change License IP", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "A response indicating the operation completed successfully with a text message.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = SuccessTextResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    ...
    @Path("/licenses/order")
    @Produces({ "application/json" })
    @Operation(summary = "Validate License Order", tags={  })
    @ApiResponses(value = { 
