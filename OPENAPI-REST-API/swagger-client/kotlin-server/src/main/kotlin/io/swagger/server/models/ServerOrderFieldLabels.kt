...
data class ServerOrderFieldLabels (
    ...
    val bandwidth: AllOfServerOrderFieldLabelsBandwidth? = null,
    /* IPs field label. */
    val ips: AllOfServerOrderFieldLabelsIps? = null,
    /* Operating System field label. */
    val os: AllOfServerOrderFieldLabelsOs? = null,
    /* Control Panel field label. */
    val cp: AllOfServerOrderFieldLabelsCp? = null,
    /* RAID field label. */
    val raid: AllOfServerOrderFieldLabelsRaid? = null,
    /* Memory field label. */
    val memory: AllOfServerOrderFieldLabelsMemory? = null,
    /* Hard Drives field label */
    val hd: AllOfServerOrderFieldLabelsHd? = null
) {
}
