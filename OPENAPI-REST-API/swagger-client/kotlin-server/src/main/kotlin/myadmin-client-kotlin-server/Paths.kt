...
object Paths {
     ...
     */
    @Location("/mail/{id}/log") class viewMailLog(val id: kotlin.Int, val id: kotlin.Long, val origin: kotlin.String, val mx: kotlin.String, val from: kotlin.String, val to: kotlin.String, val subject: kotlin.String, val mailid: kotlin.String, val skip: kotlin.Int, val limit: kotlin.Int, val startDate: kotlin.Long, val endDate: kotlin.Long, val delivered: kotlin.String)
