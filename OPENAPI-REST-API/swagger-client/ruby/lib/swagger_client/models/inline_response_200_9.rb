...
module SwaggerClient
  class InlineResponse2009
    ...
    def valid?
      type_validator = EnumAttributeValidator.new('Object', ['redirect', 'submit', 'single'])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('Object', ['redirect', 'submit', 'single'])
    ...
    def hash
      [type, redirect, action, method, items, text].hash
    end
