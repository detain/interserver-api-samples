...
# Unit tests for SwaggerClient::VpsTrafficResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VpsTrafficResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::VpsTrafficResponse.new
  end
  ...
  describe 'test an instance of VpsTrafficResponse' do
    it 'should create an instance of VpsTrafficResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::VpsTrafficResponse)
    end
  end
