...
# Unit tests for SwaggerClient::CreateFirewallRule
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateFirewallRule' do
  before do
    # run before each test
    @instance = SwaggerClient::CreateFirewallRule.new
  end
  ...
  describe 'test an instance of CreateFirewallRule' do
    it 'should create an instance of CreateFirewallRule' do
      expect(@instance).to be_instance_of(SwaggerClient::CreateFirewallRule)
    end
  end
