...
# Unit tests for SwaggerClient::ConfigIds
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConfigIds' do
  before do
    # run before each test
    @instance = SwaggerClient::ConfigIds.new
  end
  ...
  describe 'test an instance of ConfigIds' do
    it 'should create an instance of ConfigIds' do
      expect(@instance).to be_instance_of(SwaggerClient::ConfigIds)
    end
  end
