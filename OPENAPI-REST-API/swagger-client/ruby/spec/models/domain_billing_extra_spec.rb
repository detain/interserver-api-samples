...
# Unit tests for SwaggerClient::DomainBillingExtra
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DomainBillingExtra' do
  before do
    # run before each test
    @instance = SwaggerClient::DomainBillingExtra.new
  end
  ...
  describe 'test an instance of DomainBillingExtra' do
    it 'should create an instance of DomainBillingExtra' do
      expect(@instance).to be_instance_of(SwaggerClient::DomainBillingExtra)
    end
  end
