...
# Unit tests for SwaggerClient::InlineResponse4005
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse4005' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse4005.new
  end
  ...
  describe 'test an instance of InlineResponse4005' do
    it 'should create an instance of InlineResponse4005' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse4005)
    end
  end
