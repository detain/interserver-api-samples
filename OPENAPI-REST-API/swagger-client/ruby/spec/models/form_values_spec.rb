...
# Unit tests for SwaggerClient::FormValues
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FormValues' do
  before do
    # run before each test
    @instance = SwaggerClient::FormValues.new
  end
  ...
  describe 'test an instance of FormValues' do
    it 'should create an instance of FormValues' do
      expect(@instance).to be_instance_of(SwaggerClient::FormValues)
    end
  end
