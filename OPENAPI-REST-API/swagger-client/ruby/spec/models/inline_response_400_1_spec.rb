...
# Unit tests for SwaggerClient::InlineResponse4001
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse4001' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse4001.new
  end
  ...
  describe 'test an instance of InlineResponse4001' do
    it 'should create an instance of InlineResponse4001' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse4001)
    end
  end
