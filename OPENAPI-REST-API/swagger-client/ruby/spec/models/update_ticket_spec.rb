...
# Unit tests for SwaggerClient::UpdateTicket
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateTicket' do
  before do
    # run before each test
    @instance = SwaggerClient::UpdateTicket.new
  end
  ...
  describe 'test an instance of UpdateTicket' do
    it 'should create an instance of UpdateTicket' do
      expect(@instance).to be_instance_of(SwaggerClient::UpdateTicket)
    end
  end
