...
# Unit tests for SwaggerClient::InlineResponse4003
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse4003' do
  before do
    # run before each test
    @instance = SwaggerClient::InlineResponse4003.new
  end
  ...
  describe 'test an instance of InlineResponse4003' do
    it 'should create an instance of InlineResponse4003' do
      expect(@instance).to be_instance_of(SwaggerClient::InlineResponse4003)
    end
  end
