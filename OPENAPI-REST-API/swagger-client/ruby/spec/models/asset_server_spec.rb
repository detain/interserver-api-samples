...
# Unit tests for SwaggerClient::AssetServer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AssetServer' do
  before do
    # run before each test
    @instance = SwaggerClient::AssetServer.new
  end
  ...
  describe 'test an instance of AssetServer' do
    it 'should create an instance of AssetServer' do
      expect(@instance).to be_instance_of(SwaggerClient::AssetServer)
    end
  end
