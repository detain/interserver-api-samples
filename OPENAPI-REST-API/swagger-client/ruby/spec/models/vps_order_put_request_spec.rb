...
# Unit tests for SwaggerClient::VpsOrderPutRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VpsOrderPutRequest' do
  before do
    # run before each test
    @instance = SwaggerClient::VpsOrderPutRequest.new
  end
  ...
  describe 'test an instance of VpsOrderPutRequest' do
    it 'should create an instance of VpsOrderPutRequest' do
      expect(@instance).to be_instance_of(SwaggerClient::VpsOrderPutRequest)
    end
  end
