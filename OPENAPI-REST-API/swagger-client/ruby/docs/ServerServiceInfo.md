# SwaggerClient::ServerServiceInfo
...
**server_discount** | [****](.md) | Discount information for the server. | [optional] 
...
**server_location** | [****](.md) | The location of the server. | [optional] 
...
**server_dedicated_hd2** | [****](.md) | The size of the second dedicated hard drive. | [optional] 
...
**server_dedicated_cp** | [****](.md) | The control panel of the server. | [optional] 
