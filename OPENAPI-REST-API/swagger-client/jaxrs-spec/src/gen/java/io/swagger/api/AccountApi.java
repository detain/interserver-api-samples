...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response addAccountCreditCard(@FormParam(value = "name")  String name,@FormParam(value = "address")  String address,@FormParam(value = "city")  String city,@FormParam(value = "state")  String state,@FormParam(value = "country")  String country,@FormParam(value = "zip")  String zip,@FormParam(value = "cc")  String cc,@FormParam(value = "cc_exp")  String ccExp,@FormParam(value = "cc_ccv2")  String ccCcv2) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response addAccountCreditCard(@Valid BillingAddCcRequest body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/username")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response deleteAccountCreditCard( @PathParam("id")

 @Parameter(description = "The credit card ID. Use the card ID returned from &#x60;POST /account/creditcards&#x60; or listed in &#x60;/billing/creditcards&#x60;.") String id
) {
        return Response.ok().entity("magic!").build();
    }
    @DELETE
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response deleteAccountOauthName( @PathParam("name")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Public" })
    ...
    public Response getCountries(  @QueryParam("fetch_by") 

 @Parameter(description = "Get countries by iso2 or iso3 or numcode")  String fetchBy
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response logoutAccountOauth( @PathParam("name")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Billing" })
    ...
    public Response updateAccountCreditCard( @PathParam("id")

 @Parameter(description = "The credit card ID. Use the card ID returned from &#x60;POST /account/creditcards&#x60; or listed in &#x60;/billing/creditcards&#x60;.") Integer id
) {
        return Response.ok().entity("magic!").build();
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountFeatures(@FormParam(value = "disable_reset")  Integer disableReset,@FormParam(value = "disable_reinstall")  Integer disableReinstall) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/features")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountFeatures(@Valid AccountFeatures body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountInfo(@FormParam(value = "name")  String name,@FormParam(value = "company")  String company,@FormParam(value = "address")  String address,@FormParam(value = "address2")  String address2,@FormParam(value = "city")  String city,@FormParam(value = "state")  String state,@FormParam(value = "zip")  String zip,@FormParam(value = "country")  String country,@FormParam(value = "phone")  String phone,@FormParam(value = "locale")  String locale,@FormParam(value = "email_invoices")  String emailInvoices,@FormParam(value = "email_abuse")  String emailAbuse,@FormParam(value = "disable_reset")  Boolean disableReset,@FormParam(value = "disable_reinstall")  Boolean disableReinstall,@FormParam(value = "disable_server_notifications")  Boolean disableServerNotifications,@FormParam(value = "disable_email_notifications")  Boolean disableEmailNotifications,@FormParam(value = "gstin")  String gstin) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Consumes({ "multipart/form-data", "application/json" })
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountInfo(@Valid AccountInfoPost body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/iplimits")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountIpLimits(@FormParam(value = "start")  String start,@FormParam(value = "end")  String end) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/iplimits")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountIpLimits(@Valid IpLimitRange body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/password")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountPassword(@FormParam(value = "password")  String password) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/password")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountPassword(@Valid PasswordRequest body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/sshkey")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountSshKey(@FormParam(value = "ssh_key")  String sshKey) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/sshkey")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountSshKey(@Valid AccountSshKey body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/2fa")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountTfa(@FormParam(value = "2fa_google_code")  String _2faGoogleCode) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/2fa")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Account" })
    ...
    public Response updateAccountTfa(@Valid Account2faBody1 body) {
        return Response.ok().entity("magic!").build();
    }}
