...
public class StatusMonthlyBreakdown   {
  ...
  private @Valid MonthlyCounts _default = null;

  private @Valid MonthlyCounts failed = null;

  private @Valid MonthlyCounts rejected = null;

  private @Valid MonthlyCounts pending = null;

  private @Valid MonthlyCounts locked = null;

  private @Valid MonthlyCounts paid = null;
