...
public class MailStatsTypeVolumeTo   {
  ...
  private @Valid Integer clientAtDomainCom = null;

  private @Valid Integer userAtSiteNet = null;

  private @Valid Integer salesAtCompanyCom = null;

  private @Valid Integer clientAtAnothersiteCom = null;
