...
public class VpsServiceAddons   {
  ...
  private @Valid Boolean hasCpanel = null;

  private @Valid Boolean hasDirectadmin = null;

  private @Valid Boolean hasFantastico = null;

  private @Valid Boolean hasSoftaculous = null;

  private @Valid Boolean hasHdspace = null;

  private @Valid Boolean dedicatedIp = null;

  private @Valid List<String> extraIps = new ArrayList<String>();

  private @Valid List<String> extraIps6 = new ArrayList<String>();

  private @Valid List<String> unpaidIps = new ArrayList<String>();

  private @Valid List<String> ips = new ArrayList<String>();

  private @Valid List<String> ips6 = new ArrayList<String>();

  private @Valid Integer cpanelId = null;

  private @Valid Integer cost = null;

  private @Valid List<String> ids = new ArrayList<String>();

  private @Valid List<String> rdata = new ArrayList<String>();
