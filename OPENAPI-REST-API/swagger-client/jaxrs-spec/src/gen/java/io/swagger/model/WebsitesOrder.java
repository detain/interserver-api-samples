...
public class WebsitesOrder   {
  ...
  private @Valid String website = null;

  private @Valid Integer period = null;

  private @Valid Integer serviceOfferId = null;

  private @Valid WebsitesOrderPackages packages = null;

  private @Valid Boolean enableDomainRegistering = null;

  private @Valid WebsitesOrderJsonServices jsonServices = null;

  private @Valid WebsitesOrderJsonServiceOffers jsonServiceOffers = null;

  private @Valid WebsitesOrderServiceTypes serviceTypes = null;

  private @Valid WebsitesOrderServiceOffers serviceOffers = null;

  private @Valid WebsitesOrderPackges packges = null;
