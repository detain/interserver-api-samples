...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response addBackup(@FormParam(value = "validateOnly")  Boolean validateOnly,@FormParam(value = "serviceType")  Integer serviceType,@FormParam(value = "coupon")  String coupon) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response addBackup(@Valid BackupOrderPutRequest body) {
        return Response.ok().entity("magic!").build();
    }
    @DELETE
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response cancelBackup( @PathParam("id")

 @Parameter(description = "The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.") Integer id
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response getBackupInfo( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response getBackupInvoices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response getBackupLogin( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response getBackupsWelcomeEmail( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response updateBackupInfo( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response validateBackupOrder(@FormParam(value = "validateOnly")  Boolean validateOnly,@FormParam(value = "serviceType")  Integer serviceType,@FormParam(value = "coupon")  String coupon) {
        return Response.ok().entity("magic!").build();
    }
    @PUT
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response validateBackupOrder(@Valid BackupOrderPutRequest body) {
        return Response.ok().entity("magic!").build();
    }}
