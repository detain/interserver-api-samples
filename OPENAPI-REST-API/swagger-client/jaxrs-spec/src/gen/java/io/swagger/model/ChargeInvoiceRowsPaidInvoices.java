...
public class ChargeInvoiceRowsPaidInvoices   {
  ...
  private @Valid String invoicesId = null;
  ...
  private @Valid String paymentType = null;

  private @Valid Map<String, ChargeInvoiceRowsRefundInvoices> refundInvoices = new HashMap<String, ChargeInvoiceRowsRefundInvoices>();
