...
public class WebsiteServiceMaster   {
  ...
  private @Valid String websiteName = null;

  private @Valid String websiteIp = null;

  private @Valid String websiteType = null;

  private @Valid String websiteAvailable = null;

  private @Valid String websiteHdsize = null;

  private @Valid String websiteHdfree = null;

  private @Valid String websiteLoad = null;

  private @Valid String websiteLastUpdate = null;

  private @Valid String websiteMaxSites = null;

  private @Valid String websiteOrder = null;

  private @Valid String websitePartitions = null;

  private @Valid String websiteDns1 = null;

  private @Valid String websiteDns2 = null;
