...
public class InlineResponse20012ServiceInfo   {
  ...
  private @Valid String scrubIpId = null;

  private @Valid String scrubIpType = null;

  private @Valid String scrubIpCustid = null;

  private @Valid String scrubIpOrderDate = null;

  private @Valid String scrubIpIp = null;

  private @Valid String scrubIpServiceId = null;

  private @Valid String scrubIpServiceModule = null;
...
public enum ScrubIpStatusEnum {
  ...
  private @Valid ScrubIpStatusEnum scrubIpStatus = null;

  private @Valid String scrubIpInvoice = null;

  private @Valid String scrubIpCurrency = null;

  private @Valid String scrubIpCoupon = null;

  private @Valid String scrubIpComment = null;
