...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response floatingIpsCancel( @PathParam("id")

 @Parameter(description = "The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.") Integer id
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response getFloatingIpInvoices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response getFloatingIpsWelcomeEmail( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response postFloatingIpsChangeIp(@FormParam(value = "ip")  String ip, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
    ...
    public Response postFloatingIpsChangeIp(@Valid IpObject body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Floating_IPs" })
 ...
 @Parameter(description = "The Floating IP service ID. Use the ID from &#x60;GET /floating_ips&#x60;.") String id
) {
        return Response.ok().entity("magic!").build();
    }}
