...
public class ServerOrder   {
  ...
  private @Valid ServerOrderFormValues formValues = null;

  private @Valid ServerOrderConfigIds configIds = null;

  private @Valid Integer cpu = null;

  private @Valid ServerOrderFieldLabels fieldLabel = null;

  private @Valid ServerOrderCpuLi cpuLi = null;

  private @Valid ServerOrderMemoryLi memoryLi = null;

  private @Valid ServerOrderBandwidthLi bandwidthLi = null;

  private @Valid ServerOrderIpsLi ipsLi = null;

  private @Valid ServerOrderOsLi osLi = null;

  private @Valid ServerOrderCpLi cpLi = null;

  private @Valid List<ServerOrderRAID> raidLi = new ArrayList<ServerOrderRAID>();
