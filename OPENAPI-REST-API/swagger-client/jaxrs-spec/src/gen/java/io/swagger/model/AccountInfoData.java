...
public class AccountInfoData   {
  ...
  private @Valid String disableCc = null;

  private @Valid String fraudrecordScore = null;
  ...
  private @Valid String ccType = null;

  private @Valid String ccWhitelist = null;

  private @Valid AccountInfoDataCcs ccs = null;

  private @Valid String ccsAdded = null;

  private @Valid String company = null;

  private @Valid String currency = null;

  private @Valid String disableReinstall = null;

  private @Valid String disableReset = null;

  private @Valid String email = null;

  private @Valid String emailAbuse = null;

  private @Valid AccountInfoDataEmailSettings emailSettings = null;

  private @Valid AccountInfoDataExtra extra = null;

  private @Valid String facebookId = null;

  private @Valid String facebookUrl = null;

  private @Valid String firstname = null;

  private @Valid AccountInfoDataFraudrecord fraudrecord = null;

  private @Valid String githubId = null;

  private @Valid String githubUrl = null;

  private @Valid String googleId = null;

  private @Valid String googleUrl = null;

  private @Valid String innertellId = null;
  ...
  private @Valid String maxmindScore = null;

  private @Valid String mbId = null;

  private @Valid String modernbillId = null;

  private @Valid String picture = null;

  private @Valid String referrerCoupon = null;

  private @Valid String resellerMarkup = null;

  private @Valid String username = null;

  private @Valid String sshKey = null;

  private @Valid String sshKeyWrapped = null;

  private @Valid String apiKey = null;

  private @Valid String apiKeyWrapped = null;

  private @Valid String _2faGoogleKey = null;

  private @Valid Boolean _2faGoogleEnabled = null;

  private @Valid Integer _2faGoogle = null;

  private @Valid String _2faGoogleSplit = null;

  private @Valid String _2faGoogleQr = null;
