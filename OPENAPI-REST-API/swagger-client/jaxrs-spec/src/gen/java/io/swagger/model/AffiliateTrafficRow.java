...
public class AffiliateTrafficRow   {
  ...
  private @Valid String trafficId = null;

  private @Valid String trafficIp = null;

  private @Valid String trafficUrl = null;

  private @Valid String trafficAffiliate = null;

  private @Valid String trafficReferrer = null;

  private @Valid String trafficTimestamp = null;
