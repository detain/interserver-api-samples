...
public class QuickserverServiceInfo   {
  ...
  private @Valid String qsCustid = null;

  private @Valid String qsServer = null;
  ...
  private @Valid String qsCurrency = null;

  private @Valid String qsType = null;

  private @Valid String qsOrderDate = null;

  private @Valid String qsStatus = null;

  private @Valid String qsInvoice = null;

  private @Valid String qsCoupon = null;

  private @Valid String qsExtra = null;

  private @Valid String qsHostname = null;

  private @Valid String qsServerStatus = null;

  private @Valid String qsComment = null;

  private @Valid String qsSlices = null;
  ...
  private @Valid String qsMac = null;

  private @Valid String qsOs = null;

  private @Valid String qsVersion = null;
