...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response cancelScrubIp( @PathParam("id")

 @Parameter(description = "ScrubIp ID number") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response createFilter(@Valid CreateFilter body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response createGeoRule(@Valid CreateGeoFirewallRule body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response createRule(@Valid CreateFirewallRule body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response deleteFilter(@Valid CreateFilter body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response disableScrub( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response enableScrub( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response getScrubIpDetails( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response getScrubIpInvoices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response getScrubIpLogs( @PathParam("id")

 @Parameter(description = "Scrub Order ID") String id
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response placeScrubOrder(@Valid ScrubIpPlaceOrder body) {
        return Response.ok().entity("magic!").build();
    }
    @POST
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response scrubIpsDeleteGeoRule(@Valid DeleteGeoFirewallRule body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Scrub Ips" })
    ...
    public Response scrubIpsDeleteRule(@Valid DeleteFirewallRule body, @PathParam("id")
