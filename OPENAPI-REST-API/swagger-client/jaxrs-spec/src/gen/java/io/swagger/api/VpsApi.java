...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response addVps(@Valid VpsOrderPostRequest body) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response addVps(@FormParam(value = "osDistro")  String osDistro,@FormParam(value = "slices")  Integer slices,@FormParam(value = "vpsPlatform")  String vpsPlatform,@FormParam(value = "controlpanel")  String controlpanel,@FormParam(value = "period")  Integer period,@FormParam(value = "location")  Integer location,@FormParam(value = "osVersion")  String osVersion,@FormParam(value = "hostname")  String hostname,@FormParam(value = "coupon")  String coupon,@FormParam(value = "rootpass")  String rootpass,@FormParam(value = "comment")  String comment) {
        return Response.ok().entity("magic!").build();
    }
    @DELETE
    @Path("/{id}/backups")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response deleteVpsBackup( @PathParam("id")

 @Parameter(description = "VPS ID number") Integer id
, @NotNull  @QueryParam("file") 

 @Parameter(description = "The backup filename to delete.")  String file
,  @QueryParam("all") 

 @Parameter(description = "Set to &#x60;1&#x60; to list all backups across all services, not just the ones for the given VPS.")  String all
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsBlockSmtp( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsDisableCd( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsDisableQuota( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsEjectCd( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsEnableQuota( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsRestart( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsStart( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response doVpsStop( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response downloadVpsBackup(@Valid IdBackupsBody2 body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response downloadVpsBackup(@FormParam(value = "file")  String file, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsBackups( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsBuyHdSpace( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsBuyIp( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsChangeTimezone( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsInfo( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsInvoices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsReinstallOs( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsReverseDns( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsSetupVnc( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsSlices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsTrafficUsage( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsViewDesktop( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response getVpsWelcomeEmail( @PathParam("id")

 @Parameter(description = "VPS ID") String id
) {
        return Response.ok().entity("magic!").build();
    }
    @GET
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsBackup( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsBuyHdSpace( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsBuyIp( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeHostname(@FormParam(value = "hostname")  String hostname, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeHostname(@Valid HostnameObject body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeRootPassword(@FormParam(value = "password")  String password, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeRootPassword(@Valid PasswordRequest body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeTimezone(@FormParam(value = "timezone")  String timezone, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeTimezone(@Valid TimezoneUpdate body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeWebuzoPassword(@FormParam(value = "password")  String password, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsChangeWebuzoPassword(@Valid PasswordRequest body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsInsertCd(@FormParam(value = "url")  String url, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsInsertCd(@Valid UrlRequest body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsReinstallOs(@FormParam(value = "template")  String template,@FormParam(value = "password")  String password,@FormParam(value = "localPassword")  String localPassword, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsReinstallOs(@Valid TemplateRequest body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsResetPassword( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsRestore(@Valid RestoreRequest body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsRestore(@FormParam(value = "backup")  String backup,@FormParam(value = "password")  String password, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsReverseDns(@Valid ReverseDnsEntries body, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsReverseDns(@FormParam(value = "ips")  Map<String, Object> ips, @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsSetupVnc( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsSlices( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response postVpsViewDesktop( @PathParam("id")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response putVps(@Valid VpsOrderPutRequest body) {
        return Response.ok().entity("magic!").build();
    }
    @PUT
    @Path("/order")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response putVps(@FormParam(value = "osDistro")  String osDistro,@FormParam(value = "slices")  Integer slices,@FormParam(value = "vpsPlatform")  String vpsPlatform,@FormParam(value = "controlpanel")  String controlpanel,@FormParam(value = "period")  Integer period,@FormParam(value = "location")  Integer location,@FormParam(value = "osVersion")  String osVersion,@FormParam(value = "hostname")  String hostname,@FormParam(value = "coupon")  String coupon,@FormParam(value = "rootpass")  String rootpass,@FormParam(value = "comment")  String comment) {
        return Response.ok().entity("magic!").build();
    }
    @POST
    @Path("/{id}")
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response updateVpsInfo( @PathParam("id")

 @Parameter(description = "VPS ID number.") String id
) {
        return Response.ok().entity("magic!").build();
    }
    @DELETE
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "VPS" })
    ...
    public Response vPSCancel( @PathParam("id")
