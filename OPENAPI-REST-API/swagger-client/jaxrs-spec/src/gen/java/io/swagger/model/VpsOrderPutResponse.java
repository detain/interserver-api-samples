...
public class VpsOrderPutResponse   {
  ...
  private @Valid List<Object> errors = new ArrayList<Object>();

  private @Valid Integer couponCode = null;

  private @Valid Integer serviceCost = null;

  private @Valid Integer sliceCost = null;

  private @Valid Integer serviceType = null;

  private @Valid Integer repeatSliceCost = null;

  private @Valid Integer originalSliceCost = null;

  private @Valid Integer originalCost = null;

  private @Valid Integer repeatServiceCost = null;

  private @Valid Integer monthlyServiceCost = null;

  private @Valid String custid = null;

  private @Valid String os = null;

  private @Valid String slices = null;

  private @Valid String platform = null;

  private @Valid String controlpanel = null;

  private @Valid Integer period = null;

  private @Valid Integer location = null;

  private @Valid String version = null;

  private @Valid String hostname = null;

  private @Valid String coupon = null;
