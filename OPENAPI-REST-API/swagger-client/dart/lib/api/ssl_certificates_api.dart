...
class SSLCertificatesApi {
  ...
  Future getSslInfo(int id) async {
    ...
    // create path and map variables
    String path = "/ssl/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<ChargeInvoiceRows> getSslInvoices(int id) async {
    ...
    // create path and map variables
    String path = "/ssl/{id}/invoices".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<SuccessTextResponse> getSslWelcomeEmail(int id) async {
    ...
    // create path and map variables
    String path = "/ssl/{id}/welcome_email".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
