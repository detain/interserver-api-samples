...
if (enabled != null)
  ...
  Future<MailLog> viewMailLog(int id, { int id, String origin, String mx, String from, String to, String subject, String mailid, int skip, int limit, int startDate, int endDate, String delivered }) async {
    Object postBody = null;
