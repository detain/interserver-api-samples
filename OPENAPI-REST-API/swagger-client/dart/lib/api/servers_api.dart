...
class ServersApi {
  ...
  Future<ServerOrder> getNewServer() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ServerOrder') as ServerOrder ;
    } else {
      return null;
    }
  }
  ...
  Future<Server> getServerInfo(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'Server') as Server ;
    } else {
      return null;
    }
  }
  ...
  Future<ChargeInvoiceRows> getServerInvoices(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}/invoices".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<List<ServerRow>> getServerList() async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
        (apiClient.deserialize(response.body, 'List<ServerRow>') as List).map((item) => item as ServerRow).toList();
    } else {
      return null;
    }
  }
  ...
  Future<ReverseDnsEntries> getServerReverseDns(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}/reverse_dns".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<SuccessTextResponse> getServersWelcomeEmail(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}/welcome_email".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<ServersBuyNowResponse> placeBuyNowServer({ OrderBuyNowServerBody body }) async {
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ServersBuyNowResponse') as ServersBuyNowResponse ;
    } else {
      return null;
    }
  }
  ...
  Future<TextResponse> postServerReverseDns(ReverseDnsEntries body, int id) async {
    Object postBody = body;
  ...
  Future<ServerIpmiLiveInfo> serverIpmiLiveGet(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}/ipmi_live".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return
          apiClient.deserialize(response.body, 'ServerIpmiLiveInfo') as ServerIpmiLiveInfo ;
    } else {
      return null;
    }
  }
  ...
  Future<ServerIpmiLiveInfo> serverIpmiLivePost(int asset, String ip, int id) async {
    Object postBody = body;

    // verify required params are set
    if(asset == null) {
     throw new ApiException(400, "Missing required param: asset");
    }
    if(ip == null) {
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      if (asset != null) {
        hasFields = true;
        mp.fields['asset'] = parameterToString(asset);
      }
      if (ip != null) {
        hasFields = true;
      ...
      if (asset != null)
        formParams['asset'] = parameterToString(asset);
if (ip != null)
  ...
  Future<TextResponse> serverIpmiPowerGet(int id) async {
    ...
    // create path and map variables
    String path = "/servers/{id}/ipmi_power".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  Future<TextResponse> serverIpmiPowerPost(int asset, String action, int id) async {
    Object postBody = body;
    ...
    if(contentType.startsWith("multipart/form-data")) {
      ...
      if (action != null) {
        hasFields = true;
        mp.fields['action'] = parameterToString(action);
      }
      if(hasFields)
        postBody = mp;
    }
      ...
      if (asset != null)
        formParams['asset'] = parameterToString(asset);
if (action != null)
        formParams['action'] = parameterToString(action);
    }
