...
void main() {
  ...
  group('tests for BillingApi', () {
    ...
    //
    //Future<SuccessTextResponse> addAccountCreditCard(String name, String address, String city, String state, String country, String zip, String cc, String ccExp, String ccCcv2, BillingAddCcRequest body) async
    ...
    //
    //Future<SuccessTextResponse> addBillingCreditCard(BillingAddCcRequest body, String name, String address, String city, String state, String country, String zip, String cc, String ccExp, String ccCcv2) async
    ...
    //
    //Future<SuccessTextResponse> addBillingPrepay(BillingPrepayRequest body, String module, double amount, String automaticUse) async
    ...
    //
    //Future<SuccessTextResponse> postBillingCreditCardVerify(BillingVerifyCcRequest body, int idx, String ccCcv2, String ccAmount1, String ccAmount2, bool terms, int id) async
    ...
    //
    //Future<TextResponse> updateAffiliateDockSetup(String affiliateDockTitle, String affiliateDockDescription, String referrerCoupon, AffiliateDockSetup body) async
    ...
    //
    //Future<TextResponse> updateAffiliateLandingPage(String affiliateDockTitle, String affiliateDockDescription, String referrerCoupon, AffiliateDockSetup body) async
    ...
    //
    //Future<TextResponse> updateAffiliatePaymentSetup(String affiliatePaypal, String affiliatePaymentMethod, AffiliatePaymentSetup body) async
    ...
    //
    //Future<SuccessTextResponse> updateBillingPaymentMethod(BillingPaymentMethodRequest body, String paymentMethod, String ccAuto) async
