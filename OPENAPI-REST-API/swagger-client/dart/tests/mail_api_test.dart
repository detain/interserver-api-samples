...
void main() {
  ...
  group('tests for MailApi', () {
    ...
    //
    //Future<GenericResponse> addRule(DenyRuleNew body, String user, String type, String data, int id) async
    ...
    //
    //Future<SuccessTextResponse> createMailAlert(MailAlertRequest body, String type, String value, String to, String enabled, int id) async
    ...
    //
    //Future<GenericResponse> delistBlock(String email, EmailAddress body, int id) async
    ...
    //
    //Future<SuccessTextResponse> postMailDelist(MailDelistRequest body, String unblock, int id) async
    ...
    //
    //Future<GenericResponse> sendAdvMail(SendMailAdv body, String subject, String body, EmailAddressName from, List<EmailAddressName> to, List<EmailAddressName> replyto, List<EmailAddressName> cc, List<EmailAddressName> bcc, List<MailAttachment> attachments, int id, int id) async
    ...
    //
    //Future<GenericResponse> sendMail(SendMail body, String to, String from, String subject, String body, int id) async
    ...
    //
    //Future<SuccessTextResponse> updateMailAlert(MailAlertUpdateRequest body, int alertId, String type, String value, String to, String enabled, int id) async
