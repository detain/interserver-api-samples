...
/// tests for VPSApi
void main() {
  var instance = new VPSApi();

  group('tests for VPSApi', () {
    // Place VPS Order
    //
    ...
    //
    //Future<InlineResponse20011> downloadVpsBackup(IdBackupsBody2 body, String file, int id, { String all }) async
    ...
    //
    //Future<QueueResponse> postVpsChangeHostname(String hostname, HostnameObject body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsChangeRootPassword(String password, PasswordRequest body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsChangeTimezone(String timezone, TimezoneUpdate body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsChangeWebuzoPassword(String password, PasswordRequest body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsInsertCd(String url, UrlRequest body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsReinstallOs(String template, String password, String localPassword, TemplateRequest body, int id) async
    ...
    //
    //Future<QueueResponse> postVpsRestore(RestoreRequest body, String backup, String password, int id) async
    ...
    //
    //Future<TextResponse> postVpsReverseDns(ReverseDnsEntries body, Map ips, int id) async
    ...
    //
    //Future<VpsOrderPutResponse> putVps({ VpsOrderPutRequest body, String osDistro, int slices, String vpsPlatform, String controlpanel, int period, int location, String osVersion, String hostname, String coupon, String rootpass, String comment }) async
