...
void main() {
  ...
  group('tests for DNSApi', () {
    ...
    //
    //Future<SuccessTextResponse> addDnsDomain(String domain, String ip, DnsNewDomain body) async
    ...
    //
    //Future addDnsRecord(String name, DnsRecordType type, String content, int ttl, int prio, DnsNewRecord body, String id) async
    ...
    //
    //Future<SuccessTextResponse> updateDnsRecord(String name, DnsRecordType type, String content, String ttl, String prio, String disabled, String ordername, String auth, DnsUpdateRecord body, int domainId, int recordId) async
