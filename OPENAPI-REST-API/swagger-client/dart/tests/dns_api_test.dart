...
void main() {
  ...
  group('tests for DNSApi', () {
    ...
    //
    //Future addDnsDomain(String domain, String ip, DnsNewDomain body) async
    ...
    //
    //Future updateDnsRecord(String name, DnsRecordType type, String content, String ttl, String prio, String disabled, String ordername, String auth, DnsUpdateRecord body, int domainId, int recordId) async
