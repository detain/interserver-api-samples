...
void main() {
  var instance = new QuickServersApi();

  group('tests for QuickServersApi', () {
    ...
    //
    //Future<InlineResponse20011> downloadQsBackup(IdBackupsBody body, String file, int id, { String all }) async
    ...
    //
    //Future<QueueResponse> postQsChangeTimezone(String timezone, TimezoneUpdate body, int id) async
    ...
    //
    //Future<TextResponse> postQsReverseDns(ReverseDnsEntries body, Map ips, int id) async
    ...
    //
    //Future<QueueResponse> postQuickServerRestore(RestoreRequest body, String backup, String password, int id) async
    ...
    //
    //Future<InlineResponse20010> quickserversCancel(int id) async
