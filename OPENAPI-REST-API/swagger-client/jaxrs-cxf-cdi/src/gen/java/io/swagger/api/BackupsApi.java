...
public class BackupsApi  {
  ...
  @Inject BackupsApiService delegate;
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    ...
    public Response addBackup(@Multipart(value = "validateOnly")  Boolean validateOnly, @Multipart(value = "serviceType")  Integer serviceType, @Multipart(value = "coupon")  String coupon) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response addBackup(
@Parameter(description = "" ,required=true) BackupOrderPutRequest body
) {
        return delegate.addBackup(body, securityContext);
    }
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response cancelBackup(
@Parameter(description = "The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.",required=true) @PathParam("id") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getBackupInvoices(
@Parameter(description = "The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.",required=true) @PathParam("id") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getBackupLogin(
@Parameter(description = "The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.",required=true) @PathParam("id") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getBackupsList() {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response getBackupsWelcomeEmail(
@Parameter(description = "The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.",required=true) @PathParam("id") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))),
        @ApiResponse(responseCode = "200", description = "Default response") })
    public Response updateBackupInfo(
@Parameter(description = "The backup service ID. Use the `backup_id` from `GET /backups` to identify the service.",required=true) @PathParam("id") Integer id
) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response validateBackupOrder(@Multipart(value = "validateOnly")  Boolean validateOnly, @Multipart(value = "serviceType")  Integer serviceType, @Multipart(value = "coupon")  String coupon) {
...
@SecurityRequirement(name = "sessionIdHeaderAuth")    }, tags={ "Backups" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Validate Backup Order Response", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BackupOrderPutResponse.class))),
        @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse401.class))) })
    public Response validateBackupOrder(
@Parameter(description = "" ,required=true) BackupOrderPutRequest body
) {
        return delegate.validateBackupOrder(body, securityContext);
    }
}
