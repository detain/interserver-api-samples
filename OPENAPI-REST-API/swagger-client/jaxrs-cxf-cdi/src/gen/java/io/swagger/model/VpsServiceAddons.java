...
public class VpsServiceAddons   {
  ...
  private List<String> extraIps = new ArrayList<String>();
  private List<String> extraIps6 = new ArrayList<String>();
  private List<String> unpaidIps = new ArrayList<String>();
  private List<String> ips = new ArrayList<String>();
  private List<String> ips6 = new ArrayList<String>();
