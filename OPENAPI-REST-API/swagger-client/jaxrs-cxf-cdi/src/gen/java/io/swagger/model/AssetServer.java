...
public class AssetServer   {
  ...
  private List<OneOfAssetServerCPUItems> CPU = new ArrayList<OneOfAssetServerCPUItems>();
  private List<OneOfAssetServerMemoryItems> memory = new ArrayList<OneOfAssetServerMemoryItems>();
  private List<OneOfAssetServerBandwidthItems> bandwidth = new ArrayList<OneOfAssetServerBandwidthItems>();
  private List<OneOfAssetServerIpsItems> ips = new ArrayList<OneOfAssetServerIpsItems>();
  private Map<String, String> HD = new HashMap<String, String>();
