...
@Parameter(description = "The mail service ID. Use `mail_id` from `GET /mail`.",required=true) @PathParam("id") Integer id
,  @NotNull 
@Parameter(description = "Alert ID to delete.",required=true)  @QueryParam("alert_id") Integer alertId
) {
...
,  @Min(0L) @Max(9999999999L) 
@Parameter(description = "Latest date to get emails in unix timestamp format.", schema=@Schema(allowableValues={ "0", "9999999999" }, maximum="9999999999")
)  @QueryParam("endDate") Long endDate
,  
@Parameter(description = "Filter emails by whether or not they were delivered.", schema=@Schema(allowableValues={ "0", "1" })
