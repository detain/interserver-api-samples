...
public enum TypeEnum {
    ...
    @XmlEnumValue("redirect") REDIRECT(String.valueOf("redirect")), @XmlEnumValue("submit") SUBMIT(String.valueOf("submit")), @XmlEnumValue("single") SINGLE(String.valueOf("single"));
