...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {API_KEY_AUTH}.make ("header", "sessionid"), "sessionIdHeaderAuth")
			is_api_key_configured := True 
			authentications.force (create {API_KEY_AUTH}.make ("query", "sessionid"), "sessionIdCookieAuth")
			is_api_key_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://my.interserver.net/apiv2"
			-- default base path.
