...
class ACCOUNT_INFO_DATA_FRAUDRECORD
...
feature --Access
    ...
    count: detachable STRING_32
      
    reliability: detachable STRING_32
...
feature -- Change Element
    ...
    set_reliability (a_name: like reliability)
        -- Set 'reliability' with 'a_name'.
      do
        reliability := a_name
      ensure
        reliability_set: reliability = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ACCOUNT_INFO_DATA_FRAUDRECORD%N")
        ...
        if attached reliability as l_reliability then
          Result.append ("%Nreliability:")
          Result.append (l_reliability.out)
          Result.append ("%N")
        end
