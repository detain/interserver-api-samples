...
feature --Access
    ...
    header: detachable LIST [STRING_32]
      -- The header of the assets table.
    rows: detachable LIST [LIST [STRING_32]]
...
feature -- Change Element
    ...
    set_header (a_name: like header)
        -- Set 'header' with 'a_name'.
      do
        header := a_name
      ensure
        header_set: header = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass SERVER_ASSETS%N")
        ...
        if attached header as l_header then
          across l_header as ic loop
            Result.append ("%N header:")
