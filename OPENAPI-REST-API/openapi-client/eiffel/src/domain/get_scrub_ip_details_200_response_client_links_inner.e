...
class GET_SCRUB_IP_DETAILS_200_RESPONSE_CLIENT_LINKS_INNER
...
feature -- Change Element
    ...
    set_other_attr (a_name: like other_attr)
        -- Set 'other_attr' with 'a_name'.
      do
        other_attr := a_name
      ensure
        other_attr_set: other_attr = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass GET_SCRUB_IP_DETAILS_200_RESPONSE_CLIENT_LINKS_INNER%N")
        ...
        if attached other_attr as l_other_attr then
          Result.append ("%Nother_attr:")
          Result.append (l_other_attr.out)
          Result.append ("%N")
        end
      end
end
