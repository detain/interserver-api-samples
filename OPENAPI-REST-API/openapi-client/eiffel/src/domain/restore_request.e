...
feature -- Change Element
    ...
    set_backup (a_name: like backup)
        -- Set 'backup' with 'a_name'.
      do
        backup := a_name
      ensure
        backup_set: backup = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass RESTORE_REQUEST%N")
        if attached backup as l_backup then
          Result.append ("%Nbackup:")
          Result.append (l_backup.out)
          Result.append ("%N")
        end
