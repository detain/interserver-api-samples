...
feature --Access
    ...
    automatic_use: detachable STRING_32
...
feature -- Change Element
    ...
    set_automatic_use (a_name: like automatic_use)
        -- Set 'automatic_use' with 'a_name'.
      do
        automatic_use := a_name
      ensure
        automatic_use_set: automatic_use = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass BILLING_PREPAY_REQUEST%N")
        ...
        if attached automatic_use as l_automatic_use then
          Result.append ("%Nautomatic_use:")
          Result.append (l_automatic_use.out)
          Result.append ("%N")
        end
      end
end
