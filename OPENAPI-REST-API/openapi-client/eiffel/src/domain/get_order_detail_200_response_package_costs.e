...
class GET_ORDER_DETAIL_200_RESPONSE_PACKAGE_COSTS
...
feature -- Change Element
    ...
    set_package_cost (a_name: like package_cost)
        -- Set 'package_cost' with 'a_name'.
      do
        package_cost := a_name
      ensure
        package_cost_set: package_cost = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass GET_ORDER_DETAIL_200_RESPONSE_PACKAGE_COSTS%N")
        if attached package_id as l_package_id then
          Result.append ("%Npackage_id:")
          Result.append (l_package_id.out)
          Result.append ("%N")
        end
        if attached package_cost as l_package_cost then
          Result.append ("%Npackage_cost:")
          Result.append (l_package_cost.out)
          Result.append ("%N")
        end
