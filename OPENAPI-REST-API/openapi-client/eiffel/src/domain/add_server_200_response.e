...
feature -- Change Element
    ...
    set_invoice (a_name: like invoice)
        -- Set 'invoice' with 'a_name'.
      do
        invoice := a_name
      ensure
        invoice_set: invoice = a_name
      end
 ...
 feature -- Status Report
    ...
    output: STRING
      ...
      do
        ...
        Result.append("%Nclass ADD_SERVER_200_RESPONSE%N")
        if attached text as l_text then
          Result.append ("%Ntext:")
          Result.append (l_text.out)
          Result.append ("%N")
        end
        if attached invoice as l_invoice then
          Result.append ("%Ninvoice:")
          Result.append (l_invoice.out)
          Result.append ("%N")
        end
