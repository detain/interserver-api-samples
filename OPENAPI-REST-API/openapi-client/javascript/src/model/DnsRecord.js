...
class DnsRecord {
    ...
    constructor(id, domain_id, name, type, content, ttl, prio, disabled, ordername, auth) { 
        ...
        DnsRecord.initialize(this, id, domain_id, name, type, content, ttl, prio, disabled, ordername, auth);
    }
     ...
     */
    static initialize(obj, id, domain_id, name, type, content, ttl, prio, disabled, ordername, auth) { 
        obj['id'] = id;
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['prio'] && !(typeof data['prio'] === 'string' || data['prio'] instanceof String)) {
            throw new Error("Expected the field `prio` to be a primitive type in the JSON string but got " + data['prio']);
        }
        // ensure the json data is a string
        if (data['disabled'] && !(typeof data['disabled'] === 'string' || data['disabled'] instanceof String)) {
            throw new Error("Expected the field `disabled` to be a primitive type in the JSON string but got " + data['disabled']);
        }
        // ensure the json data is a string
...
DnsRecord.RequiredProperties = ["id", "domain_id", "name", "type", "content", "ttl", "prio", "disabled", "ordername", "auth"];
