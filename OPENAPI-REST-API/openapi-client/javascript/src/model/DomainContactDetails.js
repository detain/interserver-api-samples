...
/**
 * The DomainContactDetails model module.
 * @module model/DomainContactDetails
 * @version 0.9.0
 */
class DomainContactDetails {
    /**
     * Constructs a new <code>DomainContactDetails</code>.
     * Contact details used for domain registrant/admin/technical/billing records.
     * @alias module:model/DomainContactDetails
     */
    constructor() { 
        
        DomainContactDetails.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainContactDetails</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainContactDetails} obj Optional instance to populate.
     * @return {module:model/DomainContactDetails} The populated <code>DomainContactDetails</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainContactDetails();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainContactDetails</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainContactDetails</code>.
     */
 ...
 */
DomainContactDetails.prototype['status'] = undefined;

/**
 * State or region for the contact address.
 * @member {String} state
 */
DomainContactDetails.prototype['state'] = undefined;

/**
 * Organization name for the contact.
 * @member {String} org_name
 */
DomainContactDetails.prototype['org_name'] = undefined;

/**
 * Two-letter country code for the contact.
 * @member {String} country
 */
DomainContactDetails.prototype['country'] = undefined;

/**
 * Postal or ZIP code for the contact address.
 * @member {String} postal_code
 */
DomainContactDetails.prototype['postal_code'] = undefined;

/**
 * Email address for the contact.
 * @member {String} email
 */
DomainContactDetails.prototype['email'] = undefined;

/**
 * Fax number for the contact, if available.
 * @member {String} fax
 */
DomainContactDetails.prototype['fax'] = undefined;

/**
 * Secondary street address line.
 * @member {String} address2
 */
DomainContactDetails.prototype['address2'] = undefined;

/**
 * Tertiary street address line.
 * @member {String} address3
 */
DomainContactDetails.prototype['address3'] = undefined;

/**
 * Primary street address line.
 * @member {String} address1
 */
DomainContactDetails.prototype['address1'] = undefined;

/**
 * City for the contact address.
 * @member {String} city
 */
DomainContactDetails.prototype['city'] = undefined;

/**
 * Phone number for the contact.
 * @member {String} phone
 */
DomainContactDetails.prototype['phone'] = undefined;

/**
 * First name for the contact.
 * @member {String} first_name
 */
DomainContactDetails.prototype['first_name'] = undefined;

/**
 * Last name for the contact.
 * @member {String} last_name
 */
DomainContactDetails.prototype['last_name'] = undefined;
