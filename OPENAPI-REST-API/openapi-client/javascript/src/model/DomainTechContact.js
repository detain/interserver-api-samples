...
/**
 * The DomainTechContact model module.
 * @module model/DomainTechContact
 * @version 0.9.0
 */
class DomainTechContact {
    /**
     * Constructs a new <code>DomainTechContact</code>.
     * Technical contact information for a domain registration.
     * @alias module:model/DomainTechContact
     */
    constructor() { 
        
        DomainTechContact.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DomainTechContact</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DomainTechContact} obj Optional instance to populate.
     * @return {module:model/DomainTechContact} The populated <code>DomainTechContact</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DomainTechContact();
    ...
    /**
     * Validates the JSON data with respect to <code>DomainTechContact</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DomainTechContact</code>.
     */
 ...
 * @member {String} state
 */
DomainTechContact.prototype['state'] = undefined;

/**
 * @member {String} status
 */
DomainTechContact.prototype['status'] = undefined;

/**
 * @member {String} org_name
 */
DomainTechContact.prototype['org_name'] = undefined;

/**
 * @member {String} country
 */
DomainTechContact.prototype['country'] = undefined;

/**
 * @member {String} postal_code
 */
DomainTechContact.prototype['postal_code'] = undefined;

/**
 * @member {String} fax
 */
DomainTechContact.prototype['fax'] = undefined;

/**
 * @member {String} email
 */
DomainTechContact.prototype['email'] = undefined;

/**
 * @member {String} address2
 */
DomainTechContact.prototype['address2'] = undefined;

/**
 * @member {String} address3
 */
DomainTechContact.prototype['address3'] = undefined;

/**
 * @member {String} address1
 */
DomainTechContact.prototype['address1'] = undefined;

/**
 * @member {String} city
 */
DomainTechContact.prototype['city'] = undefined;

/**
 * @member {String} phone
 */
DomainTechContact.prototype['phone'] = undefined;

/**
 * @member {String} first_name
 */
DomainTechContact.prototype['first_name'] = undefined;

/**
 * @member {String} last_name
 */
DomainTechContact.prototype['last_name'] = undefined;
...
export default DomainTechContact;
