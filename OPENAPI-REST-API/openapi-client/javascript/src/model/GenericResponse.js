...
class GenericResponse {
    ...
    constructor(status, text) { 
        ...
        GenericResponse.initialize(this, status, text);
    }
     ...
     */
    static initialize(obj, status, text) { 
        obj['status'] = status;
        obj['text'] = text;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GenericResponse.RequiredProperties) {
...
GenericResponse.RequiredProperties = ["status", "text"];
