...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.Invoice();
  });
  ...
  describe('Invoice', function() {
    it('should create an instance of Invoice', function() {
      ...
      //var instance = new InterServerManagementApi.Invoice();
      //expect(instance).to.be.a(InterServerManagementApi.Invoice);
    });
