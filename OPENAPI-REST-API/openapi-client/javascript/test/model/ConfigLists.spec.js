...
(function(root, factory) {
  ...
  describe('ConfigLists', function() {
    it('should create an instance of ConfigLists', function() {
      // uncomment below and update the code to test ConfigLists
      //var instance = new InterServerManagementApi.ConfigLists();
    ...
    it('should have the property hd_li (base name: "hd_li")', function() {
      // uncomment below and update the code to test the property hd_li
      //var instance = new InterServerManagementApi.ConfigLists();
      //expect(instance).to.be();
    });
