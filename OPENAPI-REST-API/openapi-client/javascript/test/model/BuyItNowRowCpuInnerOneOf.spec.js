...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.BuyItNowRowCpuInnerOneOf();
  });
  ...
  describe('BuyItNowRowCpuInnerOneOf', function() {
    it('should create an instance of BuyItNowRowCpuInnerOneOf', function() {
      // uncomment below and update the code to test BuyItNowRowCpuInnerOneOf
      //var instance = new InterServerManagementApi.BuyItNowRowCpuInnerOneOf();
      //expect(instance).to.be.a(InterServerManagementApi.BuyItNowRowCpuInnerOneOf);
    });
