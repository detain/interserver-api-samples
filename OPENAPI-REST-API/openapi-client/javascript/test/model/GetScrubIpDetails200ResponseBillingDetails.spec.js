...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.GetScrubIpDetails200ResponseBillingDetails();
  });
  ...
  describe('GetScrubIpDetails200ResponseBillingDetails', function() {
    it('should create an instance of GetScrubIpDetails200ResponseBillingDetails', function() {
      // uncomment below and update the code to test GetScrubIpDetails200ResponseBillingDetails
      //var instance = new InterServerManagementApi.GetScrubIpDetails200ResponseBillingDetails();
      //expect(instance).to.be.a(InterServerManagementApi.GetScrubIpDetails200ResponseBillingDetails);
    });
