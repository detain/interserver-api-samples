...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.InlineObject();
  });
  ...
  describe('InlineObject', function() {
    it('should create an instance of InlineObject', function() {
      ...
      //var instance = new InterServerManagementApi.InlineObject();
      //expect(instance).to.be.a(InterServerManagementApi.InlineObject);
    });
