...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.GetScrubIpDetails200Response();
  });
  ...
  describe('GetScrubIpDetails200Response', function() {
    it('should create an instance of GetScrubIpDetails200Response', function() {
      // uncomment below and update the code to test GetScrubIpDetails200Response
      //var instance = new InterServerManagementApi.GetScrubIpDetails200Response();
      //expect(instance).to.be.a(InterServerManagementApi.GetScrubIpDetails200Response);
    });
    ...
    it('should have the property filter_firewall (base name: "filter_firewall")', function() {
      // uncomment below and update the code to test the property filter_firewall
      //var instance = new InterServerManagementApi.GetScrubIpDetails200Response();
      //expect(instance).to.be();
    });
