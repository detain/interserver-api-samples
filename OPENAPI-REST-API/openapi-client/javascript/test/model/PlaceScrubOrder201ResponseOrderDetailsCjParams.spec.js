...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InterServerManagementApi.PlaceScrubOrder201ResponseOrderDetailsCjParams();
  });
  ...
  describe('PlaceScrubOrder201ResponseOrderDetailsCjParams', function() {
    it('should create an instance of PlaceScrubOrder201ResponseOrderDetailsCjParams', function() {
      // uncomment below and update the code to test PlaceScrubOrder201ResponseOrderDetailsCjParams
      //var instance = new InterServerManagementApi.PlaceScrubOrder201ResponseOrderDetailsCjParams();
      //expect(instance).to.be.a(InterServerManagementApi.PlaceScrubOrder201ResponseOrderDetailsCjParams);
    });
