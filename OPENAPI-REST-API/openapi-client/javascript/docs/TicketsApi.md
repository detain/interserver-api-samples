...
let TicketNew = new InterServerManagementApi.TicketNew(); // TicketNew | 
apiInstance.addNewTicket(TicketNew, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new InterServerManagementApi.TicketsApi();
let id = "1511222"; // String | Ticket ID
...
let apiInstance = new InterServerManagementApi.TicketsApi();
let id = 3.4; // Number | Ticket ID number.
...
let apiInstance = new InterServerManagementApi.TicketsApi();
let id = 3.4; // Number | The ticket ID number.
let opts = {
  'ReplyTicketRequest': new InterServerManagementApi.ReplyTicketRequest() // ReplyTicketRequest | 
};
...
let id = 3.4; // Number | The ticket ID number.
let opts = {
  'UpdateTicket': new InterServerManagementApi.UpdateTicket() // UpdateTicket | 
};
