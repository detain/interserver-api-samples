# InterServerManagementApi.LicensesApi
...
let apiInstance = new InterServerManagementApi.LicensesApi();
apiInstance.addLicense((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new InterServerManagementApi.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.getLicenseInfo(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
------------- | ------------- | ------------- | -------------
 **id** | **Number**| The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. | 
...
let apiInstance = new InterServerManagementApi.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.getLicenseInvoices(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.LicensesApi();
apiInstance.getLicenseList((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
apiInstance.getLicenseOrderCatTagInfo(catTag, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
let apiInstance = new InterServerManagementApi.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.getLicensesWelcomeEmail(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.LicensesApi();
apiInstance.getNewLicense((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
apiInstance.licensesCancel(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.LicensesApi();
let id = 56; // Number | The license service ID. Use `license_id` from `GET /licenses`.
let IpObject = new InterServerManagementApi.IpObject(); // IpObject | 
apiInstance.postLicenseChangeIp(id, IpObject, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.LicensesApi();
apiInstance.putLicenses((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
apiInstance.updateLicenseInfo(id, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
