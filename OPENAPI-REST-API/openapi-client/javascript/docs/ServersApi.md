...
let apiInstance = new InterServerManagementApi.ServersApi();
let opts = {
  'PlaceBuyNowServerRequest': new InterServerManagementApi.PlaceBuyNowServerRequest() // PlaceBuyNowServerRequest | 
};
...
apiInstance.postServerReverseDns(id, ReverseDnsEntries, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> ServerIpmiLiveInfo serverIpmiLivePost(id, ip, opts)
...
let opts = {
  'asset': 56 // Number | Asset ID
};
apiInstance.serverIpmiLivePost(id, ip, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **asset** | **Number**| Asset ID | [optional] 
...
> TextResponse serverIpmiPowerPost(id, action, opts)
...
let opts = {
  'asset': 56 // Number | The Asset ID
};
apiInstance.serverIpmiPowerPost(id, action, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
 ...
 **asset** | **Number**| The Asset ID | [optional] 
