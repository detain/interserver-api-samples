# InterServerManagementApi.ServerOrderConfigIds

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**memory** | **Number** | Memory configuration ID for the server order. | [optional] 
...
**cp** | **Number** | Control Panel configuration ID for the server order. | [optional] 
