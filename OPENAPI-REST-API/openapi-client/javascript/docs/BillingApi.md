...
> SuccessTextResponse addAccountCreditCard(opts)
...
apiInstance.addAccountCreditCard(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new InterServerManagementApi.BillingApi();
let BillingAddCcRequest = new InterServerManagementApi.BillingAddCcRequest(); // BillingAddCcRequest | 
apiInstance.addBillingCreditCard(BillingAddCcRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.BillingApi();
let BillingPrepayRequest = new InterServerManagementApi.BillingPrepayRequest(); // BillingPrepayRequest | 
apiInstance.addBillingPrepay(BillingPrepayRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.BillingApi();
let id = 56; // Number | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.
let BillingVerifyCcRequest = new InterServerManagementApi.BillingVerifyCcRequest(); // BillingVerifyCcRequest | 
apiInstance.postBillingCreditCardVerify(id, BillingVerifyCcRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TextResponse updateAffiliateDockSetup(opts)
...
apiInstance.updateAffiliateDockSetup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TextResponse updateAffiliateLandingPage(opts)
...
apiInstance.updateAffiliateLandingPage(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> TextResponse updateAffiliatePaymentSetup(opts)
...
apiInstance.updateAffiliatePaymentSetup(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new InterServerManagementApi.BillingApi();
let BillingPaymentMethodRequest = new InterServerManagementApi.BillingPaymentMethodRequest(); // BillingPaymentMethodRequest | 
apiInstance.updateBillingPaymentMethod(BillingPaymentMethodRequest, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
