...
object ServerOrderRAID {
  given encoderServerOrderRAID: Encoder[ServerOrderRAID] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServerOrderRAID: Decoder[ServerOrderRAID] = Decoder.instance { c =>
    for {
