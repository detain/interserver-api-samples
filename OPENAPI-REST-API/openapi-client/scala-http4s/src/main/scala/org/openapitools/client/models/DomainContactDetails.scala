...
object DomainContactDetails {
  given encoderDomainContactDetails: Encoder[DomainContactDetails] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderDomainContactDetails: Decoder[DomainContactDetails] = Decoder.instance { c =>
    for {
