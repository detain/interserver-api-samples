...
object LicenseIpInfoRow {
  given encoderLicenseIpInfoRow: Encoder[LicenseIpInfoRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderLicenseIpInfoRow: Decoder[LicenseIpInfoRow] = Decoder.instance { c =>
    for {
      desc <- c.downField("desc").as[Option[String]]
      value <- c.downField("value").as[Option[String]]
    } yield LicenseIpInfoRow(
      desc = desc,
      value = value
    )
  }
