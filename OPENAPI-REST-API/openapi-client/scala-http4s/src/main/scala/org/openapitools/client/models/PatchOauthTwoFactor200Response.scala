...
object PatchOauthTwoFactor200Response {
  given encoderPatchOauthTwoFactor200Response: Encoder[PatchOauthTwoFactor200Response] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderPatchOauthTwoFactor200Response: Decoder[PatchOauthTwoFactor200Response] = Decoder.instance { c =>
    for {
      login <- c.downField("login").as[Option[Boolean]]
    } yield PatchOauthTwoFactor200Response(
      login = login
    )
  }
}
