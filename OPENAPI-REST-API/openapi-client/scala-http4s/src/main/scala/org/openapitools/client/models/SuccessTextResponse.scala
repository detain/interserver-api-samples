...
object SuccessTextResponse {
  given encoderSuccessTextResponse: Encoder[SuccessTextResponse] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
