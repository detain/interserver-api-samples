...
object WebsiteTableRow {
  given encoderWebsiteTableRow: Encoder[WebsiteTableRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderWebsiteTableRow: Decoder[WebsiteTableRow] = Decoder.instance { c =>
    for {
      desc <- c.downField("desc").as[Option[String]]
      value <- c.downField("value").as[Option[String]]
    } yield WebsiteTableRow(
      desc = desc,
      value = value
    )
  }
