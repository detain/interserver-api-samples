...
object DownloadQsBackup200Response {
  given encoderDownloadQsBackup200Response: Encoder[DownloadQsBackup200Response] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderDownloadQsBackup200Response: Decoder[DownloadQsBackup200Response] = Decoder.instance { c =>
    for {
      text <- c.downField("text").as[Option[String]]
      url <- c.downField("url").as[Option[String]]
    } yield DownloadQsBackup200Response(
      text = text,
      url = url
    )
  }
