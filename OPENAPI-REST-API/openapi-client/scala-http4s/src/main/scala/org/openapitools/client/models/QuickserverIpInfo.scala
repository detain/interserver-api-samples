...
object QuickserverIpInfo {
  given encoderQuickserverIpInfo: Encoder[QuickserverIpInfo] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderQuickserverIpInfo: Decoder[QuickserverIpInfo] = Decoder.instance { c =>
    for {
      title <- c.downField("title").as[Option[String]]
      rows <- c.downField("rows").as[Option[Seq[QuickserverIpTableRow]]]
    } yield QuickserverIpInfo(
      title = title,
      rows = rows
    )
  }
