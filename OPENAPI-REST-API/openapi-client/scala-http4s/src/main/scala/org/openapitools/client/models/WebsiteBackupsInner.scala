...
object WebsiteBackupsInner {
  given encoderWebsiteBackupsInner: Encoder[WebsiteBackupsInner] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderWebsiteBackupsInner: Decoder[WebsiteBackupsInner] = Decoder.instance { c =>
    for {
      name <- c.downField("name").as[String]
      size <- c.downField("size").as[Option[Int]]
    } yield WebsiteBackupsInner(
      name = name,
      size = size
    )
  }
