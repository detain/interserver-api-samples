...
object GetAccountInfo401Response {
  given encoderGetAccountInfo401Response: Encoder[GetAccountInfo401Response] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderGetAccountInfo401Response: Decoder[GetAccountInfo401Response] = Decoder.instance { c =>
    for {
      code <- c.downField("code").as[Int]
      message <- c.downField("message").as[String]
    } yield GetAccountInfo401Response(
      code = code,
      message = message
    )
  }
