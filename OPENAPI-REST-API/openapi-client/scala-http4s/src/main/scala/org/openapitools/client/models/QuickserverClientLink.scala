...
object QuickserverClientLink {
  given encoderQuickserverClientLink: Encoder[QuickserverClientLink] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderQuickserverClientLink: Decoder[QuickserverClientLink] = Decoder.instance { c =>
    for {
