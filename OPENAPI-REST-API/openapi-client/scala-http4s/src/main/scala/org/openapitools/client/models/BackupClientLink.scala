...
object BackupClientLink {
  given encoderBackupClientLink: Encoder[BackupClientLink] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderBackupClientLink: Decoder[BackupClientLink] = Decoder.instance { c =>
    for {
