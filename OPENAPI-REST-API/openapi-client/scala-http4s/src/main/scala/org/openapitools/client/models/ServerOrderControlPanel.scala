...
object ServerOrderControlPanel {
  given encoderServerOrderControlPanel: Encoder[ServerOrderControlPanel] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServerOrderControlPanel: Decoder[ServerOrderControlPanel] = Decoder.instance { c =>
    for {
      ...
      os_type <- c.downField("os_type").as[Option[String]]
      monthly_price <- c.downField("monthly_price").as[Option[Int]]
      types <- c.downField("types").as[Option[Seq[String]]]
