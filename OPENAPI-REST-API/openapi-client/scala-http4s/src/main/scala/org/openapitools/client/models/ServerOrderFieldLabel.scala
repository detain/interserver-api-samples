...
object ServerOrderFieldLabel {
  given encoderServerOrderFieldLabel: Encoder[ServerOrderFieldLabel] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServerOrderFieldLabel: Decoder[ServerOrderFieldLabel] = Decoder.instance { c =>
    for {
      name <- c.downField("name").as[Option[String]]
      active <- c.downField("active").as[Option[Int]]
    } yield ServerOrderFieldLabel(
      name = name,
      active = active
    )
  }
