...
object ServersBuyNowError {
  given encoderServersBuyNowError: Encoder[ServersBuyNowError] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServersBuyNowError: Decoder[ServersBuyNowError] = Decoder.instance { c =>
    for {
