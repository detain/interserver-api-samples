...
object ServerOrderConfigIds {
  given encoderServerOrderConfigIds: Encoder[ServerOrderConfigIds] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServerOrderConfigIds: Decoder[ServerOrderConfigIds] = Decoder.instance { c =>
    for {
