...
object QuickserverAddonsRow {
  given encoderQuickserverAddonsRow: Encoder[QuickserverAddonsRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderQuickserverAddonsRow: Decoder[QuickserverAddonsRow] = Decoder.instance { c =>
    for {
      desc <- c.downField("desc").as[Option[String]]
      value <- c.downField("value").as[Option[String]]
    } yield QuickserverAddonsRow(
      desc = desc,
      value = value
    )
  }
