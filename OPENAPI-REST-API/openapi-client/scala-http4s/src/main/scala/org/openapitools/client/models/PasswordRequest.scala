...
object PasswordRequest {
  given encoderPasswordRequest: Encoder[PasswordRequest] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderPasswordRequest: Decoder[PasswordRequest] = Decoder.instance { c =>
    for {
      password <- c.downField("password").as[String]
    } yield PasswordRequest(
      password = password
    )
  }
}
