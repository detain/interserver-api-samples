...
object ServiceCategories {
  given encoderServiceCategories: Encoder[ServiceCategories] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
      ).flatten
    }
  }
  given decoderServiceCategories: Decoder[ServiceCategories] = Decoder.instance { c =>
    for {
