...
object ServerOrderBandwidth {
  given encoderServerOrderBandwidth: Encoder[ServerOrderBandwidth] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderServerOrderBandwidth: Decoder[ServerOrderBandwidth] = Decoder.instance { c =>
    for {
      ...
      qty <- c.downField("qty").as[Option[String]]
