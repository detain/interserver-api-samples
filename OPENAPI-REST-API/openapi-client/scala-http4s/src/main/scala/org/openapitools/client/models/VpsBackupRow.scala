...
object VpsBackupRow {
  given encoderVpsBackupRow: Encoder[VpsBackupRow] = Encoder.instance { t =>
    Json.fromFields{
      Seq(
  ...
  given decoderVpsBackupRow: Decoder[VpsBackupRow] = Decoder.instance { c =>
    for {
      `type` <- c.downField("type").as[String]
      service <- c.downField("service").as[Int]
