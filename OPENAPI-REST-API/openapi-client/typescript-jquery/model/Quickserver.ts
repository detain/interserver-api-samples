...
export interface Quickserver {
    serviceInfo: models.QuickserverServiceInfo;

    client_links: Array<models.QuickserverClientLink>;

    billingDetails: models.QuickserverBillingDetails;
    ...
    serviceMaster: models.QuickserverServiceMaster;
    ...
    serviceExtra: models.QuickserverServiceExtra;

    extraInfoTables: models.QuickserverExtraInfoTables;
