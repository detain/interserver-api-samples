...
export interface MailSchema {
    serviceInfo: models.MailServiceInfo;

    /**
     * Links related to the mail service for clients.
     */
    client_links: Array<models.MailClientLink>;

    billingDetails: models.MailBillingDetails;
    ...
    extraInfoTables: models.MailSchemaExtraInfoTables;

    serviceType: models.MailServiceType;
