...
export interface AccountInfo {
    ...
    data?: models.AccountInfoData;

    ip?: string;

    oauthproviders?: models.AccountInfoOauthproviders;

    oauthconfig?: models.AccountInfoOauthConfig;

    oauthadapters?: Array<string>;

    limits?: models.AccountInfoLimits;

    language?: string;

    countryCurrencies?: models.AccountInfoCountryCurrencies;
