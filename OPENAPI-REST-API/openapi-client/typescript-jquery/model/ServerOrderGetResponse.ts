...
export interface ServerOrderGetResponse {
    ...
    config_ids: models.ConfigIds;

    cpu: number;

    cpu_li: { [key: string]: models.Cpu; };

    config_li: models.ConfigLists;
    ...
    field_label?: { [key: string]: models.FieldLabel; };

    cpu_cores?: { [key: string]: { [key: string]: models.CpuWithDefaults; }; };
    ...
    asset_servers?: Array<models.AssetServer>;
