...
|------------- | ------------- | -------------|
|[**addBackup**](#addbackup) | **POST** /backups/order | Place Backup Order|
|[**cancelBackup**](#cancelbackup) | **DELETE** /backups/{id} | Cancel Backup Service|
|[**getBackupInfo**](#getbackupinfo) | **GET** /backups/{id} | Get Backup Service Details|
|[**getBackupInvoices**](#getbackupinvoices) | **GET** /backups/{id}/invoices | Get Backup Order Invoices|
|[**getBackupLogin**](#getbackuplogin) | **GET** /backups/{id}/login | Get Backup Storage Panel Login|
|[**getBackupsList**](#getbackupslist) | **GET** /backups | List Backup Services|
|[**getBackupsWelcomeEmail**](#getbackupswelcomeemail) | **GET** /backups/{id}/welcome_email | Resend Backup Welcome Email|
|[**getNewBackup**](#getnewbackup) | **GET** /backups/order | Get Backup Order Form Data|
|[**updateBackupInfo**](#updatebackupinfo) | **POST** /backups/{id} | Update Backup Information|
|[**validateBackupOrder**](#validatebackuporder) | **PUT** /backups/order | Validate Backup Order|
...
let validateOnly: boolean; // (optional) (default to undefined)
let serviceType: number; // (optional) (default to undefined)
let coupon: string; // (optional) (default to undefined)

const { status, data } = await apiInstance.addBackup(
    validateOnly,
    serviceType,
    coupon
);
...
let id: number; //The backup service ID. Use the `backup_id` from `GET /backups` to identify the service. (default to undefined)
...
const { status, data } = await apiInstance.getBackupInvoices(
    id
);
```
...
const { status, data } = await apiInstance.getBackupLogin(
    id
);
```
...
const { status, data } = await apiInstance.getBackupsList();
```
...
const { status, data } = await apiInstance.getBackupsWelcomeEmail(
    id
);
```
...
const { status, data } = await apiInstance.getNewBackup();
```
...
const { status, data } = await apiInstance.updateBackupInfo(
    id
);
```
...
const { status, data } = await apiInstance.validateBackupOrder(
    validateOnly,
    serviceType,
    coupon
);
