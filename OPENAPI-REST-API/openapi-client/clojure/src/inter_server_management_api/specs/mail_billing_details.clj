(ns inter-server-management-api.specs.mail-billing-details
...
(def mail-billing-details-spec
  (ds/spec
    {:name ::mail-billing-details
     :spec mail-billing-details-data}))
