(ns inter-server-management-api.core
...
(def auth-definitions
  {"apiKeyAuth" {:type :api-key :in :header :param-name "X-API-KEY"}
   "sessionIdHeaderAuth" {:type :api-key :in :header :param-name "sessionid"}
   "sessionIdCookieAuth" {:type :api-key :param-name "sessionid"}})

(def default-api-context
  "Default API context."
  {:base-url        "https://my.interserver.net/apiv2"
   :date-format     "yyyy-MM-dd"
   :datetime-format "yyyy-MM-dd'T'HH:mm:ss.SSSXXX"
   :decode-models   false
   :debug           false
   :auths           {"apiKeyAuth" nil
                     "sessionIdHeaderAuth" nil
                     "sessionIdCookieAuth" nil}})
