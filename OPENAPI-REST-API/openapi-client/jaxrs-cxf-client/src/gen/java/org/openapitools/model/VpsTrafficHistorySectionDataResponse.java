 ...
 */
@ApiModel(description="VPS Traffic Hisotrty Data Row of Hour/Day Section")

public class VpsTrafficHistorySectionDataResponse extends ArrayList<VPSTrafficDataDataSectionResponseInner> {
    @Override
