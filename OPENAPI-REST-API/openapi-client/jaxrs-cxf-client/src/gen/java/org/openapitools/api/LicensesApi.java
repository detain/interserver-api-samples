...
public interface LicensesApi  {
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get License", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}/invoices")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get License Invoices", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "List Licenses", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/order/{catTag}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get License Order Information for Category", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "License types and pricing for the specified category."),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Resend License Welcome Email", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/order")
    @Produces({ "application/json" })
    @ApiOperation(value = "Get License Order Information", tags={  })
    @ApiResponses(value = { 
    ...
    @Path("/{id}")
    @Produces({ "application/json" })
    @ApiOperation(value = "Cancel License", tags={  })
    @ApiResponses(value = { 
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Change License IP", tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "A response indicating the operation completed successfully with a text message.", response = SuccessTextResponse.class),
        @ApiResponse(code = 401, message = "Unauthorized", response = GetAccountInfo401Response.class) })
    ...
    @Path("/order")
    @Produces({ "application/json" })
    @ApiOperation(value = "Validate License Order", tags={  })
    @ApiResponses(value = { 
