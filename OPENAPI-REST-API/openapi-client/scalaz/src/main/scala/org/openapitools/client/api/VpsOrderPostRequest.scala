...
object VpsOrderPostRequest {
  ...
  implicit val VpsOrderPostRequestCodecJson: CodecJson[VpsOrderPostRequest] = CodecJson.derive[VpsOrderPostRequest]
  implicit val VpsOrderPostRequestDecoder: EntityDecoder[VpsOrderPostRequest] = jsonOf[VpsOrderPostRequest]
  implicit val VpsOrderPostRequestEncoder: EntityEncoder[VpsOrderPostRequest] = jsonEncoderOf[VpsOrderPostRequest]
}
