...
void
CreateRule_201_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CreateRule_201_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CreateRule_201_response::fromJson(char* jsonStr)
{
...
CreateRule_201_response::CreateRule_201_response(char* json)
{
	this->fromJson(json);
}
...
bool
CreateRule_201_response::getSuccess()
{
	return success;
}
