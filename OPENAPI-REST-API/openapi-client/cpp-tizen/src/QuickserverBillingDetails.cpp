...
void
QuickserverBillingDetails::__init()
{
	...
	//service_extra = new QuickserverServiceExtra();
	//service_extra_json = std::string();
}

void
QuickserverBillingDetails::__cleanup()
{
...
void
QuickserverBillingDetails::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("QuickserverServiceExtra")) {
			jsonToValue(&service_extra, node, "QuickserverServiceExtra", "QuickserverServiceExtra");
		} else {
			
			QuickserverServiceExtra* obj = static_cast<QuickserverServiceExtra*> (&service_extra);
...
QuickserverBillingDetails::QuickserverBillingDetails(char* json)
{
	this->fromJson(json);
}
...
QuickserverBillingDetails::toJson()
{
	...
	if (isprimitive("QuickserverServiceExtra")) {
		QuickserverServiceExtra obj = getServiceExtra();
		node = converttoJson(&obj, "QuickserverServiceExtra", "");
	}
	else {
		
		QuickserverServiceExtra obj = static_cast<QuickserverServiceExtra> (getServiceExtra());
		GError *mygerror;
		mygerror = NULL;
