...
void
DeleteFilter_500_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
DeleteFilter_500_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
DeleteFilter_500_response::fromJson(char* jsonStr)
{
...
DeleteFilter_500_response::DeleteFilter_500_response(char* json)
{
	this->fromJson(json);
}
...
bool
DeleteFilter_500_response::getSuccess()
{
	return success;
}
