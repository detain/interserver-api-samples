...
void
BuyItNowRow_cpu_inner_oneOf::__init()
{
	//img = std::string();
	//type = std::string();
	//speed = std::string();
...
void
BuyItNowRow_cpu_inner_oneOf::__cleanup()
{
	//if(img != NULL) {
	//
	//delete img;
...
void
BuyItNowRow_cpu_inner_oneOf::fromJson(char* jsonStr)
{
...
BuyItNowRow_cpu_inner_oneOf::BuyItNowRow_cpu_inner_oneOf(char* json)
{
	this->fromJson(json);
}
