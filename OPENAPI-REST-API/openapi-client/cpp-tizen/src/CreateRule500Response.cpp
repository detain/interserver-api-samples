...
void
CreateRule_500_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CreateRule_500_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CreateRule_500_response::fromJson(char* jsonStr)
{
...
CreateRule_500_response::CreateRule_500_response(char* json)
{
	this->fromJson(json);
}
...
bool
CreateRule_500_response::getSuccess()
{
	return success;
}
