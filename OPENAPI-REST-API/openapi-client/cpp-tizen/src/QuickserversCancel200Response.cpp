...
void
QuickserversCancel_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
QuickserversCancel_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
QuickserversCancel_200_response::fromJson(char* jsonStr)
{
...
QuickserversCancel_200_response::QuickserversCancel_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
QuickserversCancel_200_response::getSuccess()
{
	return success;
}
