...
#ifndef _WebsiteServiceInfo_H_
#define _WebsiteServiceInfo_H_
...
class WebsiteServiceInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	WebsiteServiceInfo();
	WebsiteServiceInfo(char* str);
