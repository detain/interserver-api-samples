...
void
CancelScrubIp_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CancelScrubIp_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CancelScrubIp_200_response::fromJson(char* jsonStr)
{
...
CancelScrubIp_200_response::CancelScrubIp_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
CancelScrubIp_200_response::getSuccess()
{
	return success;
}
