...
void
DisableScrub_400_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
DisableScrub_400_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
DisableScrub_400_response::fromJson(char* jsonStr)
{
...
DisableScrub_400_response::DisableScrub_400_response(char* json)
{
	this->fromJson(json);
}
...
bool
DisableScrub_400_response::getSuccess()
{
	return success;
}
