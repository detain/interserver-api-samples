...
void
ServersCancel_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
ServersCancel_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
ServersCancel_200_response::fromJson(char* jsonStr)
{
...
ServersCancel_200_response::ServersCancel_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
ServersCancel_200_response::getSuccess()
{
	return success;
}
