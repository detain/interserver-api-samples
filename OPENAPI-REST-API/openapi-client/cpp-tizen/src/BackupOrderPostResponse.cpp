...
void
BackupOrderPostResponse::__init()
{
	...
	//cj_params = new BackupOrderPostResponse_cj_params();
}

void
BackupOrderPostResponse::__cleanup()
{
	//if(r_continue != NULL) {
	//
	//delete r_continue;
...
void
BackupOrderPostResponse::fromJson(char* jsonStr)
{
	...
	if (node !=NULL) {
		...
		if (isprimitive("BackupOrderPostResponse_cj_params")) {
			jsonToValue(&cj_params, node, "BackupOrderPostResponse_cj_params", "BackupOrderPostResponse_cj_params");
		} else {
			
			BackupOrderPostResponse_cj_params* obj = static_cast<BackupOrderPostResponse_cj_params*> (&cj_params);
...
BackupOrderPostResponse::BackupOrderPostResponse(char* json)
{
	this->fromJson(json);
}
...
BackupOrderPostResponse::toJson()
{
	...
	if (isprimitive("BackupOrderPostResponse_cj_params")) {
		BackupOrderPostResponse_cj_params obj = getCjParams();
		node = converttoJson(&obj, "BackupOrderPostResponse_cj_params", "");
	}
	else {
		
		BackupOrderPostResponse_cj_params obj = static_cast<BackupOrderPostResponse_cj_params> (getCjParams());
		GError *mygerror;
		mygerror = NULL;
...
bool
BackupOrderPostResponse::getRContinue()
{
	return r_continue;
}
