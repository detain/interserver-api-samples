...
void
ServerBillingDetails::__cleanup()
{
...
void
ServerBillingDetails::fromJson(char* jsonStr)
{
...
ServerBillingDetails::ServerBillingDetails(char* json)
{
	this->fromJson(json);
}
