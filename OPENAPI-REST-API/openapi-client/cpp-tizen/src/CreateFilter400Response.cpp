...
void
CreateFilter_400_response::__init()
{
	//success = bool(false);
	//text = std::string();
...
void
CreateFilter_400_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CreateFilter_400_response::fromJson(char* jsonStr)
{
...
CreateFilter_400_response::CreateFilter_400_response(char* json)
{
	this->fromJson(json);
}
...
bool
CreateFilter_400_response::getSuccess()
{
	return success;
}
