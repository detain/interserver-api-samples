...
void
DomainContactDetails::__cleanup()
{
	//if(status != NULL) {
	//
	//delete status;
...
void
DomainContactDetails::fromJson(char* jsonStr)
{
...
DomainContactDetails::DomainContactDetails(char* json)
{
	this->fromJson(json);
}
