...
void
CloseTicketResponseSchema::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CloseTicketResponseSchema::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CloseTicketResponseSchema::fromJson(char* jsonStr)
{
...
CloseTicketResponseSchema::CloseTicketResponseSchema(char* json)
{
	this->fromJson(json);
}
...
bool
CloseTicketResponseSchema::getSuccess()
{
	return success;
}
