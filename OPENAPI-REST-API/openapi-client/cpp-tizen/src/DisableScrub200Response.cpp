...
void
DisableScrub_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
DisableScrub_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
DisableScrub_200_response::fromJson(char* jsonStr)
{
...
DisableScrub_200_response::DisableScrub_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
DisableScrub_200_response::getSuccess()
{
	return success;
}
