...
void
HomeDetailsModulesWebhosting::__init()
{
	//icon = std::string();
...
void
HomeDetailsModulesWebhosting::__cleanup()
{
	//if(icon != NULL) {
	//
	//delete icon;
...
void
HomeDetailsModulesWebhosting::fromJson(char* jsonStr)
{
...
HomeDetailsModulesWebhosting::HomeDetailsModulesWebhosting(char* json)
{
	this->fromJson(json);
}
