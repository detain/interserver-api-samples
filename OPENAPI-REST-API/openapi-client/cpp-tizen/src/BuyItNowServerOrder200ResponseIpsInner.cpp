...
void
BuyItNowServerOrder_200_response_ips_inner::__init()
{
	//id = std::string();
...
void
BuyItNowServerOrder_200_response_ips_inner::__cleanup()
{
	//if(id != NULL) {
	//
	//delete id;
...
void
BuyItNowServerOrder_200_response_ips_inner::fromJson(char* jsonStr)
{
...
BuyItNowServerOrder_200_response_ips_inner::BuyItNowServerOrder_200_response_ips_inner(char* json)
{
	this->fromJson(json);
}
