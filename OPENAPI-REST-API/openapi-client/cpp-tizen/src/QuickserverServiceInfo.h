...
#ifndef _QuickserverServiceInfo_H_
#define _QuickserverServiceInfo_H_
...
class QuickserverServiceInfo : public Object {
public:
	/*! \brief Constructor.
	 */
	QuickserverServiceInfo();
	QuickserverServiceInfo(char* str);
...
#endif /* _QuickserverServiceInfo_H_ */
