...
void
CancelDomain_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CancelDomain_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CancelDomain_200_response::fromJson(char* jsonStr)
{
...
CancelDomain_200_response::CancelDomain_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
CancelDomain_200_response::getSuccess()
{
	return success;
}
