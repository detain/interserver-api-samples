...
void
DeleteFilter_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
DeleteFilter_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
DeleteFilter_200_response::fromJson(char* jsonStr)
{
...
DeleteFilter_200_response::DeleteFilter_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
DeleteFilter_200_response::getSuccess()
{
	return success;
}
