...
void
DeleteFilter_400_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
DeleteFilter_400_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
DeleteFilter_400_response::fromJson(char* jsonStr)
{
...
DeleteFilter_400_response::DeleteFilter_400_response(char* json)
{
	this->fromJson(json);
}
...
bool
DeleteFilter_400_response::getSuccess()
{
	return success;
}
