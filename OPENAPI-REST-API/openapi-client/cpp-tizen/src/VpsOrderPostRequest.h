...
#ifndef _VpsOrderPostRequest_H_
#define _VpsOrderPostRequest_H_
...
class VpsOrderPostRequest : public Object {
public:
	/*! \brief Constructor.
	 */
	VpsOrderPostRequest();
	VpsOrderPostRequest(char* str);
