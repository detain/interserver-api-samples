...
#ifndef _BuyItNowRow_cpu_inner_oneOf_H_
#define _BuyItNowRow_cpu_inner_oneOf_H_
...
class BuyItNowRow_cpu_inner_oneOf : public Object {
public:
	/*! \brief Constructor.
	 */
	BuyItNowRow_cpu_inner_oneOf();
	BuyItNowRow_cpu_inner_oneOf(char* str);
...
#endif /* _BuyItNowRow_cpu_inner_oneOf_H_ */
