...
void
MailClientLink::fromJson(char* jsonStr)
{
...
MailClientLink::MailClientLink(char* json)
{
	this->fromJson(json);
}

char*
MailClientLink::toJson()
{
...
std::string
MailClientLink::getLabel()
{
	return label;
}

void
MailClientLink::setLabel(std::string  label)
{
	this->label = label;
}

std::string
MailClientLink::getLink()
{
	return link;
}

void
MailClientLink::setLink(std::string  link)
{
	this->link = link;
}

std::string
MailClientLink::getIcon()
{
	return icon;
}

void
MailClientLink::setIcon(std::string  icon)
{
	this->icon = icon;
}

std::string
MailClientLink::getIconText()
{
	return icon_text;
}

void
MailClientLink::setIconText(std::string  icon_text)
{
	this->icon_text = icon_text;
}

std::string
MailClientLink::getHelpText()
{
	return help_text;
}

void
MailClientLink::setHelpText(std::string  help_text)
{
	this->help_text = help_text;
}

std::string
MailClientLink::getOtherAttr()
{
	return other_attr;
}

void
MailClientLink::setOtherAttr(std::string  other_attr)
{
