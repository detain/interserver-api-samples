...
void
LicensesOrderServiceTypes11482::__init()
{
...
void
LicensesOrderServiceTypes11482::__cleanup()
{
	//if(services_id != NULL) {
	//
	//delete services_id;
...
void
LicensesOrderServiceTypes11482::fromJson(char* jsonStr)
{
...
LicensesOrderServiceTypes11482::LicensesOrderServiceTypes11482(char* json)
{
	this->fromJson(json);
}
