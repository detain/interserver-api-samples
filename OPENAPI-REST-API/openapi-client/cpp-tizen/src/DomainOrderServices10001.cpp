...
void
DomainOrderServices10001::__init()
{
...
void
DomainOrderServices10001::__cleanup()
{
	//if(services_id != NULL) {
	//
	//delete services_id;
...
void
DomainOrderServices10001::fromJson(char* jsonStr)
{
...
DomainOrderServices10001::DomainOrderServices10001(char* json)
{
	this->fromJson(json);
}
