...
void
CancelBackup_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
CancelBackup_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
CancelBackup_200_response::fromJson(char* jsonStr)
{
...
CancelBackup_200_response::CancelBackup_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
CancelBackup_200_response::getSuccess()
{
	return success;
}
