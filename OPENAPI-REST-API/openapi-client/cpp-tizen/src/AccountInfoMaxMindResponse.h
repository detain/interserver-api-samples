...
#ifndef _AccountInfoMaxMindResponse_H_
#define _AccountInfoMaxMindResponse_H_
...
class AccountInfoMaxMindResponse : public Object {
public:
	/*! \brief Constructor.
	 */
	AccountInfoMaxMindResponse();
	AccountInfoMaxMindResponse(char* str);
...
#endif /* _AccountInfoMaxMindResponse_H_ */
