...
void
HomeDetailsModulesBackups::__init()
{
	//icon = std::string();
...
void
HomeDetailsModulesBackups::__cleanup()
{
	//if(icon != NULL) {
	//
	//delete icon;
...
void
HomeDetailsModulesBackups::fromJson(char* jsonStr)
{
...
HomeDetailsModulesBackups::HomeDetailsModulesBackups(char* json)
{
	this->fromJson(json);
}
