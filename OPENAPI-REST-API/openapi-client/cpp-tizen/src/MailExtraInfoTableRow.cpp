...
void
MailExtraInfoTableRow::__cleanup()
{
	//if(desc != NULL) {
	//
	//delete desc;
...
void
MailExtraInfoTableRow::fromJson(char* jsonStr)
{
...
MailExtraInfoTableRow::MailExtraInfoTableRow(char* json)
{
	this->fromJson(json);
}
