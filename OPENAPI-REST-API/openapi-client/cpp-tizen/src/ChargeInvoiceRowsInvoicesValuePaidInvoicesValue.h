...
#ifndef _ChargeInvoiceRows_invoices_value_paid_invoices_value_H_
#define _ChargeInvoiceRows_invoices_value_paid_invoices_value_H_
...
class ChargeInvoiceRows_invoices_value_paid_invoices_value : public Object {
public:
	/*! \brief Constructor.
	 */
	ChargeInvoiceRows_invoices_value_paid_invoices_value();
	ChargeInvoiceRows_invoices_value_paid_invoices_value(char* str);
	 ...
	 */
	std::map<std::string, std::string> getRefundInvoices();

	/*! \brief Set This is optional when refund is present this will show
	 */
	void setRefundInvoices(std::map <std::string, std::string> refund_invoices);
...
private:
	...
	std::map <std::string, std::string>refund_invoices;
	void __init();
	void __cleanup();
...
#endif /* _ChargeInvoiceRows_invoices_value_paid_invoices_value_H_ */
