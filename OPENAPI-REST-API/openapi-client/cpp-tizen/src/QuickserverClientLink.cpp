...
void
QuickserverClientLink::__cleanup()
{
	//if(label != NULL) {
	//
	//delete label;
...
void
QuickserverClientLink::fromJson(char* jsonStr)
{
...
QuickserverClientLink::QuickserverClientLink(char* json)
{
	this->fromJson(json);
}
