...
void
VpsClientLink::fromJson(char* jsonStr)
{
...
VpsClientLink::VpsClientLink(char* json)
{
	this->fromJson(json);
}

char*
VpsClientLink::toJson()
{
...
std::string
VpsClientLink::getLabel()
{
	return label;
}

void
VpsClientLink::setLabel(std::string  label)
{
	this->label = label;
}

std::string
VpsClientLink::getLink()
{
	return link;
}

void
VpsClientLink::setLink(std::string  link)
{
	this->link = link;
}

std::string
VpsClientLink::getIcon()
{
	return icon;
}

void
VpsClientLink::setIcon(std::string  icon)
{
	this->icon = icon;
}

std::string
VpsClientLink::getIconText()
{
	return icon_text;
}

void
VpsClientLink::setIconText(std::string  icon_text)
{
	this->icon_text = icon_text;
}

std::string
VpsClientLink::getHelpText()
{
	return help_text;
}

void
VpsClientLink::setHelpText(std::string  help_text)
{
