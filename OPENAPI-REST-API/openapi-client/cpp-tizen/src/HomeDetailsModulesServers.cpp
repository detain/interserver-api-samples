...
void
HomeDetailsModulesServers::__init()
{
	//icon = std::string();
...
void
HomeDetailsModulesServers::__cleanup()
{
	//if(icon != NULL) {
	//
	//delete icon;
...
void
HomeDetailsModulesServers::fromJson(char* jsonStr)
{
...
HomeDetailsModulesServers::HomeDetailsModulesServers(char* json)
{
	this->fromJson(json);
}

char*
HomeDetailsModulesServers::toJson()
{
...
std::string
HomeDetailsModulesServers::getIcon()
{
	return icon;
}

void
HomeDetailsModulesServers::setIcon(std::string  icon)
{
	this->icon = icon;
}

std::string
HomeDetailsModulesServers::getViewLink()
{
	return view_link;
}

void
HomeDetailsModulesServers::setViewLink(std::string  view_link)
{
	this->view_link = view_link;
}

std::string
HomeDetailsModulesServers::getHeading()
{
	return heading;
}

void
HomeDetailsModulesServers::setHeading(std::string  heading)
{
	this->heading = heading;
}

std::string
HomeDetailsModulesServers::getBuyLink()
{
	return buy_link;
}

void
HomeDetailsModulesServers::setBuyLink(std::string  buy_link)
{
	this->buy_link = buy_link;
}

std::string
HomeDetailsModulesServers::getListLink()
{
	return list_link;
}

void
HomeDetailsModulesServers::setListLink(std::string  list_link)
{
