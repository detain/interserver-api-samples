...
void
ServerOrderConfigIds::__cleanup()
{
	//if(memory != NULL) {
	//
	//delete memory;
...
void
ServerOrderConfigIds::fromJson(char* jsonStr)
{
...
ServerOrderConfigIds::ServerOrderConfigIds(char* json)
{
	this->fromJson(json);
}
