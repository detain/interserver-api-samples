...
void
ServerOrderRAID::fromJson(char* jsonStr)
{
...
ServerOrderRAID::ServerOrderRAID(char* json)
{
	this->fromJson(json);
}

char*
ServerOrderRAID::toJson()
{
...
std::string
ServerOrderRAID::getId()
{
	return id;
}

void
ServerOrderRAID::setId(std::string  id)
{
	this->id = id;
}

int
ServerOrderRAID::getPrice()
{
	return price;
}

void
ServerOrderRAID::setPrice(int  price)
{
	this->price = price;
}

std::string
ServerOrderRAID::getImg()
{
	return img;
}

void
ServerOrderRAID::setImg(std::string  img)
{
	this->img = img;
}

std::string
ServerOrderRAID::getShortDesc()
{
	return short_desc;
}

void
ServerOrderRAID::setShortDesc(std::string  short_desc)
{
	this->short_desc = short_desc;
}

std::string
ServerOrderRAID::getLongDesc()
{
	return long_desc;
}

void
ServerOrderRAID::setLongDesc(std::string  long_desc)
{
	this->long_desc = long_desc;
}

int
ServerOrderRAID::getMonthlyPrice()
{
	return monthly_price;
}

void
ServerOrderRAID::setMonthlyPrice(int  monthly_price)
{
	this->monthly_price = monthly_price;
}

std::string
ServerOrderRAID::getActive()
{
	return active;
}

void
ServerOrderRAID::setActive(std::string  active)
{
	this->active = active;
}

std::string
ServerOrderRAID::getPriceDisplay()
{
	return price_display;
}

void
ServerOrderRAID::setPriceDisplay(std::string  price_display)
{
	this->price_display = price_display;
}

std::string
ServerOrderRAID::getMonthlyPriceDisplay()
{
	return monthly_price_display;
}

void
ServerOrderRAID::setMonthlyPriceDisplay(std::string  monthly_price_display)
{
