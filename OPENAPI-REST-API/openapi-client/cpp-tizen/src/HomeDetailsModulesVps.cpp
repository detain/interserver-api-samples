...
void
HomeDetailsModulesVps::__cleanup()
{
	//if(icon != NULL) {
	//
	//delete icon;
...
void
HomeDetailsModulesVps::fromJson(char* jsonStr)
{
...
HomeDetailsModulesVps::HomeDetailsModulesVps(char* json)
{
	this->fromJson(json);
}
