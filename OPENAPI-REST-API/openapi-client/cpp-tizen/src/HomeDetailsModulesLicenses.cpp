...
void
HomeDetailsModulesLicenses::__init()
{
	//icon = std::string();
...
void
HomeDetailsModulesLicenses::__cleanup()
{
	//if(icon != NULL) {
	//
	//delete icon;
...
void
HomeDetailsModulesLicenses::fromJson(char* jsonStr)
{
...
HomeDetailsModulesLicenses::HomeDetailsModulesLicenses(char* json)
{
	this->fromJson(json);
}
