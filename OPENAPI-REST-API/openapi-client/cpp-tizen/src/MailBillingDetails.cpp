...
void
MailBillingDetails::fromJson(char* jsonStr)
{
...
MailBillingDetails::MailBillingDetails(char* json)
{
	this->fromJson(json);
}

char*
MailBillingDetails::toJson()
{
...
std::string
MailBillingDetails::getServiceLastInvoiceDate()
{
	return service_last_invoice_date;
}

void
MailBillingDetails::setServiceLastInvoiceDate(std::string  service_last_invoice_date)
{
	this->service_last_invoice_date = service_last_invoice_date;
}

std::string
MailBillingDetails::getServicePaymentStatus()
{
	return service_payment_status;
}

void
MailBillingDetails::setServicePaymentStatus(std::string  service_payment_status)
{
	this->service_payment_status = service_payment_status;
}

std::string
MailBillingDetails::getServiceFrequency()
{
	return service_frequency;
}

void
MailBillingDetails::setServiceFrequency(std::string  service_frequency)
{
	this->service_frequency = service_frequency;
}

std::string
MailBillingDetails::getNextDate()
{
	return next_date;
}

void
MailBillingDetails::setNextDate(std::string  next_date)
{
	this->next_date = next_date;
}

std::string
MailBillingDetails::getServiceNextInvoiceDate()
{
	return service_next_invoice_date;
}

void
MailBillingDetails::setServiceNextInvoiceDate(std::string  service_next_invoice_date)
{
	this->service_next_invoice_date = service_next_invoice_date;
}

std::string
MailBillingDetails::getServiceCurrency()
{
	return service_currency;
}

void
MailBillingDetails::setServiceCurrency(std::string  service_currency)
{
	this->service_currency = service_currency;
}

std::string
MailBillingDetails::getServiceCurrencySymbol()
{
	return service_currency_symbol;
}

void
MailBillingDetails::setServiceCurrencySymbol(std::string  service_currency_symbol)
{
	this->service_currency_symbol = service_currency_symbol;
}

std::string
MailBillingDetails::getServiceCostInfo()
{
	return service_cost_info;
}

void
MailBillingDetails::setServiceCostInfo(std::string  service_cost_info)
{
	this->service_cost_info = service_cost_info;
}

std::list<std::string>
MailBillingDetails::getServiceExtra()
{
	return service_extra;
}

void
MailBillingDetails::setServiceExtra(std::list <std::string> service_extra)
{
	this->service_extra = service_extra;
}

std::string
MailBillingDetails::getServiceExtraJson()
{
	return service_extra_json;
}

void
MailBillingDetails::setServiceExtraJson(std::string  service_extra_json)
{
