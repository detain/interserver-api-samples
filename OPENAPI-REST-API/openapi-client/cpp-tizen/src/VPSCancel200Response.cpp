...
void
VPSCancel_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
VPSCancel_200_response::fromJson(char* jsonStr)
{
...
VPSCancel_200_response::VPSCancel_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
VPSCancel_200_response::getSuccess()
{
	return success;
}
