...
#ifndef _DomainBillingExtra_H_
#define _DomainBillingExtra_H_
...
class DomainBillingExtra : public Object {
public:
	/*! \brief Constructor.
	 */
	DomainBillingExtra();
	DomainBillingExtra(char* str);
