...
void
WebhostingCancel_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
WebhostingCancel_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
WebhostingCancel_200_response::fromJson(char* jsonStr)
{
...
WebhostingCancel_200_response::WebhostingCancel_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
WebhostingCancel_200_response::getSuccess()
{
	return success;
}
