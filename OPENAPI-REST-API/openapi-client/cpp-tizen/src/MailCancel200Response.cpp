...
void
MailCancel_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
MailCancel_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
MailCancel_200_response::fromJson(char* jsonStr)
{
...
MailCancel_200_response::MailCancel_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
MailCancel_200_response::getSuccess()
{
	return success;
}
