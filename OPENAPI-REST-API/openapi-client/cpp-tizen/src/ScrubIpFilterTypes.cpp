...
void
ScrubIpFilterTypes::__init()
{
	//success = bool(false);
	//new std::map()std::map> filters;
}

void
ScrubIpFilterTypes::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
ScrubIpFilterTypes::fromJson(char* jsonStr)
{
...
ScrubIpFilterTypes::ScrubIpFilterTypes(char* json)
{
	this->fromJson(json);
}
...
ScrubIpFilterTypes::toJson()
{
	...
	{
		JsonObject* json_obj;
		map<string, string> new_list = static_cast<map <string, string> > (getFilters());
...
void
ScrubIpFilterTypes::setFilters(std::map <string, string> filters)
{
