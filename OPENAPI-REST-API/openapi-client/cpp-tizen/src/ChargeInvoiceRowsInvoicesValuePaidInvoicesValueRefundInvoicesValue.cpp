...
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value()
{
	//__init();
}
...
void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::__init()
{
...
void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::__cleanup()
{
	//if(invoices_id != NULL) {
	//
	//delete invoices_id;
...
void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::fromJson(char* jsonStr)
{
...
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value(char* json)
{
	this->fromJson(json);
}

char*
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::toJson()
{
...
long long
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesId()
{
	return invoices_id;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesId(long long  invoices_id)
{
	this->invoices_id = invoices_id;
}

std::string
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesDescription()
{
	return invoices_description;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesDescription(std::string  invoices_description)
{
	this->invoices_description = invoices_description;
}

long long
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesAmount()
{
	return invoices_amount;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesAmount(long long  invoices_amount)
{
	this->invoices_amount = invoices_amount;
}

std::string
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesDate()
{
	return invoices_date;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesDate(std::string  invoices_date)
{
	this->invoices_date = invoices_date;
}

std::string
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesCurrency()
{
	return invoices_currency;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesCurrency(std::string  invoices_currency)
{
	this->invoices_currency = invoices_currency;
}

std::string
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getCurrencySymbol()
{
	return currency_symbol;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setCurrencySymbol(std::string  currency_symbol)
{
	this->currency_symbol = currency_symbol;
}

std::string
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::getInvoicesDateFormatted()
{
	return invoices_date_formatted;
}

void
ChargeInvoiceRows_invoices_value_paid_invoices_value_refund_invoices_value::setInvoicesDateFormatted(std::string  invoices_date_formatted)
{
