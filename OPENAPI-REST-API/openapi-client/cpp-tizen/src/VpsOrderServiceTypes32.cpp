...
void
VpsOrder_serviceTypes_32::__init()
{
...
void
VpsOrder_serviceTypes_32::__cleanup()
{
	//if(services_id != NULL) {
	//
	//delete services_id;
...
void
VpsOrder_serviceTypes_32::fromJson(char* jsonStr)
{
...
VpsOrder_serviceTypes_32::VpsOrder_serviceTypes_32(char* json)
{
	this->fromJson(json);
}
