...
void
EnableScrub_200_response::__init()
{
	//success = bool(false);
	//text = std::string();
}
...
void
EnableScrub_200_response::__cleanup()
{
	//if(success != NULL) {
	//
	//delete success;
...
void
EnableScrub_200_response::fromJson(char* jsonStr)
{
...
EnableScrub_200_response::EnableScrub_200_response(char* json)
{
	this->fromJson(json);
}
...
bool
EnableScrub_200_response::getSuccess()
{
	return success;
}
