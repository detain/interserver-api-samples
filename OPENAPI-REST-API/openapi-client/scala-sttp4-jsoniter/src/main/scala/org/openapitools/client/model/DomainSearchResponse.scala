...
case class DomainSearchResponse(
  ...
  @named("success") success: Option[Boolean] = scala.None,
  ...
  @named("response_time") response_time: Option[String] = scala.None,
  /* Availability lookup results for queried domains. */
  @named("lookup") lookup: Option[Seq[io.circe.Json]] = scala.None,
  /* Suggested alternative domains and availability data. */
  @named("suggest") suggest: Option[Seq[io.circe.Json]] = scala.None,
  /* TLDs evaluated during the search. */
  @named("tlds") tlds: Option[Seq[String]] = scala.None
)
