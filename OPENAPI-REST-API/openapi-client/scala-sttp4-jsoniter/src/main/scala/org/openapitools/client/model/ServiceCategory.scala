...
case class ServiceCategory(
  @named("category_id") category_id: Int,
  @named("category_name") category_name: String,
  @named("category_tag") category_tag: String,
  @named("category_module") category_module: String
)
