...
case class FormValues(
  ...
  @named("memory") memory: Option[Int] = scala.None,
  /* Selected bandwidth option ID. */
  @named("bandwidth") bandwidth: Option[Int] = scala.None,
  /* Selected IP block option ID. */
  @named("ips") ips: Option[Int] = scala.None,
  /* Selected operating system option ID. */
  @named("os") os: Option[Int] = scala.None,
  /* Selected control panel option ID. */
  @named("cp") cp: Option[Int] = scala.None,
  /* Selected RAID option ID. */
  @named("raid") raid: Option[Int] = scala.None,
  /* Selected hard drive option ID. */
  @named("hd") hd: Option[Int] = scala.None,
  /* Selected datacenter region ID. */
  @named("region") region: Option[Int] = scala.None
)
