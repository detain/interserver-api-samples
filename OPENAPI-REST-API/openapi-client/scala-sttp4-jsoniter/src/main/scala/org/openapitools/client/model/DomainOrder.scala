...
case class DomainOrder(
  ...
  @named("whoisPrivacyCost") whoisPrivacyCost: Option[String] = scala.None,
  @named("services") services: Option[DomainOrderServices] = scala.None,
  /* Map of TLDs to domain service IDs. */
  @named("tldServices") tldServices: Option[io.circe.Json] = scala.None
)
