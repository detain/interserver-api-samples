...
case class QuickserverRow(
  /* The id of the qs. */
  @named("qs_id") qs_id: String,
  /* The name of the qs. */
  @named("qs_name") qs_name: String,
  /* The cost of the qs. */
  @named("cost") cost: String,
  /* The hostname of the qs. */
  @named("qs_hostname") qs_hostname: String,
  /* The status of the qs. */
  @named("qs_status") qs_status: String,
  /* The comment of the qs. */
  @named("qs_comment") qs_comment: String
)
