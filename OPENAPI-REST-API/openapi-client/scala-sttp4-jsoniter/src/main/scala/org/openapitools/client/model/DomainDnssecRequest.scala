...
case class DomainDnssecRequest(
  ...
  @named("algorithm") algorithm: Option[Seq[Int]] = scala.None,
  /* List of digest type IDs for each record. */
  @named("digest_type") digest_type: Option[Seq[Int]] = scala.None,
  /* List of hex digests for each record. */
  @named("digest") digest: Option[Seq[String]] = scala.None,
  /* List of key tag values corresponding to each record. */
  @named("key_tag") key_tag: Option[Seq[Int]] = scala.None
)
