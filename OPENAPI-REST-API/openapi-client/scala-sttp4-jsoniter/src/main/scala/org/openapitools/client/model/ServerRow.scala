...
case class ServerRow(
  ...
  @named("server_id") server_id: String,
  /* The account lid of the server. */
  @named("account_lid") account_lid: String,
  /* The hostname of the server. */
  @named("server_hostname") server_hostname: String,
  /* The status of the server. */
  @named("server_status") server_status: String
)
