...
case class LoginSubmissionExample(
  ...
  @named("passwd") passwd: String,
  @named("remember") remember: Option[String] = scala.None,
  @named("g-recaptcha-response") g_recaptcha_response: Option[LoginSubmissionExampleGRecaptchaResponse] = scala.None,
  /* Two Factor Authentication Response. */
  @named("tfa") tfa: Option[String] = scala.None
)
