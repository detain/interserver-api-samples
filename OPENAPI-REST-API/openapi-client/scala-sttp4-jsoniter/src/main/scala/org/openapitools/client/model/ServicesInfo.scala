...
case class ServicesInfo(
  @named("modules") modules: Modules,
  @named("services") services: Services,
  @named("serviceTypes") serviceTypes: ServiceTypes,
  @named("serviceCategories") serviceCategories: ServiceCategories
)
