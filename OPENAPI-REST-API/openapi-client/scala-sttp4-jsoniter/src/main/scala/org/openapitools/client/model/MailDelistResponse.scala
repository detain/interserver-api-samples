...
case class MailDelistResponse(
  ...
  @named("local") local: Option[Seq[io.circe.Json]] = scala.None,
  /* MailBaby trap block entries. */
  @named("mbtrap") mbtrap: Option[Seq[io.circe.Json]] = scala.None,
  /* Subject-based block entries. */
  @named("subject") subject: Option[Seq[io.circe.Json]] = scala.None,
  /* Manually blocked entries. */
  @named("manual") manual: Option[Seq[io.circe.Json]] = scala.None
)
