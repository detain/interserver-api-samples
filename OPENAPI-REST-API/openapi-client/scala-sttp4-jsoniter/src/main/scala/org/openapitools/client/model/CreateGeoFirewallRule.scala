...
case class CreateGeoFirewallRule(
  /* 1 = Block,  0 = Whitelist */
  @named("xdp_action") xdp_action: CreateGeoFirewallRuleEnums.XdpAction,
  ...
  @named("country_code") country_code: Option[Int] = scala.None,
  /* ASN number */
  @named("asn") asn: Option[Int] = scala.None
)
...
end CreateGeoFirewallRuleEnums
