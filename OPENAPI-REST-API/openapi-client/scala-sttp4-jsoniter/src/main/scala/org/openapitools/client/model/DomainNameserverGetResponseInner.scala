...
case class DomainNameserverGetResponseInner(
  ...
  @named("can_delete") can_delete: DomainNameserverGetResponseInnerEnums.CanDelete
)
...
object DomainNameserverGetResponseInnerEnums:
  ...
  object CanDelete:
    ...
    given canDeleteCodec: JsonValueCodec[CanDelete] = JsonCodecMaker.make {
      CodecMakerConfig
...
end DomainNameserverGetResponseInnerEnums
