...
case class PostOauthCallback200Response(
  ...
  @named("login") login: Option[Boolean] = scala.None,
  /* Whether a new account was created. */
  @named("signup") signup: Option[Boolean] = scala.None,
  /* Whether the OAuth provider was linked to an existing account. */
  @named("linked") linked: Option[Boolean] = scala.None,
  /* The account ID associated with the OAuth login. */
  @named("account_id") account_id: Option[Int] = scala.None,
  /* Error code if additional verification is needed (e.g. `2fa_required`). */
  @named("error_code") error_code: Option[String] = scala.None
)
