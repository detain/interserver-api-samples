...
case class MailDeliverabilityResponse(
  ...
  @named("stat") stat: Option[io.circe.Json] = scala.None,
  /* Bounce percentage. */
  @named("percent") percent: Option[Double] = scala.None,
  /* Detailed deliverability breakdown by sender or domain. */
  @named("table_data") table_data: Option[Seq[Seq[String]]] = scala.None
)
