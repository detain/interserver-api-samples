...
case class DnsRecord(
  ...
  @named("domain_id") domain_id: String,
  @named("name") name: String,
  @named("type") `type`: DnsRecordType,
  /* The content of the record, such as the IP address or hsotname. */
  @named("content") content: String,
  /* Time To Live (seconds) */
  @named("ttl") ttl: String,
  /* Priority */
  @named("prio") prio: String,
  @named("disabled") disabled: String,
  /* Alternate name to use for sorting */
  @named("ordername") ordername: String,
  @named("auth") auth: String
)
