...
case class VpsDALicense(
  ...
  @named("sub_name") sub_name: Option[String] = scala.None,
  /* Monthly cost in cents. */
  @named("cost") cost: Option[Int] = scala.None,
  /* Image path for the disabled state icon. */
  @named("img_disabled") img_disabled: Option[String] = scala.None,
  /* Image path for the active state icon. */
  @named("img_active") img_active: Option[String] = scala.None
)
