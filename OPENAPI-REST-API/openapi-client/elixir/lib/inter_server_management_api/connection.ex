...
defmodule InterServerManagementAPI.Connection do
  @moduledoc """
  Handle Tesla connections for InterServerManagementAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, InterServerManagementAPI.Connection,
        base_url: "https://my.interserver.net/apiv2",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :inter_server_management_api,
        :base_url, "https://my.interserver.net/apiv2"
  """
  ...
  @doc """
  Configure a InterServerManagementAPI client.

  ### Parameters

  - `options`: an optional keyword list of InterServerManagementAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:inter_server_management_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - InterServerManagementAPI 1.0.0 - elixir"
        )
      )
