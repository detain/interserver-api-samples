...
defmodule InterServerManagementAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    InterServerManagementAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    InterServerManagementAPI.Deserializer.json_decode(body, module)
  end
end
