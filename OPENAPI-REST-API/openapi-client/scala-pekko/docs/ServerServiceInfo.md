...
**server_discount** | **AnyType** | Discount information for the server. |  [optional]
...
**server_location** | **AnyType** | The location of the server. |  [optional]
...
**server_dedicated_hd2** | **AnyType** | The size of the second dedicated hard drive. |  [optional]
...
**server_dedicated_cp** | **AnyType** | The control panel of the server. |  [optional]
