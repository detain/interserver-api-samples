...
**server_discount** | **mixed** | Discount information for the server. | [optional]
...
**server_location** | **mixed** | The location of the server. | [optional]
...
**server_dedicated_hd2** | **mixed** | The size of the second dedicated hard drive. | [optional]
...
**server_dedicated_cp** | **mixed** | The control panel of the server. | [optional]
