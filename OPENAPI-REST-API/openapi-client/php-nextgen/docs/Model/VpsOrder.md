...
**platform_packages** | [**\OpenAPI\Client\Model\VpsOrderPlatformPackages**](VpsOrderPlatformPackages.md) |  |
**platform_names** | [**\OpenAPI\Client\Model\VpsOrderPlatformNames**](VpsOrderPlatformNames.md) |  |
**package_costs** | [**\OpenAPI\Client\Model\VpsOrderPackageCosts**](VpsOrderPackageCosts.md) |  |
**location_stock** | [**\OpenAPI\Client\Model\VpsOrderLocationStock**](VpsOrderLocationStock.md) |  |
**location_names** | [**\OpenAPI\Client\Model\VpsOrderLocationNames**](VpsOrderLocationNames.md) |  |
**os_names** | [**\OpenAPI\Client\Model\VpsOrderOsNames**](VpsOrderOsNames.md) |  |
**templates** | [**\OpenAPI\Client\Model\VpsOrderTemplates**](VpsOrderTemplates.md) |  |
**service_types** | [**\OpenAPI\Client\Model\VpsOrderServiceTypes**](VpsOrderServiceTypes.md) |  |
