...
```php
addServer(): \OpenAPI\Client\Model\AddServer200Response
```
...
[**\OpenAPI\Client\Model\AddServer200Response**](../Model/AddServer200Response.md)
...
```php
updateServerInfo($id): \OpenAPI\Client\Model\SuccessTextResponse
```
