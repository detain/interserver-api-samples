...
```php
addWebsite(): \OpenAPI\Client\Model\ServiceOrderPostResponse
```
...
$apiInstance = new OpenAPI\Client\Api\WebhostingApi(
...
```php
getNewWebsite(): \OpenAPI\Client\Model\WebsitesOrder
```
...
[**\OpenAPI\Client\Model\WebsitesOrder**](../Model/WebsitesOrder.md)
...
```php
getWebsiteBuyIp($id): \OpenAPI\Client\Model\GetWebsiteBuyIp200Response
```
...
[**\OpenAPI\Client\Model\GetWebsiteBuyIp200Response**](../Model/GetWebsiteBuyIp200Response.md)
...
```php
getWebsiteInfo($id): \OpenAPI\Client\Model\Website
```
...
```php
getWebsiteInvoices($id): \OpenAPI\Client\Model\ChargeInvoiceRows
```
...
```php
getWebsiteList(): \OpenAPI\Client\Model\WebsiteRow[]
```
...
[**\OpenAPI\Client\Model\WebsiteRow[]**](../Model/WebsiteRow.md)
...
```php
getWebsitesBackups($id): \OpenAPI\Client\Model\WebsiteBackups
```
...
[**\OpenAPI\Client\Model\WebsiteBackups**](../Model/WebsiteBackups.md)
...
```php
getWebsitesLogin($id): \OpenAPI\Client\Model\WebsiteLoginResponse
```
...
[**\OpenAPI\Client\Model\WebsiteLoginResponse**](../Model/WebsiteLoginResponse.md)
...
```php
getWebsitesWelcomeEmail($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
gettWebsiteReverseDns($id): \OpenAPI\Client\Model\ReverseDnsEntries
```
...
```php
postWebsiteBuyIp($id, $post_website_buy_ip_request): \OpenAPI\Client\Model\PostWebsiteBuyIp200Response
```
...
$id = 56; // int | The website service ID. Use `website_id` from `GET /websites`.
$post_website_buy_ip_request = new \OpenAPI\Client\Model\PostWebsiteBuyIpRequest(); // \OpenAPI\Client\Model\PostWebsiteBuyIpRequest

try {
    $result = $apiInstance->postWebsiteBuyIp($id, $post_website_buy_ip_request);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | |
| **post_website_buy_ip_request** | [**\OpenAPI\Client\Model\PostWebsiteBuyIpRequest**](../Model/PostWebsiteBuyIpRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\PostWebsiteBuyIp200Response**](../Model/PostWebsiteBuyIp200Response.md)
...
```php
postWebsiteMigration($id, $post_website_migration_request): \OpenAPI\Client\Model\PostWebsiteMigration200Response
```
...
$id = 56; // int | The website service ID. Use `website_id` from `GET /websites`.
$post_website_migration_request = new \OpenAPI\Client\Model\PostWebsiteMigrationRequest(); // \OpenAPI\Client\Model\PostWebsiteMigrationRequest

try {
    $result = $apiInstance->postWebsiteMigration($id, $post_website_migration_request);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| The website service ID. Use &#x60;website_id&#x60; from &#x60;GET /websites&#x60;. | |
| **post_website_migration_request** | [**\OpenAPI\Client\Model\PostWebsiteMigrationRequest**](../Model/PostWebsiteMigrationRequest.md)|  | |

### Return type

[**\OpenAPI\Client\Model\PostWebsiteMigration200Response**](../Model/PostWebsiteMigration200Response.md)
...
```php
postWebsitesReverseDns($id, $reverse_dns_entries): \OpenAPI\Client\Model\TextResponse
```
...
try {
    $result = $apiInstance->postWebsitesReverseDns($id, $reverse_dns_entries);
    print_r($result);
} catch (Exception $e) {
...
```php
updateWebsiteInfo($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
webhostingCancel($id): \OpenAPI\Client\Model\WebhostingCancel200Response
```
...
[**\OpenAPI\Client\Model\WebhostingCancel200Response**](../Model/WebhostingCancel200Response.md)
