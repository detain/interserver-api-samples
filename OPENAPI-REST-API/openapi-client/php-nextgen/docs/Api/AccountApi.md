...
```php
deleteIpLimit($ip_limit_range): \OpenAPI\Client\Model\GenericResponse
```
...
$ip_limit_range = new \OpenAPI\Client\Model\IpLimitRange(); // \OpenAPI\Client\Model\IpLimitRange

try {
    $result = $apiInstance->deleteIpLimit($ip_limit_range);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **ip_limit_range** | [**\OpenAPI\Client\Model\IpLimitRange**](../Model/IpLimitRange.md)|  | [optional] |
...
```php
updateAccountInfo($name, $address, $city, $state, $zip, $country, $phone, $company, $address2, $locale, $email_invoices, $email_abuse, $disable_reset, $disable_reinstall, $disable_server_notifications, $disable_email_notifications, $gstin): \OpenAPI\Client\Model\SuccessTextResponse
```
...
try {
    $result = $apiInstance->updateAccountInfo($name, $address, $city, $state, $zip, $country, $phone, $company, $address2, $locale, $email_invoices, $email_abuse, $disable_reset, $disable_reinstall, $disable_server_notifications, $disable_email_notifications, $gstin);
    print_r($result);
} catch (Exception $e) {
...
```php
updateAccountIpLimits($start, $end): \OpenAPI\Client\Model\SuccessTextResponse
```
