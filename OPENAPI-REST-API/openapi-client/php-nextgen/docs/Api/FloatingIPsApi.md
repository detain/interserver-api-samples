...
$apiInstance = new OpenAPI\Client\Api\FloatingIPsApi(
...
```php
floatingIpsCancel($id): \OpenAPI\Client\Model\FloatingIpsCancel200Response
```
...
[**\OpenAPI\Client\Model\FloatingIpsCancel200Response**](../Model/FloatingIpsCancel200Response.md)
...
```php
getFloatingIpInvoices($id): \OpenAPI\Client\Model\ChargeInvoiceRows
```
...
```php
getFloatingIpsWelcomeEmail($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
postFloatingIpsChangeIp($id, $ip): \OpenAPI\Client\Model\SuccessTextResponse
```
