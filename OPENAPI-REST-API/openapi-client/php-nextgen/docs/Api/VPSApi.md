...
```php
addVps($vps_order_post_request): \OpenAPI\Client\Model\ServiceOrderPostResponse
```
...
$apiInstance = new OpenAPI\Client\Api\VPSApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$vps_order_post_request = new \OpenAPI\Client\Model\VpsOrderPostRequest(); // \OpenAPI\Client\Model\VpsOrderPostRequest

try {
    $result = $apiInstance->addVps($vps_order_post_request);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **vps_order_post_request** | [**\OpenAPI\Client\Model\VpsOrderPostRequest**](../Model/VpsOrderPostRequest.md)|  | [optional] |
...
```php
deleteVpsBackup($id, $file, $all): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
doVpsBlockSmtp($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsDisableCd($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsDisableQuota($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsEjectCd($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsEnableQuota($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsRestart($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsStart($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
doVpsStop($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
downloadVpsBackup($id, $download_qs_backup_request, $all): \OpenAPI\Client\Model\DownloadQsBackup200Response
```
...
try {
    $result = $apiInstance->downloadVpsBackup($id, $download_qs_backup_request, $all);
    print_r($result);
} catch (Exception $e) {
...
```php
getNewVps(): \OpenAPI\Client\Model\VpsOrder
```
...
[**\OpenAPI\Client\Model\VpsOrder**](../Model/VpsOrder.md)
...
```php
getVpsBackups($id, $all): \OpenAPI\Client\Model\VpsBackupRows
```
...
```php
getVpsInfo($id): \OpenAPI\Client\Model\Vps
```
...
[**\OpenAPI\Client\Model\Vps**](../Model/Vps.md)
...
```php
getVpsInvoices($id): \OpenAPI\Client\Model\ChargeInvoiceRows
```
...
```php
getVpsList(): \OpenAPI\Client\Model\VpsRow[]
```
...
[**\OpenAPI\Client\Model\VpsRow[]**](../Model/VpsRow.md)
...
```php
getVpsReinstallOs($id): \OpenAPI\Client\Model\VpsTemplatesList
```
...
```php
getVpsReverseDns($id): \OpenAPI\Client\Model\ReverseDnsEntries
```
...
```php
getVpsTrafficUsage($id): \OpenAPI\Client\Model\VpsTrafficResponse
```
...
[**\OpenAPI\Client\Model\VpsTrafficResponse**](../Model/VpsTrafficResponse.md)
...
```php
getVpsWelcomeEmail($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
postVpsBackup($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsChangeHostname($id, $hostname): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsChangeRootPassword($id, $password): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsChangeTimezone($id, $timezone): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsChangeWebuzoPassword($id, $password): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsInsertCd($id, $url): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsReinstallOs($id, $template, $local_password, $password): \OpenAPI\Client\Model\QueueResponse
```
...
$local_password = 'local_password_example'; // string | Password for this account.
$password = 'password_example'; // string | Password for Root / Administrator Account.

try {
    $result = $apiInstance->postVpsReinstallOs($id, $template, $local_password, $password);
    print_r($result);
} catch (Exception $e) {
...
```php
postVpsResetPassword($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
postVpsRestore($id, $restore_request): \OpenAPI\Client\Model\QueueResponse
```
...
$id = 56; // int | VPS ID number
$restore_request = new \OpenAPI\Client\Model\RestoreRequest(); // \OpenAPI\Client\Model\RestoreRequest | VPS Restore request

try {
    $result = $apiInstance->postVpsRestore($id, $restore_request);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| VPS ID number | |
| **restore_request** | [**\OpenAPI\Client\Model\RestoreRequest**](../Model/RestoreRequest.md)| VPS Restore request | |
...
```php
postVpsReverseDns($id, $reverse_dns_entries): \OpenAPI\Client\Model\TextResponse
```
...
try {
    $result = $apiInstance->postVpsReverseDns($id, $reverse_dns_entries);
    print_r($result);
} catch (Exception $e) {
...
```php
postVpsSetupVnc($id): \OpenAPI\Client\Model\QueueResponse
```
...
```php
putVps($vps_order_put_request): \OpenAPI\Client\Model\VpsOrderPutResponse
```
...
$vps_order_put_request = new \OpenAPI\Client\Model\VpsOrderPutRequest(); // \OpenAPI\Client\Model\VpsOrderPutRequest

try {
    $result = $apiInstance->putVps($vps_order_put_request);
    print_r($result);
} catch (Exception $e) {
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **vps_order_put_request** | [**\OpenAPI\Client\Model\VpsOrderPutRequest**](../Model/VpsOrderPutRequest.md)|  | [optional] |

### Return type

[**\OpenAPI\Client\Model\VpsOrderPutResponse**](../Model/VpsOrderPutResponse.md)
...
```php
updateVpsInfo($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
vPSCancel($id): \OpenAPI\Client\Model\VPSCancel200Response
```
...
[**\OpenAPI\Client\Model\VPSCancel200Response**](../Model/VPSCancel200Response.md)
