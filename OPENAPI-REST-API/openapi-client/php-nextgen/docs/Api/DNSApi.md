...
try {
    $apiInstance->deleteDnsRecord($domain_id, $record_id);
} catch (Exception $e) {
...
```php
updateDnsRecord($domain_id, $record_id, $name, $type, $content, $ttl, $prio, $disabled, $ordername, $auth)
```
...
try {
    $apiInstance->updateDnsRecord($domain_id, $record_id, $name, $type, $content, $ttl, $prio, $disabled, $ordername, $auth);
} catch (Exception $e) {
