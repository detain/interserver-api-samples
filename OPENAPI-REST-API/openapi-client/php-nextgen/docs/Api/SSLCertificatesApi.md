...
```php
addSsl(): \OpenAPI\Client\Model\ServiceOrderPostResponse
```
...
```php
getSslInvoices($id): \OpenAPI\Client\Model\ChargeInvoiceRows
```
...
```php
getSslWelcomeEmail($id): \OpenAPI\Client\Model\SuccessTextResponse
```
...
```php
sslCancel($id): \OpenAPI\Client\Model\SslCancel200Response
```
...
[**\OpenAPI\Client\Model\SslCancel200Response**](../Model/SslCancel200Response.md)
...
```php
updateSslInfo($id): \OpenAPI\Client\Model\SuccessTextResponse
```
