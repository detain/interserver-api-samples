...
```php
addNewTicket($ticket_new): \OpenAPI\Client\Model\TicketNewResponse
```
...
$ticket_new = new \OpenAPI\Client\Model\TicketNew(); // \OpenAPI\Client\Model\TicketNew

try {
    $result = $apiInstance->addNewTicket($ticket_new);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **ticket_new** | [**\OpenAPI\Client\Model\TicketNew**](../Model/TicketNew.md)|  | |

### Return type

[**\OpenAPI\Client\Model\TicketNewResponse**](../Model/TicketNewResponse.md)
...
```php
closeTicket($id): \OpenAPI\Client\Model\CloseTicketResponseSchema
```
...
[**\OpenAPI\Client\Model\CloseTicketResponseSchema**](../Model/CloseTicketResponseSchema.md)
...
```php
deleteTicketInfo($id): \OpenAPI\Client\Model\ViewTicketResponse
```
...
[**\OpenAPI\Client\Model\ViewTicketResponse**](../Model/ViewTicketResponse.md)
...
```php
getTicketInfo($id): \OpenAPI\Client\Model\ViewTicketResponse
```
...
```php
getTicketsList($page, $period, $view): \OpenAPI\Client\Model\Tickets
```
...
[**\OpenAPI\Client\Model\Tickets**](../Model/Tickets.md)
...
```php
postTicketInfo($id): \OpenAPI\Client\Model\ViewTicketResponse
```
...
```php
postTicketsList(): \OpenAPI\Client\Model\Tickets
```
...
```php
putTicketInfo($id): \OpenAPI\Client\Model\ViewTicketResponse
```
...
```php
replyTicket($id, $reply_ticket_request): \OpenAPI\Client\Model\ReplyTicketResponseSchema
```
...
$reply_ticket_request = new \OpenAPI\Client\Model\ReplyTicketRequest(); // \OpenAPI\Client\Model\ReplyTicketRequest

try {
    $result = $apiInstance->replyTicket($id, $reply_ticket_request);
    print_r($result);
} catch (Exception $e) {
...
| **reply_ticket_request** | [**\OpenAPI\Client\Model\ReplyTicketRequest**](../Model/ReplyTicketRequest.md)|  | [optional] |

### Return type

[**\OpenAPI\Client\Model\ReplyTicketResponseSchema**](../Model/ReplyTicketResponseSchema.md)
...
```php
updateTicketInfo($id, $update_ticket): \OpenAPI\Client\Model\UpdateTicketResponseSchema
```
...
$id = 3.4; // float | The ticket ID number.
$update_ticket = new \OpenAPI\Client\Model\UpdateTicket(); // \OpenAPI\Client\Model\UpdateTicket

try {
    $result = $apiInstance->updateTicketInfo($id, $update_ticket);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **float**| The ticket ID number. | |
| **update_ticket** | [**\OpenAPI\Client\Model\UpdateTicket**](../Model/UpdateTicket.md)|  | [optional] |

### Return type

[**\OpenAPI\Client\Model\UpdateTicketResponseSchema**](../Model/UpdateTicketResponseSchema.md)
