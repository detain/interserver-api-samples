...
class WebsiteClientLink implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'WebsiteClientLink';
    ...
    */
     ...
     * Sets icon_text
     *
     * @param string|null $icon_text Icon text for the link
     *
     * @return $this
     */
     ...
     * Sets help_text
     *
     * @param string|null $help_text Help text for the link
     *
     * @return $this
     */
     ...
     * Sets other_attr
     *
     * @param string|null $other_attr Other attributes for the link
     *
     * @return $this
     */
