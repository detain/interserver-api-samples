...
class GetOrderDetail200ResponsePackageCosts implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'getOrderDetail_200_response_packageCosts';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('package_cost', $data ?? [], null);
     ...
     * @return float|null
     */
    public function getPackageId(): ?float
    {
     ...
     * @return $this
     */
    public function setPackageId(?float $package_id): static
    {
     ...
     * @return float|null
     */
    public function getPackageCost(): ?float
    {
     ...
     * Sets package_cost
     *
     * @param float|null $package_cost package_cost
     *
     * @return $this
     */
    public function setPackageCost(?float $package_cost): static
    {
        if (is_null($package_cost)) {
            throw new InvalidArgumentException('non-nullable package_cost cannot be null');
        }
