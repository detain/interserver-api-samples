...
/**
 * ServerOrderConfigIds Class Doc Comment
 *
 ...
 */
class ServerOrderConfigIds implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ServerOrderConfigIds';
    ...
    */
     ...
     * Sets memory
     *
     * @param int|null $memory Memory configuration ID for the server order.
     *
     * @return $this
     */
     ...
     * Sets bandwidth
     *
     * @param string|null $bandwidth Bandwidth configuration ID for the server order.
     *
     * @return $this
     */
     ...
     * Sets ips
     *
     * @param string|null $ips IPs configuration ID for the server order.
     *
     * @return $this
     */
     ...
     * Sets os
     *
     * @param string|null $os Operating System configuration ID for the server order.
     *
     * @return $this
     */
     ...
     * Sets cp
     *
     * @param int|null $cp Control Panel configuration ID for the server order.
     *
     * @return $this
     */
     ...
     * Sets raid
     *
     * @param string|null $raid RAID configuration ID for the server order.
     *
     * @return $this
     */
    public function setRaid(?string $raid): static
    {
        if (is_null($raid)) {
     ...
     * Sets hd
     *
     * @param string|null $hd Hard Drives configuration ID for the server order.
     *
     * @return $this
     */
