...
class VpsClientLink implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'VpsClientLink';
     ...
     * Sets icon_text
     *
     * @param string|null $icon_text Icon text label.
     *
     * @return $this
     */
     ...
     * Sets help_text
     *
     * @param string|null $help_text Help tooltip text for the link.
     *
     * @return $this
     */
