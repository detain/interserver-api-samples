...
/**
 * VpsTrafficTotalsSectionResponse Class Doc Comment
 *
 ...
 */
class VpsTrafficTotalsSectionResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'VpsTrafficTotalsSectionResponse';
    ...
    */
     ...
     * @return $this
     */
    public function setIn(int $in): static
    {
        if (is_null($in)) {
     ...
     * @return $this
     */
    public function setOut(int $out): static
    {
        if (is_null($out)) {
