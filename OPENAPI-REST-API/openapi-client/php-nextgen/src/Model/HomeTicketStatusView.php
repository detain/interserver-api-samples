...
/**
 * HomeTicketStatusView Class Doc Comment
 *
 ...
 */
class HomeTicketStatusView implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'Home_ticketStatusView';
     ...
     * Sets _4
     *
     * @param string|null $_4 Status corresponding to view number 4.
     *
     * @return $this
     */
    public function set4(?string $_4): static
    {
        if (is_null($_4)) {
     ...
     * Sets _5
     *
     * @param string|null $_5 Status corresponding to view number 5.
     *
     * @return $this
     */
    public function set5(?string $_5): static
    {
        if (is_null($_5)) {
     ...
     * Sets _6
     *
     * @param string|null $_6 Status corresponding to view number 6.
     *
     * @return $this
     */
    public function set6(?string $_6): static
    {
        if (is_null($_6)) {
