...
class DomainDnssecRecordsInner implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DomainDnssecRecords_inner';
     ...
     * Sets digest_type
     *
     * @param string|null $digest_type digest_type
     *
     * @return $this
     */
    public function setDigestType(?string $digest_type): static
    {
     ...
     * Sets key_tag
     *
     * @param string|null $key_tag key_tag
     *
     * @return $this
     */
    public function setKeyTag(?string $key_tag): static
    {
        if (is_null($key_tag)) {
