...
class DomainOrderResponseAttributes implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DomainOrderResponse_attributes';
    ...
    */
     ...
     * Sets admin_email
     *
     * @param string|null $admin_email Administrative contact email provided for the order.
     *
     * @return $this
     */
