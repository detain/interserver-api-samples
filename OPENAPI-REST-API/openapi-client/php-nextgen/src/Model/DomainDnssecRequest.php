...
class DomainDnssecRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DomainDnssecRequest';
    ...
    */
     ...
     * @return $this
     */
    public function setAlgorithm(?array $algorithm): static
    {
     ...
     * @return int[]|null
     */
    public function getDigestType(): ?array
    {
     ...
     * Sets digest_type
     *
     * @param int[]|null $digest_type List of digest type IDs for each record.
     *
     * @return $this
     */
    public function setDigestType(?array $digest_type): static
    {
     ...
     * @return $this
     */
    public function setDigest(?array $digest): static
    {
        if (is_null($digest)) {
     ...
     * @return int[]|null
     */
    public function getKeyTag(): ?array
    {
     ...
     * Sets key_tag
     *
     * @param int[]|null $key_tag List of key tag values corresponding to each record.
     *
     * @return $this
     */
    public function setKeyTag(?array $key_tag): static
    {
        if (is_null($key_tag)) {
