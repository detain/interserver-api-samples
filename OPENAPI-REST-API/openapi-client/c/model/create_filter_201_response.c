...
#include <string.h>
#include <stdio.h>
#include "create_filter_201_response.h"
...
void create_filter_201_response_free(create_filter_201_response_t *create_filter_201_response) {
    if(NULL == create_filter_201_response){
        return ;
    }
    if(create_filter_201_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_filter_201_response_free");
        return ;
    }
    ...
    free(create_filter_201_response);
}

cJSON *create_filter_201_response_convertToJSON(create_filter_201_response_t *create_filter_201_response) {
    ...
    if(create_filter_201_response->text) {
    if(cJSON_AddStringToObject(item, "text", create_filter_201_response->text) == NULL) {
    goto fail; //String
    }
    }
...
create_filter_201_response_t *create_filter_201_response_parseFromJSON(cJSON *create_filter_201_responseJSON){
    ...
    // create_filter_201_response->text
    cJSON *text = cJSON_GetObjectItemCaseSensitive(create_filter_201_responseJSON, "text");
