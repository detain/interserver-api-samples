...
static home_details_modules_licenses_t *home_details_modules_licenses_create_internal(
    ...
    memset(home_details_modules_licenses_local_var, 0, sizeof(home_details_modules_licenses_t));
...
__attribute__((deprecated)) home_details_modules_licenses_t *home_details_modules_licenses_create(
    ...
    home_details_modules_licenses_t *result = home_details_modules_licenses_create_internal (
        icon,
        view_link,
        heading,
        buy_link,
