/*
 * scrub_ips_delete_rule_500_response.h
 *
 * 
 */

#ifndef _scrub_ips_delete_rule_500_response_H_
#define _scrub_ips_delete_rule_500_response_H_
...
typedef struct scrub_ips_delete_rule_500_response_t scrub_ips_delete_rule_500_response_t;




typedef struct scrub_ips_delete_rule_500_response_t {
    int success; //boolean
    char *text; // string

    int _library_owned; // Is the library responsible for freeing this object?
} scrub_ips_delete_rule_500_response_t;
...
#endif /* _scrub_ips_delete_rule_500_response_H_ */
