...
static licenses_order_service_types11482_t *licenses_order_service_types11482_create_internal(
    ...
    memset(licenses_order_service_types11482_local_var, 0, sizeof(licenses_order_service_types11482_t));
...
__attribute__((deprecated)) licenses_order_service_types11482_t *licenses_order_service_types11482_create(
    ...
    licenses_order_service_types11482_t *result = licenses_order_service_types11482_create_internal (
        services_id,
        services_name,
        services_cost,
        services_category,
