/*
 * server_order_bandwidth_li.h
 *
 * Bandwidth options for the server order.
 */

#ifndef _server_order_bandwidth_li_H_
#define _server_order_bandwidth_li_H_
...
typedef struct server_order_bandwidth_li_t server_order_bandwidth_li_t;

#include "server_order_bandwidth.h"



typedef struct server_order_bandwidth_li_t {
    struct server_order_bandwidth_t *_15; //model

    int _library_owned; // Is the library responsible for freeing this object?
} server_order_bandwidth_li_t;
...
#endif /* _server_order_bandwidth_li_H_ */
