...
static mail_tutorials_table_row_t *mail_tutorials_table_row_create_internal(
    ...
    memset(mail_tutorials_table_row_local_var, 0, sizeof(mail_tutorials_table_row_t));
...
__attribute__((deprecated)) mail_tutorials_table_row_t *mail_tutorials_table_row_create(
    ...
    mail_tutorials_table_row_t *result = mail_tutorials_table_row_create_internal (
        desc,
        value
        );
    if (!result) {
