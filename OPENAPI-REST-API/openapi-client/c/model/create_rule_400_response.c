...
#include <string.h>
#include <stdio.h>
#include "create_rule_400_response.h"
...
static create_rule_400_response_t *create_rule_400_response_create_internal(
    ...
    create_rule_400_response_t *create_rule_400_response_local_var = malloc(sizeof(create_rule_400_response_t));
...
void create_rule_400_response_free(create_rule_400_response_t *create_rule_400_response) {
    if(NULL == create_rule_400_response){
        return ;
    }
    if(create_rule_400_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "create_rule_400_response_free");
        return ;
    }
    ...
    if (create_rule_400_response->errors) {
        list_ForEach(listEntry, create_rule_400_response->errors) {
            free(listEntry->data);
        }
        list_freeList(create_rule_400_response->errors);
        create_rule_400_response->errors = NULL;
    }
    free(create_rule_400_response);
}

cJSON *create_rule_400_response_convertToJSON(create_rule_400_response_t *create_rule_400_response) {
    ...
    if(create_rule_400_response->text) {
    if(cJSON_AddStringToObject(item, "text", create_rule_400_response->text) == NULL) {
    goto fail; //String
    }
    }


    // create_rule_400_response->errors
    if(create_rule_400_response->errors) {
    ...
    list_ForEach(errorsListEntry, create_rule_400_response->errors) {
...
create_rule_400_response_t *create_rule_400_response_parseFromJSON(cJSON *create_rule_400_responseJSON){
    ...
    // create_rule_400_response->success
    cJSON *success = cJSON_GetObjectItemCaseSensitive(create_rule_400_responseJSON, "success");
    ...
    *success_local_var = success->valueint;
    ...
    // create_rule_400_response->text
    cJSON *text = cJSON_GetObjectItemCaseSensitive(create_rule_400_responseJSON, "text");
    ...
    // create_rule_400_response->errors
    cJSON *errors = cJSON_GetObjectItemCaseSensitive(create_rule_400_responseJSON, "errors");
