...
static quickserver_order_templates_t *quickserver_order_templates_create_internal(
    ...
    memset(quickserver_order_templates_local_var, 0, sizeof(quickserver_order_templates_t));
...
__attribute__((deprecated)) quickserver_order_templates_t *quickserver_order_templates_create(
    ...
    quickserver_order_templates_t *result = quickserver_order_templates_create_internal (
        ubuntu
        );
    if (!result) {
    }
