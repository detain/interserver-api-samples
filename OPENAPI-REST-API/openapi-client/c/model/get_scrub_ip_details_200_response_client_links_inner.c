...
static get_scrub_ip_details_200_response_client_links_inner_t *get_scrub_ip_details_200_response_client_links_inner_create_internal(
    ...
    memset(get_scrub_ip_details_200_response_client_links_inner_local_var, 0, sizeof(get_scrub_ip_details_200_response_client_links_inner_t));
...
__attribute__((deprecated)) get_scrub_ip_details_200_response_client_links_inner_t *get_scrub_ip_details_200_response_client_links_inner_create(
    ...
    get_scrub_ip_details_200_response_client_links_inner_t *result = get_scrub_ip_details_200_response_client_links_inner_create_internal (
        label,
        link,
        icon,
        icon_text,
