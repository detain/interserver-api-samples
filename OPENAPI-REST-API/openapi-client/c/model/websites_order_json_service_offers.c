...
static websites_order_json_service_offers_t *websites_order_json_service_offers_create_internal(
    list_t *_1026
    ) {
    websites_order_json_service_offers_t *websites_order_json_service_offers_local_var = malloc(sizeof(websites_order_json_service_offers_t));
...
void websites_order_json_service_offers_free(websites_order_json_service_offers_t *websites_order_json_service_offers) {
    if(NULL == websites_order_json_service_offers){
        return ;
    }
    if(websites_order_json_service_offers->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "websites_order_json_service_offers_free");
        return ;
    }
    listEntry_t *listEntry;
    if (websites_order_json_service_offers->_1026) {
        list_ForEach(listEntry, websites_order_json_service_offers->_1026) {
            websites_order_json_service_offers_item_free(listEntry->data);
        }
        list_freeList(websites_order_json_service_offers->_1026);
        websites_order_json_service_offers->_1026 = NULL;
    }
    free(websites_order_json_service_offers);
}
...
cJSON *websites_order_json_service_offers_convertToJSON(websites_order_json_service_offers_t *websites_order_json_service_offers) {
    ...
    // websites_order_json_service_offers->_1026
    if (!websites_order_json_service_offers->_1026) {
        goto fail;
    }
    ...
    if (websites_order_json_service_offers->_1026) {
    list_ForEach(_1026ListEntry, websites_order_json_service_offers->_1026) {
    cJSON *itemLocal = websites_order_json_service_offers_item_convertToJSON(_1026ListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
websites_order_json_service_offers_t *websites_order_json_service_offers_parseFromJSON(cJSON *websites_order_json_service_offersJSON){
    ...
    websites_order_json_service_offers_t *websites_order_json_service_offers_local_var = NULL;

    // define the local list for websites_order_json_service_offers->_1026
    list_t *_1026List = NULL;

    // websites_order_json_service_offers->_1026
    cJSON *_1026 = cJSON_GetObjectItemCaseSensitive(websites_order_json_service_offersJSON, "1026");
    ...
    cJSON_ArrayForEach(_1026_local_nonprimitive,_1026 )
    {
        ...
        websites_order_json_service_offers_item_t *_1026Item = websites_order_json_service_offers_item_parseFromJSON(_1026_local_nonprimitive);
