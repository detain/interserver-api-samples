...
static home_details_modules_vps_t *home_details_modules_vps_create_internal(
    ...
    memset(home_details_modules_vps_local_var, 0, sizeof(home_details_modules_vps_t));
...
__attribute__((deprecated)) home_details_modules_vps_t *home_details_modules_vps_create(
    ...
    home_details_modules_vps_t *result = home_details_modules_vps_create_internal (
        icon,
        view_link,
        heading,
        buy_link,
