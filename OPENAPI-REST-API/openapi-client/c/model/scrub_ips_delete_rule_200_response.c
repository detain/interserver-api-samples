...
#include <string.h>
#include <stdio.h>
#include "scrub_ips_delete_rule_200_response.h"
...
void scrub_ips_delete_rule_200_response_free(scrub_ips_delete_rule_200_response_t *scrub_ips_delete_rule_200_response) {
    if(NULL == scrub_ips_delete_rule_200_response){
        return ;
    }
    if(scrub_ips_delete_rule_200_response->_library_owned != 1){
        fprintf(stderr, "WARNING: %s() does NOT free objects allocated by the user\n", "scrub_ips_delete_rule_200_response_free");
        return ;
    }
    ...
    free(scrub_ips_delete_rule_200_response);
}

cJSON *scrub_ips_delete_rule_200_response_convertToJSON(scrub_ips_delete_rule_200_response_t *scrub_ips_delete_rule_200_response) {
    ...
    if(scrub_ips_delete_rule_200_response->text) {
    if(cJSON_AddStringToObject(item, "text", scrub_ips_delete_rule_200_response->text) == NULL) {
    goto fail; //String
    }
    }
...
scrub_ips_delete_rule_200_response_t *scrub_ips_delete_rule_200_response_parseFromJSON(cJSON *scrub_ips_delete_rule_200_responseJSON){
    ...
    // scrub_ips_delete_rule_200_response->text
    cJSON *text = cJSON_GetObjectItemCaseSensitive(scrub_ips_delete_rule_200_responseJSON, "text");
