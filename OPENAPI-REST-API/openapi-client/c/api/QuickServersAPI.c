...
// Functions for enum ALL for QuickServersAPI_deleteQsBackup

static char* deleteQsBackup_ALL_ToString(interserver_management_api_deleteQsBackup_all_e ALL){
    char *ALLArray[] =  { "NULL", "0", "1" };
    return ALLArray[ALL];
}

static interserver_management_api_deleteQsBackup_all_e deleteQsBackup_ALL_FromString(char* ALL){
...
/*
// Function deleteQsBackup_ALL_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *deleteQsBackup_ALL_convertToJSON(interserver_management_api_deleteQsBackup_all_e ALL) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "all", deleteQsBackup_ALL_ToString(ALL)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function deleteQsBackup_ALL_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static interserver_management_api_deleteQsBackup_all_e deleteQsBackup_ALL_parseFromJSON(cJSON* ALLJSON) {
    interserver_management_api_deleteQsBackup_all_e ALLVariable = 0;
    cJSON *ALLVar = cJSON_GetObjectItemCaseSensitive(ALLJSON, "all");
    if(!cJSON_IsString(ALLVar) || (ALLVar->valuestring == NULL))
    {
        goto end;
    }
    ALLVariable = deleteQsBackup_ALL_FromString(ALLVar->valuestring);
    return ALLVariable;
end:
    return 0;
}
...
// Functions for enum ALL for QuickServersAPI_downloadQsBackup

static char* downloadQsBackup_ALL_ToString(interserver_management_api_downloadQsBackup_all_e ALL){
    char *ALLArray[] =  { "NULL", "0", "1" };
    return ALLArray[ALL];
}

static interserver_management_api_downloadQsBackup_all_e downloadQsBackup_ALL_FromString(char* ALL){
    int stringToReturn = 0;
    char *ALLArray[] =  { "NULL", "0", "1" };
    size_t sizeofArray = sizeof(ALLArray) / sizeof(ALLArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function downloadQsBackup_ALL_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *downloadQsBackup_ALL_convertToJSON(interserver_management_api_downloadQsBackup_all_e ALL) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "all", downloadQsBackup_ALL_ToString(ALL)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function downloadQsBackup_ALL_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static interserver_management_api_downloadQsBackup_all_e downloadQsBackup_ALL_parseFromJSON(cJSON* ALLJSON) {
    interserver_management_api_downloadQsBackup_all_e ALLVariable = 0;
    cJSON *ALLVar = cJSON_GetObjectItemCaseSensitive(ALLJSON, "all");
    if(!cJSON_IsString(ALLVar) || (ALLVar->valuestring == NULL))
    {
        goto end;
    }
    ALLVariable = downloadQsBackup_ALL_FromString(ALLVar->valuestring);
    return ALLVariable;
end:
    return 0;
}
...
// Functions for enum ALL for QuickServersAPI_getQsBackups

static char* getQsBackups_ALL_ToString(interserver_management_api_getQsBackups_all_e ALL){
    char *ALLArray[] =  { "NULL", "0", "1" };
    return ALLArray[ALL];
}

static interserver_management_api_getQsBackups_all_e getQsBackups_ALL_FromString(char* ALL){
    int stringToReturn = 0;
    char *ALLArray[] =  { "NULL", "0", "1" };
    size_t sizeofArray = sizeof(ALLArray) / sizeof(ALLArray[0]);
    while(stringToReturn < sizeofArray) {
...
/*
// Function getQsBackups_ALL_convertToJSON is not currently used,
// since conversion to JSON passes through the conversion of the model, and ToString. The function is kept for future reference.
//
static cJSON *getQsBackups_ALL_convertToJSON(interserver_management_api_getQsBackups_all_e ALL) {
    cJSON *item = cJSON_CreateObject();
    if(cJSON_AddStringToObject(item, "all", getQsBackups_ALL_ToString(ALL)) == NULL) {
        goto fail;
    }
    return item;
    fail:
...
// Function getQsBackups_ALL_parseFromJSON is not currently used,
// since conversion from JSON passes through the conversion of the model, and FromString. The function is kept for future reference.
//
static interserver_management_api_getQsBackups_all_e getQsBackups_ALL_parseFromJSON(cJSON* ALLJSON) {
    interserver_management_api_getQsBackups_all_e ALLVariable = 0;
    cJSON *ALLVar = cJSON_GetObjectItemCaseSensitive(ALLJSON, "all");
    if(!cJSON_IsString(ALLVar) || (ALLVar->valuestring == NULL))
    {
        goto end;
    }
    ALLVariable = getQsBackups_ALL_FromString(ALLVar->valuestring);
    return ALLVariable;
end:
    return 0;
}
...
QuickServersAPI_addQs(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/order");
...
QuickServersAPI_deleteQsBackup(apiClient_t *apiClient, int *id, char *file, interserver_management_api_deleteQsBackup_all_e all)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/backups");
    ...
    interserver_management_api_deleteQsBackup_all_e valueQuery_all ;
    keyValuePair_t *keyPairQuery_all = 0;
    if (all)
    {
        keyQuery_all = strdup("all");
        valueQuery_all = (all);
        keyPairQuery_all = keyValuePair_create(keyQuery_all, strdup(deleteQsBackup_ALL_ToString(
        valueQuery_all)));
...
QuickServersAPI_doQsBlockSmtp(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/block_smtp");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = queue_response_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_doQsDisableCd(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/disable_cd");
...
QuickServersAPI_doQsDisableQuota(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/disable_quota");
...
QuickServersAPI_doQsEjectCd(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/eject_cd");
...
QuickServersAPI_doQsEnableQuota(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/enable_quota");
...
QuickServersAPI_doQsRestart(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/restart");
...
QuickServersAPI_doQsStart(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/start");
...
QuickServersAPI_doQsStop(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/stop");
...
QuickServersAPI_downloadQsBackup(apiClient_t *apiClient, int *id, download_qs_backup_request_t *download_qs_backup_request, interserver_management_api_downloadQsBackup_all_e all)
{
    ...
    // query parameters
    char *keyQuery_all = NULL;
    interserver_management_api_downloadQsBackup_all_e valueQuery_all ;
    keyValuePair_t *keyPairQuery_all = 0;
    if (all)
    {
        keyQuery_all = strdup("all");
        valueQuery_all = (all);
        keyPairQuery_all = keyValuePair_create(keyQuery_all, strdup(downloadQsBackup_ALL_ToString(
        valueQuery_all)));
        list_addElement(localVarQueryParameters,keyPairQuery_all);
    }
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = download_qs_backup_200_response_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getNewQs(apiClient_t *apiClient)
{
    ...
    //}
    //nonprimitive not container
    quickserver_order_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = quickserver_order_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsBackups(apiClient_t *apiClient, int *id, interserver_management_api_getQsBackups_all_e all)
{
    ...
    // query parameters
    char *keyQuery_all = NULL;
    interserver_management_api_getQsBackups_all_e valueQuery_all ;
    keyValuePair_t *keyPairQuery_all = 0;
    if (all)
    {
        keyQuery_all = strdup("all");
        valueQuery_all = (all);
        keyPairQuery_all = keyValuePair_create(keyQuery_all, strdup(getQsBackups_ALL_ToString(
        valueQuery_all)));
        list_addElement(localVarQueryParameters,keyPairQuery_all);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = vps_backup_rows_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsChangeHostname(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/change_hostname");
...
QuickServersAPI_getQsChangeRootPassword(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/change_root_password");
...
QuickServersAPI_getQsChangeTimezone(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/change_timezone");
...
QuickServersAPI_getQsChangeWebuzoPassword(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/change_webuzo_password");
...
QuickServersAPI_getQsInfo(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}");
    ...
    //}
    //nonprimitive not container
    quickserver_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = quickserver_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsInsertCd(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/insert_cd");
...
QuickServersAPI_getQsInvoices(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/invoices");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = charge_invoice_rows_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsList(apiClient_t *apiClient)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(QuickServersAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, QuickServersAPIlocalVarJSON)
        {
...
QuickServersAPI_getQsReinstallOs(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/reinstall_os");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = vps_templates_list_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsResetPassword(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/reset_password");
...
QuickServersAPI_getQsReverseDns(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/reverse_dns");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = reverse_dns_entries_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_getQsSetupVnc(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/setup_vnc");
...
QuickServersAPI_getQsTrafficUsage(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/traffic_usage");
...
QuickServersAPI_getQsViewDesktop(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/view_desktop");
...
QuickServersAPI_getQsWelcomeEmail(apiClient_t *apiClient, char *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/welcome_email");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = text_response_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
QuickServersAPI_postQsBackup(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/backup");
...
QuickServersAPI_postQuickServerRestore(apiClient_t *apiClient, int *id, restore_request_t *restore_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/qs/{id}/restore");
...
QuickServersAPI_quickserversCancel(apiClient_t *apiClient, int *id)
{
    ...
    //}
    //nonprimitive not container
    quickservers_cancel_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *QuickServersAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = quickservers_cancel_200_response_parseFromJSON(QuickServersAPIlocalVarJSON);
        cJSON_Delete(QuickServersAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
