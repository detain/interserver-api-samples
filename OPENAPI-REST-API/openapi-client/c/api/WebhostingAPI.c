...
WebhostingAPI_addWebsite(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/order");
...
WebhostingAPI_getNewWebsite(apiClient_t *apiClient)
{
    ...
    //}
    //nonprimitive not container
    websites_order_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = websites_order_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsiteBuyIp(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/buy_ip");
    ...
    //}
    //nonprimitive not container
    get_website_buy_ip_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = get_website_buy_ip_200_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsiteInfo(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}");
    ...
    //}
    //nonprimitive not container
    website_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = website_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsiteInvoices(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/invoices");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = charge_invoice_rows_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsiteList(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(WebhostingAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, WebhostingAPIlocalVarJSON)
        {
...
WebhostingAPI_getWebsitesBackups(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/backups");
    ...
    //}
    //nonprimitive not container
    website_backups_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = website_backups_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsitesLogin(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/login");
    ...
    //}
    //nonprimitive not container
    website_login_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = website_login_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_getWebsitesWelcomeEmail(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/welcome_email");
...
WebhostingAPI_gettWebsiteReverseDns(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/reverse_dns");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = reverse_dns_entries_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_postWebsiteBuyIp(apiClient_t *apiClient, int *id, post_website_buy_ip_request_t *post_website_buy_ip_request)
{
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_post_website_buy_ip_request = NULL;
    if (post_website_buy_ip_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_post_website_buy_ip_request = post_website_buy_ip_request_convertToJSON(post_website_buy_ip_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_post_website_buy_ip_request);
    ...
    //}
    //nonprimitive not container
    post_website_buy_ip_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = post_website_buy_ip_200_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_post_website_buy_ip_request) {
        cJSON_Delete(localVarSingleItemJSON_post_website_buy_ip_request);
        localVarSingleItemJSON_post_website_buy_ip_request = NULL;
    }
...
WebhostingAPI_postWebsiteMigration(apiClient_t *apiClient, int *id, post_website_migration_request_t *post_website_migration_request)
{
    ...
    // create the path
    char *localVarPath = strdup("/websites/{id}/migration");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_post_website_migration_request = NULL;
    if (post_website_migration_request != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_post_website_migration_request = post_website_migration_request_convertToJSON(post_website_migration_request);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_post_website_migration_request);
        localVarBodyLength = strlen(localVarBodyParameters);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarContentType,"application/json"); //consumes
    ...
    //}
    //nonprimitive not container
    post_website_migration_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = post_website_migration_200_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_post_website_migration_request) {
        cJSON_Delete(localVarSingleItemJSON_post_website_migration_request);
        localVarSingleItemJSON_post_website_migration_request = NULL;
    }
    free(localVarBodyParameters);
    return elementToReturn;
end:
...
WebhostingAPI_postWebsitesReverseDns(apiClient_t *apiClient, int *id, reverse_dns_entries_t *reverse_dns_entries)
{
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = text_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
WebhostingAPI_webhostingCancel(apiClient_t *apiClient, char *id)
{
    ...
    //}
    //nonprimitive not container
    webhosting_cancel_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *WebhostingAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = webhosting_cancel_200_response_parseFromJSON(WebhostingAPIlocalVarJSON);
        cJSON_Delete(WebhostingAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
