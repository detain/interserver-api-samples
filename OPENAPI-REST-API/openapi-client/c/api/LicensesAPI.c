...
LicensesAPI_addLicense(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/order");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        ...
        elementToReturn = service_order_post_response_parseFromJSON(LicensesAPIlocalVarJSON);
...
LicensesAPI_getLicenseInfo(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/{id}");
    ...
    //}
    //nonprimitive not container
    license_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = license_parseFromJSON(LicensesAPIlocalVarJSON);
        cJSON_Delete(LicensesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LicensesAPI_getLicenseInvoices(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/{id}/invoices");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = charge_invoice_rows_parseFromJSON(LicensesAPIlocalVarJSON);
        cJSON_Delete(LicensesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LicensesAPI_getLicenseList(apiClient_t *apiClient)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        if(!cJSON_IsArray(LicensesAPIlocalVarJSON)) {
            return 0;//nonprimitive container
        }
        elementToReturn = list_createList();
        cJSON *VarJSON;
        cJSON_ArrayForEach(VarJSON, LicensesAPIlocalVarJSON)
        {
...
LicensesAPI_getLicenseOrderCatTagInfo(apiClient_t *apiClient, char *catTag)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/order/{catTag}");
    ...
    // Path Params
    long sizeOfPathParams_catTag = strlen(catTag)+3 + sizeof("{ catTag }") - 1;
    if(catTag == NULL) {
        goto end;
    }
    char* localVarToReplace_catTag = malloc(sizeOfPathParams_catTag);
    sprintf(localVarToReplace_catTag, "{%s}", "catTag");

    localVarPath = strReplace(localVarPath, localVarToReplace_catTag, catTag);
...
LicensesAPI_getLicensesWelcomeEmail(apiClient_t *apiClient, int *id)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/{id}/welcome_email");
    ...
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = success_text_response_parseFromJSON(LicensesAPIlocalVarJSON);
        cJSON_Delete(LicensesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LicensesAPI_getNewLicense(apiClient_t *apiClient)
{
    ...
    //}
    //nonprimitive not container
    licenses_order_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = licenses_order_parseFromJSON(LicensesAPIlocalVarJSON);
        cJSON_Delete(LicensesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LicensesAPI_licensesCancel(apiClient_t *apiClient, int *id)
{
    ...
    //}
    //nonprimitive not container
    licenses_cancel_200_response_t *elementToReturn = NULL;
    if(apiClient->response_code >= 200 && apiClient->response_code < 300) {
        cJSON *LicensesAPIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
        elementToReturn = licenses_cancel_200_response_parseFromJSON(LicensesAPIlocalVarJSON);
        cJSON_Delete(LicensesAPIlocalVarJSON);
        if(elementToReturn == NULL) {
            // return 0;
        }
...
LicensesAPI_postLicenseChangeIp(apiClient_t *apiClient, int *id, ip_object_t *ip_object)
{
    ...
    // create the path
    char *localVarPath = strdup("/licenses/{id}/change_ip");
    ...
    // Body Param
    cJSON *localVarSingleItemJSON_ip_object = NULL;
    if (ip_object != NULL)
    {
        //not string, not binary
        localVarSingleItemJSON_ip_object = ip_object_convertToJSON(ip_object);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_ip_object);
    ...
    free(localVarPath);
    free(localVarToReplace_id);
    if (localVarSingleItemJSON_ip_object) {
        cJSON_Delete(localVarSingleItemJSON_ip_object);
        localVarSingleItemJSON_ip_object = NULL;
    }
