...
--[[
Unit tests for openapiclient.model.restore_request
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("restore_request", function()
  local openapiclient_restore_request = require "openapiclient.model.restore_request"

  -- unit tests for the property 'backup'
  describe("property backup test", function()
