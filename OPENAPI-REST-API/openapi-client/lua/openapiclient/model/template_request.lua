...
-- template_request class
local template_request = {}
local template_request_mt = {
	__name = "template_request";
	__index = template_request;
}

local function cast_template_request(t)
...
return {
	cast = cast_template_request;
	new = new_template_request;
}
