...
-- license_service_info class
local license_service_info = {}
local license_service_info_mt = {
	__name = "license_service_info";
	__index = license_service_info;
}

local function cast_license_service_info(t)
...
return {
	cast = cast_license_service_info;
	new = new_license_service_info;
}
