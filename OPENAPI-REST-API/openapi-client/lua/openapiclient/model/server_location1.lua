...
-- server_location1 class
local server_location1 = {}
local server_location1_mt = {
	__name = "server_location1";
	__index = server_location1;
}

local function cast_server_location1(t)
...
return {
	cast = cast_server_location1;
	new = new_server_location1;
}
