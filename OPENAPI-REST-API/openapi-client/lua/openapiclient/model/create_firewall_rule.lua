...
-- create_firewall_rule class
local create_firewall_rule = {}
local create_firewall_rule_mt = {
	__name = "create_firewall_rule";
	__index = create_firewall_rule;
}

local function cast_create_firewall_rule(t)
...
return {
	cast = cast_create_firewall_rule;
	new = new_create_firewall_rule;
}
