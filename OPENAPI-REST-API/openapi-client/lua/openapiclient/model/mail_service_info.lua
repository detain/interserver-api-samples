...
-- mail_service_info class
local mail_service_info = {}
local mail_service_info_mt = {
	__name = "mail_service_info";
	__index = mail_service_info;
}

local function cast_mail_service_info(t)
...
return {
	cast = cast_mail_service_info;
	new = new_mail_service_info;
}
