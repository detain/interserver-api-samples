...
local function cast_backup(t)
	return setmetatable(t, backup_mt)
end

local function new_backup(service_info, client_links, billing_details, cust_currency, cust_currency_symbol, service_master, package, service_extra, extra_info_tables)
	return cast_backup({
