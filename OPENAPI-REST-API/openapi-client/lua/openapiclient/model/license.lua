...
local function cast_license(t)
	return setmetatable(t, license_mt)
end

local function new_license(service_info, client_links, billing_details, cust_currency, cust_currency_symbol, package, service_extra, extra_info_tables, service_overview_extra, service_type, license_key)
	return cast_license({
