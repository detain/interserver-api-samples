...
local function cast_website(t)
	return setmetatable(t, website_mt)
end

local function new_website(service_info, client_links, billing_details, cust_currency, cust_currency_symbol, service_master, package, service_extra, extra_info_tables)
	return cast_website({
