...
-- account_info_post class
local account_info_post = {}
local account_info_post_mt = {
	__name = "account_info_post";
	__index = account_info_post;
}

local function cast_account_info_post(t)
...
return {
	cast = cast_account_info_post;
	new = new_account_info_post;
}
