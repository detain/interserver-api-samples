...
-- vps_order_put_request class
local vps_order_put_request = {}
local vps_order_put_request_mt = {
	__name = "vps_order_put_request";
	__index = vps_order_put_request;
}

local function cast_vps_order_put_request(t)
...
return {
	cast = cast_vps_order_put_request;
	new = new_vps_order_put_request;
}
