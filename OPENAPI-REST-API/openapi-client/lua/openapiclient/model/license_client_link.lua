...
-- license_client_link class
local license_client_link = {}
local license_client_link_mt = {
	__name = "license_client_link";
	__index = license_client_link;
}

local function cast_license_client_link(t)
...
return {
	cast = cast_license_client_link;
	new = new_license_client_link;
}
