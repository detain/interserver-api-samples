...
-- websites_order_packages_info class
local websites_order_packages_info = {}
local websites_order_packages_info_mt = {
	__name = "websites_order_packages_info";
	__index = websites_order_packages_info;
}

local function cast_websites_order_packages_info(t)
...
return {
	cast = cast_websites_order_packages_info;
	new = new_websites_order_packages_info;
}
