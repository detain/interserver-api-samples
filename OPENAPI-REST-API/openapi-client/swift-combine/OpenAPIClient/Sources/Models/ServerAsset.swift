...
public struct ServerAsset: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        primaryIpv4 = try container.decode(String.self, forKey: .primaryIpv4)
        primaryIpv6 = try container.decode(String.self, forKey: .primaryIpv6)
        ...
        rack = try container.decode(String.self, forKey: .rack)
        row = try container.decode(String.self, forKey: .row)
        col = try container.decode(String.self, forKey: .col)
        unitStart = try container.decode(String.self, forKey: .unitStart)
        unitEnd = try container.decode(String.self, forKey: .unitEnd)
        unitSub = try container.decode(String.self, forKey: .unitSub)
        ipmiMac = try container.decode(String.self, forKey: .ipmiMac)
        ipmiIp = try container.decode(String.self, forKey: .ipmiIp)
        ipmiWorking = try container.decode(String.self, forKey: .ipmiWorking)
        ...
        billingStatus = try container.decode(String.self, forKey: .billingStatus)
        overdue = try container.decode(String.self, forKey: .overdue)
        assetId = try container.decode(String.self, forKey: .assetId)
        assetName = try container.decode(String.self, forKey: .assetName)
        rackId = try container.decode(String.self, forKey: .rackId)
        rackName = try container.decode(String.self, forKey: .rackName)
        rackLocation = try container.decode(String.self, forKey: .rackLocation)
        rackSize = try container.decode(String.self, forKey: .rackSize)
        rackX = try container.decode(String.self, forKey: .rackX)
        rackY = try container.decode(String.self, forKey: .rackY)
        switchports = try container.decode([Int].self, forKey: .switchports)
