...
case class CpuWithDefaults (
    ...
    _memory_det: Option[MemoryOption],
    _hd_det: Option[HardDrive],
    _monthly_fee: Option[String]
)
object CpuWithDefaults {
    def toStringBody(var_id: Object, var_short_desc: Object, var_long_desc: Object, var_type: Object, var_speed: Object, var_num_cores: Object, var_num_cpus: Object, var_benchmark: Object, var_monthly_price: Object, var_monthly_price_display: Object, var_max_ram: Object, var_min_ram: Object, var_max_lff: Object, var_max_sff: Object, var_max_nve: Object, var_visible: Object, var_active: Object, var_memory_det: Object, var_hd_det: Object, var_monthly_fee: Object) =
        s"""
        | {
        | "id":$var_id,"short_desc":$var_short_desc,"long_desc":$var_long_desc,"type":$var_type,"speed":$var_speed,"num_cores":$var_num_cores,"num_cpus":$var_num_cpus,"benchmark":$var_benchmark,"monthly_price":$var_monthly_price,"monthly_price_display":$var_monthly_price_display,"max_ram":$var_max_ram,"min_ram":$var_min_ram,"max_lff":$var_max_lff,"max_sff":$var_max_sff,"max_nve":$var_max_nve,"visible":$var_visible,"active":$var_active,"memory_det":$var_memory_det,"hd_det":$var_hd_det,"monthly_fee":$var_monthly_fee
        | }
        """.stripMargin
}
