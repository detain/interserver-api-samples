...
const BEE_DEFAULT_HOST := "my.interserver.net"
...
# Authentication method `sessionIdHeaderAuth`.
# Api Key Authentication `sessionid`
func set_security_sessionIdHeaderAuth(value: String):
	self.headers_base["sessionid"] = value


# Authentication method `sessionIdCookieAuth`.
# Api Key Authentication `sessionid`
func set_security_sessionIdCookieAuth(value: String):
