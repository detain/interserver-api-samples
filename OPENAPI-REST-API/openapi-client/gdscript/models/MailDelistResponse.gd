...
# Required: False
# isArray: true
@export var manual: Array:
	set(value):
		__manual__was__set = true
		manual = value
var __manual__was__set := false
...
func bzz_normalize() -> Dictionary:
	...
	if self.__manual__was__set:
		bzz_dictionary["manual"] = self.manual
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("local"):
		me.local = from_dict["local"]
	if from_dict.has("mbtrap"):
		me.mbtrap = from_dict["mbtrap"]
	if from_dict.has("subject"):
		me.subject = from_dict["subject"]
	if from_dict.has("manual"):
		me.manual = from_dict["manual"]
	return me
