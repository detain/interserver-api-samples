extends Resource
class_name ServerExtraInfoTables
...
# ServerExtraInfoTables Model


# Required: True
# isArray: false
@export var assets: ServerAssets:
	set(value):
...
static func bzz_denormalize_single(from_dict: Dictionary):
	...
	if from_dict.has("assets"):
		me.assets = ServerAssets.bzz_denormalize_single(from_dict["assets"])
	return me
