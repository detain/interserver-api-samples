...
export class PostWebsiteMigrationRequest {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "ftpUsername",
            "baseName": "ftpUsername",
            "type": "string",
            "format": ""
        },
        {
            "name": "ftpPassword",
            "baseName": "ftpPassword",
            "type": "string",
            "format": ""
        },
        {
            "name": "siteBusyMig",
            "baseName": "siteBusyMig",
            "type": "string",
            "format": ""
        },
        {
        ...
        },
        {
            ...
            "baseName": "domainRegPortal",
            "type": "string",
            "format": ""
        },
        {
            "name": "domainRegEmail",
            "baseName": "domainRegEmail",
            "type": "string",
            "format": ""
        },
        {
            "name": "domainRegPassword",
            "baseName": "domainRegPassword",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return PostWebsiteMigrationRequest.attributeTypeMap;
    }
