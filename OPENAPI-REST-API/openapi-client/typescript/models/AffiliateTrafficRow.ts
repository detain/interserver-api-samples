...
*/
export class AffiliateTrafficRow {
    'traffic_id'?: string;
    'traffic_ip'?: string;
    'traffic_url'?: string;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "traffic_url",
            "baseName": "traffic_url",
            "type": "string",
            "format": ""
        },
        {
            "name": "traffic_affiliate",
            "baseName": "traffic_affiliate",
            "type": "string",
            "format": ""
        },
        {
            "name": "traffic_referrer",
            "baseName": "traffic_referrer",
            "type": "string",
            "format": ""
        },
        {
            "name": "traffic_timestamp",
            "baseName": "traffic_timestamp",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return AffiliateTrafficRow.attributeTypeMap;
    }
