...
const data = await apiInstance.changeAccountUsername(request);
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiDeleteAccountOauthNameRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiDeleteAccountOauthNameRequest = {
  
  name: "name_example",
};

const data = await apiInstance.deleteAccountOauthName(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.deleteAccountTfa(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.getAccountInfo(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.getAccountTfaSetup(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.getHome(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiLogoutAccountOauthRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiLogoutAccountOauthRequest = {
  
  name: "name_example",
};

const data = await apiInstance.logoutAccountOauth(request);
console.log('API called successfully. Returned data:', data);
```
...
const data = await apiInstance.updateAccountApiKey(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountFeaturesRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountFeaturesRequest = {
...
const data = await apiInstance.updateAccountFeatures(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountInfoRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountInfoRequest = {
    // Your name.
  name: "John Doe",
    // Your address.
  address: "124 My St",
...
const data = await apiInstance.updateAccountInfo(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountIpLimitsRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountIpLimitsRequest = {
...
const data = await apiInstance.updateAccountIpLimits(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountPasswordRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountPasswordRequest = {
  
  password: "password_example",
};

const data = await apiInstance.updateAccountPassword(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountSshKeyRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountSshKeyRequest = {
  
  sshKey: "sshKey_example",
};

const data = await apiInstance.updateAccountSshKey(request);
console.log('API called successfully. Returned data:', data);
```
...
```typescript
import { createConfiguration, AccountApi } from '';
import type { AccountApiUpdateAccountTfaRequest } from '';

const configuration = createConfiguration();
const apiInstance = new AccountApi(configuration);

const request: AccountApiUpdateAccountTfaRequest = {
    // The 6-digit verification code from your authenticator app.
  _2faGoogleCode: "_2faGoogleCode_example",
};

const data = await apiInstance.updateAccountTfa(request);
console.log('API called successfully. Returned data:', data);
```
