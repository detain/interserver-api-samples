...
export function BackupOrderPutResponseFromJSON(json: any): BackupOrderPutResponse {
    return {
        ...
        'originalCost': !exists(json, 'originalCost') ? undefined : json['originalCost'],
        'repeatServiceCost': !exists(json, 'repeatServiceCost') ? undefined : json['repeatServiceCost'],
...
export function BackupOrderPutResponseToJSON(value?: BackupOrderPutResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
