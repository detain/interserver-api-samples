 ...
 * Place Mail Order
 */
function addMailRaw<T>( requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
...
* Place Mail Order
*/
export function addMail<T>( requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
 ...
 * Update Mail Order
 */
function updateMailInfoRaw<T>(requestParameters: UpdateMailInfoRequest, requestConfig: runtime.TypedQueryConfig<T, void> = {}): QueryConfig<T> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
...
* Update Mail Order
*/
export function updateMailInfo<T>(requestParameters: UpdateMailInfoRequest, requestConfig?: runtime.TypedQueryConfig<T, void>): QueryConfig<T> {
