...
var _ resource.Resource = &WebhostingResource{}
var _ resource.ResourceWithImportState = &WebhostingResource{}
...
func (r *WebhostingResource) Schema(_ context.Context, _ resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Manages a webhosting resource.",
...
func (r *WebhostingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	resp.Diagnostics.AddError("Not Supported", "Create is not supported for webhosting")
}
