...
#ifndef VpsOrderPostRequest_H_
#define VpsOrderPostRequest_H_
 ...
 */
class VpsOrderPostRequest : public oatpp::DTO {

  DTO_INIT(VpsOrderPostRequest, DTO /* Extends */)

  DTO_FIELD(oatpp::String, osDistro);

  DTO_FIELD(oatpp::Int32, slices);
  ...
  DTO_FIELD(oatpp::String, osVersion);
