...
#ifndef VpsOrderPutRequest_H_
#define VpsOrderPutRequest_H_
 ...
 */
class VpsOrderPutRequest : public oatpp::DTO {

  DTO_INIT(VpsOrderPutRequest, DTO /* Extends */)
