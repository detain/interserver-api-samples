...
#ifndef SuccessTextResponse_H_
#define SuccessTextResponse_H_
 ...
 */
class SuccessTextResponse : public oatpp::DTO {

  DTO_INIT(SuccessTextResponse, DTO /* Extends */)
