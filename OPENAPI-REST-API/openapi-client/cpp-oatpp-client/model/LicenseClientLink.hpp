...
#ifndef LicenseClientLink_H_
#define LicenseClientLink_H_
 ...
 */
class LicenseClientLink : public oatpp::DTO {

  DTO_INIT(LicenseClientLink, DTO /* Extends */)
