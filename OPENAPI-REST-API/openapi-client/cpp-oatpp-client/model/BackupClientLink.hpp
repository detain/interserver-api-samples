...
#ifndef BackupClientLink_H_
#define BackupClientLink_H_
 ...
 */
class BackupClientLink : public oatpp::DTO {

  DTO_INIT(BackupClientLink, DTO /* Extends */)
