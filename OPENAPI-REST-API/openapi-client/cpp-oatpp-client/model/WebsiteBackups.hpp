...
#ifndef WebsiteBackups_H_
#define WebsiteBackups_H_


#include "WebsiteBackups_inner.hpp"
 ...
 */
class WebsiteBackups : public oatpp::DTO {

  DTO_INIT(WebsiteBackups, DTO /* Extends */)
