...
class Service : public oatpp::DTO {
  ...
  DTO_FIELD(oatpp::Float64, services_cost);

  DTO_FIELD(oatpp::String, services_currency);

  DTO_FIELD(oatpp::Int32, services_category);

  DTO_FIELD(oatpp::Boolean, services_buyable);

  DTO_FIELD(oatpp::Int32, services_type);
