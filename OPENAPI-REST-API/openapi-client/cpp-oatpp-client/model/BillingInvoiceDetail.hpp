...
#ifndef BillingInvoiceDetail_H_
#define BillingInvoiceDetail_H_
 ...
 */
class BillingInvoiceDetail : public oatpp::DTO {

  DTO_INIT(BillingInvoiceDetail, DTO /* Extends */)
