...
#ifndef LoginErrorResponse_H_
#define LoginErrorResponse_H_
 ...
 */
class LoginErrorResponse : public oatpp::DTO {

  DTO_INIT(LoginErrorResponse, DTO /* Extends */)

  DTO_FIELD(oatpp::String, message);
  DTO_FIELD(oatpp::Boolean, messageIsSet);
  DTO_FIELD(oatpp::String, field);
  DTO_FIELD(oatpp::Boolean, fieldIsSet);
