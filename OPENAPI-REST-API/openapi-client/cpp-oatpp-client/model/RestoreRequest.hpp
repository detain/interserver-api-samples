...
#ifndef RestoreRequest_H_
#define RestoreRequest_H_
 ...
 */
class RestoreRequest : public oatpp::DTO {

  DTO_INIT(RestoreRequest, DTO /* Extends */)

  DTO_FIELD(oatpp::String, backup);
  DTO_FIELD(oatpp::Boolean, backupIsSet);
