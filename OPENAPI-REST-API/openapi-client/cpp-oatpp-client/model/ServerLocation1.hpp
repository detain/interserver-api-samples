...
#ifndef ServerLocation1_H_
#define ServerLocation1_H_
 ...
 */
class ServerLocation1 : public oatpp::DTO {

  DTO_INIT(ServerLocation1, DTO /* Extends */)

  DTO_FIELD(oatpp::Int32, location_id);
