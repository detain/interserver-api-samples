...
#ifndef WebsiteClientLink_H_
#define WebsiteClientLink_H_
 ...
 */
class WebsiteClientLink : public oatpp::DTO {

  DTO_INIT(WebsiteClientLink, DTO /* Extends */)
