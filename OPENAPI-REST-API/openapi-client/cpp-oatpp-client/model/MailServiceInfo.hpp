...
#ifndef MailServiceInfo_H_
#define MailServiceInfo_H_
 ...
 */
class MailServiceInfo : public oatpp::DTO {

  DTO_INIT(MailServiceInfo, DTO /* Extends */)
  ...
  DTO_FIELD(oatpp::String, mail_order_date);

  DTO_FIELD(oatpp::String, mail_custid);
  ...
  DTO_FIELD(oatpp::Boolean, mail_extraIsSet);
  DTO_FIELD(oatpp::String, mail_server_status);
  DTO_FIELD(oatpp::Boolean, mail_server_statusIsSet);
  DTO_FIELD(oatpp::String, mail_comment);
  DTO_FIELD(oatpp::Boolean, mail_commentIsSet);
