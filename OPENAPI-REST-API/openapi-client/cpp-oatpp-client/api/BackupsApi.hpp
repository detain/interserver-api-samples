...
#ifndef BackupsApi_H_
#define BackupsApi_H_
...
#include "Backup.hpp"
#include "BackupLoginResponse.hpp"
#include "BackupOrderPostResponse.hpp"
#include "BackupOrderPutResponse.hpp"
#include "BackupRow.hpp"
#include "BackupsOrder.hpp"
#include "CancelBackup_200_response.hpp"
...
class BackupsApi : public oatpp::web::client::ApiClient {
public:

  API_CLIENT_INIT(BackupsApi)
  ...
  /// </remarks>
  /// <param name="validateOnly"> (optional, default to false)</param>
  /// <param name="serviceType"> (optional, default to 0)</param>
  /// <param name="coupon"> (optional, default to &quot;&quot;)</param>
  API_CALL("POST", "/backups/order", add_backup, BODY(std::shared_ptr<oatpp::web::protocol::http::outgoing::MultipartBody>, formData))
  /// <summary>
  ...
  API_CALL("DELETE", "/backups/{id}", cancel_backup, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
  API_CALL("GET", "/backups/{id}", get_backup_info, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
  API_CALL("GET", "/backups/{id}/invoices", get_backup_invoices, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
  API_CALL("GET", "/backups/{id}/login", get_backup_login, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  API_CALL("GET", "/backups", get_backups_list)
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
  API_CALL("GET", "/backups/{id}/welcome_email", get_backups_welcome_email, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// </remarks>
  API_CALL("GET", "/backups/order", get_new_backup)
  /// <summary>
  ...
  /// </remarks>
  /// <param name="id">The backup service ID. Use the &#x60;backup_id&#x60; from &#x60;GET /backups&#x60; to identify the service.</param>
  API_CALL("POST", "/backups/{id}", update_backup_info, PATH(oatpp::Int32, id))
  /// <summary>
  ...
  /// <param name="serviceType"> (optional, default to 0)</param>
  /// <param name="coupon"> (optional, default to &quot;&quot;)</param>
  API_CALL("PUT", "/backups/order", validate_backup_order, BODY(std::shared_ptr<oatpp::web::protocol::http::outgoing::MultipartBody>, formData))
};
