...
class AccountApi(baseUrl: String) {
   ...
   */
  def changeAccountUsername(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], TextResponse]] =
    basicRequest
   ...
   * @param name 
   */
  def deleteAccountOauthName(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def deleteAccountTfa(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   * @param ipLimitRange 
   */
  def deleteIpLimit(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(ipLimitRange: Option[IpLimitRange] = None): Request[Either[ResponseException[String, Exception], GenericResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], AccountInfo]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getAccountTfaSetup(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], GetAccountTfaSetup200Response]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getHome(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], Home]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getSearch(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], SearchAutocompleteResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def logout(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   * @param name 
   */
  def logoutAccountOauth(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(name: String): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def updateAccountApiKey(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def updateAccountFeatures(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(disableReset: Option[Int] = None, disableReinstall: Option[Int] = None): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
...
, 
   ...
   * @param password 
   */
  def updateAccountPassword(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(password: String): Request[Either[ResponseException[String, Exception], TextResponse]] =
    basicRequest
   ...
   * @param sshKey 
   */
  def updateAccountSshKey(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(sshKey: Option[String] = None): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
   ...
   */
  def updateAccountTfa(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(`2faGoogleCode`: String): Request[Either[ResponseException[String, Exception], SuccessTextResponse]] =
    basicRequest
