...
**serverDiscount** | **JSONValue** | Discount information for the server. | [optional] 
...
**serverLocation** | **JSONValue** | The location of the server. | [optional] 
...
**serverDedicatedHd2** | **JSONValue** | The size of the second dedicated hard drive. | [optional] 
...
**serverDedicatedCp** | **JSONValue** | The control panel of the server. | [optional] 
