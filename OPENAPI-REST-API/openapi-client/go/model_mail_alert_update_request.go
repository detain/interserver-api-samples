...
// checks if the MailAlertUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailAlertUpdateRequest{}
...
func (o MailAlertUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o MailAlertUpdateRequest) ToMap() (map[string]interface{}, error) {
...
type NullableMailAlertUpdateRequest struct {
	value *MailAlertUpdateRequest
	isSet bool
}

func (v NullableMailAlertUpdateRequest) Get() *MailAlertUpdateRequest {
	return v.value
}

func (v *NullableMailAlertUpdateRequest) Set(val *MailAlertUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMailAlertUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMailAlertUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailAlertUpdateRequest(val *MailAlertUpdateRequest) *NullableMailAlertUpdateRequest {
	return &NullableMailAlertUpdateRequest{value: val, isSet: true}
}

func (v NullableMailAlertUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailAlertUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
