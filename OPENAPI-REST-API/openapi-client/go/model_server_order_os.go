...
// checks if the ServerOrderOS type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerOrderOS{}

// ServerOrderOS An operating system option available when ordering a dedicated server.
type ServerOrderOS struct {
	// Operating System ID.
...
func (o ServerOrderOS) MarshalJSON() ([]byte, error) {
...
func (o ServerOrderOS) ToMap() (map[string]interface{}, error) {
...
type NullableServerOrderOS struct {
	value *ServerOrderOS
	isSet bool
}

func (v NullableServerOrderOS) Get() *ServerOrderOS {
	return v.value
}

func (v *NullableServerOrderOS) Set(val *ServerOrderOS) {
	v.value = val
	v.isSet = true
}

func (v NullableServerOrderOS) IsSet() bool {
	return v.isSet
}

func (v *NullableServerOrderOS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerOrderOS(val *ServerOrderOS) *NullableServerOrderOS {
	return &NullableServerOrderOS{value: val, isSet: true}
}

func (v NullableServerOrderOS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerOrderOS) UnmarshalJSON(src []byte) error {
	v.isSet = true
