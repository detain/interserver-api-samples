...
// checks if the RaidOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RaidOption{}
...
func (o RaidOption) MarshalJSON() ([]byte, error) {
...
func (o RaidOption) ToMap() (map[string]interface{}, error) {
...
type NullableRaidOption struct {
	value *RaidOption
	isSet bool
}

func (v NullableRaidOption) Get() *RaidOption {
	return v.value
}

func (v *NullableRaidOption) Set(val *RaidOption) {
	v.value = val
	v.isSet = true
}

func (v NullableRaidOption) IsSet() bool {
	return v.isSet
}

func (v *NullableRaidOption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRaidOption(val *RaidOption) *NullableRaidOption {
	return &NullableRaidOption{value: val, isSet: true}
}

func (v NullableRaidOption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRaidOption) UnmarshalJSON(src []byte) error {
	v.isSet = true
