...
// checks if the CaptchaResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaptchaResponse{}
...
type _CaptchaResponse CaptchaResponse
...
func (o *CaptchaResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCaptchaResponse := _CaptchaResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCaptchaResponse)

	if err != nil {
		return err
	}

	*o = CaptchaResponse(varCaptchaResponse)
...
func (v NullableCaptchaResponse) Get() *CaptchaResponse {
	return v.value
}

func (v *NullableCaptchaResponse) Set(val *CaptchaResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableCaptchaResponse(val *CaptchaResponse) *NullableCaptchaResponse {
	return &NullableCaptchaResponse{value: val, isSet: true}
}
