...
// checks if the BackupLoginResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupLoginResponse{}
...
func (o BackupLoginResponse) MarshalJSON() ([]byte, error) {
...
func (o BackupLoginResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBackupLoginResponse struct {
	value *BackupLoginResponse
	isSet bool
}

func (v NullableBackupLoginResponse) Get() *BackupLoginResponse {
	return v.value
}

func (v *NullableBackupLoginResponse) Set(val *BackupLoginResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupLoginResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupLoginResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupLoginResponse(val *BackupLoginResponse) *NullableBackupLoginResponse {
	return &NullableBackupLoginResponse{value: val, isSet: true}
}

func (v NullableBackupLoginResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupLoginResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
