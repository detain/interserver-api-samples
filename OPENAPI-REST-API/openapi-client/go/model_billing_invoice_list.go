...
// checks if the BillingInvoiceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingInvoiceList{}
...
func (o BillingInvoiceList) MarshalJSON() ([]byte, error) {
...
func (o BillingInvoiceList) ToMap() (map[string]interface{}, error) {
...
type NullableBillingInvoiceList struct {
	value *BillingInvoiceList
	isSet bool
}

func (v NullableBillingInvoiceList) Get() *BillingInvoiceList {
	return v.value
}

func (v *NullableBillingInvoiceList) Set(val *BillingInvoiceList) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingInvoiceList) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingInvoiceList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingInvoiceList(val *BillingInvoiceList) *NullableBillingInvoiceList {
	return &NullableBillingInvoiceList{value: val, isSet: true}
}

func (v NullableBillingInvoiceList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingInvoiceList) UnmarshalJSON(src []byte) error {
	v.isSet = true
