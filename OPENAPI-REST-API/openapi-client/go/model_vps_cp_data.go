...
// checks if the VpsCPData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpsCPData{}
...
func (o VpsCPData) MarshalJSON() ([]byte, error) {
...
func (o VpsCPData) ToMap() (map[string]interface{}, error) {
...
type NullableVpsCPData struct {
	value *VpsCPData
	isSet bool
}

func (v NullableVpsCPData) Get() *VpsCPData {
	return v.value
}

func (v *NullableVpsCPData) Set(val *VpsCPData) {
	v.value = val
	v.isSet = true
}

func (v NullableVpsCPData) IsSet() bool {
	return v.isSet
}

func (v *NullableVpsCPData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpsCPData(val *VpsCPData) *NullableVpsCPData {
	return &NullableVpsCPData{value: val, isSet: true}
}

func (v NullableVpsCPData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpsCPData) UnmarshalJSON(src []byte) error {
	v.isSet = true
