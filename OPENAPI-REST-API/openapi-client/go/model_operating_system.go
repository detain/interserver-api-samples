...
func (o *OperatingSystem) GetShortDesc() string {
...
// and a boolean to check if the value has been set.
func (o *OperatingSystem) GetShortDescOk() (*string, bool) {
	if o == nil || IsNil(o.ShortDesc) {
		return nil, false
	}
...
func (o *OperatingSystem) HasShortDesc() bool {
	if o != nil && !IsNil(o.ShortDesc) {
		return true
	}
...
func (o *OperatingSystem) SetShortDesc(v string) {
	o.ShortDesc = &v
}

// GetMonthlyPrice returns the MonthlyPrice field value if set, zero value otherwise.
func (o *OperatingSystem) GetMonthlyPrice() float32 {
...
// and a boolean to check if the value has been set.
func (o *OperatingSystem) GetMonthlyPriceOk() (*float32, bool) {
	if o == nil || IsNil(o.MonthlyPrice) {
		return nil, false
	}
...
func (o *OperatingSystem) HasMonthlyPrice() bool {
	if o != nil && !IsNil(o.MonthlyPrice) {
		return true
	}
...
func (o *OperatingSystem) SetMonthlyPrice(v float32) {
	o.MonthlyPrice = &v
}
