 ...
 */
@JsonPropertyOrder({
  MailDelistRequest.JSON_PROPERTY_UNBLOCK
})
@JsonTypeName("MailDelistRequest")
...
public class MailDelistRequest {
    public static final String JSON_PROPERTY_UNBLOCK = "unblock";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_UNBLOCK)
