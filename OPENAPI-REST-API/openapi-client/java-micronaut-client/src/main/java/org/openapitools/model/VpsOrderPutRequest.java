 ...
 */
@JsonPropertyOrder({
  VpsOrderPutRequest.JSON_PROPERTY_OS_DISTRO,
  VpsOrderPutRequest.JSON_PROPERTY_SLICES,
  VpsOrderPutRequest.JSON_PROPERTY_VPS_PLATFORM,
  VpsOrderPutRequest.JSON_PROPERTY_PERIOD,
  VpsOrderPutRequest.JSON_PROPERTY_LOCATION,
  VpsOrderPutRequest.JSON_PROPERTY_OS_VERSION,
  VpsOrderPutRequest.JSON_PROPERTY_HOSTNAME,
  VpsOrderPutRequest.JSON_PROPERTY_ROOTPASS,
  VpsOrderPutRequest.JSON_PROPERTY_CONTROLPANEL,
  VpsOrderPutRequest.JSON_PROPERTY_COUPON,
...
public class VpsOrderPutRequest {
    ...
    public VpsOrderPutRequest(String osDistro, Integer slices, VpsPlatformEnum vpsPlatform, Integer period, Integer location, String osVersion, String hostname, String rootpass) {
