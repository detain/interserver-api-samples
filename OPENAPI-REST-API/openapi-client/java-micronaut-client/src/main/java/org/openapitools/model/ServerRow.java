 ...
 */
@JsonPropertyOrder({
  ServerRow.JSON_PROPERTY_SERVER_ID,
  ServerRow.JSON_PROPERTY_ACCOUNT_LID,
  ServerRow.JSON_PROPERTY_SERVER_HOSTNAME,
  ServerRow.JSON_PROPERTY_SERVER_STATUS
})
@JsonTypeName("ServerRow")
...
public class ServerRow {
    ...
    public ServerRow(String serverId, String accountLid, String serverHostname, String serverStatus) {
