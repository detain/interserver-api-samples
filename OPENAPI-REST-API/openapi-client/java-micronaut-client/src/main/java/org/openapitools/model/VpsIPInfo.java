 ...
 */
@JsonPropertyOrder({
  VpsIPInfo.JSON_PROPERTY_TITLE,
  VpsIPInfo.JSON_PROPERTY_ROWS
})
@JsonTypeName("VpsIPInfo")
...
public class VpsIPInfo {
    ...
    private List<@Valid VpsIPInfoRow> rows = null;
    ...
    public VpsIPInfo rows(List<@Valid VpsIPInfoRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid VpsIPInfoRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid VpsIPInfoRow> rows) {
        this.rows = rows;
    }
