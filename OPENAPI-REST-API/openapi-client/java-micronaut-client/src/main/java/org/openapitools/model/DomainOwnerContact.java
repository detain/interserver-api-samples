 ...
 */
@JsonPropertyOrder({
  DomainOwnerContact.JSON_PROPERTY_POSTAL_CODE,
  DomainOwnerContact.JSON_PROPERTY_ORG_NAME,
  DomainOwnerContact.JSON_PROPERTY_COUNTRY,
  DomainOwnerContact.JSON_PROPERTY_STATUS,
  DomainOwnerContact.JSON_PROPERTY_STATE,
  DomainOwnerContact.JSON_PROPERTY_FIRST_NAME,
  DomainOwnerContact.JSON_PROPERTY_LAST_NAME,
  DomainOwnerContact.JSON_PROPERTY_ADDRESS3,
  DomainOwnerContact.JSON_PROPERTY_FAX,
  DomainOwnerContact.JSON_PROPERTY_ADDRESS2,
  DomainOwnerContact.JSON_PROPERTY_EMAIL,
  DomainOwnerContact.JSON_PROPERTY_CITY,
  DomainOwnerContact.JSON_PROPERTY_PHONE,
  DomainOwnerContact.JSON_PROPERTY_ADDRESS1
})
@JsonTypeName("DomainOwnerContact")
