 ...
 */
@JsonPropertyOrder({
  VpsTemplatesList.JSON_PROPERTY_TEMPLATES
})
@JsonTypeName("VpsTemplatesList")
...
public class VpsTemplatesList {
    ...
    private List<@Valid VpsTemplateRow> templates = new ArrayList<>();

    public VpsTemplatesList(List<@Valid VpsTemplateRow> templates) {
        this.templates = templates;
    }

    public VpsTemplatesList templates(List<@Valid VpsTemplateRow> templates) {
        this.templates = templates;
        return this;
    }
    ...
    public List<@Valid VpsTemplateRow> getTemplates() {
        return templates;
    }

    @JsonProperty(JSON_PROPERTY_TEMPLATES)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setTemplates(List<@Valid VpsTemplateRow> templates) {
        this.templates = templates;
    }
