 ...
 */
@JsonPropertyOrder({
  VpsTrafficDataSectionResponse.JSON_PROPERTY_NAME,
  VpsTrafficDataSectionResponse.JSON_PROPERTY_DATA
})
@JsonTypeName("VpsTrafficDataSectionResponse")
...
public class VpsTrafficDataSectionResponse {
    ...
    public VpsTrafficDataSectionResponse(String name, List<VPSTrafficDataDataSectionResponse> data) {
        this.name = name;
        this.data = data;
    }
