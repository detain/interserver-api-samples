 ...
 */
@JsonPropertyOrder({
  LoginSubmissionExampleGRecaptchaResponseDep.JSON_PROPERTY_W,
  LoginSubmissionExampleGRecaptchaResponseDep.JSON_PROPERTY_N
})
@JsonTypeName("LoginSubmissionExample_g_recaptcha_response_dep")
