 ...
 */
@JsonPropertyOrder({
  AccountInfoOauthConfig.JSON_PROPERTY_CALLBACK,
  AccountInfoOauthConfig.JSON_PROPERTY_PROVIDERS
})
@JsonTypeName("AccountInfoOauthConfig")
...
public class AccountInfoOauthConfig {
    ...
    public AccountInfoOauthConfig(String callback, AccountInfoOauthConfigProviders providers) {
