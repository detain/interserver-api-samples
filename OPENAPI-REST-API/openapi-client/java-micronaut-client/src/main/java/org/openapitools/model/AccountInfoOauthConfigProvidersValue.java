 ...
 */
@JsonPropertyOrder({
  AccountInfoOauthConfigProvidersValue.JSON_PROPERTY_ENABLED,
  AccountInfoOauthConfigProvidersValue.JSON_PROPERTY_LINKED,
  AccountInfoOauthConfigProvidersValue.JSON_PROPERTY_ACCOUNT,
  AccountInfoOauthConfigProvidersValue.JSON_PROPERTY_URL
})
@JsonTypeName("AccountInfoOauthConfigProviders_value")
