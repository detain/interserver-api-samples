 ...
 */
@JsonPropertyOrder({
  TicketCustomFieldDetails.JSON_PROPERTY_CUSTOMER_SERVER_ACCESS,
  TicketCustomFieldDetails.JSON_PROPERTY_IP_ADDRESS,
  TicketCustomFieldDetails.JSON_PROPERTY_ROOT_PASSWORD,
  TicketCustomFieldDetails.JSON_PROPERTY_SUDO_USER,
  TicketCustomFieldDetails.JSON_PROPERTY_SUDO_PASSWORD,
...
public class TicketCustomFieldDetails {
    ...
    public static final String JSON_PROPERTY_CUSTOMER_SERVER_ACCESS = "Customer Server Access";
    private CustomerServerAccessEnum customerServerAccess;

    public static final String JSON_PROPERTY_IP_ADDRESS = "Ip Address";
    private String ipAddress;

    public static final String JSON_PROPERTY_ROOT_PASSWORD = "Root Password";
    private String rootPassword;

    public static final String JSON_PROPERTY_SUDO_USER = "Sudo User";
    private String sudoUser;

    public static final String JSON_PROPERTY_SUDO_PASSWORD = "Sudo Password";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_SUDO_USER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
