 ...
 */
@JsonPropertyOrder({
  VpsClientLink.JSON_PROPERTY_LABEL,
  VpsClientLink.JSON_PROPERTY_LINK,
  VpsClientLink.JSON_PROPERTY_ICON,
  VpsClientLink.JSON_PROPERTY_ICON_TEXT,
  VpsClientLink.JSON_PROPERTY_HELP_TEXT
})
@JsonTypeName("VpsClientLink")
