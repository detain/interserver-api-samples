 ...
 */
@JsonPropertyOrder({
  ServerNetworkInfoSwitchports.JSON_PROPERTY_10414
})
@JsonTypeName("ServerNetworkInfo_switchports")
...
public class ServerNetworkInfoSwitchports {
    public static final String JSON_PROPERTY_10414 = "10414";
    private ServerSwitchport _10414;

    public ServerNetworkInfoSwitchports(ServerSwitchport _10414) {
        this._10414 = _10414;
    }
    ...
    @Valid
    @NotNull
    @JsonProperty(JSON_PROPERTY_10414)
