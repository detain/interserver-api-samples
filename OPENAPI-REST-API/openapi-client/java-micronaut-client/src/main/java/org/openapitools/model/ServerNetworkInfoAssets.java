 ...
 */
@JsonPropertyOrder({
  ServerNetworkInfoAssets.JSON_PROPERTY_3497
})
@JsonTypeName("ServerNetworkInfo_assets")
...
public class ServerNetworkInfoAssets {
    public static final String JSON_PROPERTY_3497 = "3497";
    private ServerAsset _3497;

    public ServerNetworkInfoAssets(ServerAsset _3497) {
        this._3497 = _3497;
    }
    ...
    @Valid
    @NotNull
    @JsonProperty(JSON_PROPERTY_3497)
