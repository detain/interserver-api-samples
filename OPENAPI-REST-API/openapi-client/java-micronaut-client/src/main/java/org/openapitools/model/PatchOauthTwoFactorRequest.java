 ...
 */
@JsonPropertyOrder({
  PatchOauthTwoFactorRequest.JSON_PROPERTY_ACCOUNT_ID,
  PatchOauthTwoFactorRequest.JSON_PROPERTY_CODE
})
@JsonTypeName("patchOauthTwoFactor_request")
...
public class PatchOauthTwoFactorRequest {
    ...
    public PatchOauthTwoFactorRequest(Integer accountId, String code) {
