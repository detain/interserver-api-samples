 ...
 */
@JsonPropertyOrder({
  VpsOrderPlatformNames.JSON_PROPERTY_KVM,
  VpsOrderPlatformNames.JSON_PROPERTY_KVMSTORAGE,
  VpsOrderPlatformNames.JSON_PROPERTY_HYPERV
})
@JsonTypeName("VpsOrder_platformNames")
