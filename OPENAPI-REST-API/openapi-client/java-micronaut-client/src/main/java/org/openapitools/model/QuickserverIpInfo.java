 ...
 */
@JsonPropertyOrder({
  QuickserverIpInfo.JSON_PROPERTY_TITLE,
  QuickserverIpInfo.JSON_PROPERTY_ROWS
})
@JsonTypeName("QuickserverIpInfo")
...
public class QuickserverIpInfo {
    ...
    private List<@Valid QuickserverIpTableRow> rows = null;
    ...
    public QuickserverIpInfo rows(List<@Valid QuickserverIpTableRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid QuickserverIpTableRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid QuickserverIpTableRow> rows) {
        this.rows = rows;
    }
