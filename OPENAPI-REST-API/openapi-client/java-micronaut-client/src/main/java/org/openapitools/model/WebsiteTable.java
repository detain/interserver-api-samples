 ...
 */
@JsonPropertyOrder({
  WebsiteTable.JSON_PROPERTY_TITLE,
  WebsiteTable.JSON_PROPERTY_ROWS
})
@JsonTypeName("WebsiteTable")
...
public class WebsiteTable {
    ...
    private List<@Valid WebsiteTableRow> rows = null;
    ...
    public WebsiteTable rows(List<@Valid WebsiteTableRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid WebsiteTableRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid WebsiteTableRow> rows) {
        this.rows = rows;
    }
