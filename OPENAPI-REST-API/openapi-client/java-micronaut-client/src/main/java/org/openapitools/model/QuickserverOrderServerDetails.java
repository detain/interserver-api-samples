 ...
 */
@JsonPropertyOrder({
  QuickserverOrderServerDetails.JSON_PROPERTY_381
})
@JsonTypeName("QuickserverOrder_server_details")
...
public class QuickserverOrderServerDetails {
    public static final String JSON_PROPERTY_381 = "381";
    ...
    @Valid
    @Nullable
    @JsonProperty(JSON_PROPERTY_381)
