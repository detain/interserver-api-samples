 ...
 */
@JsonPropertyOrder({
  MailSchemaExtraInfoTables.JSON_PROPERTY_MAIL,
  MailSchemaExtraInfoTables.JSON_PROPERTY_TUTORIALS
})
@JsonTypeName("MailSchema_extraInfoTables")
...
public class MailSchemaExtraInfoTables {
    ...
    public static final String JSON_PROPERTY_TUTORIALS = "tutorials";
    ...
    @Valid
    @Nullable
    @JsonProperty(JSON_PROPERTY_TUTORIALS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
