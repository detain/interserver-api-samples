 ...
 */
@JsonPropertyOrder({
  WebsitesOrderJsonServices.JSON_PROPERTY_11447
})
@JsonTypeName("WebsitesOrderJsonServices")
...
public class WebsitesOrderJsonServices {
    ...
    public WebsitesOrderJsonServices(String _11447) {
        this._11447 = _11447;
    }
     ...
     */
    @NotNull
    @JsonProperty(JSON_PROPERTY_11447)
