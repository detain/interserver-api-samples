 ...
 */
@JsonPropertyOrder({
  MailTutorialsTable.JSON_PROPERTY_TITLE,
  MailTutorialsTable.JSON_PROPERTY_ROWS
})
@JsonTypeName("MailTutorialsTable")
...
public class MailTutorialsTable {
    ...
    private List<@Valid MailTutorialsTableRow> rows = null;
    ...
    public MailTutorialsTable rows(List<@Valid MailTutorialsTableRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid MailTutorialsTableRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid MailTutorialsTableRow> rows) {
        this.rows = rows;
    }
