 ...
 */
@JsonPropertyOrder({
  MemoryOption.JSON_PROPERTY_ID,
  MemoryOption.JSON_PROPERTY_SHORT_DESC,
  MemoryOption.JSON_PROPERTY_MONTHLY_PRICE,
  MemoryOption.JSON_PROPERTY_MONTHLY_PRICE_DISPLAY
})
@JsonTypeName("MemoryOption")
