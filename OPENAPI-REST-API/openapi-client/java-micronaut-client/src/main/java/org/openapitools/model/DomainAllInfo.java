 ...
 */
@JsonPropertyOrder({
  DomainAllInfo.JSON_PROPERTY_O_P_S_VERSION,
  DomainAllInfo.JSON_PROPERTY_ATTRIBUTES,
  DomainAllInfo.JSON_PROPERTY_OBJECT,
  DomainAllInfo.JSON_PROPERTY_PROTOCOL,
  DomainAllInfo.JSON_PROPERTY_RESPONSE_TEXT,
  DomainAllInfo.JSON_PROPERTY_RESPONSE_CODE,
  DomainAllInfo.JSON_PROPERTY_ACTION,
  DomainAllInfo.JSON_PROPERTY_IS_SUCCESS
})
@JsonTypeName("DomainAllInfo")
