 ...
 */
@JsonPropertyOrder({
  DomainOrderServices.JSON_PROPERTY_DOMAIN_ORDER_SERVICES10001
})
@JsonTypeName("DomainOrder_services")
...
public class DomainOrderServices {
    public static final String JSON_PROPERTY_DOMAIN_ORDER_SERVICES10001 = "DomainOrderServices10001";
    ...
    @Valid
    @Nullable
    @JsonProperty(JSON_PROPERTY_DOMAIN_ORDER_SERVICES10001)
