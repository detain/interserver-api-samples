 ...
 */
@JsonPropertyOrder({
  LicensesOrderServiceCategories.JSON_PROPERTY_LICENSES_ORDER_SERVICE_CATEGORIES509
})
@JsonTypeName("LicensesOrder_serviceCategories")
...
public class LicensesOrderServiceCategories {
    public static final String JSON_PROPERTY_LICENSES_ORDER_SERVICE_CATEGORIES509 = "LicensesOrderServiceCategories509";
    ...
    @Valid
    @Nullable
    @JsonProperty(JSON_PROPERTY_LICENSES_ORDER_SERVICE_CATEGORIES509)
