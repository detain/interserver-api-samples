 ...
 */
@JsonPropertyOrder({
  MailExtraInfoTable.JSON_PROPERTY_TITLE,
  MailExtraInfoTable.JSON_PROPERTY_ROWS
})
@JsonTypeName("MailExtraInfoTable")
...
public class MailExtraInfoTable {
    ...
    private List<@Valid MailExtraInfoTableRow> rows = null;
    ...
    public MailExtraInfoTable rows(List<@Valid MailExtraInfoTableRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid MailExtraInfoTableRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid MailExtraInfoTableRow> rows) {
        this.rows = rows;
    }
