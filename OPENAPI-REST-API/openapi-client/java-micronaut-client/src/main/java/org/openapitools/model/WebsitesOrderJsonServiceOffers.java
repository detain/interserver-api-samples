 ...
 */
@JsonPropertyOrder({
  WebsitesOrderJsonServiceOffers.JSON_PROPERTY_1026
})
@JsonTypeName("WebsitesOrderJsonServiceOffers")
...
public class WebsitesOrderJsonServiceOffers {
    ...
    private List<@Valid WebsitesOrderJsonServiceOffersItem> _1026 = new ArrayList<>();

    public WebsitesOrderJsonServiceOffers(List<@Valid WebsitesOrderJsonServiceOffersItem> _1026) {
        this._1026 = _1026;
    }

    public WebsitesOrderJsonServiceOffers _1026(List<@Valid WebsitesOrderJsonServiceOffersItem> _1026) {
        this._1026 = _1026;
        return this;
    }
    ...
    public List<@Valid WebsitesOrderJsonServiceOffersItem> get1026() {
        return _1026;
    }

    @JsonProperty(JSON_PROPERTY_1026)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void set1026(List<@Valid WebsitesOrderJsonServiceOffersItem> _1026) {
        this._1026 = _1026;
    }
