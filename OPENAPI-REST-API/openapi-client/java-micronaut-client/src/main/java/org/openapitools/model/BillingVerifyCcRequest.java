 ...
 */
@JsonPropertyOrder({
  BillingVerifyCcRequest.JSON_PROPERTY_IDX,
  BillingVerifyCcRequest.JSON_PROPERTY_CC_CCV2,
  BillingVerifyCcRequest.JSON_PROPERTY_CC_AMOUNT1,
  BillingVerifyCcRequest.JSON_PROPERTY_CC_AMOUNT2,
  BillingVerifyCcRequest.JSON_PROPERTY_TERMS
})
@JsonTypeName("BillingVerifyCcRequest")
...
public class BillingVerifyCcRequest {
    ...
    public static final String JSON_PROPERTY_CC_AMOUNT1 = "cc_amount1";
    private String ccAmount1;

    public static final String JSON_PROPERTY_CC_AMOUNT2 = "cc_amount2";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_CC_AMOUNT1)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_CC_AMOUNT2)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
