 ...
 */
@JsonPropertyOrder({
  VpsTrafficTotalsSectionResponse.JSON_PROPERTY_IN,
  VpsTrafficTotalsSectionResponse.JSON_PROPERTY_OUT
})
@JsonTypeName("VpsTrafficTotalsSectionResponse")
...
public class VpsTrafficTotalsSectionResponse {
    ...
    public VpsTrafficTotalsSectionResponse(Long in, Long out) {
        this.in = in;
        this.out = out;
    }
