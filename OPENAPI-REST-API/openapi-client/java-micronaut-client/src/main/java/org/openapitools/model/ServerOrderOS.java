 ...
 */
@JsonPropertyOrder({
  ServerOrderOS.JSON_PROPERTY_ID,
  ServerOrderOS.JSON_PROPERTY_PRICE,
  ServerOrderOS.JSON_PROPERTY_IMG,
  ServerOrderOS.JSON_PROPERTY_SHORT_DESC,
  ServerOrderOS.JSON_PROPERTY_LONG_DESC,
  ServerOrderOS.JSON_PROPERTY_MONTHLY_PRICE,
  ServerOrderOS.JSON_PROPERTY_ACTIVE,
  ServerOrderOS.JSON_PROPERTY_PRICE_DISPLAY,
  ServerOrderOS.JSON_PROPERTY_MONTHLY_PRICE_DISPLAY
})
@JsonTypeName("ServerOrderOS")
