 ...
 */
@JsonPropertyOrder({
  MailAlertRequest.JSON_PROPERTY_TYPE,
  MailAlertRequest.JSON_PROPERTY_VALUE,
  MailAlertRequest.JSON_PROPERTY_TO,
  MailAlertRequest.JSON_PROPERTY_ENABLED
})
@JsonTypeName("MailAlertRequest")
