 ...
 */
@JsonPropertyOrder({
  GetOrderDetail200ResponseIpsInner.JSON_PROPERTY_SERVICE_ID,
  GetOrderDetail200ResponseIpsInner.JSON_PROPERTY_SERVICE_MODULE,
  GetOrderDetail200ResponseIpsInner.JSON_PROPERTY_SERVICE_HOSTNAME
})
@JsonTypeName("getOrderDetail_200_response_ips_inner")
