 ...
 */
@JsonPropertyOrder({
  QuickserverClientLink.JSON_PROPERTY_LABEL,
  QuickserverClientLink.JSON_PROPERTY_LINK,
  QuickserverClientLink.JSON_PROPERTY_ICON,
  QuickserverClientLink.JSON_PROPERTY_ICON_TEXT,
  QuickserverClientLink.JSON_PROPERTY_HELP_TEXT,
  QuickserverClientLink.JSON_PROPERTY_OTHER_ATTR
})
@JsonTypeName("QuickserverClientLink")
