 ...
 */
@JsonPropertyOrder({
  HomeDetailsModulesLicenses.JSON_PROPERTY_ICON,
  HomeDetailsModulesLicenses.JSON_PROPERTY_VIEW_LINK,
  HomeDetailsModulesLicenses.JSON_PROPERTY_HEADING,
  HomeDetailsModulesLicenses.JSON_PROPERTY_BUY_LINK,
  HomeDetailsModulesLicenses.JSON_PROPERTY_LIST_LINK
})
@JsonTypeName("HomeDetailsModulesLicenses")
