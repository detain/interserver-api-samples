 ...
 */
@JsonPropertyOrder({
  DomainProvProcessPendingAttributes.JSON_PROPERTY_ID,
  DomainProvProcessPendingAttributes.JSON_PROPERTY_ORDER_ID,
  DomainProvProcessPendingAttributes.JSON_PROPERTY_REGISTRATION_EXPIRATION_DATE,
  DomainProvProcessPendingAttributes.JSON_PROPERTY_F_AUTO_RENEW
})
@JsonTypeName("DomainProvProcessPending_attributes")
...
public class DomainProvProcessPendingAttributes {
    ...
    public static final String JSON_PROPERTY_REGISTRATION_EXPIRATION_DATE = "registration expiration date";
    private String registrationExpirationDate;

    public static final String JSON_PROPERTY_F_AUTO_RENEW = "f_auto_renew";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_REGISTRATION_EXPIRATION_DATE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_F_AUTO_RENEW)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
