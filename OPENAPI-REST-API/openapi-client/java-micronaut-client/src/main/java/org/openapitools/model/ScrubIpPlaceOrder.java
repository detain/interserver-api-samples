 ...
 */
@JsonPropertyOrder({
  ScrubIpPlaceOrder.JSON_PROPERTY_SERVICE_TYPE,
  ScrubIpPlaceOrder.JSON_PROPERTY_IP
})
@JsonTypeName("ScrubIpPlaceOrder")
...
public class ScrubIpPlaceOrder {
    ...
    public ScrubIpPlaceOrder(Integer serviceType, String ip) {
