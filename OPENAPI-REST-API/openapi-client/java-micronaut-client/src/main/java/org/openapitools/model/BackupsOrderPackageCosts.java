 ...
 */
@JsonPropertyOrder({
  BackupsOrderPackageCosts.JSON_PROPERTY_11006
})
@JsonTypeName("BackupsOrderPackageCosts")
...
public class BackupsOrderPackageCosts {
    public static final String JSON_PROPERTY_11006 = "11006";
    private Integer _11006;

    public BackupsOrderPackageCosts(Integer _11006) {
        this._11006 = _11006;
    }
     ...
     */
    @NotNull
    @JsonProperty(JSON_PROPERTY_11006)
