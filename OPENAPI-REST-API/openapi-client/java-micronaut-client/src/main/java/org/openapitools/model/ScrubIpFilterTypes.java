 ...
 */
@JsonPropertyOrder({
  ScrubIpFilterTypes.JSON_PROPERTY_SUCCESS,
  ScrubIpFilterTypes.JSON_PROPERTY_FILTERS
})
@JsonTypeName("ScrubIpFilterTypes")
...
public class ScrubIpFilterTypes {
    ...
    private Map<String, ScrubIpFilterTypesFiltersValue> filters = null;
