 ...
 */
@JsonPropertyOrder({
  VpsOrderLocationStock1.JSON_PROPERTY_KVM,
  VpsOrderLocationStock1.JSON_PROPERTY_KVMSTORAGE,
  VpsOrderLocationStock1.JSON_PROPERTY_HYPERV
})
@JsonTypeName("VpsOrder_locationStock_1")
