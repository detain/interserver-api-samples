 ...
 */
@JsonPropertyOrder({
  UpdateAccountTfaRequest.JSON_PROPERTY_2FA_GOOGLE_CODE
})
@JsonTypeName("updateAccountTfa_request")
...
public class UpdateAccountTfaRequest {
    public static final String JSON_PROPERTY_2FA_GOOGLE_CODE = "2fa_google_code";
    private String _2faGoogleCode;

    public UpdateAccountTfaRequest(String _2faGoogleCode) {
     ...
     */
    @NotNull
    @JsonProperty(JSON_PROPERTY_2FA_GOOGLE_CODE)
