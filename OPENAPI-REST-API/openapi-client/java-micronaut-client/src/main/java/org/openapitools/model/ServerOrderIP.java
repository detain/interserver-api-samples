 ...
 */
@JsonPropertyOrder({
  ServerOrderIP.JSON_PROPERTY_ID,
  ServerOrderIP.JSON_PROPERTY_PRICE,
  ServerOrderIP.JSON_PROPERTY_IMG,
  ServerOrderIP.JSON_PROPERTY_SHORT_DESC,
  ServerOrderIP.JSON_PROPERTY_LONG_DESC,
  ServerOrderIP.JSON_PROPERTY_QTY,
  ServerOrderIP.JSON_PROPERTY_MONTHLY_PRICE,
  ServerOrderIP.JSON_PROPERTY_PRICE_DISPLAY,
  ServerOrderIP.JSON_PROPERTY_MONTHLY_PRICE_DISPLAY
})
@JsonTypeName("ServerOrderIP")
