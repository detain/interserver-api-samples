...
public interface DomainsApi {
     ...
     */
    @Post(uri="/domains/{id}/dnssec")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<SuccessTextResponse> addDomainDnssec(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid DomainDnssecRequest domainDnssecRequest
    );
     ...
     * @return TextResponse
     */
    @Post(uri="/domains/{id}/nameservers")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<TextResponse> addDomainNameserver(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid DomainNameserverPostRequest domainNameserverPostRequest
    );
     ...
     */
    @Delete(uri="/domains/{id}")
    @Consumes({"application/json"})
    Mono<CancelDomain200Response> cancelDomain(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @return SuccessTextResponse
     */
    @Delete(uri="/domains/{id}/dnssec")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> deleteDomainDnssec(
        @PathVariable(name="id") @NotNull Integer id, 
     ...
     * @return TextResponse
     */
    @Delete(uri="/domains/{id}/nameservers")
    @Consumes({"application/json"})
    Mono<TextResponse> deleteDomainNameserver(
        @PathVariable(name="id") @NotNull Integer id, 
        @QueryValue(value="index") @NotNull Integer index
    );
     ...
     */
    @Get(uri="/domains/{id}/contact")
    @Consumes({"application/json"})
    Mono<DomainContactDetails> getDomainContact(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     */
    @Get(uri="/domains/{id}/dnssec")
    @Consumes({"application/json"})
    Mono<DomainDnssecRecords> getDomainDnssec(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     */
    @Get(uri="/domains/{id}/invoices")
    @Consumes({"application/json"})
    Mono<ChargeInvoiceRows> getDomainInvoices(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     */
    @Get(uri="/domains/lookup/{name}")
    @Consumes({"application/json"})
    Mono<DomainLookupResponse> getDomainLookup(
     ...
     */
    @Get(uri="/domains/{id}/nameservers")
    @Consumes({"application/json"})
    Mono<DomainNameserverGetResponse> getDomainNameservers(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     */
    @Get(uri="/domains/order/{domain}/{regType}")
    @Consumes({"application/json"})
    Mono<Void> getDomainOrderFields(
        @PathVariable(name="domain") @NotNull String domain, 
        @PathVariable(name="regType") @NotNull String regType
    );
     ...
     */
    @Get(uri="/domains/order/{domain}")
    @Consumes({"application/json"})
    Mono<Void> getDomainOrderSearchResults(
        @PathVariable(name="domain") @NotNull String domain
    );
     ...
     * @return SuccessTextResponse
     */
    @Get(uri="/domains/{id}/renew")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> getDomainRenewal(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     */
    @Get(uri="/domains/search/{name}")
    @Consumes({"application/json"})
    Mono<DomainSearchResponse> getDomainSearch(
        @PathVariable(name="name") @NotNull String name
    );
     ...
     * @return SuccessTextResponse
     */
    @Get(uri="/domains/{id}/transfer")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> getDomainTransfer(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @return SuccessTextResponse
     */
    @Get(uri="/domains/{id}/whois")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> getDomainWhoisPrivacy(
        @PathVariable(name="id") @NotNull Integer id
    );
    ...
    @Get(uri="/domains")
    @Consumes({"application/json"})
    Mono<List<DomainRow>> getDomainsList();
     ...
     * @return SuccessTextResponse
     */
    @Get(uri="/domains/{id}/welcome_email")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> getDomainsWelcomeEmail(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @return DomainOrder
     */
    @Get(uri="/domains/order")
    @Consumes({"application/json"})
    Mono<DomainOrder> getNewDomain();
     ...
     *
     */
    @Patch(uri="/domains/order")
    @Consumes({"application/json"})
    Mono<Void> patchDomains();
     ...
     * @return SuccessTextResponse
     */
    @Post(uri="/domains/{id}/renew")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> postDomainRenewal(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     * @return SuccessTextResponse
     */
    @Post(uri="/domains/{id}/transfer")
    @Consumes({"application/json"})
    Mono<SuccessTextResponse> postDomainTransfer(
        @PathVariable(name="id") @NotNull Integer id
    );
     ...
     *
     */
    @Put(uri="/domains/order")
    @Consumes({"application/json"})
    Mono<Void> putDomains();
     ...
     * @return SuccessTextResponse
     */
    @Post(uri="/domains/{id}/contact")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<SuccessTextResponse> updateDomainContact(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid DomainContactDetails domainContactDetails
    );
     ...
     * @return TextResponse
     */
    @Put(uri="/domains/{id}/nameservers")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<TextResponse> updateDomainNameservers(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid DomainNameserverPutRequest domainNameserverPutRequest
    );
     ...
     * @return SuccessTextResponse
     */
    @Post(uri="/domains/{id}/whois")
    @Consumes({"application/json"})
    @Produces({"application/json", "multipart/form-data"})
    Mono<SuccessTextResponse> updateDomainWhoisPrivacy(
        @PathVariable(name="id") @NotNull Integer id, 
        @Body @NotNull @Valid DomainWhoisPrivacyRequest domainWhoisPrivacyRequest
    );
