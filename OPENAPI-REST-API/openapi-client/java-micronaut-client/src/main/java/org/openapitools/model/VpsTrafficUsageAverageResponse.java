 ...
 */
@JsonPropertyOrder({
  VpsTrafficUsageAverageResponse.JSON_PROPERTY_IN,
  VpsTrafficUsageAverageResponse.JSON_PROPERTY_OUT
})
@JsonTypeName("VpsTrafficUsageAverageResponse")
...
public class VpsTrafficUsageAverageResponse {
    ...
    public VpsTrafficUsageAverageResponse(VpsTrafficUsageAverageSectionResponse in, VpsTrafficUsageAverageSectionResponse out) {
        this.in = in;
        this.out = out;
    }
