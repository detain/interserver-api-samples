 ...
 */
@JsonPropertyOrder({
  SuccessTextResponse.JSON_PROPERTY_SUCCESS,
  SuccessTextResponse.JSON_PROPERTY_TEXT,
  SuccessTextResponse.JSON_PROPERTY_ACTION
})
@JsonTypeName("SuccessTextResponse")
...
public class SuccessTextResponse {
    ...
    public SuccessTextResponse(Boolean success) {
