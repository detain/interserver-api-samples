 ...
 */
@JsonPropertyOrder({
  HomeServicesServersLinks.JSON_PROPERTY_16058
})
@JsonTypeName("HomeServicesServersLinks")
...
public class HomeServicesServersLinks {
    public static final String JSON_PROPERTY_16058 = "16058";
     ...
     */
    @Nullable
    @JsonProperty(JSON_PROPERTY_16058)
