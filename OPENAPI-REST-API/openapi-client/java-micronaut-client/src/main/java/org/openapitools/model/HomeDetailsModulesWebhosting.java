 ...
 */
@JsonPropertyOrder({
  HomeDetailsModulesWebhosting.JSON_PROPERTY_ICON,
  HomeDetailsModulesWebhosting.JSON_PROPERTY_VIEW_LINK,
  HomeDetailsModulesWebhosting.JSON_PROPERTY_HEADING,
  HomeDetailsModulesWebhosting.JSON_PROPERTY_BUY_LINK,
  HomeDetailsModulesWebhosting.JSON_PROPERTY_LIST_LINK
})
@JsonTypeName("HomeDetailsModulesWebhosting")
