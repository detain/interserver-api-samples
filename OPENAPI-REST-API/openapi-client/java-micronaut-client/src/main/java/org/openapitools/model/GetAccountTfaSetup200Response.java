 ...
 */
@JsonPropertyOrder({
  GetAccountTfaSetup200Response.JSON_PROPERTY_2FA_GOOGLE_KEY,
  GetAccountTfaSetup200Response.JSON_PROPERTY_2FA_GOOGLE_SPLIT
})
@JsonTypeName("getAccountTfaSetup_200_response")
