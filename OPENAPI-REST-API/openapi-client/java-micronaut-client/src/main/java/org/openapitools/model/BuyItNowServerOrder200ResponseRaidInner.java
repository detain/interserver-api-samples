 ...
 */
@JsonPropertyOrder({
  BuyItNowServerOrder200ResponseRaidInner.JSON_PROPERTY_ID,
  BuyItNowServerOrder200ResponseRaidInner.JSON_PROPERTY_SHORT_DESC,
  BuyItNowServerOrder200ResponseRaidInner.JSON_PROPERTY_LONG_DESC,
  BuyItNowServerOrder200ResponseRaidInner.JSON_PROPERTY_MONTHLY_PRICE
})
@JsonTypeName("buyItNowServerOrder_200_response_raid_inner")
