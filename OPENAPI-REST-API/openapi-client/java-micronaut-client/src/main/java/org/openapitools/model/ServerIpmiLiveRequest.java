 ...
 */
@JsonPropertyOrder({
  ServerIpmiLiveRequest.JSON_PROPERTY_IP,
  ServerIpmiLiveRequest.JSON_PROPERTY_ASSET
})
@JsonTypeName("ServerIpmiLiveRequest")
...
public class ServerIpmiLiveRequest {
    ...
    public ServerIpmiLiveRequest(String ip) {
        this.ip = ip;
    }
