 ...
 */
@JsonPropertyOrder({
  VpsPleskLicense.JSON_PROPERTY_ID,
  VpsPleskLicense.JSON_PROPERTY_NAME,
  VpsPleskLicense.JSON_PROPERTY_SUB_NAME,
  VpsPleskLicense.JSON_PROPERTY_COST
})
@JsonTypeName("VpsPleskLicense")
