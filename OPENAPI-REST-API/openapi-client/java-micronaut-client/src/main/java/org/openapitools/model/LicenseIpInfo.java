 ...
 */
@JsonPropertyOrder({
  LicenseIpInfo.JSON_PROPERTY_TITLE,
  LicenseIpInfo.JSON_PROPERTY_ROWS
})
@JsonTypeName("LicenseIpInfo")
...
public class LicenseIpInfo {
    ...
    private List<@Valid LicenseIpInfoRow> rows = null;
    ...
    public LicenseIpInfo rows(List<@Valid LicenseIpInfoRow> rows) {
        this.rows = rows;
        return this;
    }
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public List<@Valid LicenseIpInfoRow> getRows() {
        return rows;
    }

    @JsonProperty(JSON_PROPERTY_ROWS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setRows(List<@Valid LicenseIpInfoRow> rows) {
        this.rows = rows;
    }
