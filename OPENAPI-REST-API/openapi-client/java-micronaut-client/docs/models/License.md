...
The class is defined in **[License.java](../../src/main/java/org/openapitools/model/License.java)**
...
**clientLinks** | [`List&lt;LicenseClientLink&gt;`](LicenseClientLink.md) |  | 
...
**_package** | `String` | Package name | 
**serviceExtra** | `List&lt;String&gt;` | Extra service information | 
