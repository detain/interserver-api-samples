...
The class is defined in **[WebsitesOrderServiceOffer.java](../../src/main/java/org/openapitools/model/WebsitesOrderServiceOffer.java)**
...
**updatedAt** | `String` | The update timestamp of the service offer. |  [optional property]
**deletedAt** | `String` | The deletion timestamp of the service offer. |  [optional property]
