...
The class is defined in **[QuickserverServiceInfo.java](../../src/main/java/org/openapitools/model/QuickserverServiceInfo.java)**
...
**qsOrderDate** | `String` | Order date |  [optional property]
**qsStatus** | `String` | Status |  [optional property]
**qsInvoice** | `String` | Invoice number |  [optional property]
**qsCoupon** | `String` | Coupon information |  [optional property]
**qsExtra** | `String` | Extra information |  [optional property]
**qsHostname** | `String` | Hostname |  [optional property]
**qsServerStatus** | `String` | Server status |  [optional property]
