...
The class is defined in **[WebsitesOrder.java](../../src/main/java/org/openapitools/model/WebsitesOrder.java)**
...
**serviceOfferId** | `Integer` | Service offer ID description | 
...
**packges** | [`WebsitesOrderPackges`](WebsitesOrderPackges.md) |  |  [optional property]
