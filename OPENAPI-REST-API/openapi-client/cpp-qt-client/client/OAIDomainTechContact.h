...
/*
 * OAIDomainTechContact.h
 *
 * Technical contact information for a domain registration.
 */

#ifndef OAIDomainTechContact_H
#define OAIDomainTechContact_H
...
class OAIDomainTechContact : public OAIObject {
public:
    OAIDomainTechContact();
    OAIDomainTechContact(const QString &json);
    ~OAIDomainTechContact() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainTechContact)

#endif // OAIDomainTechContact_H
