...
#ifndef OAIVpsCPData_H
#define OAIVpsCPData_H
...
class OAIVpsCPData : public OAIObject {
public:
    OAIVpsCPData();
    OAIVpsCPData(const QString &json);
    ~OAIVpsCPData() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpsCPData)

#endif // OAIVpsCPData_H
