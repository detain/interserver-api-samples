...
/*
 * OAIDomainContactDetails.h
 *
 * Contact details used for domain registrant/admin/technical/billing records.
 */

#ifndef OAIDomainContactDetails_H
#define OAIDomainContactDetails_H
...
class OAIDomainContactDetails : public OAIObject {
public:
    OAIDomainContactDetails();
    OAIDomainContactDetails(const QString &json);
    ~OAIDomainContactDetails() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainContactDetails)

#endif // OAIDomainContactDetails_H
