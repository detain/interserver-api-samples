...
/*
 * OAIGetOrderDetail_200_response_packageCosts.h
 *
 * 
 */

#ifndef OAIGetOrderDetail_200_response_packageCosts_H
#define OAIGetOrderDetail_200_response_packageCosts_H
...
public:
    ...
    void setPackageCost(const double &package_cost);
    bool is_package_cost_Set() const;
    bool is_package_cost_Valid() const;
...
private:
    ...
    double m_package_cost;
    bool m_package_cost_isSet;
    bool m_package_cost_isValid;
...
Q_DECLARE_METATYPE(OpenAPI::OAIGetOrderDetail_200_response_packageCosts)

#endif // OAIGetOrderDetail_200_response_packageCosts_H
