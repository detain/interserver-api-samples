...
/*
 * OAIScrubIpFilterTypes.h
 *
 * Available scrub filter types for building firewall rules.
 */

#ifndef OAIScrubIpFilterTypes_H
#define OAIScrubIpFilterTypes_H
...
namespace OpenAPI {
class OAIScrubIpFilterTypes_filters_value;
...
public:
    ...
    QMap<QString, OAIScrubIpFilterTypes_filters_value> getFilters() const;
    void setFilters(const QMap<QString, OAIScrubIpFilterTypes_filters_value> &filters);
...
private:
    ...
    QMap<QString, OAIScrubIpFilterTypes_filters_value> m_filters;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScrubIpFilterTypes)

#endif // OAIScrubIpFilterTypes_H
