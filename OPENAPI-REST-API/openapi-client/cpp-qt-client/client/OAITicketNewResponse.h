...
/*
 * OAITicketNewResponse.h
 *
 * Response returned after creating a new support ticket.
 */

#ifndef OAITicketNewResponse_H
#define OAITicketNewResponse_H
...
class OAITicketNewResponse : public OAIObject {
public:
    OAITicketNewResponse();
    OAITicketNewResponse(const QString &json);
    ~OAITicketNewResponse() override;
    ...
    void setTicketId(const qint32 &ticket_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAITicketNewResponse)

#endif // OAITicketNewResponse_H
