...
#ifndef OAIIpLimitRange_H
#define OAIIpLimitRange_H
...
class OAIIpLimitRange : public OAIObject {
public:
    OAIIpLimitRange();
    OAIIpLimitRange(const QString &json);
    ~OAIIpLimitRange() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIIpLimitRange)

#endif // OAIIpLimitRange_H
