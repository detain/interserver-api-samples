...
/*
 * OAIServerOrderConfigIds.h
 *
 * Configuration IDs for the server order.
 */

#ifndef OAIServerOrderConfigIds_H
#define OAIServerOrderConfigIds_H
...
class OAIServerOrderConfigIds : public OAIObject {
public:
    OAIServerOrderConfigIds();
    OAIServerOrderConfigIds(const QString &json);
    ~OAIServerOrderConfigIds() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOrderConfigIds)

#endif // OAIServerOrderConfigIds_H
