...
/*
 * OAIMailDelistRequest.h
 *
 * Payload for removing a sender from mail blocklists.
 */

#ifndef OAIMailDelistRequest_H
#define OAIMailDelistRequest_H
...
public:
    ...
    bool is_unblock_Set() const;
    bool is_unblock_Valid() const;
...
private:
    ...
    QString m_unblock;
    bool m_unblock_isSet;
    bool m_unblock_isValid;
};

} // namespace OpenAPI

Q_DECLARE_METATYPE(OpenAPI::OAIMailDelistRequest)

#endif // OAIMailDelistRequest_H
