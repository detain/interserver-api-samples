...
/*
 * OAIDomainProvProcessPending.h
 *
 * Provisioning status data for a pending domain order.
 */

#ifndef OAIDomainProvProcessPending_H
#define OAIDomainProvProcessPending_H
...
namespace OpenAPI {
class OAIDomainProvProcessPending_attributes;
...
public:
    ...
    OAIDomainProvProcessPending_attributes getAttributes() const;
    void setAttributes(const OAIDomainProvProcessPending_attributes &attributes);
...
private:
    ...
    OAIDomainProvProcessPending_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainProvProcessPending)

#endif // OAIDomainProvProcessPending_H
