...
/*
 * OAIMailExtraInfoTableRow.h
 *
 * A single row in the mail service supplementary information table.
 */

#ifndef OAIMailExtraInfoTableRow_H
#define OAIMailExtraInfoTableRow_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailExtraInfoTableRow)

#endif // OAIMailExtraInfoTableRow_H
