...
QString OAIInline_object::getCode() const {
    return m_code;
}
void OAIInline_object::setCode(const QString &code) {
    m_code = code;
    m_code_isSet = true;
}

bool OAIInline_object::is_code_Set() const{
    return m_code_isSet;
}

bool OAIInline_object::is_code_Valid() const{
    return m_code_isValid;
}

QString OAIInline_object::getMessage() const {
    return m_message;
}
void OAIInline_object::setMessage(const QString &message) {
    m_message = message;
    m_message_isSet = true;
}

bool OAIInline_object::is_message_Set() const{
    return m_message_isSet;
}

bool OAIInline_object::is_message_Valid() const{
