...
/*
 * OAIBackupExtraInfoTables.h
 *
 * Supplementary information tables for a backup service (IP info, etc.).
 */

#ifndef OAIBackupExtraInfoTables_H
#define OAIBackupExtraInfoTables_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIBackupExtraInfoTables)

#endif // OAIBackupExtraInfoTables_H
