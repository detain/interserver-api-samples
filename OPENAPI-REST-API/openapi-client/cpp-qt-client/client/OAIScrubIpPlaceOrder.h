...
/*
 * OAIScrubIpPlaceOrder.h
 *
 * Place ScrubIP Order
 */

#ifndef OAIScrubIpPlaceOrder_H
#define OAIScrubIpPlaceOrder_H
...
class OAIScrubIpPlaceOrder : public OAIObject {
public:
    OAIScrubIpPlaceOrder();
    OAIScrubIpPlaceOrder(const QString &json);
    ~OAIScrubIpPlaceOrder() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIScrubIpPlaceOrder)

#endif // OAIScrubIpPlaceOrder_H
