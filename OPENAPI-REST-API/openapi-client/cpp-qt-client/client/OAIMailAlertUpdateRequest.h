...
/*
 * OAIMailAlertUpdateRequest.h
 *
 * Payload for updating an existing mail alert.
 */

#ifndef OAIMailAlertUpdateRequest_H
#define OAIMailAlertUpdateRequest_H
...
class OAIMailAlertUpdateRequest : public OAIObject {
public:
    OAIMailAlertUpdateRequest();
    OAIMailAlertUpdateRequest(const QString &json);
    ~OAIMailAlertUpdateRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIMailAlertUpdateRequest)

#endif // OAIMailAlertUpdateRequest_H
