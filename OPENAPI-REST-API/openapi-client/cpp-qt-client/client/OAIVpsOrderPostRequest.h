...
/*
 * OAIVpsOrderPostRequest.h
 *
 * request to validate a vps order
 */

#ifndef OAIVpsOrderPostRequest_H
#define OAIVpsOrderPostRequest_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpsOrderPostRequest)

#endif // OAIVpsOrderPostRequest_H
