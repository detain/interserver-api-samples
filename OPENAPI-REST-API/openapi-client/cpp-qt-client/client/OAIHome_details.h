...
#ifndef OAIHome_details_H
#define OAIHome_details_H
...
private:
    ...
    OAIHome_details_modules m_modules;
...
Q_DECLARE_METATYPE(OpenAPI::OAIHome_details)

#endif // OAIHome_details_H
