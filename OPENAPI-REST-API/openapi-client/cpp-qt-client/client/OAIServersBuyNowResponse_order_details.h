...
/*
 * OAIServersBuyNowResponse_order_details.h
 *
 * Details of the placed order.
 */

#ifndef OAIServersBuyNowResponse_order_details_H
#define OAIServersBuyNowResponse_order_details_H
...
public:
    ...
    void setInvoiceId(const double &invoice_id);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServersBuyNowResponse_order_details)

#endif // OAIServersBuyNowResponse_order_details_H
