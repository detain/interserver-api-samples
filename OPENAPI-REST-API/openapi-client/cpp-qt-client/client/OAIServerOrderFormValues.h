...
/*
 * OAIServerOrderFormValues.h
 *
 * Form values for the server order.
 */

#ifndef OAIServerOrderFormValues_H
#define OAIServerOrderFormValues_H
...
class OAIServerOrderFormValues : public OAIObject {
public:
    OAIServerOrderFormValues();
    OAIServerOrderFormValues(const QString &json);
    ~OAIServerOrderFormValues() override;
    ...
    QString getRaid() const;
    void setRaid(const QString &raid);
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOrderFormValues)

#endif // OAIServerOrderFormValues_H
