...
/*
 * OAIAccountInfoLimits.h
 *
 * IP address ranges used to restrict account access to specific IPs.
 */

#ifndef OAIAccountInfoLimits_H
#define OAIAccountInfoLimits_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountInfoLimits)

#endif // OAIAccountInfoLimits_H
