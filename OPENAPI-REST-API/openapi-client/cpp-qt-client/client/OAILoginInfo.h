...
#ifndef OAILoginInfo_H
#define OAILoginInfo_H
...
public:
    ...
    bool is_captcha_Set() const;
    bool is_captcha_Valid() const;

    OAILoginServiceCounts getCounts() const;
    void setCounts(const OAILoginServiceCounts &counts);
...
private:
    ...
    QString m_captcha;
    bool m_captcha_isSet;
    bool m_captcha_isValid;

    OAILoginServiceCounts m_counts;
    bool m_counts_isSet;
...
Q_DECLARE_METATYPE(OpenAPI::OAILoginInfo)

#endif // OAILoginInfo_H
