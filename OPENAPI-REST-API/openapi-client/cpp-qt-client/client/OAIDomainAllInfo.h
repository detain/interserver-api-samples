...
#ifndef OAIDomainAllInfo_H
#define OAIDomainAllInfo_H
...
namespace OpenAPI {
class OAIDomainAllInfo_attributes;
...
public:
    ...
    OAIDomainAllInfo_attributes getAttributes() const;
    void setAttributes(const OAIDomainAllInfo_attributes &attributes);
...
private:
    ...
    OAIDomainAllInfo_attributes m_attributes;
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainAllInfo)

#endif // OAIDomainAllInfo_H
