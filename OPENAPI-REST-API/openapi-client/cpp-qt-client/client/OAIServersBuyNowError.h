...
/*
 * OAIServersBuyNowError.h
 *
 * Error response when a buy-it-now server order fails validation.
 */

#ifndef OAIServersBuyNowError_H
#define OAIServersBuyNowError_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIServersBuyNowError)

#endif // OAIServersBuyNowError_H
