...
#ifndef OAIVpsPlesk12Data_H
#define OAIVpsPlesk12Data_H
...
public:
    ...
    OAIVpsPleskLicense getPro() const;
    void setPro(const OAIVpsPleskLicense &pro);
    bool is_pro_Set() const;
    bool is_pro_Valid() const;

    OAIVpsPleskLicense getHost() const;
    void setHost(const OAIVpsPleskLicense &host);
...
private:
    ...
    OAIVpsPleskLicense m_admin;
    bool m_admin_isSet;
    bool m_admin_isValid;

    OAIVpsPleskLicense m_pro;
    bool m_pro_isSet;
    bool m_pro_isValid;

    OAIVpsPleskLicense m_host;
    bool m_host_isSet;
    bool m_host_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIVpsPlesk12Data)

#endif // OAIVpsPlesk12Data_H
