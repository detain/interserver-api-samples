...
/*
 * OAIBillingInvoiceList.h
 *
 * Summary list of invoices for the account.
 */

#ifndef OAIBillingInvoiceList_H
#define OAIBillingInvoiceList_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIBillingInvoiceList)

#endif // OAIBillingInvoiceList_H
