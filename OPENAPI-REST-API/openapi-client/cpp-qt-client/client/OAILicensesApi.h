...
public:
    ...
    */
    virtual void getLicenseInfo(const qint32 &id);

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void getLicenseInvoices(const qint32 &id);
    ...
    * @param[in]  id qint32 [required]
    */
    virtual void getLicensesWelcomeEmail(const qint32 &id);


    virtual void getNewLicense();

    /**
    * @param[in]  id qint32 [required]
    */
    virtual void licensesCancel(const qint32 &id);

    /**
    * @param[in]  id qint32 [required]
    * @param[in]  oaiip_object OAIIpObject [required]
    */
    ...
    */
    virtual void updateLicenseInfo(const QString &id);
...
private:
    ...
    void postLicenseChangeIpCallback(OAIHttpRequestWorker *worker);
    void putLicensesCallback(OAIHttpRequestWorker *worker);
    void updateLicenseInfoCallback(OAIHttpRequestWorker *worker);
