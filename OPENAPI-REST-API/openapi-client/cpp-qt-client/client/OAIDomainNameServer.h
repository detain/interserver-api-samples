...
/*
 * OAIDomainNameServer.h
 *
 * A single registered nameserver entry with glue IPs.
 */

#ifndef OAIDomainNameServer_H
#define OAIDomainNameServer_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIDomainNameServer)

#endif // OAIDomainNameServer_H
