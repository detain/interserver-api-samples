...
/*
 * OAIWebsiteExtraInfoTables.h
 *
 * Supplementary information tables displayed for a webhosting service (links, DNS, preview).
 */

#ifndef OAIWebsiteExtraInfoTables_H
#define OAIWebsiteExtraInfoTables_H
...
public:
    ...
    OAIWebsiteTable getPreview() const;
    void setPreview(const OAIWebsiteTable &preview);
    bool is_preview_Set() const;
    bool is_preview_Valid() const;

    OAIWebsiteTable getDns() const;
    void setDns(const OAIWebsiteTable &dns);
...
private:
    ...
    OAIWebsiteTable m_links;
    bool m_links_isSet;
    bool m_links_isValid;

    OAIWebsiteTable m_preview;
    bool m_preview_isSet;
    bool m_preview_isValid;

    OAIWebsiteTable m_dns;
    bool m_dns_isSet;
    bool m_dns_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIWebsiteExtraInfoTables)

#endif // OAIWebsiteExtraInfoTables_H
