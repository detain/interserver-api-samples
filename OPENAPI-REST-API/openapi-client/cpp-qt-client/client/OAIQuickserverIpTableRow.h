...
/*
 * OAIQuickserverIpTableRow.h
 *
 * A single row in the QuickServer IP information table.
 */

#ifndef OAIQuickserverIpTableRow_H
#define OAIQuickserverIpTableRow_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIQuickserverIpTableRow)

#endif // OAIQuickserverIpTableRow_H
