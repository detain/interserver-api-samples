...
/*
 * OAIAccountInfoOauthConfig.h
 *
 * OAuth integration configuration including callback URL and available providers.
 */

#ifndef OAIAccountInfoOauthConfig_H
#define OAIAccountInfoOauthConfig_H

#include <QJsonObject>

#include "OAIAccountInfoOauthConfigProviders.h"
#include <QString>
...
public:
    ...
    OAIAccountInfoOauthConfigProviders<QString, OAIAccountInfoOauthConfigProviders_value> getProviders() const;
    void setProviders(const OAIAccountInfoOauthConfigProviders<QString, OAIAccountInfoOauthConfigProviders_value> &providers);
...
private:
    ...
    OAIAccountInfoOauthConfigProviders<QString, OAIAccountInfoOauthConfigProviders_value> m_providers;
...
Q_DECLARE_METATYPE(OpenAPI::OAIAccountInfoOauthConfig)

#endif // OAIAccountInfoOauthConfig_H
