...
/*
 * OAIServerOrder_ips_li.h
 *
 * IP options for the server order.
 */

#ifndef OAIServerOrder_ips_li_H
#define OAIServerOrder_ips_li_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOrder_ips_li)

#endif // OAIServerOrder_ips_li_H
