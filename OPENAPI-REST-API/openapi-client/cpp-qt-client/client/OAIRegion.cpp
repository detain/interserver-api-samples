...
OAIRegion::OAIRegion(const QString &json) {
...
void OAIRegion::fromJson(const QString &jsonString) {
...
qint32 OAIRegion::getRegionId() const {
    return m_region_id;
}
void OAIRegion::setRegionId(const qint32 &region_id) {
