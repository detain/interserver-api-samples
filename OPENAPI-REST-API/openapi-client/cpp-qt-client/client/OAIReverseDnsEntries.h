...
/*
 * OAIReverseDnsEntries.h
 *
 * The Reverse DNS entries.
 */

#ifndef OAIReverseDnsEntries_H
#define OAIReverseDnsEntries_H
...
Q_DECLARE_METATYPE(OpenAPI::OAIReverseDnsEntries)

#endif // OAIReverseDnsEntries_H
