...
/*
 * OAILoginServiceCounts.h
 *
 * Order counts per module.
 */

#ifndef OAILoginServiceCounts_H
#define OAILoginServiceCounts_H
...
public:
    ...
    qint32 getWebsites() const;
    void setWebsites(const qint32 &websites);
...
Q_DECLARE_METATYPE(OpenAPI::OAILoginServiceCounts)

#endif // OAILoginServiceCounts_H
