...
/*
 * OAIServerOrder_bandwidth_li.h
 *
 * Bandwidth options for the server order.
 */

#ifndef OAIServerOrder_bandwidth_li_H
#define OAIServerOrder_bandwidth_li_H
...
public:
    ...
    bool is_r_15_Set() const;
    bool is_r_15_Valid() const;
...
private:
    ...
    OAIServerOrderBandwidth m_r_15;
    bool m_r_15_isSet;
    bool m_r_15_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOrder_bandwidth_li)

#endif // OAIServerOrder_bandwidth_li_H
