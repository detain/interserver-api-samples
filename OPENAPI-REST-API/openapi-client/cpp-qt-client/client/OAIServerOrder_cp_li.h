...
/*
 * OAIServerOrder_cp_li.h
 *
 * Control Panel options for the server order.
 */

#ifndef OAIServerOrder_cp_li_H
#define OAIServerOrder_cp_li_H
...
namespace OpenAPI {
class OAIServerOrderControlPanel;
...
private:
    ...
    OAIServerOrderControlPanel m_r_9;
    bool m_r_9_isSet;
    bool m_r_9_isValid;
};
...
Q_DECLARE_METATYPE(OpenAPI::OAIServerOrder_cp_li)

#endif // OAIServerOrder_cp_li_H
