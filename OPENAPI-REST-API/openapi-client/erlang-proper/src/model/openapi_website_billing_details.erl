-module(openapi_website_billing_details).

-include("openapi.hrl").

-export([openapi_website_billing_details/0]).

-export([openapi_website_billing_details/1]).

-export_type([openapi_website_billing_details/0]).

-type openapi_website_billing_details() ::
...
openapi_website_billing_details() ->
    openapi_website_billing_details([]).

openapi_website_billing_details(Fields) ->
