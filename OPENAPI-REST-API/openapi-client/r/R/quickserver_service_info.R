...
#' @field qs_ipv6 IPv6 address (null) \link{AnyType} [optional]
...
#' @field qs_vnc_port VNC port (null) \link{AnyType} [optional]
...
#' @field qs_platform Platform (null) \link{AnyType} [optional]
  ...
  public = list(
    ...
    toSimpleType = function() {
      ...
      if (!is.null(self$`qs_ipv6`)) {
        QuickserverServiceInfoObject[["qs_ipv6"]] <-
          self$extractSimpleType(self$`qs_ipv6`)
      }
      ...
      if (!is.null(self$`qs_vnc_port`)) {
        QuickserverServiceInfoObject[["qs_vnc_port"]] <-
          self$extractSimpleType(self$`qs_vnc_port`)
      }
      ...
      if (!is.null(self$`qs_platform`)) {
        QuickserverServiceInfoObject[["qs_platform"]] <-
          self$extractSimpleType(self$`qs_platform`)
      }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`qs_ipv6`)) {
        `qs_ipv6_object` <- AnyType$new()
        `qs_ipv6_object`$fromJSON(jsonlite::toJSON(this_object$`qs_ipv6`, auto_unbox = TRUE, digits = NA))
        self$`qs_ipv6` <- `qs_ipv6_object`
      }
      ...
      if (!is.null(this_object$`qs_vnc_port`)) {
        `qs_vnc_port_object` <- AnyType$new()
        `qs_vnc_port_object`$fromJSON(jsonlite::toJSON(this_object$`qs_vnc_port`, auto_unbox = TRUE, digits = NA))
        self$`qs_vnc_port` <- `qs_vnc_port_object`
      }
      ...
      if (!is.null(this_object$`qs_platform`)) {
        `qs_platform_object` <- AnyType$new()
        `qs_platform_object`$fromJSON(jsonlite::toJSON(this_object$`qs_platform`, auto_unbox = TRUE, digits = NA))
        self$`qs_platform` <- `qs_platform_object`
      }
      self
    },
    ...
    fromJSONString = function(input_json) {
      ...
      self$`qs_server` <- this_object$`qs_server`
      self$`qs_ip` <- this_object$`qs_ip`
      self$`qs_ipv6` <- AnyType$new()$fromJSON(jsonlite::toJSON(this_object$`qs_ipv6`, auto_unbox = TRUE, digits = NA))
      self$`qs_vzid` <- this_object$`qs_vzid`
      self$`qs_currency` <- this_object$`qs_currency`
      self$`qs_type` <- this_object$`qs_type`
      self$`qs_order_date` <- this_object$`qs_order_date`
      ...
      self$`qs_slices` <- this_object$`qs_slices`
      self$`qs_vnc` <- this_object$`qs_vnc`
      self$`qs_vnc_port` <- AnyType$new()$fromJSON(jsonlite::toJSON(this_object$`qs_vnc_port`, auto_unbox = TRUE, digits = NA))
      self$`qs_rootpass` <- this_object$`qs_rootpass`
      self$`qs_mac` <- this_object$`qs_mac`
      self$`qs_os` <- this_object$`qs_os`
      self$`qs_version` <- this_object$`qs_version`
      self$`qs_location` <- this_object$`qs_location`
      self$`qs_platform` <- AnyType$new()$fromJSON(jsonlite::toJSON(this_object$`qs_platform`, auto_unbox = TRUE, digits = NA))
      self
    },
