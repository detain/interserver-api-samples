#' Create a new BackupBillingDetails
#'
#' @description
#' BackupBillingDetails Class
#'
#' @docType class
#' @title BackupBillingDetails
#' @description BackupBillingDetails Class
#' @format An \code{R6Class} generator object
#' @field service_last_invoice_date Last invoice date of the service. character [optional]
#' @field service_payment_status Payment status of the service. character [optional]
#' @field service_frequency Billing frequency of the service. character [optional]
#' @field next_date Next billing date of the service. character [optional]
#' @field service_next_invoice_date Next invoice date of the service. character [optional]
#' @field service_currency Currency of the service. character [optional]
#' @field service_currency_symbol Currency symbol of the service. character [optional]
#' @field service_cost_info Cost information of the service. character [optional]
#' @field service_extra Service Extra Info character [optional]
#' @field service_extra_json JSON representation of extra service information. character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
BackupBillingDetails <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new BackupBillingDetails class.
    #'
    #' @param service_last_invoice_date Last invoice date of the service.
    #' @param service_payment_status Payment status of the service.
    #' @param service_frequency Billing frequency of the service.
    #' @param next_date Next billing date of the service.
    #' @param service_next_invoice_date Next invoice date of the service.
    #' @param service_currency Currency of the service.
    #' @param service_currency_symbol Currency symbol of the service.
    #' @param service_cost_info Cost information of the service.
    #' @param service_extra Service Extra Info
    #' @param service_extra_json JSON representation of extra service information.
    ...
    initialize = function(`service_last_invoice_date` = NULL, `service_payment_status` = NULL, `service_frequency` = NULL, `next_date` = NULL, `service_next_invoice_date` = NULL, `service_currency` = NULL, `service_currency_symbol` = NULL, `service_cost_info` = NULL, `service_extra` = NULL, `service_extra_json` = NULL, ...) {
      ...
      if (!is.null(`service_extra`)) {
        if (!(is.character(`service_extra`) && length(`service_extra`) == 1)) {
          stop(paste("Error! Invalid data for `service_extra`. Must be a string:", `service_extra`))
        }
    ...
    #'
    #' @return BackupBillingDetails as a base R list.
    #' @examples
    #' # convert array of BackupBillingDetails (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert BackupBillingDetails to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      BackupBillingDetailsObject <- list()
      if (!is.null(self$`service_last_invoice_date`)) {
        BackupBillingDetailsObject[["service_last_invoice_date"]] <-
          self$`service_last_invoice_date`
      }
      if (!is.null(self$`service_payment_status`)) {
        BackupBillingDetailsObject[["service_payment_status"]] <-
          self$`service_payment_status`
      }
      if (!is.null(self$`service_frequency`)) {
        BackupBillingDetailsObject[["service_frequency"]] <-
          self$`service_frequency`
      }
      if (!is.null(self$`next_date`)) {
        BackupBillingDetailsObject[["next_date"]] <-
          self$`next_date`
      }
      if (!is.null(self$`service_next_invoice_date`)) {
        BackupBillingDetailsObject[["service_next_invoice_date"]] <-
          self$`service_next_invoice_date`
      }
      if (!is.null(self$`service_currency`)) {
        BackupBillingDetailsObject[["service_currency"]] <-
          self$`service_currency`
      }
      if (!is.null(self$`service_currency_symbol`)) {
        BackupBillingDetailsObject[["service_currency_symbol"]] <-
          self$`service_currency_symbol`
      }
      if (!is.null(self$`service_cost_info`)) {
        BackupBillingDetailsObject[["service_cost_info"]] <-
          self$`service_cost_info`
      }
      if (!is.null(self$`service_extra`)) {
        BackupBillingDetailsObject[["service_extra"]] <-
          self$`service_extra`
      }
      if (!is.null(self$`service_extra_json`)) {
        BackupBillingDetailsObject[["service_extra_json"]] <-
          self$`service_extra_json`
      }
      return(BackupBillingDetailsObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of BackupBillingDetails
    #'
    #' @param input_json the JSON input
    #' @return the instance of BackupBillingDetails
    ...
    #' @return BackupBillingDetails in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to BackupBillingDetails and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of BackupBillingDetails
    toString = function() {
      self$toJSONString()
    },
...
# BackupBillingDetails$unlock()
#
## Below is an example to define the print function
# BackupBillingDetails$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# BackupBillingDetails$lock()
