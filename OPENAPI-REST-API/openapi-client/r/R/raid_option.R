...
RaidOption <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new RaidOption class.
    #'
    #' @param id id
    ...
    #'
    #' @return RaidOption as a base R list.
    #' @examples
    #' # convert array of RaidOption (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert RaidOption to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      RaidOptionObject <- list()
      if (!is.null(self$`id`)) {
        RaidOptionObject[["id"]] <-
          self$`id`
      }
      if (!is.null(self$`short_desc`)) {
        RaidOptionObject[["short_desc"]] <-
          self$`short_desc`
      }
      if (!is.null(self$`monthly_price`)) {
        RaidOptionObject[["monthly_price"]] <-
          self$`monthly_price`
      }
      return(RaidOptionObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of RaidOption
    #'
    #' @param input_json the JSON input
    #' @return the instance of RaidOption
    ...
    #' @return RaidOption in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to RaidOption and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of RaidOption
    toString = function() {
      self$toJSONString()
    },
...
# RaidOption$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
