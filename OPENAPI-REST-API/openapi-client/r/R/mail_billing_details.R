#' Create a new MailBillingDetails
#'
#' @description
#' Billing information for a mail service including payment status, billing cycle, and cost.
#'
#' @docType class
#' @title MailBillingDetails
#' @description MailBillingDetails Class
#' @format An \code{R6Class} generator object
#' @field service_last_invoice_date The last invoice date of the service. character [optional]
#' @field service_payment_status The payment status of the service. character [optional]
#' @field service_frequency The frequency of the service payment. character [optional]
#' @field next_date The next payment date of the service. character [optional]
#' @field service_next_invoice_date The next invoice date of the service. character [optional]
#' @field service_currency The currency of the service. character [optional]
#' @field service_currency_symbol The currency symbol of the service. character [optional]
#' @field service_cost_info The cost information of the service. character [optional]
#' @field service_extra Extra information for the service. list(character) [optional]
#' @field service_extra_json Extra JSON information for the service. character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
MailBillingDetails <- R6::R6Class(
  "MailBillingDetails",
  public = list(
    ...
    #' @description
    #' Initialize a new MailBillingDetails class.
    #'
    #' @param service_last_invoice_date The last invoice date of the service.
    #' @param service_payment_status The payment status of the service.
    #' @param service_frequency The frequency of the service payment.
    #' @param next_date The next payment date of the service.
    #' @param service_next_invoice_date The next invoice date of the service.
    #' @param service_currency The currency of the service.
    #' @param service_currency_symbol The currency symbol of the service.
    #' @param service_cost_info The cost information of the service.
    #' @param service_extra Extra information for the service.
    #' @param service_extra_json Extra JSON information for the service.
    ...
    initialize = function(`service_last_invoice_date` = NULL, `service_payment_status` = NULL, `service_frequency` = NULL, `next_date` = NULL, `service_next_invoice_date` = NULL, `service_currency` = NULL, `service_currency_symbol` = NULL, `service_cost_info` = NULL, `service_extra` = NULL, `service_extra_json` = NULL, ...) {
      ...
      if (!is.null(`service_extra`)) {
        stopifnot(is.vector(`service_extra`), length(`service_extra`) != 0)
        sapply(`service_extra`, function(x) stopifnot(is.character(x)))
    ...
    #'
    #' @return MailBillingDetails as a base R list.
    #' @examples
    #' # convert array of MailBillingDetails (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert MailBillingDetails to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      MailBillingDetailsObject <- list()
      if (!is.null(self$`service_last_invoice_date`)) {
        MailBillingDetailsObject[["service_last_invoice_date"]] <-
          self$`service_last_invoice_date`
      }
      if (!is.null(self$`service_payment_status`)) {
        MailBillingDetailsObject[["service_payment_status"]] <-
          self$`service_payment_status`
      }
      if (!is.null(self$`service_frequency`)) {
        MailBillingDetailsObject[["service_frequency"]] <-
          self$`service_frequency`
      }
      if (!is.null(self$`next_date`)) {
        MailBillingDetailsObject[["next_date"]] <-
          self$`next_date`
      }
      if (!is.null(self$`service_next_invoice_date`)) {
        MailBillingDetailsObject[["service_next_invoice_date"]] <-
          self$`service_next_invoice_date`
      }
      if (!is.null(self$`service_currency`)) {
        MailBillingDetailsObject[["service_currency"]] <-
          self$`service_currency`
      }
      if (!is.null(self$`service_currency_symbol`)) {
        MailBillingDetailsObject[["service_currency_symbol"]] <-
          self$`service_currency_symbol`
      }
      if (!is.null(self$`service_cost_info`)) {
        MailBillingDetailsObject[["service_cost_info"]] <-
          self$`service_cost_info`
      }
      if (!is.null(self$`service_extra`)) {
        MailBillingDetailsObject[["service_extra"]] <-
          self$`service_extra`
      }
      if (!is.null(self$`service_extra_json`)) {
        MailBillingDetailsObject[["service_extra_json"]] <-
          self$`service_extra_json`
      }
      return(MailBillingDetailsObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of MailBillingDetails
    #'
    #' @param input_json the JSON input
    #' @return the instance of MailBillingDetails
    ...
    #' @return MailBillingDetails in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to MailBillingDetails and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of MailBillingDetails
    toString = function() {
      self$toJSONString()
    },
...
# MailBillingDetails$unlock()
#
## Below is an example to define the print function
# MailBillingDetails$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# MailBillingDetails$lock()
