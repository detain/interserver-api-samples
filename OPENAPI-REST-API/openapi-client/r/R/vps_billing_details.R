#' Create a new VpsBillingDetails
#'
#' @description
#' Billing information for a VPS service including payment status, billing cycle, and cost.
#'
#' @docType class
#' @title VpsBillingDetails
#' @description VpsBillingDetails Class
...
#' @field service_frequency Billing frequency character [optional]
#' @field next_date Next billing date character [optional]
#' @field service_next_invoice_date Next invoice date character [optional]
#' @field service_currency Currency used for billing character [optional]
#' @field service_currency_symbol Currency symbol character [optional]
#' @field service_coupon Billing coupon code character [optional]
#' @field service_cost_info Cost information character [optional]
#' @field service_extra  \link{VpsServiceExtra} [optional]
#' @field service_extra_json Additional information in JSON format character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
VpsBillingDetails <- R6::R6Class(
  "VpsBillingDetails",
  public = list(
    ...
    #' @description
    #' Initialize a new VpsBillingDetails class.
    #'
    ...
    #'
    #' @return VpsBillingDetails as a base R list.
    #' @examples
    #' # convert array of VpsBillingDetails (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Deserialize JSON string into an instance of VpsBillingDetails
    #'
    #' @param input_json the JSON input
    #' @return the instance of VpsBillingDetails
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`service_extra`)) {
        `service_extra_object` <- VpsServiceExtra$new()
    ...
    #' @return VpsBillingDetails in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`service_coupon` <- this_object$`service_coupon`
      self$`service_cost_info` <- this_object$`service_cost_info`
      self$`service_extra` <- VpsServiceExtra$new()$fromJSON(jsonlite::toJSON(this_object$`service_extra`, auto_unbox = TRUE, digits = NA))
      self$`service_extra_json` <- this_object$`service_extra_json`
      self
    },

    #' @description
    #' Validate JSON input with respect to VpsBillingDetails and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of VpsBillingDetails
    toString = function() {
      self$toJSONString()
    },
...
# VpsBillingDetails$unlock()
#
## Below is an example to define the print function
# VpsBillingDetails$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VpsBillingDetails$lock()
