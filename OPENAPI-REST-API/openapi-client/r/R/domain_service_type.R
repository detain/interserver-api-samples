#' Create a new DomainServiceType
#'
#' @description
#' Service type definition for a domain registration, including name, pricing, and category.
#'
#' @docType class
#' @title DomainServiceType
#' @description DomainServiceType Class
#' @format An \code{R6Class} generator object
#' @field services_id Service type ID. character [optional]
#' @field services_name Service type name (e.g., .com Registration). character [optional]
#' @field services_cost Service cost per billing period. character [optional]
#' @field services_category Service category ID. character [optional]
#' @field services_buyable Whether this service type is available for purchase. character [optional]
#' @field services_type Internal service type identifier. character [optional]
#' @field services_field1 TLD or first configurable field for the service type. character [optional]
#' @field services_field2 Second configurable field for the service type. character [optional]
#' @field services_module Backend module handling this service type. character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
DomainServiceType <- R6::R6Class(
  "DomainServiceType",
  public = list(
    `services_id` = NULL,
    `services_name` = NULL,
    ...
    #' @description
    #' Initialize a new DomainServiceType class.
    #'
    ...
    #'
    #' @return DomainServiceType as a base R list.
    #' @examples
    #' # convert array of DomainServiceType (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DomainServiceType to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DomainServiceTypeObject <- list()
      if (!is.null(self$`services_id`)) {
        DomainServiceTypeObject[["services_id"]] <-
          self$`services_id`
      }
      if (!is.null(self$`services_name`)) {
        DomainServiceTypeObject[["services_name"]] <-
          self$`services_name`
      }
      if (!is.null(self$`services_cost`)) {
        DomainServiceTypeObject[["services_cost"]] <-
          self$`services_cost`
      }
      if (!is.null(self$`services_category`)) {
        DomainServiceTypeObject[["services_category"]] <-
          self$`services_category`
      }
      if (!is.null(self$`services_buyable`)) {
        DomainServiceTypeObject[["services_buyable"]] <-
          self$`services_buyable`
      }
      if (!is.null(self$`services_type`)) {
        DomainServiceTypeObject[["services_type"]] <-
          self$`services_type`
      }
      if (!is.null(self$`services_field1`)) {
        DomainServiceTypeObject[["services_field1"]] <-
          self$`services_field1`
      }
      if (!is.null(self$`services_field2`)) {
        DomainServiceTypeObject[["services_field2"]] <-
          self$`services_field2`
      }
      if (!is.null(self$`services_module`)) {
        DomainServiceTypeObject[["services_module"]] <-
          self$`services_module`
      }
      return(DomainServiceTypeObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of DomainServiceType
    #'
    #' @param input_json the JSON input
    #' @return the instance of DomainServiceType
    ...
    #' @return DomainServiceType in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DomainServiceType and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of DomainServiceType
    toString = function() {
      self$toJSONString()
    },
...
# DomainServiceType$unlock()
#
## Below is an example to define the print function
# DomainServiceType$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DomainServiceType$lock()
