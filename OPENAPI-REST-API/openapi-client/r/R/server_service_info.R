...
#' @field server_discount Discount information for the server. character [optional]
...
#' @field server_location The location of the server. character [optional]
...
#' @field server_dedicated_hd2 The size of the second dedicated hard drive. character [optional]
...
#' @field server_dedicated_cp The control panel of the server. character [optional]
  ...
  public = list(
    ...
    initialize = function(`server_id` = NULL, `server_hostname` = NULL, `server_custid` = NULL, `server_type` = NULL, `server_currency` = NULL, `server_order_date` = NULL, `server_invoice` = NULL, `server_coupon` = NULL, `server_status` = NULL, `server_root` = NULL, `server_dedicated_tag` = NULL, `server_custom_tag` = NULL, `server_comment` = NULL, `server_initial_bill` = NULL, `server_hardware` = NULL, `server_ips` = NULL, `server_monthly_bill` = NULL, `server_setup` = NULL, `server_discount` = NULL, `server_rep` = NULL, `server_date` = NULL, `server_total_cost` = NULL, `server_location` = NULL, `server_hardware_ordered` = NULL, `server_billed` = NULL, `server_welcome_email` = NULL, `server_dedicated_cpu` = NULL, `server_dedicated_memory` = NULL, `server_dedicated_hd1` = NULL, `server_dedicated_hd2` = NULL, `server_dedicated_bandwidth` = NULL, `server_dedicated_ips` = NULL, `server_dedicated_os` = NULL, `server_dedicated_cp` = NULL, `server_dedicated_raid` = NULL, `server_extra` = NULL, ...) {
      ...
      if (!is.null(`server_discount`)) {
        if (!(is.character(`server_discount`) && length(`server_discount`) == 1)) {
          stop(paste("Error! Invalid data for `server_discount`. Must be a string:", `server_discount`))
        }
      ...
      if (!is.null(`server_location`)) {
        if (!(is.character(`server_location`) && length(`server_location`) == 1)) {
          stop(paste("Error! Invalid data for `server_location`. Must be a string:", `server_location`))
        }
      ...
      if (!is.null(`server_dedicated_hd2`)) {
        if (!(is.character(`server_dedicated_hd2`) && length(`server_dedicated_hd2`) == 1)) {
          stop(paste("Error! Invalid data for `server_dedicated_hd2`. Must be a string:", `server_dedicated_hd2`))
        }
      ...
      if (!is.null(`server_dedicated_cp`)) {
        if (!(is.character(`server_dedicated_cp`) && length(`server_dedicated_cp`) == 1)) {
          stop(paste("Error! Invalid data for `server_dedicated_cp`. Must be a string:", `server_dedicated_cp`))
        }
    ...
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`server_discount`)) {
        self$`server_discount` <- this_object$`server_discount`
      }
      ...
      if (!is.null(this_object$`server_location`)) {
        self$`server_location` <- this_object$`server_location`
      }
      ...
      if (!is.null(this_object$`server_dedicated_hd2`)) {
        self$`server_dedicated_hd2` <- this_object$`server_dedicated_hd2`
      }
      ...
      if (!is.null(this_object$`server_dedicated_cp`)) {
        self$`server_dedicated_cp` <- this_object$`server_dedicated_cp`
      }
