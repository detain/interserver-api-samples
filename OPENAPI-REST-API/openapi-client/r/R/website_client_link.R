#' Create a new WebsiteClientLink
#'
#' @description
#' A navigation link for webhosting-related actions in the client portal.
#'
#' @docType class
#' @title WebsiteClientLink
#' @description WebsiteClientLink Class
#' @format An \code{R6Class} generator object
#' @field label Label for the link character [optional]
#' @field link Link URL character [optional]
#' @field icon Icon for the link character [optional]
#' @field icon_text Icon text for the link character [optional]
#' @field help_text Help text for the link character [optional]
#' @field other_attr Other attributes for the link character [optional]
#' @importFrom R6 R6Class
#' @importFrom jsonlite fromJSON toJSON
#' @export
WebsiteClientLink <- R6::R6Class(
  "WebsiteClientLink",
  public = list(
    `label` = NULL,
    `link` = NULL,
    ...
    #' @description
    #' Initialize a new WebsiteClientLink class.
    #'
    ...
    #'
    #' @return WebsiteClientLink as a base R list.
    #' @examples
    #' # convert array of WebsiteClientLink (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert WebsiteClientLink to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      WebsiteClientLinkObject <- list()
      if (!is.null(self$`label`)) {
        WebsiteClientLinkObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`link`)) {
        WebsiteClientLinkObject[["link"]] <-
          self$`link`
      }
      if (!is.null(self$`icon`)) {
        WebsiteClientLinkObject[["icon"]] <-
          self$`icon`
      }
      if (!is.null(self$`icon_text`)) {
        WebsiteClientLinkObject[["icon_text"]] <-
          self$`icon_text`
      }
      if (!is.null(self$`help_text`)) {
        WebsiteClientLinkObject[["help_text"]] <-
          self$`help_text`
      }
      if (!is.null(self$`other_attr`)) {
        WebsiteClientLinkObject[["other_attr"]] <-
          self$`other_attr`
      }
      return(WebsiteClientLinkObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of WebsiteClientLink
    #'
    #' @param input_json the JSON input
    #' @return the instance of WebsiteClientLink
    ...
    #' @return WebsiteClientLink in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to WebsiteClientLink and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of WebsiteClientLink
    toString = function() {
      self$toJSONString()
    },
...
# WebsiteClientLink$unlock()
#
## Below is an example to define the print function
# WebsiteClientLink$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# WebsiteClientLink$lock()
