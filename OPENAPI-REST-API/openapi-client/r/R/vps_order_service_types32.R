#' Create a new VpsOrderServiceTypes32
#'
#' @description
#' VpsOrderServiceTypes32 Class
#'
#' @docType class
#' @title VpsOrderServiceTypes32
#' @description VpsOrderServiceTypes32 Class
#' @format An \code{R6Class} generator object
#' @field services_id  character [optional]
#' @field services_name  character [optional]
#' @field services_cost  character [optional]
#' @field services_category  character [optional]
#' @field services_buyable  character [optional]
#' @field services_type  character [optional]
...
#' @export
VpsOrderServiceTypes32 <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new VpsOrderServiceTypes32 class.
    #'
    ...
    #'
    #' @return VpsOrderServiceTypes32 as a base R list.
    #' @examples
    #' # convert array of VpsOrderServiceTypes32 (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert VpsOrderServiceTypes32 to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      VpsOrderServiceTypes32Object <- list()
      if (!is.null(self$`services_id`)) {
        VpsOrderServiceTypes32Object[["services_id"]] <-
          self$`services_id`
      }
      if (!is.null(self$`services_name`)) {
        VpsOrderServiceTypes32Object[["services_name"]] <-
          self$`services_name`
      }
      if (!is.null(self$`services_cost`)) {
        VpsOrderServiceTypes32Object[["services_cost"]] <-
          self$`services_cost`
      }
      if (!is.null(self$`services_category`)) {
        VpsOrderServiceTypes32Object[["services_category"]] <-
          self$`services_category`
      }
      if (!is.null(self$`services_buyable`)) {
        VpsOrderServiceTypes32Object[["services_buyable"]] <-
          self$`services_buyable`
      }
      if (!is.null(self$`services_type`)) {
        VpsOrderServiceTypes32Object[["services_type"]] <-
          self$`services_type`
      }
      if (!is.null(self$`services_field1`)) {
        VpsOrderServiceTypes32Object[["services_field1"]] <-
          self$`services_field1`
      }
      if (!is.null(self$`services_field2`)) {
        VpsOrderServiceTypes32Object[["services_field2"]] <-
          self$`services_field2`
      }
      if (!is.null(self$`services_module`)) {
        VpsOrderServiceTypes32Object[["services_module"]] <-
          self$`services_module`
      }
      return(VpsOrderServiceTypes32Object)
    },

    #' @description
    #' Deserialize JSON string into an instance of VpsOrderServiceTypes32
    #'
    #' @param input_json the JSON input
    #' @return the instance of VpsOrderServiceTypes32
    ...
    #' @return VpsOrderServiceTypes32 in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to VpsOrderServiceTypes32 and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of VpsOrderServiceTypes32
    toString = function() {
      self$toJSONString()
    },
...
# VpsOrderServiceTypes32$unlock()
#
## Below is an example to define the print function
# VpsOrderServiceTypes32$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VpsOrderServiceTypes32$lock()
