#' Create a new DomainAdminContact
#'
#' @description
#' Administrative contact information for a domain registration.
#'
#' @docType class
#' @title DomainAdminContact
#' @description DomainAdminContact Class
...
DomainAdminContact <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DomainAdminContact class.
    #'
    #' @param status status
    #' @param state state
    ...
    #'
    #' @return DomainAdminContact as a base R list.
    #' @examples
    #' # convert array of DomainAdminContact (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DomainAdminContact to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DomainAdminContactObject <- list()
      if (!is.null(self$`status`)) {
        DomainAdminContactObject[["status"]] <-
          self$`status`
      }
      if (!is.null(self$`state`)) {
        DomainAdminContactObject[["state"]] <-
          self$`state`
      }
      if (!is.null(self$`org_name`)) {
        DomainAdminContactObject[["org_name"]] <-
          self$`org_name`
      }
      if (!is.null(self$`country`)) {
        DomainAdminContactObject[["country"]] <-
          self$`country`
      }
      if (!is.null(self$`postal_code`)) {
        DomainAdminContactObject[["postal_code"]] <-
          self$`postal_code`
      }
      if (!is.null(self$`email`)) {
        DomainAdminContactObject[["email"]] <-
          self$`email`
      }
      if (!is.null(self$`fax`)) {
        DomainAdminContactObject[["fax"]] <-
          self$`fax`
      }
      if (!is.null(self$`address2`)) {
        DomainAdminContactObject[["address2"]] <-
          self$`address2`
      }
      if (!is.null(self$`address3`)) {
        DomainAdminContactObject[["address3"]] <-
          self$`address3`
      }
      if (!is.null(self$`address1`)) {
        DomainAdminContactObject[["address1"]] <-
          self$`address1`
      }
      if (!is.null(self$`city`)) {
        DomainAdminContactObject[["city"]] <-
          self$`city`
      }
      if (!is.null(self$`phone`)) {
        DomainAdminContactObject[["phone"]] <-
          self$`phone`
      }
      if (!is.null(self$`first_name`)) {
        DomainAdminContactObject[["first_name"]] <-
          self$`first_name`
      }
      if (!is.null(self$`last_name`)) {
        DomainAdminContactObject[["last_name"]] <-
          self$`last_name`
      }
      return(DomainAdminContactObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of DomainAdminContact
    #'
    #' @param input_json the JSON input
    #' @return the instance of DomainAdminContact
    ...
    #' @return DomainAdminContact in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to DomainAdminContact and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of DomainAdminContact
    toString = function() {
      self$toJSONString()
    },
...
# DomainAdminContact$unlock()
#
## Below is an example to define the print function
# DomainAdminContact$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DomainAdminContact$lock()
