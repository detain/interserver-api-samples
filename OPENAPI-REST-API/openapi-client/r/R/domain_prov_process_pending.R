#' Create a new DomainProvProcessPending
#'
#' @description
#' Provisioning status data for a pending domain order.
#'
#' @docType class
#' @title DomainProvProcessPending
#' @description DomainProvProcessPending Class
...
#' @field attributes  \link{DomainProvProcessPendingAttributes} [optional]
...
DomainProvProcessPending <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new DomainProvProcessPending class.
    #'
    ...
    initialize = function(`_OPS_version` = NULL, `response_text` = NULL, `protocol` = NULL, `response_code` = NULL, `action` = NULL, `object` = NULL, `is_success` = NULL, `attributes` = NULL, ...) {
    ...
    #'
    #' @return DomainProvProcessPending as a base R list.
    #' @examples
    #' # convert array of DomainProvProcessPending (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert DomainProvProcessPending to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      DomainProvProcessPendingObject <- list()
      if (!is.null(self$`_OPS_version`)) {
        DomainProvProcessPendingObject[["_OPS_version"]] <-
          self$`_OPS_version`
      }
      if (!is.null(self$`response_text`)) {
        DomainProvProcessPendingObject[["response_text"]] <-
          self$`response_text`
      }
      if (!is.null(self$`protocol`)) {
        DomainProvProcessPendingObject[["protocol"]] <-
          self$`protocol`
      }
      if (!is.null(self$`response_code`)) {
        DomainProvProcessPendingObject[["response_code"]] <-
          self$`response_code`
      }
      if (!is.null(self$`action`)) {
        DomainProvProcessPendingObject[["action"]] <-
          self$`action`
      }
      if (!is.null(self$`object`)) {
        DomainProvProcessPendingObject[["object"]] <-
          self$`object`
      }
      if (!is.null(self$`is_success`)) {
        DomainProvProcessPendingObject[["is_success"]] <-
          self$`is_success`
      }
      if (!is.null(self$`attributes`)) {
        DomainProvProcessPendingObject[["attributes"]] <-
          self$extractSimpleType(self$`attributes`)
      }
      return(DomainProvProcessPendingObject)
    },
    ...
    #' @description
    #' Deserialize JSON string into an instance of DomainProvProcessPending
    #'
    #' @param input_json the JSON input
    #' @return the instance of DomainProvProcessPending
    fromJSON = function(input_json) {
      ...
      if (!is.null(this_object$`attributes`)) {
        `attributes_object` <- DomainProvProcessPendingAttributes$new()
    ...
    #' @return DomainProvProcessPending in JSON format
    ...
    fromJSONString = function(input_json) {
      ...
      self$`object` <- this_object$`object`
      self$`is_success` <- this_object$`is_success`
      self$`attributes` <- DomainProvProcessPendingAttributes$new()$fromJSON(jsonlite::toJSON(this_object$`attributes`, auto_unbox = TRUE, digits = NA))
      self
    },

    #' @description
    #' Validate JSON input with respect to DomainProvProcessPending and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of DomainProvProcessPending
    toString = function() {
      self$toJSONString()
    },
...
# DomainProvProcessPending$unlock()
#
## Below is an example to define the print function
# DomainProvProcessPending$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# DomainProvProcessPending$lock()
