#' Create a new VpsOrderPostRequest
#'
#' @description
#' request to validate a vps order
#'
#' @docType class
#' @title VpsOrderPostRequest
#' @description VpsOrderPostRequest Class
...
VpsOrderPostRequest <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new VpsOrderPostRequest class.
    #'
    ...
    #'
    #' @return VpsOrderPostRequest as a base R list.
    #' @examples
    #' # convert array of VpsOrderPostRequest (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert VpsOrderPostRequest to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      VpsOrderPostRequestObject <- list()
      if (!is.null(self$`osDistro`)) {
        VpsOrderPostRequestObject[["osDistro"]] <-
          self$`osDistro`
      }
      if (!is.null(self$`slices`)) {
        VpsOrderPostRequestObject[["slices"]] <-
          self$`slices`
      }
      if (!is.null(self$`vpsPlatform`)) {
        VpsOrderPostRequestObject[["vpsPlatform"]] <-
          self$`vpsPlatform`
      }
      if (!is.null(self$`controlpanel`)) {
        VpsOrderPostRequestObject[["controlpanel"]] <-
          self$`controlpanel`
      }
      if (!is.null(self$`period`)) {
        VpsOrderPostRequestObject[["period"]] <-
          self$`period`
      }
      if (!is.null(self$`location`)) {
        VpsOrderPostRequestObject[["location"]] <-
          self$`location`
      }
      if (!is.null(self$`osVersion`)) {
        VpsOrderPostRequestObject[["osVersion"]] <-
          self$`osVersion`
      }
      if (!is.null(self$`hostname`)) {
        VpsOrderPostRequestObject[["hostname"]] <-
          self$`hostname`
      }
      if (!is.null(self$`coupon`)) {
        VpsOrderPostRequestObject[["coupon"]] <-
          self$`coupon`
      }
      if (!is.null(self$`rootpass`)) {
        VpsOrderPostRequestObject[["rootpass"]] <-
          self$`rootpass`
      }
      if (!is.null(self$`comment`)) {
        VpsOrderPostRequestObject[["comment"]] <-
          self$`comment`
      }
      return(VpsOrderPostRequestObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of VpsOrderPostRequest
    #'
    #' @param input_json the JSON input
    #' @return the instance of VpsOrderPostRequest
    ...
    #' @return VpsOrderPostRequest in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to VpsOrderPostRequest and throw an exception if invalid
    #'
    ...
    validateJSON = function(input) {
      ...
      if (!is.null(input_json$`osDistro`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `osDistro` is missing."))
      }
      ...
      if (!is.null(input_json$`slices`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `slices` is missing."))
      }
      ...
      if (!is.null(input_json$`vpsPlatform`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `vpsPlatform` is missing."))
      }
      ...
      if (!is.null(input_json$`period`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `period` is missing."))
      }
      ...
      if (!is.null(input_json$`location`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `location` is missing."))
      }
      ...
      if (!is.null(input_json$`osVersion`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `osVersion` is missing."))
      }
      ...
      if (!is.null(input_json$`hostname`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `hostname` is missing."))
      }
      ...
      if (!is.null(input_json$`rootpass`)) {
        ...
        stop(paste("The JSON input `", input, "` is invalid for VpsOrderPostRequest: the required field `rootpass` is missing."))
      }
    },
    ...
    #'
    #' @return String representation of VpsOrderPostRequest
    toString = function() {
      self$toJSONString()
    },
...
# VpsOrderPostRequest$unlock()
#
## Below is an example to define the print function
# VpsOrderPostRequest$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# VpsOrderPostRequest$lock()
