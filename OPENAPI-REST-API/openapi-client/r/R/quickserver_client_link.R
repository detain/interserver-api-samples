#' Create a new QuickserverClientLink
#'
#' @description
#' A navigation link for QuickServer-related actions in the client portal.
#'
#' @docType class
#' @title QuickserverClientLink
#' @description QuickserverClientLink Class
#' @format An \code{R6Class} generator object
#' @field label Link label character [optional]
#' @field link Link character [optional]
#' @field icon Icon class character [optional]
#' @field icon_text Icon text character [optional]
#' @field help_text Help text character [optional]
#' @field other_attr Other attribute character [optional]
...
QuickserverClientLink <- R6::R6Class(
  ...
  public = list(
    ...
    #' @description
    #' Initialize a new QuickserverClientLink class.
    #'
    ...
    #'
    #' @return QuickserverClientLink as a base R list.
    #' @examples
    #' # convert array of QuickserverClientLink (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert QuickserverClientLink to a base R type
    #'
    #' @return A base R type, e.g. a list or numeric/character array.
    toSimpleType = function() {
      QuickserverClientLinkObject <- list()
      if (!is.null(self$`label`)) {
        QuickserverClientLinkObject[["label"]] <-
          self$`label`
      }
      if (!is.null(self$`link`)) {
        QuickserverClientLinkObject[["link"]] <-
          self$`link`
      }
      if (!is.null(self$`icon`)) {
        QuickserverClientLinkObject[["icon"]] <-
          self$`icon`
      }
      if (!is.null(self$`icon_text`)) {
        QuickserverClientLinkObject[["icon_text"]] <-
          self$`icon_text`
      }
      if (!is.null(self$`help_text`)) {
        QuickserverClientLinkObject[["help_text"]] <-
          self$`help_text`
      }
      if (!is.null(self$`other_attr`)) {
        QuickserverClientLinkObject[["other_attr"]] <-
          self$`other_attr`
      }
      return(QuickserverClientLinkObject)
    },

    #' @description
    #' Deserialize JSON string into an instance of QuickserverClientLink
    #'
    #' @param input_json the JSON input
    #' @return the instance of QuickserverClientLink
    ...
    #' @return QuickserverClientLink in JSON format
    ...
    #' @description
    #' Validate JSON input with respect to QuickserverClientLink and throw an exception if invalid
    #'
    ...
    #'
    #' @return String representation of QuickserverClientLink
    toString = function() {
      self$toJSONString()
    },
...
# QuickserverClientLink$unlock()
#
## Below is an example to define the print function
# QuickserverClientLink$set("public", "print", function(...) {
#   print(jsonlite::prettify(self$toJSONString()))
#   invisible(self)
# })
## Uncomment below to lock the class to prevent modifications to the method or field
# QuickserverClientLink$lock()
