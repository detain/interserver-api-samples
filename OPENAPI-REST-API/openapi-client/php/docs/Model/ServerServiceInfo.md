...
**serverDiscount** | **mixed** | Discount information for the server. | [optional]
...
**serverLocation** | **mixed** | The location of the server. | [optional]
...
**serverDedicatedHd2** | **mixed** | The size of the second dedicated hard drive. | [optional]
...
**serverDedicatedCp** | **mixed** | The control panel of the server. | [optional]
