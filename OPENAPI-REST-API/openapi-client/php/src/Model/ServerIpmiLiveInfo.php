 ...
 */
class ServerIpmiLiveInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ServerIpmiLiveInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('publicIp', $data ?? [], null);
        $this->setIfExists('allowedIp', $data ?? [], null);
        $this->setIfExists('clientUsername', $data ?? [], null);
        $this->setIfExists('clientPassword', $data ?? [], null);
    }
     ...
     * Sets publicIp
     *
     * @param string|null $publicIp publicIp
     *
     * @return self
     */
    ...
    {
        if (is_null($publicIp)) {
            throw new \InvalidArgumentException('non-nullable publicIp cannot be null');
        }
     ...
     * Sets allowedIp
     *
     * @param string|null $allowedIp allowedIp
     *
     * @return self
     */
    public function setAllowedIp($allowedIp)
    {
        if (is_null($allowedIp)) {
            throw new \InvalidArgumentException('non-nullable allowedIp cannot be null');
        }
     ...
     * Sets clientUsername
     *
     * @param string|null $clientUsername clientUsername
     *
     * @return self
     */
    public function setClientUsername($clientUsername)
    {
        if (is_null($clientUsername)) {
            throw new \InvalidArgumentException('non-nullable clientUsername cannot be null');
        }
     ...
     * Sets clientPassword
     *
     * @param string|null $clientPassword clientPassword
     *
     * @return self
     */
    public function setClientPassword($clientPassword)
    {
        if (is_null($clientPassword)) {
            throw new \InvalidArgumentException('non-nullable clientPassword cannot be null');
        }
