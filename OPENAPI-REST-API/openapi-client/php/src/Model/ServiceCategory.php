...
class ServiceCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ServiceCategory';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('categoryTag', $data ?? [], null);
        $this->setIfExists('categoryModule', $data ?? [], null);
    }
    ...
    public function setCategoryTag($categoryTag)
    {
        if (is_null($categoryTag)) {
            throw new \InvalidArgumentException('non-nullable categoryTag cannot be null');
        }
    ...
    {
        if (is_null($categoryModule)) {
            throw new \InvalidArgumentException('non-nullable categoryModule cannot be null');
        }
