...
/**
 * GetOrderDetail200ResponsePackageCosts Class Doc Comment
 *
 * @category Class
 * @package  Interserver\MyAdmin
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderDetail200ResponsePackageCosts implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getOrderDetail_200_response_packageCosts';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('packageCost', $data ?? [], null);
     ...
     * Sets packageId
     *
     * @param float|null $packageId packageId
     *
     * @return self
     */
    ...
    {
        return $this->container['packageCost'];
    }

    /**
     * Sets packageCost
     *
     * @param float|null $packageCost packageCost
     *
     * @return self
     */
    public function setPackageCost($packageCost)
    {
        if (is_null($packageCost)) {
            throw new \InvalidArgumentException('non-nullable packageCost cannot be null');
        }
        $this->container['packageCost'] = $packageCost;
