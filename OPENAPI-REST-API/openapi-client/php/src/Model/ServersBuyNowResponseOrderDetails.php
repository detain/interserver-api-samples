...
class ServersBuyNowResponseOrderDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServersBuyNowResponse_order_details';
    ...
    */
     ...
     * Sets serviceId
     *
     * @param float|null $serviceId The newly created service ID for the ordered server.
     *
     * @return self
     */
     ...
     * Sets invoiceId
     *
     * @param float|null $invoiceId The invoice ID generated for the order.
     *
     * @return self
     */
