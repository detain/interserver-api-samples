...
class PostOauthCallback200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'postOauthCallback_200_response';
     ...
     * Sets accountId
     *
     * @param int|null $accountId The account ID associated with the OAuth login.
     *
     * @return self
     */
     ...
     * Sets errorCode
     *
     * @param string|null $errorCode Error code if additional verification is needed (e.g. `2fa_required`).
     *
     * @return self
     */
