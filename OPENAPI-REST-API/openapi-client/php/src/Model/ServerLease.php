 ...
 */
class ServerLease implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServerLease';
    ...
    */
     ...
     * Sets mac
     *
     * @param string $mac MAC address associated with the lease.
     *
     * @return self
     */
     ...
     * Sets authenticated
     *
     * @param bool $authenticated Indicates if the lease is authenticated.
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string $group Group identifier for the lease.
     *
     * @return self
     */
