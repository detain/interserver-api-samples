...
*/
export class LicensesOrderServiceCategories {
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "LicensesOrderServiceCategories509",
            "baseName": "LicensesOrderServiceCategories509",
            "type": "LicensesOrderServiceCategories509"
        }    ];

    static getAttributeTypeMap() {
        return LicensesOrderServiceCategories.attributeTypeMap;
    }
}
