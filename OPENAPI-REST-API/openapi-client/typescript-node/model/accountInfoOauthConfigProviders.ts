...
*/
export class AccountInfoOauthConfigProviders extends AccountInfoOauthConfigProvidersValue {
    ...
    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(AccountInfoOauthConfigProviders.attributeTypeMap);
    }
}
