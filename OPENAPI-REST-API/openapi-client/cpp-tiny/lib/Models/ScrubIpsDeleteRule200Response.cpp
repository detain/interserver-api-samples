...
ScrubIpsDeleteRule_200_response::ScrubIpsDeleteRule_200_response(std::string jsonString)
{
...
void
ScrubIpsDeleteRule_200_response::fromJson(std::string jsonObj)
{
...
bool
ScrubIpsDeleteRule_200_response::isSuccess()
{
	return success;
}
