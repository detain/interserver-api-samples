...
#ifndef TINY_CPP_CLIENT_QuickserverBillingDetails_H_
#define TINY_CPP_CLIENT_QuickserverBillingDetails_H_
...
public:
    ...
    QuickserverBillingDetails(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_QuickserverBillingDetails_H_ */
