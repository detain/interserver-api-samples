...
#ifndef TINY_CPP_CLIENT_AccountInfoData_H_
#define TINY_CPP_CLIENT_AccountInfoData_H_
...
public:
	 ...
	 */
    AccountInfoData();
    AccountInfoData(std::string jsonString);
	...
	/*! \brief Get 
	 */
	AccountInfoDataCcs&lt;std::string, AccountInfoDataCc&gt; getCcs();

	/*! \brief Set 
	 */
	void setCcs(AccountInfoDataCcs&lt;std::string, AccountInfoDataCc&gt; ccs);
	/*! \brief Get 
	 */
    ...
    AccountInfoDataCcs&lt;std::string, AccountInfoDataCc&gt; ccs;
...
#endif /* TINY_CPP_CLIENT_AccountInfoData_H_ */
