...
WebsiteBillingDetails::WebsiteBillingDetails(std::string jsonString)
{
...
void
WebsiteBillingDetails::fromJson(std::string jsonObj)
{
...
void
WebsiteBillingDetails::setServiceExtra(Object service_extra)
{
