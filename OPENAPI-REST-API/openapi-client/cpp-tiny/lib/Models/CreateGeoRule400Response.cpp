...
CreateGeoRule_400_response::CreateGeoRule_400_response(std::string jsonString)
{
...
void
CreateGeoRule_400_response::fromJson(std::string jsonObj)
{
...
bool
CreateGeoRule_400_response::isSuccess()
{
	return success;
}
