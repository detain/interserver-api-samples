...
#ifndef TINY_CPP_CLIENT_VpsOrderPutRequest_H_
#define TINY_CPP_CLIENT_VpsOrderPutRequest_H_
...
public:
	 ...
	 */
    VpsOrderPutRequest();
    VpsOrderPutRequest(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_VpsOrderPutRequest_H_ */
