...
#ifndef TINY_CPP_CLIENT_CpuWithDefaults_H_
#define TINY_CPP_CLIENT_CpuWithDefaults_H_
...
public:
	 ...
	 */
    CpuWithDefaults();
    CpuWithDefaults(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_CpuWithDefaults_H_ */
