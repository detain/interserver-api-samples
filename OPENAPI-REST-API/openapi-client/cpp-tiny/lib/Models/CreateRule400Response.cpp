...
CreateRule_400_response::CreateRule_400_response(std::string jsonString)
{
...
void
CreateRule_400_response::fromJson(std::string jsonObj)
{
...
bool
CreateRule_400_response::isSuccess()
{
	return success;
}
