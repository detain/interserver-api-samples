...
#ifndef TINY_CPP_CLIENT_QuickserverServiceMaster_H_
#define TINY_CPP_CLIENT_QuickserverServiceMaster_H_
...
public:
    ...
    QuickserverServiceMaster(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_QuickserverServiceMaster_H_ */
