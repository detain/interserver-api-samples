...
#ifndef TINY_CPP_CLIENT_VpsOrderPutResponse_H_
#define TINY_CPP_CLIENT_VpsOrderPutResponse_H_
...
public:
	 ...
	 */
    VpsOrderPutResponse();
    VpsOrderPutResponse(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_VpsOrderPutResponse_H_ */
