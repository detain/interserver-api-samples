...
ScrubIpsDeleteRule_400_response::ScrubIpsDeleteRule_400_response(std::string jsonString)
{
...
void
ScrubIpsDeleteRule_400_response::fromJson(std::string jsonObj)
{
...
bool
ScrubIpsDeleteRule_400_response::isSuccess()
{
	return success;
}
