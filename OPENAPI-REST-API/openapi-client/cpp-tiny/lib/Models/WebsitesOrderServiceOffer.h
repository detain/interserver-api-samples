...
#ifndef TINY_CPP_CLIENT_WebsitesOrderServiceOffer_H_
#define TINY_CPP_CLIENT_WebsitesOrderServiceOffer_H_
...
public:
    ...
    WebsitesOrderServiceOffer(std::string jsonString);
...
#endif /* TINY_CPP_CLIENT_WebsitesOrderServiceOffer_H_ */
