...
constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: ConfigurationParameters = {}) {
        ...
        // init default sessionIdHeaderAuth credential
        if (!this.credentials['sessionIdHeaderAuth']) {
            this.credentials['sessionIdHeaderAuth'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['sessionIdHeaderAuth'] || this.apiKeys['sessionid'];
                }
            };
        }

        // init default sessionIdCookieAuth credential
        if (!this.credentials['sessionIdCookieAuth']) {
            this.credentials['sessionIdCookieAuth'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['sessionIdCookieAuth'] || this.apiKeys['sessionid'];
                }
            };
        }
    }
