...
, 
   ...
   * @param prio Priority
   */
  def addDnsRecord(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String, name: String, `type`: DnsRecordType, content: String, ttl: Option[Int] = None, prio: Option[Int] = None
...
, 
   ...
   */
  def getDnsDomain(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], Seq[DnsRecord]], Any] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getDnsList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
): Request[Either[ResponseException[String, Exception], Seq[DnsListItem]], Any] =
    basicRequest
