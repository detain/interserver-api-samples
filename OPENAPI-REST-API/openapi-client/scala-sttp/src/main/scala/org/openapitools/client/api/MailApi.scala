...
class MailApi(baseUrl: String) {
   ...
   */
  def addMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
   ...
   */
  def addRule(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, denyRuleNew: DenyRuleNew
   ...
   */
  def createMailAlert(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, mailAlertRequest: MailAlertRequest
   ...
   */
  def deleteMailAlert(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, alertId: Int
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   */
  def deleteRule(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, rule: String
): Request[Either[ResponseException[String, Exception], GenericResponse], Any] =
    basicRequest
   ...
   */
  def delistBlock(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, email: Option[String] = None
): Request[Either[ResponseException[String, Exception], GenericResponse], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailAlerts(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], MailAlertsResponse], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailBlocks(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailDelist(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], MailDelistResponse], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailDeliverability(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], MailDeliverabilityResponse], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], MailSchema], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailInvoices(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getMailList(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
): Request[Either[ResponseException[String, Exception], Seq[MailRow]], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getMailWelcomeEmail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def getNewMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
): Request[Either[ResponseException[String, Exception], MailOrder], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def getRules(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
   ...
   */
  def getStats(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, time: Option[String] = None
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def mailCancel(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], MailCancel200Response], Any] =
    basicRequest
   ...
   */
  def postMailDelist(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, mailDelistRequest: MailDelistRequest
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   *   sessionIdHeaderAuth (apiKey)
   */
  def putMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def resetMailPassword(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   * @param sendMailAdv 
   */
  def sendAdvMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, sendMailAdv: SendMailAdv
): Request[Either[ResponseException[String, Exception], GenericResponse], Any] =
    basicRequest
   ...
   * @param sendMail 
   */
  def sendMail(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, sendMail: SendMail
): Request[Either[ResponseException[String, Exception], GenericResponse], Any] =
    basicRequest
   ...
   */
  def updateMailAlert(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, mailAlertUpdateRequest: MailAlertUpdateRequest
): Request[Either[ResponseException[String, Exception], SuccessTextResponse], Any] =
    basicRequest
   ...
   * @param id The mail service ID. Use `mail_id` from `GET /mail`.
   */
  def updateMailInfo(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: String
): Request[Either[ResponseException[String, Exception], Unit], Any] =
    basicRequest
   ...
   */
  def viewMailLog(apiKeyCookie: String, apiKeyHeader: String, apiKeyHeader: String)(id: Int, id2: Option[Long] = None, origin: Option[String] = None, mx: Option[String] = None, from: Option[String] = None, to: Option[String] = None, subject: Option[String] = None, mailid: Option[String] = None, skip: Option[Int] = None, limit: Option[Int] = None, startDate: Option[Long] = None, endDate: Option[Long] = None, delivered: Option[String] = None
