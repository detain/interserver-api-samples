...
public class Example {
  public static void main(String[] args) {
    ...
    DomainDnssecRequest domainDnssecRequest = new DomainDnssecRequest(); // DomainDnssecRequest | 
    try {
      SuccessTextResponse result = apiInstance.addDomainDnssec(id, domainDnssecRequest);
...
public class Example {
  public static void main(String[] args) {
    ...
    DomainsApi apiInstance = new DomainsApi(defaultClient);
    Integer id = 56; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
    DomainNameserverPostRequest domainNameserverPostRequest = new DomainNameserverPostRequest(); // DomainNameserverPostRequest | 
    try {
      TextResponse result = apiInstance.addDomainNameserver(id, domainNameserverPostRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    Integer id = 56; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
    try {
      CancelDomain200Response result = apiInstance.cancelDomain(id);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DomainsApi apiInstance = new DomainsApi(defaultClient);
    Integer id = 56; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
    DomainContactDetails domainContactDetails = new DomainContactDetails(); // DomainContactDetails | 
    try {
      SuccessTextResponse result = apiInstance.updateDomainContact(id, domainContactDetails);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DomainsApi apiInstance = new DomainsApi(defaultClient);
    Integer id = 56; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
    DomainNameserverPutRequest domainNameserverPutRequest = new DomainNameserverPutRequest(); // DomainNameserverPutRequest | 
    try {
      TextResponse result = apiInstance.updateDomainNameservers(id, domainNameserverPutRequest);
      System.out.println(result);
    } catch (ApiException e) {
...
public class Example {
  public static void main(String[] args) {
    ...
    DomainsApi apiInstance = new DomainsApi(defaultClient);
    Integer id = 56; // Integer | The domain service ID. Use `domain_id` from `GET /domains`.
    DomainWhoisPrivacyRequest domainWhoisPrivacyRequest = new DomainWhoisPrivacyRequest(); // DomainWhoisPrivacyRequest | 
    try {
      SuccessTextResponse result = apiInstance.updateDomainWhoisPrivacy(id, domainWhoisPrivacyRequest);
      System.out.println(result);
    } catch (ApiException e) {
