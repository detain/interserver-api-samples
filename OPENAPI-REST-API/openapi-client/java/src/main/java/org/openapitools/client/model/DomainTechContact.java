...
public class DomainTechContact {
  ...
  public DomainTechContact state(@javax.annotation.Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public DomainTechContact status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public DomainTechContact orgName(@javax.annotation.Nullable String orgName) {
  ...
  public DomainTechContact country(@javax.annotation.Nullable String country) {
  ...
  public DomainTechContact postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public DomainTechContact fax(@javax.annotation.Nullable String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public DomainTechContact email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public DomainTechContact address2(@javax.annotation.Nullable String address2) {
  ...
  public DomainTechContact address3(@javax.annotation.Nullable String address3) {
  ...
  public DomainTechContact address1(@javax.annotation.Nullable String address1) {
  ...
  public DomainTechContact city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public DomainTechContact phone(@javax.annotation.Nullable String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public DomainTechContact firstName(@javax.annotation.Nullable String firstName) {
  ...
  public DomainTechContact lastName(@javax.annotation.Nullable String lastName) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("state", "status", "org_name", "country", "postal_code", "fax", "email", "address2", "address3", "address1", "city", "phone", "first_name", "last_name"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainTechContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainTechContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DomainTechContact is not found in the empty JSON string", DomainTechContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainTechContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DomainTechContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainTechContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainTechContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainTechContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainTechContact.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainTechContact>() {
           @Override
           public void write(JsonWriter out, DomainTechContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainTechContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainTechContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainTechContact
   * @throws IOException if the JSON string is invalid with respect to DomainTechContact
   */
  public static DomainTechContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainTechContact.class);
  }

  /**
   * Convert an instance of DomainTechContact to an JSON string
   *
   * @return JSON string
   */
