...
public class AccountInfoMaxMindResponseRiskScore extends AbstractOpenApiSchema {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AccountInfoMaxMindResponseRiskScore.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AccountInfoMaxMindResponseRiskScore' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<AccountInfoMaxMindResponseRiskScore>() {
                @Override
                public void write(JsonWriter out, AccountInfoMaxMindResponseRiskScore value) throws IOException {
                ...
                @Override
                public AccountInfoMaxMindResponseRiskScore read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        AccountInfoMaxMindResponseRiskScore ret = new AccountInfoMaxMindResponseRiskScore();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for AccountInfoMaxMindResponseRiskScore: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public AccountInfoMaxMindResponseRiskScore() {
        super("oneOf", Boolean.FALSE);
    }

    public AccountInfoMaxMindResponseRiskScore(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return AccountInfoMaxMindResponseRiskScore.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to AccountInfoMaxMindResponseRiskScore
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for AccountInfoMaxMindResponseRiskScore with oneOf schemas: BigDecimal, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of AccountInfoMaxMindResponseRiskScore given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of AccountInfoMaxMindResponseRiskScore
     * @throws IOException if the JSON string is invalid with respect to AccountInfoMaxMindResponseRiskScore
     */
    public static AccountInfoMaxMindResponseRiskScore fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, AccountInfoMaxMindResponseRiskScore.class);
    }

    /**
     * Convert an instance of AccountInfoMaxMindResponseRiskScore to an JSON string
     *
     * @return JSON string
     */
