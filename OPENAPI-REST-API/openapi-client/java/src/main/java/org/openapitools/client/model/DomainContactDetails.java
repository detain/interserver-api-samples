...
public class DomainContactDetails {
  ...
  public DomainContactDetails status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public DomainContactDetails state(@javax.annotation.Nullable String state) {
    this.state = state;
    return this;
  }
  ...
  public DomainContactDetails orgName(@javax.annotation.Nullable String orgName) {
  ...
  public DomainContactDetails country(@javax.annotation.Nullable String country) {
  ...
  public DomainContactDetails postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public DomainContactDetails email(@javax.annotation.Nullable String email) {
    this.email = email;
    return this;
  }
  ...
  public DomainContactDetails fax(@javax.annotation.Nullable String fax) {
    this.fax = fax;
    return this;
  }
  ...
  public DomainContactDetails address2(@javax.annotation.Nullable String address2) {
  ...
  public DomainContactDetails address3(@javax.annotation.Nullable String address3) {
  ...
  public DomainContactDetails address1(@javax.annotation.Nullable String address1) {
  ...
  public DomainContactDetails city(@javax.annotation.Nullable String city) {
    this.city = city;
    return this;
  }
  ...
  public DomainContactDetails phone(@javax.annotation.Nullable String phone) {
    this.phone = phone;
    return this;
  }
  ...
  public DomainContactDetails firstName(@javax.annotation.Nullable String firstName) {
  ...
  public DomainContactDetails lastName(@javax.annotation.Nullable String lastName) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to DomainContactDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DomainContactDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DomainContactDetails is not found in the empty JSON string", DomainContactDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainContactDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DomainContactDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DomainContactDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DomainContactDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DomainContactDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DomainContactDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<DomainContactDetails>() {
           @Override
           public void write(JsonWriter out, DomainContactDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DomainContactDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DomainContactDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DomainContactDetails
   * @throws IOException if the JSON string is invalid with respect to DomainContactDetails
   */
  public static DomainContactDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DomainContactDetails.class);
  }

  /**
   * Convert an instance of DomainContactDetails to an JSON string
   *
   * @return JSON string
   */
