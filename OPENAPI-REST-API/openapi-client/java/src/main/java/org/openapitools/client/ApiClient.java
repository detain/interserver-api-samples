...
public class ApiClient {
    ...
    protected String basePath = "https://my.interserver.net/apiv2";
    ...
    public ApiClient() {
        ...
        authentications.put("sessionIdHeaderAuth", new ApiKeyAuth("header", "sessionid"));
        authentications.put("sessionIdCookieAuth", new ApiKeyAuth("cookie", "sessionid"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://my.interserver.net/apiv2)
