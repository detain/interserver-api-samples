...
public class OperatingSystem {
  ...
  public OperatingSystem id(@javax.annotation.Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public OperatingSystem shortDesc(@javax.annotation.Nullable String shortDesc) {
  ...
  public OperatingSystem monthlyPrice(@javax.annotation.Nullable BigDecimal monthlyPrice) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OperatingSystem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in OperatingSystem is not found in the empty JSON string", OperatingSystem.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!OperatingSystem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `OperatingSystem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
