...
module.exports = {
        ...
        return [
            {
                ...
                label: `Last invoice date for the service - [${labelPrefix}service_last_invoice_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_payment_status`,
                label: `Payment status for the service - [${labelPrefix}service_payment_status]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_frequency`,
                label: `Frequency of the service - [${labelPrefix}service_frequency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}next_date`,
                label: `Next date for the service - [${labelPrefix}next_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_next_invoice_date`,
                label: `Next invoice date for the service - [${labelPrefix}service_next_invoice_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_currency`,
                label: `Currency for the service - [${labelPrefix}service_currency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_currency_symbol`,
                label: `Currency symbol for the service - [${labelPrefix}service_currency_symbol]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_coupon`,
                label: `Coupon for the service - [${labelPrefix}service_coupon]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_cost_info`,
                label: `Cost information for the service - [${labelPrefix}service_cost_info]`,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                label: `Extra information in JSON format for the service - [${labelPrefix}service_extra_json]`,
                type: 'string',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'service_coupon': bundle.inputData?.[`${keyPrefix}service_coupon`],
