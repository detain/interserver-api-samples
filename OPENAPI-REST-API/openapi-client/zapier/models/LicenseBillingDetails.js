    ...
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `Service currency - [${labelPrefix}service_currency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_currency_symbol`,
                label: `Service currency symbol - [${labelPrefix}service_currency_symbol]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_coupon`,
                label: `Service coupon - [${labelPrefix}service_coupon]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_cost_info`,
                label: `Service cost information - [${labelPrefix}service_cost_info]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_extra`,
                label: `Additional service information - [${labelPrefix}service_extra]`,
                list: true,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_extra_json`,
                label: `Additional service information in JSON format - [${labelPrefix}service_extra_json]`,
                type: 'string',
            },
        ]
    },
