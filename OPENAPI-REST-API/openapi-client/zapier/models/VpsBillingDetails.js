...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            },
            {
                ...
                label: `Billing frequency - [${labelPrefix}service_frequency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}next_date`,
                label: `Next billing date - [${labelPrefix}next_date]`,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                label: `Currency used for billing - [${labelPrefix}service_currency]`,
                type: 'string',
            },
            {
            ...
            },
            {
                ...
                label: `Billing coupon code - [${labelPrefix}service_coupon]`,
                type: 'string',
            },
            {
            ...
            ...VpsServiceExtra.fields(`${keyPrefix}service_extra`, isInput),
            {
                key: `${keyPrefix}service_extra_json`,
                label: `Additional information in JSON format - [${labelPrefix}service_extra_json]`,
                type: 'string',
            },
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'service_extra': utils.removeIfEmpty(VpsServiceExtra.mapping(bundle, `${keyPrefix}service_extra`)),
