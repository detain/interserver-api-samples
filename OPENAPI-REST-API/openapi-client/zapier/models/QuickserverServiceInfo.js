...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            ....fields(`${keyPrefix}qs_ipv6`, isInput),
            {
            ...
            ....fields(`${keyPrefix}qs_vnc_port`, isInput),
            {
            ...
            ....fields(`${keyPrefix}qs_platform`, isInput),
        ]
    },
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'qs_ipv6': utils.removeIfEmpty(.mapping(bundle, `${keyPrefix}qs_ipv6`)),
            ...
            'qs_vnc_port': utils.removeIfEmpty(.mapping(bundle, `${keyPrefix}qs_vnc_port`)),
            ...
            'qs_platform': utils.removeIfEmpty(.mapping(bundle, `${keyPrefix}qs_platform`)),
        }
    },
}
