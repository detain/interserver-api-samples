...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}server_discount`,
                label: `Discount information for the server. - [${labelPrefix}server_discount]`,
                type: 'string',
            },
            {
            ...
            {
                key: `${keyPrefix}server_location`,
                label: `The location of the server. - [${labelPrefix}server_location]`,
                type: 'string',
            },
            {
            ...
            {
                key: `${keyPrefix}server_dedicated_hd2`,
                label: `The size of the second dedicated hard drive. - [${labelPrefix}server_dedicated_hd2]`,
                type: 'string',
            },
            {
            ...
            {
                key: `${keyPrefix}server_dedicated_cp`,
                label: `The control panel of the server. - [${labelPrefix}server_dedicated_cp]`,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'server_discount': bundle.inputData?.[`${keyPrefix}server_discount`],
            ...
            'server_location': bundle.inputData?.[`${keyPrefix}server_location`],
            ...
            'server_dedicated_hd2': bundle.inputData?.[`${keyPrefix}server_dedicated_hd2`],
            ...
            'server_dedicated_cp': bundle.inputData?.[`${keyPrefix}server_dedicated_cp`],
