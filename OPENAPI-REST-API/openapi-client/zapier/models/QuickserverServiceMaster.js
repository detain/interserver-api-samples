...
module.exports = {
    fields: (prefix = '', isInput = true, isArrayChild = false) => {
        ...
        return [
            ...
            {
                key: `${keyPrefix}qs_last_install_time`,
                label: `Last install time (null) - [${labelPrefix}qs_last_install_time]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}qs_partitions`,
                label: `Partitions information (null) - [${labelPrefix}qs_partitions]`,
                type: 'string',
            },
            {
    ...
    mapping: (bundle, prefix = '') => {
        ...
        return {
            ...
            'qs_last_install_time': bundle.inputData?.[`${keyPrefix}qs_last_install_time`],
            'qs_partitions': bundle.inputData?.[`${keyPrefix}qs_partitions`],
