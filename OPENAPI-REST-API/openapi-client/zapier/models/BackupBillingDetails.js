        ...
        return [
            {
                ...
                label: `Last invoice date of the service. - [${labelPrefix}service_last_invoice_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_payment_status`,
                label: `Payment status of the service. - [${labelPrefix}service_payment_status]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_frequency`,
                label: `Billing frequency of the service. - [${labelPrefix}service_frequency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}next_date`,
                label: `Next billing date of the service. - [${labelPrefix}next_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_next_invoice_date`,
                label: `Next invoice date of the service. - [${labelPrefix}service_next_invoice_date]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_currency`,
                label: `Currency of the service. - [${labelPrefix}service_currency]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_currency_symbol`,
                label: `Currency symbol of the service. - [${labelPrefix}service_currency_symbol]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_cost_info`,
                label: `Cost information of the service. - [${labelPrefix}service_cost_info]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_extra`,
                label: `Service Extra Info - [${labelPrefix}service_extra]`,
                type: 'string',
            },
            {
                key: `${keyPrefix}service_extra_json`,
                label: `JSON representation of extra service information. - [${labelPrefix}service_extra_json]`,
                type: 'string',
            },
        ]
    },
