...
Protected Interface FloatingIPsApiCallbackHandler
	#tag Method, Flags = &h0
		Sub AddFloatingIpCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub GetFloatingIpInfoCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub GetFloatingIpsListCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub GetNewFloatingIpCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub UpdateFloatingIpInfoCallback(status As OpenAPIClient.OpenAPIClientException)
