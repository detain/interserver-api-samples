...
Protected Interface WebhostingApiCallbackHandler
	#tag Method, Flags = &h0
		Sub AddWebsiteCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As OpenAPIClient.Models.ServiceOrderPostResponse)
	...
	#tag Method, Flags = &h0
		Sub UpdateWebsiteInfoCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As OpenAPIClient.Models.SuccessTextResponse)
