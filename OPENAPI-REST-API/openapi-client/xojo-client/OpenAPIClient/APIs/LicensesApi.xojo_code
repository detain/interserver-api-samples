...
Protected Class LicensesApi
	#tag Method, Flags = &h0
		Sub AddLicense()
		  ...
		  // Place License Order
		  //
		  // Invokes LicensesApiCallbackHandler.AddLicenseCallback() on completion. 
		  //
		  // - POST /licenses/order
	...
	#tag Method, Flags = &h21
		Private Sub AddLicense_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  CallbackHandler.AddLicenseCallback(error)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub UpdateLicenseInfo(, id As String)
		  ...
		  // - parameter id: (path) The license service ID. Use &#x60;license_id&#x60; from &#x60;GET /licenses&#x60;. 
		  //
		  // Invokes LicensesApiCallbackHandler.UpdateLicenseInfoCallback() on completion. 
		  //
		  // - POST /licenses/{id}
	...
	#tag Method, Flags = &h21
		Private Sub UpdateLicenseInfo_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.UpdateLicenseInfoCallback(error)
		End Sub
	#tag EndMethod
