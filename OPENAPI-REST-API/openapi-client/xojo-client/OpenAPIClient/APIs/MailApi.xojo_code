...
Protected Class MailApi
	#tag Method, Flags = &h0
		Sub AddMail()
		  ...
		  // Place Mail Order
		  //
		  // Invokes MailApiCallbackHandler.AddMailCallback() on completion. 
		  //
		  // - POST /mail/order
	...
	#tag Method, Flags = &h21
		Private Sub AddMail_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  CallbackHandler.AddMailCallback(error)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub DeleteMailAlert(, id As Integer, alertId As Integer)
		  ...
		  localVarQueryParams = localVarQueryParams + EncodeURLComponent("alert_id") + "=" + EncodeURLComponent(alertId.ToString)
	...
	#tag Method, Flags = &h0
		Sub UpdateMailInfo(, id As String)
		  ...
		  // - parameter id: (path) The mail service ID. Use &#x60;mail_id&#x60; from &#x60;GET /mail&#x60;. 
		  //
		  // Invokes MailApiCallbackHandler.UpdateMailInfoCallback() on completion. 
		  //
		  // - POST /mail/{id}
	...
	#tag Method, Flags = &h21
		Private Sub UpdateMailInfo_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.UpdateMailInfoCallback(error)
		End Sub
	#tag EndMethod
