...
Protected Interface AccountApiCallbackHandler
	...
	#tag Method, Flags = &h0
		Sub UpdateAccountInfoCallback(status As OpenAPIClient.OpenAPIClientException)
		  
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub UpdateAccountIpLimitsCallback(status As OpenAPIClient.OpenAPIClientException)
