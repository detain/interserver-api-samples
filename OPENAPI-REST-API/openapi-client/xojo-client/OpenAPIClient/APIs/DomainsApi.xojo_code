...
Protected Class DomainsApi
	...
	#tag Method, Flags = &h0
		Sub DeleteDomainDnssec(, id As Integer, action As String)
	...
	#tag Method, Flags = &h0
		Sub GetDomainOrderFields(, domain As String, regType As String)
		  ...
		  //
		  // Invokes DomainsApiCallbackHandler.GetDomainOrderFieldsCallback() on completion. 
		  //
		  ...
		  If me.ApiKeysessionIdCookieAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeysessionIdCookieAuth` before invoking `DomainsApi.GetDomainOrderFields()`.")
		  
		  
		  If me.ApiKeyapiKeyAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeyapiKeyAuth` before invoking `DomainsApi.GetDomainOrderFields()`.")
		  
		  localVarHTTPSocket.SetRequestHeader(EncodeURLComponent("X-API-KEY"), EncodeURLComponent(me.ApiKeyapiKeyAuth))
		  If me.ApiKeysessionIdHeaderAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeysessionIdHeaderAuth` before invoking `DomainsApi.GetDomainOrderFields()`.")
		  
		  localVarHTTPSocket.SetRequestHeader(EncodeURLComponent("sessionid"), EncodeURLComponent(me.ApiKeysessionIdHeaderAuth))
		  


		  Dim localVarPath As String = "/domains/order/{domain}/{regType}"
		  
		  Dim localVarPathStringdomain As String = domain
		  
		  localVarPath = localVarPath.ReplaceAllB("{domain}", localVarPathStringdomain)
		  Dim localVarPathStringregType As String = regType
		  
		  localVarPath = localVarPath.ReplaceAllB("{regType}", localVarPathStringregType)
		  
		  
		  AddHandler localVarHTTPSocket.PageReceived, addressof Me.GetDomainOrderFields_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.GetDomainOrderFields_error
	...
	#tag Method, Flags = &h21
		Private Sub GetDomainOrderFields_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.GetDomainOrderFieldsCallback(error)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub GetDomainOrderFields_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
	...
	#tag Method, Flags = &h0
		Sub GetDomainOrderSearchResults(, domain As String)
		  ...
		  //
		  // Invokes DomainsApiCallbackHandler.GetDomainOrderSearchResultsCallback() on completion. 
		  //
		  ...
		  If me.ApiKeysessionIdCookieAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeysessionIdCookieAuth` before invoking `DomainsApi.GetDomainOrderSearchResults()`.")
		  
		  
		  If me.ApiKeyapiKeyAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeyapiKeyAuth` before invoking `DomainsApi.GetDomainOrderSearchResults()`.")
		  
		  localVarHTTPSocket.SetRequestHeader(EncodeURLComponent("X-API-KEY"), EncodeURLComponent(me.ApiKeyapiKeyAuth))
		  If me.ApiKeysessionIdHeaderAuth = "" Then Raise New OpenAPIClient.OpenAPIClientException(kErrorCannotAuthenticate, "API key is unset. Please assign a value to `DomainsApi.ApiKeysessionIdHeaderAuth` before invoking `DomainsApi.GetDomainOrderSearchResults()`.")
		  
		  localVarHTTPSocket.SetRequestHeader(EncodeURLComponent("sessionid"), EncodeURLComponent(me.ApiKeysessionIdHeaderAuth))
		  


		  Dim localVarPath As String = "/domains/order/{domain}"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof Me.GetDomainOrderSearchResults_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.GetDomainOrderSearchResults_error
	...
	#tag Method, Flags = &h21
		Private Sub GetDomainOrderSearchResults_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.GetDomainOrderSearchResultsCallback(error)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub GetDomainOrderSearchResults_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  #Pragma Unused Headers
		  #Pragma Unused Content
	...
	#tag Method, Flags = &h0
		Sub UpdateDomainInfo(, id As String)
