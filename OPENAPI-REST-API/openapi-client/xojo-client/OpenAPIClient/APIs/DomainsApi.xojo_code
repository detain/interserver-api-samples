...
Protected Class DomainsApi
	#tag Method, Flags = &h0
		Sub AddDomain()
		  ...
		  // Place Domain Order
		  //
		  // Invokes DomainsApiCallbackHandler.AddDomainCallback() on completion. 
		  //
		  // - POST /domains/order
	...
	#tag Method, Flags = &h21
		Private Sub AddDomain_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  CallbackHandler.AddDomainCallback(error)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub UpdateDomainInfo(, id As String)
		  ...
		  // - parameter id: (path) The domain service ID. Use &#x60;domain_id&#x60; from &#x60;GET /domains&#x60;. 
		  //
		  // Invokes DomainsApiCallbackHandler.UpdateDomainInfoCallback() on completion. 
		  //
		  // - POST /domains/{id}
	...
	#tag Method, Flags = &h21
		Private Sub UpdateDomainInfo_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  CallbackHandler.UpdateDomainInfoCallback(error)
		End Sub
	#tag EndMethod
