...
Protected Class ServersApi
	#tag Method, Flags = &h0
		Sub AddServer()
		  ...
		  // - 
		  //
		  // Invokes ServersApiCallbackHandler.AddServerCallback(AddServer200Response) on completion. 
		  //
		  // - POST /servers/order
	...
	#tag Method, Flags = &h21
		Private Function AddServerPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.AddServer200Response) As Boolean
		  ...
		  If HTTPStatus > 199 and HTTPStatus < 300 then
		    If contentType.LeftB(16) = "application/json" then
			  ...
			  outData = New OpenAPIClient.Models.AddServer200Response
			  Try
	...
	#tag Method, Flags = &h21
		Private Sub AddServer_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim data As OpenAPIClient.Models.AddServer200Response
		  CallbackHandler.AddServerCallback(error, data)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub AddServer_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  ...
		  Dim data As OpenAPIClient.Models.AddServer200Response
		  Call AddServerPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
...
localVarFormParams.Value("action") = ActionEnum_ServerIpmiPowerPostToString(action)
	...
	#tag Method, Flags = &h0
		Sub UpdateServerInfo(, id As String)
		  ...
		  // - parameter id: (path) Server ID number. 
		  //
		  // Invokes ServersApiCallbackHandler.UpdateServerInfoCallback(SuccessTextResponse) on completion. 
		  //
		  // - POST /servers/{id}
	...
	#tag Method, Flags = &h21
		Private Function UpdateServerInfoPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.SuccessTextResponse) As Boolean
		  Dim contentType As String = Headers.Value("Content-Type")
		  Dim contentEncoding As TextEncoding = OpenAPIClient.EncodingFromContentType(contentType)
		  Content = DefineEncoding(Content, contentEncoding)
	...
	#tag Method, Flags = &h21
		Private Sub UpdateServerInfo_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As OpenAPIClient.Models.SuccessTextResponse
		  CallbackHandler.UpdateServerInfoCallback(error, data)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateServerInfo_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  ...
		  Dim data As OpenAPIClient.Models.SuccessTextResponse
		  Call UpdateServerInfoPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
