...
Protected Interface DNSApiCallbackHandler
	#tag Method, Flags = &h0
		Sub AddDnsDomainCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub DeleteDnsDomainCallback(status As OpenAPIClient.OpenAPIClientException)
		  
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub DeleteDnsRecordCallback(status As OpenAPIClient.OpenAPIClientException)
	...
	#tag Method, Flags = &h0
		Sub UpdateDnsRecordCallback(status As OpenAPIClient.OpenAPIClientException)
