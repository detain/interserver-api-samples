...
If ccCcv2 <> nil Then localVarFormParams.Value("cc_ccv2") = ccCcv2
	...
	#tag Method, Flags = &h0
		Sub DeleteAccountCreditCard(, id As String)
		  ...
		  //
		  // Invokes BillingApiCallbackHandler.DeleteAccountCreditCardCallback(String) on completion. 
		  //
	...
	#tag Method, Flags = &h21
		Private Function DeleteAccountCreditCardPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As String) As Boolean
		  Dim contentType As String = Headers.Value("Content-Type")
		  Dim contentEncoding As TextEncoding = OpenAPIClient.EncodingFromContentType(contentType)
		  Content = DefineEncoding(Content, contentEncoding)
	...
	#tag Method, Flags = &h21
		Private Sub DeleteAccountCreditCard_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As String
		  CallbackHandler.DeleteAccountCreditCardCallback(error, data)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub DeleteAccountCreditCard_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  ...
		  Dim data As String
		  Call DeleteAccountCreditCardPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Method, Flags = &h0
		Sub UpdateAccountCreditCard(, id As Integer)
		  ...
		  // - parameter id: (path) The credit card ID. Use the card ID returned from &#x60;POST /account/creditcards&#x60; or listed in &#x60;/billing/creditcards&#x60;. 
		  //
		  // Invokes BillingApiCallbackHandler.UpdateAccountCreditCardCallback(String) on completion. 
		  //
	...
	#tag Method, Flags = &h21
		Private Function UpdateAccountCreditCardPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As String) As Boolean
		  Dim contentType As String = Headers.Value("Content-Type")
		  Dim contentEncoding As TextEncoding = OpenAPIClient.EncodingFromContentType(contentType)
		  Content = DefineEncoding(Content, contentEncoding)
	...
	#tag Method, Flags = &h21
		Private Sub UpdateAccountCreditCard_error(sender As HTTPSecureSocket, Code As Integer)
		  ...
		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As String
		  CallbackHandler.UpdateAccountCreditCardCallback(error, data)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateAccountCreditCard_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  ...
		  Dim data As String
		  Call UpdateAccountCreditCardPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
