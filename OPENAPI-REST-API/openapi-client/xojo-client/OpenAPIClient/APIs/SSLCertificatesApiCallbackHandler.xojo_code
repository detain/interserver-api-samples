...
Protected Interface SSLCertificatesApiCallbackHandler
	#tag Method, Flags = &h0
		Sub AddSslCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As OpenAPIClient.Models.ServiceOrderPostResponse)
		  
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub GetNewSslCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As Object)
		  
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub GetSslInfoCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As Object)
	...
	#tag Method, Flags = &h0
		Sub UpdateSslInfoCallback(status As OpenAPIClient.OpenAPIClientException, Optional data As OpenAPIClient.Models.SuccessTextResponse)
