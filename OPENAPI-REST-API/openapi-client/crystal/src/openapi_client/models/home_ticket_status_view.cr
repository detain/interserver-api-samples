...
module OpenAPIClient
  ...
  class HomeTicketStatusView
    ...
    @[JSON::Field(key: "4", type: String?, nillable: true, emit_null: false)]
    property _4 : String?

    # Status corresponding to view number 5.
    @[JSON::Field(key: "5", type: String?, nillable: true, emit_null: false)]
    property _5 : String?

    # Status corresponding to view number 6.
    @[JSON::Field(key: "6", type: String?, nillable: true, emit_null: false)]
    property _6 : String?
