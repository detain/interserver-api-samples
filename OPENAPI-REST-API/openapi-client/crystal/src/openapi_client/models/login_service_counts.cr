...
module OpenAPIClient
  ...
  class LoginServiceCounts
    ...
    @[JSON::Field(key: "vps", type: Int32, nillable: false, emit_null: false)]
    property vps : Int32

    # The number of total website orders that have been placed in our billing system.
    @[JSON::Field(key: "websites", type: Int32, nillable: false, emit_null: false)]
    property websites : Int32

    # The number of total server orders that have been placed in our billing system.
    @[JSON::Field(key: "servers", type: Int32, nillable: false, emit_null: false)]
