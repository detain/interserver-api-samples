...
module OpenAPIClient
  ...
  class VpsTrafficHistorySectionResponse
    ...
    # Required properties
    @[JSON::Field(key: "data", type: Array(VpsTrafficHistorySectionDataResponse), nillable: false, emit_null: false)]
    property data : Array(VpsTrafficHistorySectionDataResponse)
    ...
    def initialize(@data : Array(VpsTrafficHistorySectionDataResponse), @times : Array(Time))
    end
