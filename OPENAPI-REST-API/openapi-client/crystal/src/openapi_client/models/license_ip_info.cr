...
module OpenAPIClient
  ...
  class LicenseIpInfo
    ...
    @[JSON::Field(key: "rows", type: Array(LicenseIpInfoRow)?, nillable: true, emit_null: false)]
    property rows : Array(LicenseIpInfoRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(LicenseIpInfoRow)? = nil)
    end
