...
module OpenAPIClient
  class PlaceBuyNowServerRequest
    ...
    @[JSON::Field(key: "server_id", type: Float64?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "server_root_password", type: String?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          ...
          server_root_password == other.server_root_password
    end
    ...
    def to_h
      ...
      hash["server_root_password"] = _to_h(server_root_password)
      hash.to_h
    end
