...
module OpenAPIClient
  ...
  class QuickserverIpInfo
    ...
    @[JSON::Field(key: "rows", type: Array(QuickserverIpTableRow)?, nillable: true, emit_null: false)]
    property rows : Array(QuickserverIpTableRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(QuickserverIpTableRow)? = nil)
    end
