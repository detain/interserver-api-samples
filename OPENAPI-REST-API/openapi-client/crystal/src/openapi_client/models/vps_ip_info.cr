...
module OpenAPIClient
  ...
  class VpsIPInfo
    ...
    @[JSON::Field(key: "rows", type: Array(VpsIPInfoRow)?, nillable: true, emit_null: false)]
    property rows : Array(VpsIPInfoRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(VpsIPInfoRow)? = nil)
    end
