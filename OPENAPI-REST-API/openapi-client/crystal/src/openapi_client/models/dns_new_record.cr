...
module OpenAPIClient
  ...
  class DnsNewRecord
    ...
    # Optional properties
    # Time-to-live
    @[JSON::Field(key: "ttl", type: Int32?, default: 86400, nillable: true, emit_null: false)]
    property ttl : Int32?

    # Priority
    @[JSON::Field(key: "prio", type: Int32?, default: 0, nillable: true, emit_null: false)]
    property prio : Int32?
    ...
    def initialize(@name : String, @_type : DnsRecordType, @content : String, @ttl : Int32? = nil, @prio : Int32? = nil)
    end
    ...
    def hash
      [name, _type, content, ttl, prio].hash
    end
