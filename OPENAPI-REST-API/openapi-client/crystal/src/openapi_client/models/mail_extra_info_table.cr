...
module OpenAPIClient
  ...
  class MailExtraInfoTable
    ...
    @[JSON::Field(key: "rows", type: Array(MailExtraInfoTableRow)?, nillable: true, emit_null: false)]
    property rows : Array(MailExtraInfoTableRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(MailExtraInfoTableRow)? = nil)
    end
