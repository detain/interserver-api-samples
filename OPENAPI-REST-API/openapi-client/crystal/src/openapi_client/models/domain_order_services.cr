...
module OpenAPIClient
  ...
  class DomainOrderServices
    ...
    # Optional properties
    @[JSON::Field(key: "DomainOrderServices10001", type: DomainOrderServices10001?, nillable: true, emit_null: false)]
    property domain_order_services10001 : DomainOrderServices10001?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@domain_order_services10001 : DomainOrderServices10001? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          domain_order_services10001 == other.domain_order_services10001
    end
    ...
    def to_h
      ...
      hash["DomainOrderServices10001"] = _to_h(domain_order_services10001)
      hash.to_h
    end
