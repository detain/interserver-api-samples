...
module OpenAPIClient
  class VpsOrderTemplatesHyperv
    ...
    # Optional properties
    @[JSON::Field(key: "windows", type: VpsOrderTemplatesHypervWindows?, nillable: true, emit_null: false)]
    property windows : VpsOrderTemplatesHypervWindows?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@windows : VpsOrderTemplatesHypervWindows? = nil)
    end
