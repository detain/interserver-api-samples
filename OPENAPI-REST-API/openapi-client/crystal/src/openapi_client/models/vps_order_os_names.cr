...
module OpenAPIClient
  ...
  class VpsOrderOsNames
    ...
    # Optional properties
    @[JSON::Field(key: "opensuse", type: String?, nillable: true, emit_null: false)]
    property opensuse : String?

    @[JSON::Field(key: "ubuntu", type: String?, nillable: true, emit_null: false)]
    property ubuntu : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@opensuse : String? = nil, @ubuntu : String? = nil)
    end
    ...
    def to_h
      ...
      hash["opensuse"] = _to_h(opensuse)
      hash["ubuntu"] = _to_h(ubuntu)
      hash.to_h
    end
