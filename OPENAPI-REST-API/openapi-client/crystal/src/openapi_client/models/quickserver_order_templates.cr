...
module OpenAPIClient
  ...
  class QuickserverOrderTemplates
    ...
    # Optional properties
    @[JSON::Field(key: "Ubuntu", type: QuickserverOrderTemplatesUbuntu64?, nillable: true, emit_null: false)]
    property ubuntu : QuickserverOrderTemplatesUbuntu64?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@ubuntu : QuickserverOrderTemplatesUbuntu64? = nil)
    end
