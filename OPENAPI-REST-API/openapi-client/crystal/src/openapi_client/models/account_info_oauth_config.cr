...
module OpenAPIClient
  ...
  class AccountInfoOauthConfig
    ...
    # Required properties
    @[JSON::Field(key: "callback", type: String, nillable: false, emit_null: false)]
    property callback : String

    @[JSON::Field(key: "providers", type: AccountInfoOauthConfigProviders, nillable: false, emit_null: false)]
    property providers : AccountInfoOauthConfigProviders

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@callback : String, @providers : AccountInfoOauthConfigProviders)
    end
    ...
    def to_h
      ...
      hash["callback"] = _to_h(callback)
      hash["providers"] = _to_h(providers)
      hash.to_h
    end
