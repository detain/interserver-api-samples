...
module OpenAPIClient
  ...
  class CreateFilter
    ...
    # Required properties
    @[JSON::Field(key: "filter_type", type: String, nillable: false, emit_null: false)]
    property filter_type : String

    @[JSON::Field(key: "port", type: Int32, nillable: false, emit_null: false)]
    property port : Int32
    ...
    def to_h
      ...
      hash["filter_type"] = _to_h(filter_type)
