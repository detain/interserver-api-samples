...
module OpenAPIClient
  ...
  class QuickserverOrderDistroSel
    ...
    # Optional properties
    @[JSON::Field(key: "Ubuntu", type: QuickserverOrderDistroSelUbuntu?, nillable: true, emit_null: false)]
    property ubuntu : QuickserverOrderDistroSelUbuntu?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@ubuntu : QuickserverOrderDistroSelUbuntu? = nil)
    end
