...
module OpenAPIClient
  class QuickserverExtraInfoTables
    ...
    # Optional properties
    @[JSON::Field(key: "ip_info", type: QuickserverIpInfo?, nillable: true, emit_null: false)]
    property ip_info : QuickserverIpInfo?

    @[JSON::Field(key: "addons", type: QuickserverAddons?, nillable: true, emit_null: false)]
    property addons : QuickserverAddons?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@ip_info : QuickserverIpInfo? = nil, @addons : QuickserverAddons? = nil)
    end
