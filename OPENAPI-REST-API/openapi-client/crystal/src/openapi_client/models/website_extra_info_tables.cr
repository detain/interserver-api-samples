...
module OpenAPIClient
  ...
  class WebsiteExtraInfoTables
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: WebsiteTable?, nillable: true, emit_null: false)]
    property links : WebsiteTable?

    @[JSON::Field(key: "preview", type: WebsiteTable?, nillable: true, emit_null: false)]
    property preview : WebsiteTable?

    @[JSON::Field(key: "dns", type: WebsiteTable?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["links"] = _to_h(links)
      hash["preview"] = _to_h(preview)
      hash["dns"] = _to_h(dns)
      hash.to_h
    end
