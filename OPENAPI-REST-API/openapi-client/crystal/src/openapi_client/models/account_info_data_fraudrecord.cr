...
module OpenAPIClient
  class AccountInfoDataFraudrecord
    ...
    @[JSON::Field(key: "count", type: String?, nillable: true, emit_null: false)]
    property count : String?

    @[JSON::Field(key: "reliability", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@score : String? = nil, @count : String? = nil, @reliability : String? = nil, @code : String? = nil)
    end
    ...
    def to_h
      ...
      hash["reliability"] = _to_h(reliability)
