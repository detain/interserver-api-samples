...
module OpenAPIClient
  class VpsServiceExtra
    ...
    # Optional properties
    # Spice
    @[JSON::Field(key: "spice", type: Int32?, nillable: true, emit_null: false)]
    property spice : Int32?

    @[JSON::Field(key: "snapshots", type: Array(VpsSnapshot)?, nillable: true, emit_null: false)]
    property snapshots : Array(VpsSnapshot)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@spice : Int32? = nil, @snapshots : Array(VpsSnapshot)? = nil)
    end
    ...
    def to_h
      ...
      hash["spice"] = _to_h(spice)
      hash["snapshots"] = _to_h(snapshots)
      hash.to_h
    end
