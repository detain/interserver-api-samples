...
module OpenAPIClient
  ...
  class MailAlertUpdateRequest
    ...
    @[JSON::Field(key: "to", type: String?, nillable: true, emit_null: false)]
    property to : String?

    # Whether the alert is enabled.
    @[JSON::Field(key: "enabled", type: String?, nillable: true, emit_null: false)]
    ...
    def hash
      [alert_id, _type, value, to, enabled].hash
    end
