...
module OpenAPIClient
  ...
  class VpsTrafficDataSectionResponse
    ...
    @[JSON::Field(key: "data", type: Array(VPSTrafficDataDataSectionResponse), nillable: false, emit_null: false)]
    property data : Array(VPSTrafficDataDataSectionResponse)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@name : String, @data : Array(VPSTrafficDataDataSectionResponse))
    end
