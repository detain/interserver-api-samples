...
module OpenAPIClient
  ...
  class DomainOrderTldServices
    ...
    @[JSON::Field(key: ".asia", type: Int32?, nillable: true, emit_null: false)]
    property _asia : Int32?

    # Service ID for .be TLD
    @[JSON::Field(key: ".be", type: Int32?, nillable: true, emit_null: false)]
    property _be : Int32?

    # Service ID for .biz TLD
    @[JSON::Field(key: ".biz", type: Int32?, nillable: true, emit_null: false)]
    property _biz : Int32?

    # Service ID for .ca TLD
    @[JSON::Field(key: ".ca", type: Int32?, nillable: true, emit_null: false)]
    property _ca : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_asia : Int32? = nil, @_be : Int32? = nil, @_biz : Int32? = nil, @_ca : Int32? = nil)
    end
