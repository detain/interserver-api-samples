...
module OpenAPIClient
  ...
  class HomeDetails
    ...
    # Optional properties
    @[JSON::Field(key: "modules", type: HomeDetailsModules?, nillable: true, emit_null: false)]
    property modules : HomeDetailsModules?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@modules : HomeDetailsModules? = nil)
    end
