...
module OpenAPIClient
  ...
  class VpsSnapshot
    ...
    @[JSON::Field(key: "used", type: Int32?, nillable: true, emit_null: false)]
    property used : Int32?

    # Unix timestamp of when the snapshot was created.
    @[JSON::Field(key: "date", type: Int32?, nillable: true, emit_null: false)]
    property date : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@name : String? = nil, @used : Int32? = nil, @date : Int32? = nil)
    end
