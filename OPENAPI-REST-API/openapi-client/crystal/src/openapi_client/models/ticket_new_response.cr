...
module OpenAPIClient
  ...
  class TicketNewResponse
    ...
    # Optional properties
    @[JSON::Field(key: "ticket_id", type: Int32?, nillable: true, emit_null: false)]
    property ticket_id : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@text : String, @success : Bool, @ticket_id : Int32? = nil)
    end
    ...
    def to_h
      ...
      hash["ticket_id"] = _to_h(ticket_id)
      hash.to_h
    end
