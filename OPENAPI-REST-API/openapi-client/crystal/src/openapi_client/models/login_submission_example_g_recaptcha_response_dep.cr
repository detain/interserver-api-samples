...
module OpenAPIClient
  class LoginSubmissionExampleGRecaptchaResponseDep
    ...
    # Optional properties
    @[JSON::Field(key: "w", type: Int32?, nillable: true, emit_null: false)]
    property w : Int32?

    @[JSON::Field(key: "n", type: Int32?, nillable: true, emit_null: false)]
    property n : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@w : Int32? = nil, @n : Int32? = nil)
    end
