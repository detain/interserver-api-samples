...
module OpenAPIClient
  class WebsiteTable
    ...
    @[JSON::Field(key: "rows", type: Array(WebsiteTableRow)?, nillable: true, emit_null: false)]
    property rows : Array(WebsiteTableRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(WebsiteTableRow)? = nil)
    end
