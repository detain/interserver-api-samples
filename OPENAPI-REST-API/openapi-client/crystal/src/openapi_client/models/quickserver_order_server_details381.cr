...
module OpenAPIClient
  class QuickserverOrderServerDetails381
    ...
    @[JSON::Field(key: "cpu", type: String?, nillable: true, emit_null: false)]
    property cpu : String?

    # RAM capacity of the server.
    @[JSON::Field(key: "ram", type: String?, nillable: true, emit_null: false)]
    property ram : String?
    ...
    # Number of CPU cores.
    @[JSON::Field(key: "cores", type: Int32?, nillable: true, emit_null: false)]
