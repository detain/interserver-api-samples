...
module OpenAPIClient
  ...
  class VpsOrderServiceTypes
    ...
    # Optional properties
    @[JSON::Field(key: "32", type: VpsOrderServiceTypes32?, nillable: true, emit_null: false)]
    property _32 : VpsOrderServiceTypes32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_32 : VpsOrderServiceTypes32? = nil)
    end
