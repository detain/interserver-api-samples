...
module OpenAPIClient
  class HomeServicesWebhosting
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: HomeServicesWebhostingLinks?, nillable: true, emit_null: false)]
    property links : HomeServicesWebhostingLinks?
    ...
    def initialize(@links : HomeServicesWebhostingLinks? = nil, @count : Int32? = nil)
    end
