...
module OpenAPIClient
  ...
  class VpsOrderTemplates
    ...
    # Optional properties
    @[JSON::Field(key: "hyperv", type: VpsOrderTemplatesHyperv?, nillable: true, emit_null: false)]
    property hyperv : VpsOrderTemplatesHyperv?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@hyperv : VpsOrderTemplatesHyperv? = nil)
    end
