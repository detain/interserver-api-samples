...
module OpenAPIClient
  class DomainNameserverGetResponseInner
    ...
    @[JSON::Field(key: "ipaddress", type: String, nillable: false, emit_null: false)]
    property ipaddress : String

    # Whether the registrar allows deletion of this nameserver entry.
    @[JSON::Field(key: "can_delete", type: String, nillable: false, emit_null: false)]
    ...
    class EnumAttributeValidatorForCanDelete < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "can_delete"
        @allowable_values = ["0", "1"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      can_delete_validator = EnumAttributeValidatorForCanDelete.new
      if !can_delete_validator.valid?(@can_delete)
        message = can_delete_validator.message
    ...
    def can_delete=(can_delete)
      validator = EnumAttributeValidatorForCanDelete.new
    ...
    def hash
      [name, ipaddress, can_delete].hash
    end
    ...
    def to_h
      ...
      hash["ipaddress"] = _to_h(ipaddress)
      hash["can_delete"] = _to_h(can_delete)
      hash.to_h
    end
