...
module OpenAPIClient
  ...
  class MailSchemaExtraInfoTables
    ...
    # Optional properties
    @[JSON::Field(key: "mail", type: MailExtraInfoTable?, nillable: true, emit_null: false)]
    property mail : MailExtraInfoTable?

    @[JSON::Field(key: "tutorials", type: MailTutorialsTable?, nillable: true, emit_null: false)]
    property tutorials : MailTutorialsTable?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@mail : MailExtraInfoTable? = nil, @tutorials : MailTutorialsTable? = nil)
    end
    ...
    def to_h
      ...
      hash["mail"] = _to_h(mail)
      hash["tutorials"] = _to_h(tutorials)
      hash.to_h
    end
