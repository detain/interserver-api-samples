...
module OpenAPIClient
  ...
  class ServerOrderMemoryLi
    ...
    # Optional properties
    @[JSON::Field(key: "254", type: ServerOrderMemoryLi254?, nillable: true, emit_null: false)]
    property _254 : ServerOrderMemoryLi254?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_254 : ServerOrderMemoryLi254? = nil)
    end
