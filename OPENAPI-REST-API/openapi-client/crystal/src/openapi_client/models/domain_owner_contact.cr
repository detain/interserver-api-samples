...
module OpenAPIClient
  ...
  class DomainOwnerContact
    ...
    def initialize(@postal_code : String? = nil, @org_name : String? = nil, @country : String? = nil, @status : String? = nil, @state : String? = nil, @first_name : String? = nil, @last_name : String? = nil, @address3 : String? = nil, @fax : String? = nil, @address2 : String? = nil, @email : String? = nil, @city : String? = nil, @phone : String? = nil, @address1 : String? = nil)
    end
    ...
    def hash
      [postal_code, org_name, country, status, state, first_name, last_name, address3, fax, address2, email, city, phone, address1].hash
    end
