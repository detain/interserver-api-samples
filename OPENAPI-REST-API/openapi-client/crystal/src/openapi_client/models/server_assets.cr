...
module OpenAPIClient
  class ServerAssets
    ...
    @[JSON::Field(key: "header", type: Array(String)?, nillable: true, emit_null: false)]
    property header : Array(String)?

    # The rows of the assets table.
    @[JSON::Field(key: "rows", type: Array(Array(String))?, nillable: true, emit_null: false)]
    ...
    def hash
      [title, size, _type, header, rows].hash
    end
