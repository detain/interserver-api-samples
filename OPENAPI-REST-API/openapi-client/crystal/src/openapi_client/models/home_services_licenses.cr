...
module OpenAPIClient
  class HomeServicesLicenses
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: HomeServicesLicensesLinks?, nillable: true, emit_null: false)]
    property links : HomeServicesLicensesLinks?
    ...
    def initialize(@links : HomeServicesLicensesLinks? = nil, @count : Int32? = nil)
    end
