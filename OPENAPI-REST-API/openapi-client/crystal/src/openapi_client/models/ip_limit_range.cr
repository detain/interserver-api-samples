...
module OpenAPIClient
  ...
  class IpLimitRange
    ...
    @[JSON::Field(key: "start", type: String, nillable: false, emit_null: false)]
    property start : String

    # The ending (or last) IP address in the range.
    @[JSON::Field(key: "end", type: String, nillable: false, emit_null: false)]
    property _end : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@start : String, @_end : String)
    end
