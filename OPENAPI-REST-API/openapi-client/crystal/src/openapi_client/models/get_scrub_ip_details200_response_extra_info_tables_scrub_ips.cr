...
module OpenAPIClient
  class GetScrubIpDetails200ResponseExtraInfoTablesScrubIps
    ...
    @[JSON::Field(key: "rows", type: Array(GetScrubIpDetails200ResponseExtraInfoTablesScrubIpsRowsInner)?, nillable: true, emit_null: false)]
    property rows : Array(GetScrubIpDetails200ResponseExtraInfoTablesScrubIpsRowsInner)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(GetScrubIpDetails200ResponseExtraInfoTablesScrubIpsRowsInner)? = nil)
    end
