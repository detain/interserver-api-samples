...
module OpenAPIClient
  ...
  class ServerOrderCpLi
    ...
    # Optional properties
    @[JSON::Field(key: "9", type: ServerOrderControlPanel?, nillable: true, emit_null: false)]
    property _9 : ServerOrderControlPanel?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_9 : ServerOrderControlPanel? = nil)
    end
