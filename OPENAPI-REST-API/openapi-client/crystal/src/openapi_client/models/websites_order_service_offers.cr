...
module OpenAPIClient
  ...
  class WebsitesOrderServiceOffers
    ...
    # Required properties
    @[JSON::Field(key: "1026", type: Array(WebsitesOrderServiceOffer), nillable: false, emit_null: false)]
    property _1026 : Array(WebsitesOrderServiceOffer)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_1026 : Array(WebsitesOrderServiceOffer))
    end
