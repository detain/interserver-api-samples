...
module OpenAPIClient
  ...
  class AffiliateBannerRow
    ...
    # Optional properties
    @[JSON::Field(key: "image", type: String?, nillable: true, emit_null: false)]
    property image : String?

    @[JSON::Field(key: "width", type: String?, nillable: true, emit_null: false)]
    property width : String?

    @[JSON::Field(key: "height", type: String?, nillable: true, emit_null: false)]
    property height : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@image : String? = nil, @width : String? = nil, @height : String? = nil)
    end
