...
module OpenAPIClient
  class ServerLease
    ...
    @[JSON::Field(key: "mac", type: String, nillable: false, emit_null: false)]
    property mac : String

    # Indicates if the lease is authenticated.
    @[JSON::Field(key: "authenticated", type: Bool, nillable: false, emit_null: false)]
    property authenticated : Bool

    # Group identifier for the lease.
    @[JSON::Field(key: "group", type: String, nillable: false, emit_null: false)]
    ...
    def to_h
      ...
      hash["mac"] = _to_h(mac)
      hash["authenticated"] = _to_h(authenticated)
