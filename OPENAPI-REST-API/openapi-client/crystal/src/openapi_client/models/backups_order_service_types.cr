...
module OpenAPIClient
  class BackupsOrderServiceTypes
    ...
    # Optional properties
    @[JSON::Field(key: "11006", type: BackupsOrderServiceTypes?, nillable: true, emit_null: false)]
    property _11006 : BackupsOrderServiceTypes?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_11006 : BackupsOrderServiceTypes? = nil)
    end
