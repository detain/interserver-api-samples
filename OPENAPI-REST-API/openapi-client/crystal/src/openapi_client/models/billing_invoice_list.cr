...
module OpenAPIClient
  ...
  class BillingInvoiceList
    ...
    @[JSON::Field(key: "rows", type: Array(JSON::Any)?, nillable: true, emit_null: false)]
    property rows : Array(JSON::Any)?

    # Totals and summary data for the invoices list.
    @[JSON::Field(key: "summary", type: JSON::Any?, nillable: true, emit_null: false)]
