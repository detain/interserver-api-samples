...
module OpenAPIClient
  ...
  class DomainNameserverPutRequest
    ...
    # Required properties
    @[JSON::Field(key: "nameserver", type: Array(String), nillable: false, emit_null: false)]
    property nameserver : Array(String)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@nameserver : Array(String))
    end
    ...
    def to_h
      ...
      hash["nameserver"] = _to_h(nameserver)
      hash.to_h
    end
