...
module OpenAPIClient
  ...
  class QuickserverOrderServerDetails
    ...
    # Optional properties
    @[JSON::Field(key: "381", type: QuickserverOrderServerDetails381?, nillable: true, emit_null: false)]
    property _381 : QuickserverOrderServerDetails381?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_381 : QuickserverOrderServerDetails381? = nil)
    end
