...
module OpenAPIClient
  ...
  class DomainNameServer
    ...
    # Optional properties
    @[JSON::Field(key: "sortorder", type: String?, nillable: true, emit_null: false)]
    property sortorder : String?

    @[JSON::Field(key: "name", type: String?, nillable: true, emit_null: false)]
    property name : String?

    @[JSON::Field(key: "ipaddress", type: String?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["sortorder"] = _to_h(sortorder)
