...
module OpenAPIClient
  ...
  class Region
    ...
    # Optional properties
    @[JSON::Field(key: "region_id", type: Int32?, nillable: true, emit_null: false)]
    property region_id : Int32?

    @[JSON::Field(key: "region_name", type: String?, nillable: true, emit_null: false)]
    property region_name : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@region_id : Int32? = nil, @region_name : String? = nil)
    end
    ...
    def to_h
      ...
      hash["region_id"] = _to_h(region_id)
      hash["region_name"] = _to_h(region_name)
      hash.to_h
    end
