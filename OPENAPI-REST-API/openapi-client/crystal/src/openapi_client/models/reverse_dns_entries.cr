...
module OpenAPIClient
  ...
  class ReverseDnsEntries
    ...
    @[JSON::Field(key: "ips", type: Hash(String, JSON::Any)?, nillable: true, emit_null: false)]
    property ips : Hash(String, JSON::Any)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@ips : Hash(String, JSON::Any)? = nil)
    end
