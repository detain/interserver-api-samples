...
module OpenAPIClient
  ...
  class MailDeliverabilityResponse
    ...
    @[JSON::Field(key: "stat", type: JSON::Any?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "table_data", type: Array(Array(String))?, nillable: true, emit_null: false)]
    ...
    def to_h
      ...
      hash["table_data"] = _to_h(table_data)
      hash.to_h
    end
