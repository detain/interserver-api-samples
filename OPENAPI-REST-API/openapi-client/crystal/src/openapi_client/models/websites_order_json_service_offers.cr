...
module OpenAPIClient
  ...
  class WebsitesOrderJsonServiceOffers
    ...
    @[JSON::Field(key: "1026", type: Array(WebsitesOrderJsonServiceOffersItem), nillable: false, emit_null: false)]
    property _1026 : Array(WebsitesOrderJsonServiceOffersItem)

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_1026 : Array(WebsitesOrderJsonServiceOffersItem))
    end
