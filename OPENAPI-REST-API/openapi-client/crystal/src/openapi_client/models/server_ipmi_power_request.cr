...
module OpenAPIClient
  ...
  class ServerIpmiPowerRequest
    ...
    @[JSON::Field(key: "action", type: String, nillable: false, emit_null: false)]
    property action : String

    # Optional properties
    # The Asset ID
    @[JSON::Field(key: "asset", type: Int32?, nillable: true, emit_null: false)]
    ...
    class EnumAttributeValidatorForAction < EnumAttributeValidator
      @attribute : String
      @allowable_values : Array(Int32 | Int64 | Float32 | Float64 | String)

      def initialize
        @attribute = "action"
        @allowable_values = ["cycle", "reset", "on", "off", "soft"].map { |value| to(String, value)}
      end
    end
    ...
    def list_invalid_properties
      ...
      action_validator = EnumAttributeValidatorForAction.new
      if !action_validator.valid?(@action)
        message = action_validator.message
    ...
    def action=(action)
      validator = EnumAttributeValidatorForAction.new
