...
module OpenAPIClient
  ...
  class VpsOrderLocationStock
    ...
    # Optional properties
    @[JSON::Field(key: "1", type: VpsOrderLocationStock1?, nillable: true, emit_null: false)]
    property _1 : VpsOrderLocationStock1?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_1 : VpsOrderLocationStock1? = nil)
    end
