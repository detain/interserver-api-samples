...
module OpenAPIClient
  ...
  class ScrubIpFilterTypes
    ...
    @[JSON::Field(key: "filters", type: Hash(String, ScrubIpFilterTypesFiltersValue)?, nillable: true, emit_null: false)]
    property filters : Hash(String, ScrubIpFilterTypesFiltersValue)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@success : Bool? = nil, @filters : Hash(String, ScrubIpFilterTypesFiltersValue)? = nil)
    end
