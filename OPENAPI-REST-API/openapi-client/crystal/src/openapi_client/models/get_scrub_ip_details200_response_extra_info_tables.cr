...
module OpenAPIClient
  class GetScrubIpDetails200ResponseExtraInfoTables
    ...
    # Optional properties
    @[JSON::Field(key: "scrub_ips", type: GetScrubIpDetails200ResponseExtraInfoTablesScrubIps?, nillable: true, emit_null: false)]
    property scrub_ips : GetScrubIpDetails200ResponseExtraInfoTablesScrubIps?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@scrub_ips : GetScrubIpDetails200ResponseExtraInfoTablesScrubIps? = nil)
    end
    ...
    def to_h
      ...
      hash["scrub_ips"] = _to_h(scrub_ips)
      hash.to_h
    end
