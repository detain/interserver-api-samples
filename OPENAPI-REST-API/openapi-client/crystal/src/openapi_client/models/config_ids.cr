...
module OpenAPIClient
  ...
  class ConfigIds
    ...
    def initialize(@memory : Int32? = nil, @hd : Int32? = nil, @bandwidth : Int32? = nil, @ips : Int32? = nil, @os : Int32? = nil, @cp : Int32? = nil, @raid : Int32? = nil)
    end
    ...
    def hash
      [memory, hd, bandwidth, ips, os, cp, raid].hash
    end
