...
module OpenAPIClient
  ...
  class MailTutorialsTable
    ...
    @[JSON::Field(key: "rows", type: Array(MailTutorialsTableRow)?, nillable: true, emit_null: false)]
    property rows : Array(MailTutorialsTableRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(MailTutorialsTableRow)? = nil)
    end
