...
module OpenAPIClient
  class HomeServicesVps
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: HomeServicesVpsLinks?, nillable: true, emit_null: false)]
    property links : HomeServicesVpsLinks?
    ...
    def initialize(@links : HomeServicesVpsLinks? = nil, @count : Int32? = nil)
    end
