...
module OpenAPIClient
  class HomeServicesDomains
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: HomeServicesDomainsLinks?, nillable: true, emit_null: false)]
    property links : HomeServicesDomainsLinks?
    ...
    def initialize(@links : HomeServicesDomainsLinks? = nil, @count : Int32? = nil)
    end
