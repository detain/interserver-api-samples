...
module OpenAPIClient
  ...
  class VpsBackupRow
    ...
    @[JSON::Field(key: "service", type: Int32, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "date", type: Int32, nillable: false, emit_null: false)]
    property date : Int32
    ...
    def hash
      [_type, service, name, size, date].hash
    end
