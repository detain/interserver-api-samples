...
module OpenAPIClient
  class AccountInfoOauthproviders
    ...
    private def self.find_and_cast_into_type(klass : AccountInfoOauthConfigProviders.class, data)
      return if data.nil?
    ...
    private def self.find_and_cast_into_type(klass : Array(JSON::Any).class, data)
      return if data.nil?
    ...
    def initialize(@value : AccountInfoOauthConfigProviders)
    end
