...
module OpenAPIClient
  ...
  class VpsTrafficHistoryResponse
    ...
    # Required properties
    @[JSON::Field(key: "hour", type: VpsTrafficHistorySectionResponse, nillable: false, emit_null: false)]
    property hour : VpsTrafficHistorySectionResponse

    @[JSON::Field(key: "day", type: VpsTrafficHistorySectionResponse, nillable: false, emit_null: false)]
