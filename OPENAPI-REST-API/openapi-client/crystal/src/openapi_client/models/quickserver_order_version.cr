...
module OpenAPIClient
  ...
  class QuickserverOrderVersion
    ...
    # Optional properties
    @[JSON::Field(key: "centosstream-8", type: QuickserverOrderVersionCentosstream8?, nillable: true, emit_null: false)]
    property centosstream_8 : QuickserverOrderVersionCentosstream8?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@centosstream_8 : QuickserverOrderVersionCentosstream8? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          centosstream_8 == other.centosstream_8
    end
    ...
    def to_h
      ...
      hash["centosstream-8"] = _to_h(centosstream_8)
      hash.to_h
    end
