...
module OpenAPIClient
  ...
  class LoginInfo
    ...
    @[JSON::Field(key: "captcha", type: String, nillable: false, emit_null: false)]
    property captcha : String

    @[JSON::Field(key: "counts", type: LoginServiceCounts, nillable: false, emit_null: false)]
    property counts : LoginServiceCounts

    # Optional properties
    # A logo image url.
    @[JSON::Field(key: "logo", type: String?, nillable: true, emit_null: false)]
    ...
    def hash
      [captcha, counts, logo, language].hash
    end
    ...
    def to_h
      ...
      hash["captcha"] = _to_h(captcha)
      hash["counts"] = _to_h(counts)
      hash["logo"] = _to_h(logo)
