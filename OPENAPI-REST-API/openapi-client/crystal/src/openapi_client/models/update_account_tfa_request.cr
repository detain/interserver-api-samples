...
module OpenAPIClient
  class UpdateAccountTfaRequest
    ...
    @[JSON::Field(key: "2fa_google_code", type: String, nillable: false, emit_null: false)]
    property _2fa_google_code : String

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_2fa_google_code : String)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          _2fa_google_code == other._2fa_google_code
    end
    ...
    def to_h
      ...
      hash["2fa_google_code"] = _to_h(_2fa_google_code)
      hash.to_h
    end
