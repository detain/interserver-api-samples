...
module OpenAPIClient
  class PostOauthCallback200Response
    ...
    @[JSON::Field(key: "login", type: Bool?, nillable: true, emit_null: false)]
    property login : Bool?

    # Whether a new account was created.
    @[JSON::Field(key: "signup", type: Bool?, nillable: true, emit_null: false)]
    property signup : Bool?

    # Whether the OAuth provider was linked to an existing account.
    @[JSON::Field(key: "linked", type: Bool?, nillable: true, emit_null: false)]
    ...
    def hash
      [login, signup, linked, account_id, error_code].hash
    end
    ...
    def to_h
      ...
      hash["signup"] = _to_h(signup)
      hash["linked"] = _to_h(linked)
