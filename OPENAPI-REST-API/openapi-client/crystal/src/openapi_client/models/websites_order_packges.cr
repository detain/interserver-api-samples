...
module OpenAPIClient
  ...
  class WebsitesOrderPackges
    ...
    # Required properties
    @[JSON::Field(key: "11440", type: WebsitesOrderPackagesInfo, nillable: false, emit_null: false)]
    property _11440 : WebsitesOrderPackagesInfo

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_11440 : WebsitesOrderPackagesInfo)
    end
