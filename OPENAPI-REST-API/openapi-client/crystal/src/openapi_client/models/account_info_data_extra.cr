...
module OpenAPIClient
  class AccountInfoDataExtra
    ...
    # Optional properties
    @[JSON::Field(key: "private_whois", type: String?, nillable: true, emit_null: false)]
    property private_whois : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@private_whois : String? = nil)
    end
    ...
    def ==(other)
      ...
      self.class == other.class &&
          private_whois == other.private_whois
    end
    ...
    def to_h
      ...
      hash["private_whois"] = _to_h(private_whois)
      hash.to_h
    end
