...
module OpenAPIClient
  class BuyItNowServerOrder200ResponseCpInner
    ...
    @[JSON::Field(key: "monthly_price", type: String?, nillable: true, emit_null: false)]
    property monthly_price : String?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@id : String? = nil, @short_desc : String? = nil, @long_desc : String? = nil, @os_type : String? = nil, @monthly_price : String? = nil)
    end
    ...
    def hash
      [id, short_desc, long_desc, os_type, monthly_price].hash
    end
