...
module OpenAPIClient
  ...
  class VpsTrafficUsageAverageResponse
    ...
    # Required properties
    @[JSON::Field(key: "in", type: VpsTrafficUsageAverageSectionResponse, nillable: false, emit_null: false)]
    property _in : VpsTrafficUsageAverageSectionResponse

    @[JSON::Field(key: "out", type: VpsTrafficUsageAverageSectionResponse, nillable: false, emit_null: false)]
    property _out : VpsTrafficUsageAverageSectionResponse

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_in : VpsTrafficUsageAverageSectionResponse, @_out : VpsTrafficUsageAverageSectionResponse)
    end
