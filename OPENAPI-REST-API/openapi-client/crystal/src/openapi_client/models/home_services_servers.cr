...
module OpenAPIClient
  class HomeServicesServers
    ...
    # Optional properties
    @[JSON::Field(key: "links", type: HomeServicesServersLinks?, nillable: true, emit_null: false)]
    property links : HomeServicesServersLinks?
    ...
    def initialize(@links : HomeServicesServersLinks? = nil, @count : Int32? = nil)
    end
