...
module OpenAPIClient
  ...
  class LicensesOrderPackageCosts
    ...
    @[JSON::Field(key: "LicensesOrderPackageCosts11468", type: Float64?, nillable: true, emit_null: false)]
    ...
    def ==(other)
      ...
      self.class == other.class &&
          licenses_order_package_costs11468 == other.licenses_order_package_costs11468
    end
    ...
    def to_h
      ...
      hash["LicensesOrderPackageCosts11468"] = _to_h(licenses_order_package_costs11468)
      hash.to_h
    end
