...
module OpenAPIClient
  class QuickserverAddons
    ...
    @[JSON::Field(key: "rows", type: Array(QuickserverAddonsRow)?, nillable: true, emit_null: false)]
    property rows : Array(QuickserverAddonsRow)?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@title : String? = nil, @rows : Array(QuickserverAddonsRow)? = nil)
    end
