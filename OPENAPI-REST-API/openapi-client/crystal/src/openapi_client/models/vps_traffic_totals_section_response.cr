...
module OpenAPIClient
  ...
  class VpsTrafficTotalsSectionResponse
    ...
    # Required properties
    @[JSON::Field(key: "in", type: Int64, nillable: false, emit_null: false)]
    property _in : Int64

    @[JSON::Field(key: "out", type: Int64, nillable: false, emit_null: false)]
    property _out : Int64

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@_in : Int64, @_out : Int64)
    end
