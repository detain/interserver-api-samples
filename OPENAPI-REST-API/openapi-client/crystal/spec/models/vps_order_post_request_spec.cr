...
# Unit tests for OpenAPIClient::VpsOrderPostRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::VpsOrderPostRequest do

  describe "test an instance of VpsOrderPostRequest" do
    skip "should create an instance of VpsOrderPostRequest" do
      #instance = OpenAPIClient::VpsOrderPostRequest.new
      #expect(instance).to be_instance_of(OpenAPIClient::VpsOrderPostRequest)
    end
  end
  describe "test attribute 'os_distro'" do
    skip "should work" do
