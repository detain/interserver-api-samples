...
# Unit tests for OpenAPIClient::DomainBillingExtra
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::DomainBillingExtra do

  describe "test an instance of DomainBillingExtra" do
    skip "should create an instance of DomainBillingExtra" do
      #instance = OpenAPIClient::DomainBillingExtra.new
      #expect(instance).to be_instance_of(OpenAPIClient::DomainBillingExtra)
    end
  end
  ...
  describe "test attribute 'prov_process_pending'" do
    skip "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
