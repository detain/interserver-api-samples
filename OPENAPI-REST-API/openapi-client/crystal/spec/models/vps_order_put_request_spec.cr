...
# Unit tests for OpenAPIClient::VpsOrderPutRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::VpsOrderPutRequest do

  describe "test an instance of VpsOrderPutRequest" do
    skip "should create an instance of VpsOrderPutRequest" do
      #instance = OpenAPIClient::VpsOrderPutRequest.new
      #expect(instance).to be_instance_of(OpenAPIClient::VpsOrderPutRequest)
    end
  end
