...
# Unit tests for OpenAPIClient::UpdateTicket
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe OpenAPIClient::UpdateTicket do

  describe "test an instance of UpdateTicket" do
    skip "should create an instance of UpdateTicket" do
      #instance = OpenAPIClient::UpdateTicket.new
      #expect(instance).to be_instance_of(OpenAPIClient::UpdateTicket)
    end
  end
  ...
  describe "test attribute 'sudo_username'" do
    skip "should work" do
      # assertion here. ref: https://crystal-lang.org/reference/guides/testing.html
    end
  end
