...
# Unit tests for OpenAPIClient::FloatingIPsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
Spectator.describe "FloatingIPsApi" do
  describe "test an instance of FloatingIPsApi" do
    it "should create an instance of FloatingIPsApi" do
      api_instance = OpenAPIClient::FloatingIPsApi.new
      expect(api_instance).to be_instance_of(OpenAPIClient::FloatingIPsApi)
    end
  end
