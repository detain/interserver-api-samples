...
Spectator.describe "BillingApi" do
  ...
  # @option opts [String] :cc_exp 
  # @option opts [String] :cc_ccv2 
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :days Number of days of sales history to include in the graph data. Determines the time window for the returned data points.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Int32] :days Number of days of traffic history to include in the graph data. Determines the time window for the returned data points.
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :affiliate_dock_title 
  # @option opts [String] :affiliate_dock_description 
  # @option opts [String] :referrer_coupon 
  # @return [TextResponse]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :affiliate_paypal 
  # @option opts [String] :affiliate_payment_method 
  # @return [TextResponse]
