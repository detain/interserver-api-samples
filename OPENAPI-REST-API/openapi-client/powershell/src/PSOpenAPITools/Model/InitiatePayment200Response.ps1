...
InitiatePayment200Response<PSCustomObject>
#>

function Initialize-InitiatePayment200Response {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipelineByPropertyName = $true)]
        [ValidateSet("redirect", "submit", "single")]
        [String]
        ${Type},
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => InitiatePayment200Response' | Write-Debug
...
Convert from JSON to InitiatePayment200Response<PSCustomObject>
...
InitiatePayment200Response<PSCustomObject>
#>
function ConvertFrom-JsonToInitiatePayment200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => InitiatePayment200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in InitiatePayment200Response
        $AllProperties = ("type", "redirect", "action", "method", "items", "text")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "redirect"))) { #optional property not found
            $Redirect = $null
        } else {
            $Redirect = $JsonParameters.PSobject.Properties["redirect"].value
        }
