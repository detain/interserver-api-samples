...
ServersBuyNowError<PSCustomObject>
#>

function Initialize-ServersBuyNowError {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServersBuyNowError' | Write-Debug
...
Convert from JSON to ServersBuyNowError<PSCustomObject>
...
ServersBuyNowError<PSCustomObject>
#>
function ConvertFrom-JsonToServersBuyNowError {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServersBuyNowError' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServersBuyNowError
