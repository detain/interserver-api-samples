...
CancelScrubIp200Response<PSCustomObject>
#>

function Initialize-CancelScrubIp200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CancelScrubIp200Response' | Write-Debug
...
Convert from JSON to CancelScrubIp200Response<PSCustomObject>
...
CancelScrubIp200Response<PSCustomObject>
#>
function ConvertFrom-JsonToCancelScrubIp200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CancelScrubIp200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CancelScrubIp200Response
