...
BackupLoginResponse<PSCustomObject>
#>

function Initialize-BackupLoginResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BackupLoginResponse' | Write-Debug
...
Convert from JSON to BackupLoginResponse<PSCustomObject>
...
BackupLoginResponse<PSCustomObject>
#>
function ConvertFrom-JsonToBackupLoginResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BackupLoginResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BackupLoginResponse
