...
VpsTrafficUsageAverageSectionResponse<PSCustomObject>
#>

function Initialize-VpsTrafficUsageAverageSectionResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VpsTrafficUsageAverageSectionResponse' | Write-Debug
...
Convert from JSON to VpsTrafficUsageAverageSectionResponse<PSCustomObject>
...
VpsTrafficUsageAverageSectionResponse<PSCustomObject>
#>
function ConvertFrom-JsonToVpsTrafficUsageAverageSectionResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VpsTrafficUsageAverageSectionResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VpsTrafficUsageAverageSectionResponse
        $AllProperties = ("total", "count", "value")
