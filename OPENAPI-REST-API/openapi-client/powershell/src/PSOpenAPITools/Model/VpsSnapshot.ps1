...
VpsSnapshot<PSCustomObject>
#>

function Initialize-VpsSnapshot {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VpsSnapshot' | Write-Debug
...
Convert from JSON to VpsSnapshot<PSCustomObject>
...
VpsSnapshot<PSCustomObject>
#>
function ConvertFrom-JsonToVpsSnapshot {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VpsSnapshot' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VpsSnapshot
        $AllProperties = ("name", "used", "date")
