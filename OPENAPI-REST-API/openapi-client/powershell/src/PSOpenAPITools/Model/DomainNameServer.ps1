...
DomainNameServer<PSCustomObject>
#>

function Initialize-DomainNameServer {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DomainNameServer' | Write-Debug
...
Convert from JSON to DomainNameServer<PSCustomObject>
...
DomainNameServer<PSCustomObject>
#>
function ConvertFrom-JsonToDomainNameServer {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DomainNameServer' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DomainNameServer
        $AllProperties = ("sortorder", "name", "ipaddress")
