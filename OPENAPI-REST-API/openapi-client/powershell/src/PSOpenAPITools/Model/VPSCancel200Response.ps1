...
VPSCancel200Response<PSCustomObject>
#>

function Initialize-VPSCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => VPSCancel200Response' | Write-Debug
...
Convert from JSON to VPSCancel200Response<PSCustomObject>
...
VPSCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToVPSCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => VPSCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in VPSCancel200Response
