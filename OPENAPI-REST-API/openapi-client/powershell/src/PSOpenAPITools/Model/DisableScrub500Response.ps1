...
DisableScrub500Response<PSCustomObject>
#>

function Initialize-DisableScrub500Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DisableScrub500Response' | Write-Debug
...
Convert from JSON to DisableScrub500Response<PSCustomObject>
...
DisableScrub500Response<PSCustomObject>
#>
function ConvertFrom-JsonToDisableScrub500Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DisableScrub500Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisableScrub500Response
