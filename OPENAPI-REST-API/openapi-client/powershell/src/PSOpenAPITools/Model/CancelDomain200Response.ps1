...
CancelDomain200Response<PSCustomObject>
#>

function Initialize-CancelDomain200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CancelDomain200Response' | Write-Debug
...
Convert from JSON to CancelDomain200Response<PSCustomObject>
...
CancelDomain200Response<PSCustomObject>
#>
function ConvertFrom-JsonToCancelDomain200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CancelDomain200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CancelDomain200Response
