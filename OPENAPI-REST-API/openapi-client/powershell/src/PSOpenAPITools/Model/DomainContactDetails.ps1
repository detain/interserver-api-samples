...
DomainContactDetails<PSCustomObject>
#>

function Initialize-DomainContactDetails {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DomainContactDetails' | Write-Debug
...
Convert from JSON to DomainContactDetails<PSCustomObject>
...
DomainContactDetails<PSCustomObject>
#>
function ConvertFrom-JsonToDomainContactDetails {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DomainContactDetails' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DomainContactDetails
        $AllProperties = ("status", "state", "org_name", "country", "postal_code", "email", "fax", "address2", "address3", "address1", "city", "phone", "first_name", "last_name")
