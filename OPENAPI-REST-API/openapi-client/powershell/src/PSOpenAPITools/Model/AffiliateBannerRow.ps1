...
AffiliateBannerRow<PSCustomObject>
#>

function Initialize-AffiliateBannerRow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => AffiliateBannerRow' | Write-Debug
...
Convert from JSON to AffiliateBannerRow<PSCustomObject>
...
AffiliateBannerRow<PSCustomObject>
#>
function ConvertFrom-JsonToAffiliateBannerRow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => AffiliateBannerRow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in AffiliateBannerRow
        $AllProperties = ("image", "width", "height")
