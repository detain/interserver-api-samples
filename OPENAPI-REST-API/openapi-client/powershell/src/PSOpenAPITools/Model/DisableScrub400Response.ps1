...
DisableScrub400Response<PSCustomObject>
#>

function Initialize-DisableScrub400Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DisableScrub400Response' | Write-Debug
...
Convert from JSON to DisableScrub400Response<PSCustomObject>
...
DisableScrub400Response<PSCustomObject>
#>
function ConvertFrom-JsonToDisableScrub400Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DisableScrub400Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisableScrub400Response
