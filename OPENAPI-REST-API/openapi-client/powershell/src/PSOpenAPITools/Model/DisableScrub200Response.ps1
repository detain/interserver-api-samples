...
DisableScrub200Response<PSCustomObject>
#>

function Initialize-DisableScrub200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DisableScrub200Response' | Write-Debug
...
Convert from JSON to DisableScrub200Response<PSCustomObject>
...
DisableScrub200Response<PSCustomObject>
#>
function ConvertFrom-JsonToDisableScrub200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DisableScrub200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DisableScrub200Response
