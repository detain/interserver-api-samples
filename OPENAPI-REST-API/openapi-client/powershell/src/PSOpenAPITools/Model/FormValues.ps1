...
function Initialize-FormValues {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FormValues' | Write-Debug
...
Convert from JSON to FormValues<PSCustomObject>
...
FormValues<PSCustomObject>
#>
function ConvertFrom-JsonToFormValues {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FormValues' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FormValues
        $AllProperties = ("memory", "bandwidth", "ips", "os", "cp", "raid", "hd", "region")
