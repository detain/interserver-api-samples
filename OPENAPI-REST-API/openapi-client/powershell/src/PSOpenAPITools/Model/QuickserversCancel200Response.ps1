...
QuickserversCancel200Response<PSCustomObject>
#>

function Initialize-QuickserversCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => QuickserversCancel200Response' | Write-Debug
...
Convert from JSON to QuickserversCancel200Response<PSCustomObject>
...
QuickserversCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToQuickserversCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => QuickserversCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in QuickserversCancel200Response
