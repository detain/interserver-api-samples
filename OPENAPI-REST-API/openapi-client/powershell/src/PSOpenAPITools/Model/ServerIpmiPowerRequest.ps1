...
function Initialize-ServerIpmiPowerRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerIpmiPowerRequest' | Write-Debug
...
Convert from JSON to ServerIpmiPowerRequest<PSCustomObject>
...
ServerIpmiPowerRequest<PSCustomObject>
#>
function ConvertFrom-JsonToServerIpmiPowerRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerIpmiPowerRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
