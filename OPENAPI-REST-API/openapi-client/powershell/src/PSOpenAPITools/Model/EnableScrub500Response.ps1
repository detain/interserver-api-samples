...
EnableScrub500Response<PSCustomObject>
#>

function Initialize-EnableScrub500Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnableScrub500Response' | Write-Debug
...
Convert from JSON to EnableScrub500Response<PSCustomObject>
...
EnableScrub500Response<PSCustomObject>
#>
function ConvertFrom-JsonToEnableScrub500Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnableScrub500Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnableScrub500Response
