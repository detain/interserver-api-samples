...
BillingAddCcRequest<PSCustomObject>
#>

function Initialize-BillingAddCcRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingAddCcRequest' | Write-Debug
...
Convert from JSON to BillingAddCcRequest<PSCustomObject>
...
BillingAddCcRequest<PSCustomObject>
#>
function ConvertFrom-JsonToBillingAddCcRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingAddCcRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingAddCcRequest
        $AllProperties = ("name", "address", "city", "state", "country", "zip", "cc", "cc_exp", "cc_ccv2")
