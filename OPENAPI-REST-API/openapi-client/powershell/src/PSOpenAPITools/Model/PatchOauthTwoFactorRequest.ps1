...
PatchOauthTwoFactorRequest<PSCustomObject>
#>

function Initialize-PatchOauthTwoFactorRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PatchOauthTwoFactorRequest' | Write-Debug
...
Convert from JSON to PatchOauthTwoFactorRequest<PSCustomObject>
...
PatchOauthTwoFactorRequest<PSCustomObject>
#>
function ConvertFrom-JsonToPatchOauthTwoFactorRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PatchOauthTwoFactorRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PatchOauthTwoFactorRequest
        $AllProperties = ("account_id", "code")
