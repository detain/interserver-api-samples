...
GetAccountInfo401Response<PSCustomObject>
#>

function Initialize-GetAccountInfo401Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => GetAccountInfo401Response' | Write-Debug
...
Convert from JSON to GetAccountInfo401Response<PSCustomObject>
...
GetAccountInfo401Response<PSCustomObject>
#>
function ConvertFrom-JsonToGetAccountInfo401Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => GetAccountInfo401Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in GetAccountInfo401Response
