...
IpLimitRange<PSCustomObject>
#>

function Initialize-IpLimitRange {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IpLimitRange' | Write-Debug
...
Convert from JSON to IpLimitRange<PSCustomObject>
...
IpLimitRange<PSCustomObject>
#>
function ConvertFrom-JsonToIpLimitRange {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IpLimitRange' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IpLimitRange
