...
WebhostingCancel200Response<PSCustomObject>
#>

function Initialize-WebhostingCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => WebhostingCancel200Response' | Write-Debug
...
Convert from JSON to WebhostingCancel200Response<PSCustomObject>
...
WebhostingCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToWebhostingCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => WebhostingCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in WebhostingCancel200Response
