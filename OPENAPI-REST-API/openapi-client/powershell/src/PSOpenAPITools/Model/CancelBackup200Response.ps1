...
CancelBackup200Response<PSCustomObject>
#>

function Initialize-CancelBackup200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => CancelBackup200Response' | Write-Debug
...
Convert from JSON to CancelBackup200Response<PSCustomObject>
...
CancelBackup200Response<PSCustomObject>
#>
function ConvertFrom-JsonToCancelBackup200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => CancelBackup200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in CancelBackup200Response
