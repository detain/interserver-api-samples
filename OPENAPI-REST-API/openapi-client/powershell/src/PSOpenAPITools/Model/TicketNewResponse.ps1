...
TicketNewResponse<PSCustomObject>
#>

function Initialize-TicketNewResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => TicketNewResponse' | Write-Debug
...
Convert from JSON to TicketNewResponse<PSCustomObject>
...
TicketNewResponse<PSCustomObject>
#>
function ConvertFrom-JsonToTicketNewResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => TicketNewResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "ticket_id"))) { #optional property not found
            $TicketId = $null
        } else {
            $TicketId = $JsonParameters.PSobject.Properties["ticket_id"].value
        }
