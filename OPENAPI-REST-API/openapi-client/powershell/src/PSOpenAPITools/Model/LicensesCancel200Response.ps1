...
LicensesCancel200Response<PSCustomObject>
#>

function Initialize-LicensesCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => LicensesCancel200Response' | Write-Debug
...
Convert from JSON to LicensesCancel200Response<PSCustomObject>
...
LicensesCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToLicensesCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => LicensesCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in LicensesCancel200Response
