...
SslCancel200Response<PSCustomObject>
#>

function Initialize-SslCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SslCancel200Response' | Write-Debug
...
Convert from JSON to SslCancel200Response<PSCustomObject>
...
SslCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToSslCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SslCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SslCancel200Response
