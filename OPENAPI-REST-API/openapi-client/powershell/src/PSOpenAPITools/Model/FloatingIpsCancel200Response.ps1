...
FloatingIpsCancel200Response<PSCustomObject>
#>

function Initialize-FloatingIpsCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => FloatingIpsCancel200Response' | Write-Debug
...
Convert from JSON to FloatingIpsCancel200Response<PSCustomObject>
...
FloatingIpsCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToFloatingIpsCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => FloatingIpsCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in FloatingIpsCancel200Response
