...
function Initialize-ServerIpmiLiveRequest {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServerIpmiLiveRequest' | Write-Debug
...
Convert from JSON to ServerIpmiLiveRequest<PSCustomObject>
...
ServerIpmiLiveRequest<PSCustomObject>
#>
function ConvertFrom-JsonToServerIpmiLiveRequest {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServerIpmiLiveRequest' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
