...
ServersCancel200Response<PSCustomObject>
#>

function Initialize-ServersCancel200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ServersCancel200Response' | Write-Debug
...
Convert from JSON to ServersCancel200Response<PSCustomObject>
...
ServersCancel200Response<PSCustomObject>
#>
function ConvertFrom-JsonToServersCancel200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ServersCancel200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ServersCancel200Response
