...
DnsNewDomain<PSCustomObject>
#>

function Initialize-DnsNewDomain {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DnsNewDomain' | Write-Debug
...
Convert from JSON to DnsNewDomain<PSCustomObject>
...
DnsNewDomain<PSCustomObject>
#>
function ConvertFrom-JsonToDnsNewDomain {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DnsNewDomain' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DnsNewDomain
        $AllProperties = ("domain", "ip")
