...
DomainAdminContact<PSCustomObject>
#>

function Initialize-DomainAdminContact {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DomainAdminContact' | Write-Debug
...
Convert from JSON to DomainAdminContact<PSCustomObject>
...
DomainAdminContact<PSCustomObject>
#>
function ConvertFrom-JsonToDomainAdminContact {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DomainAdminContact' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DomainAdminContact
