...
BillingInvoiceList<PSCustomObject>
#>

function Initialize-BillingInvoiceList {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BillingInvoiceList' | Write-Debug
...
Convert from JSON to BillingInvoiceList<PSCustomObject>
...
BillingInvoiceList<PSCustomObject>
#>
function ConvertFrom-JsonToBillingInvoiceList {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BillingInvoiceList' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BillingInvoiceList
        $AllProperties = ("rows", "summary")
