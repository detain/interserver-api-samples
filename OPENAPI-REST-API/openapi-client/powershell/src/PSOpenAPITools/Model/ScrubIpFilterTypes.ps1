...
ScrubIpFilterTypes<PSCustomObject>
#>

function Initialize-ScrubIpFilterTypes {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ScrubIpFilterTypes' | Write-Debug
...
Convert from JSON to ScrubIpFilterTypes<PSCustomObject>
...
ScrubIpFilterTypes<PSCustomObject>
#>
function ConvertFrom-JsonToScrubIpFilterTypes {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ScrubIpFilterTypes' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ScrubIpFilterTypes
        $AllProperties = ("success", "filters")
