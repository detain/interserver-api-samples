...
DomainOwnerContact<PSCustomObject>
#>

function Initialize-DomainOwnerContact {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => DomainOwnerContact' | Write-Debug
...
Convert from JSON to DomainOwnerContact<PSCustomObject>
...
DomainOwnerContact<PSCustomObject>
#>
function ConvertFrom-JsonToDomainOwnerContact {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => DomainOwnerContact' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in DomainOwnerContact
        $AllProperties = ("postal_code", "org_name", "country", "status", "state", "first_name", "last_name", "address3", "fax", "address2", "email", "city", "phone", "address1")
