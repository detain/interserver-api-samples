...
AccountInfoMaxMindResponseRiskScore<PSCustomObject>
#>
function ConvertFrom-JsonToAccountInfoMaxMindResponseRiskScore {
    [CmdletBinding()]
    Param (
        [AllowEmptyString()]
        [string]$Json
    ...
    Process {
        ...
        try {
            ...
            Write-Debug "Failed to match 'Decimal' defined in oneOf (AccountInfoMaxMindResponseRiskScore). Proceeding to the next one if any."
        }
        ...
        try {
            ...
            # fail to match the schema defined in oneOf, proceed to the next one
            Write-Debug "Failed to match 'String' defined in oneOf (AccountInfoMaxMindResponseRiskScore). Proceeding to the next one if any."
        }
