...
SuccessTextResponse<PSCustomObject>
#>

function Initialize-SuccessTextResponse {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => SuccessTextResponse' | Write-Debug
...
Convert from JSON to SuccessTextResponse<PSCustomObject>
...
SuccessTextResponse<PSCustomObject>
#>
function ConvertFrom-JsonToSuccessTextResponse {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => SuccessTextResponse' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in SuccessTextResponse
        $AllProperties = ("success", "text", "action")
