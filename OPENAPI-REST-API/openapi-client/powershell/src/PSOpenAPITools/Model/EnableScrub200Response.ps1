...
EnableScrub200Response<PSCustomObject>
#>

function Initialize-EnableScrub200Response {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnableScrub200Response' | Write-Debug
...
Convert from JSON to EnableScrub200Response<PSCustomObject>
...
EnableScrub200Response<PSCustomObject>
#>
function ConvertFrom-JsonToEnableScrub200Response {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnableScrub200Response' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnableScrub200Response
