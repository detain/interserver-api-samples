...
function Initialize-IpObject {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => IpObject' | Write-Debug
...
Convert from JSON to IpObject<PSCustomObject>
...
IpObject<PSCustomObject>
#>
function ConvertFrom-JsonToIpObject {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => IpObject' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in IpObject
        $AllProperties = ("ip")
