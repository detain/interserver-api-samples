...
/*
 * OpenAPIMailAlertUpdateRequest
 *
 * Payload for updating an existing mail alert.
 */
class OPENAPI_API OpenAPIMailAlertUpdateRequest : public Model
{
public:
    virtual ~OpenAPIMailAlertUpdateRequest() {}
