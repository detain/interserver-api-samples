...
/*
 * OpenAPIServerOrderFormValues
 *
 * Form values for the server order.
 */
class OPENAPI_API OpenAPIServerOrderFormValues : public Model
{
public:
    virtual ~OpenAPIServerOrderFormValues() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Memory value for the server order. */
	TOptional<int32> Memory;
	/* Bandwidth value for the server order. */
	TOptional<FString> Bandwidth;
	/* IPs value for the server order. */
	TOptional<FString> Ips;
