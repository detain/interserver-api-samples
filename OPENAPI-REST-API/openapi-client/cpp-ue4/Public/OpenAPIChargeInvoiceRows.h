...
/*
 * OpenAPIChargeInvoiceRows
 *
 * Billing invoices associated with a service, including invoice IDs, descriptions, amounts, and payment status.
 */
class OPENAPI_API OpenAPIChargeInvoiceRows : public Model
{
public:
    virtual ~OpenAPIChargeInvoiceRows() {}
	...
	TOptional<TMap<FString, OpenAPIChargeInvoiceRowsInvoicesValue>> Invoices;
};
