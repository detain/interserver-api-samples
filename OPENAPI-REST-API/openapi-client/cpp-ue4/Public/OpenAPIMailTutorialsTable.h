...
/*
 * OpenAPIMailTutorialsTable
 *
 * A table of tutorial links displayed for a mail service.
 */
class OPENAPI_API OpenAPIMailTutorialsTable : public Model
{
public:
    virtual ~OpenAPIMailTutorialsTable() {}
	...
	TOptional<TArray<OpenAPIMailTutorialsTableRow>> Rows;
};
