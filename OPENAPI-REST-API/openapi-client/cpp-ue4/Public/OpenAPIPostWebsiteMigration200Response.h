...
/*
 * OpenAPIPostWebsiteMigration200Response
 *
 * 
 */
class OPENAPI_API OpenAPIPostWebsiteMigration200Response : public Model
{
public:
    virtual ~OpenAPIPostWebsiteMigration200Response() {}
