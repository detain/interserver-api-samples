...
/*
 * OpenAPICreateFirewallRule
 *
 * Create firewall rule for your ip
 */
class OPENAPI_API OpenAPICreateFirewallRule : public Model
{
public:
    virtual ~OpenAPICreateFirewallRule() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	enum class ProtocolIdEnum
	{
		_1,
		_2,
  	};
	...
	static bool EnumFromString(const FString& EnumAsString, ProtocolIdEnum& EnumValue);
	/* 1 = TCP, 2 = UDP */
	ProtocolIdEnum ProtocolId = 0;
