...
/*
 * OpenAPIHomeTicketStatusView
 *
 * Ticket statuses with view numbers.
 */
class OPENAPI_API OpenAPIHomeTicketStatusView : public Model
{
public:
    virtual ~OpenAPIHomeTicketStatusView() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Status corresponding to view number 4. */
	TOptional<FString> _4;
	/* Status corresponding to view number 5. */
	TOptional<FString> _5;
	/* Status corresponding to view number 6. */
	TOptional<FString> _6;
};
