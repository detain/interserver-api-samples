...
/*
 * OpenAPIPostOauthCallback200Response
 *
 * 
 */
class OPENAPI_API OpenAPIPostOauthCallback200Response : public Model
{
public:
    virtual ~OpenAPIPostOauthCallback200Response() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Whether the user was logged in to an existing account. */
	TOptional<bool> Login;
	/* Whether a new account was created. */
	TOptional<bool> Signup;
	/* Whether the OAuth provider was linked to an existing account. */
	TOptional<bool> Linked;
	/* The account ID associated with the OAuth login. */
	TOptional<int32> AccountId;
