...
/*
 * OpenAPIBillingPrepayRequest
 *
 * Request payload for creating a new prepay balance.
 */
class OPENAPI_API OpenAPIBillingPrepayRequest : public Model
{
public:
    virtual ~OpenAPIBillingPrepayRequest() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Module the prepay should be applied to (for example `default`). */
	TOptional<FString> Module;
	...
	TOptional<FString> AutomaticUse;
};
