...
/*
 * OpenAPIInitiatePayment200Response
 *
 * 
 */
class OPENAPI_API OpenAPIInitiatePayment200Response : public Model
{
public:
    virtual ~OpenAPIInitiatePayment200Response() {}
