...
/*
 * OpenAPIPlaceBuyNowServerRequest
 *
 * 
 */
class OPENAPI_API OpenAPIPlaceBuyNowServerRequest : public Model
{
public:
    virtual ~OpenAPIPlaceBuyNowServerRequest() {}
	...
	TOptional<FString> ServerRootPassword;
};
