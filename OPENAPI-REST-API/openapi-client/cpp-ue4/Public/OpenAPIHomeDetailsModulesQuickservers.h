...
/*
 * OpenAPIHomeDetailsModulesQuickservers
 *
 * Dashboard module configuration for QuickServer services.
 */
class OPENAPI_API OpenAPIHomeDetailsModulesQuickservers : public Model
{
public:
    virtual ~OpenAPIHomeDetailsModulesQuickservers() {}
	...
	TOptional<FString> ViewLink;
	/* Heading for quick servers. */
	TOptional<FString> Heading;
	/* Link to order quick server. */
	TOptional<FString> BuyLink;
	/* Link to view quick servers list. */
	TOptional<FString> ListLink;
};
