...
/*
 * OpenAPIServerOrderControlPanel
 *
 * A control panel option available when ordering a dedicated server.
 */
class OPENAPI_API OpenAPIServerOrderControlPanel : public Model
{
public:
    virtual ~OpenAPIServerOrderControlPanel() {}
	...
	TOptional<FString> OsType;
	/* Monthly price. */
	TOptional<int32> MonthlyPrice;
	/* List of types. */
	TOptional<TArray<FString>> Types;
