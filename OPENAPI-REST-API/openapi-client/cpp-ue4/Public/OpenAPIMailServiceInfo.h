...
/*
 * OpenAPIMailServiceInfo
 *
 * 
 */
class OPENAPI_API OpenAPIMailServiceInfo : public Model
{
public:
    virtual ~OpenAPIMailServiceInfo() {}
	...
	FString MailCurrency;
	/* The order date of the mail service. */
	FString MailOrderDate;
