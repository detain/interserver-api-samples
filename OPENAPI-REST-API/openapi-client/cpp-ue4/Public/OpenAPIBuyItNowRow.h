 ...
 */
class OPENAPI_API OpenAPIBuyItNowRow : public Model
{
public:
    virtual ~OpenAPIBuyItNowRow() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Unique server ID. Use this as `server_id` in `POST /servers/order/buy_now_server`. */
	TOptional<FString> ServerId;
	TOptional<TArray<OpenAPIBuyItNowRowCpuInner>> Cpu;
	TOptional<FString> Memory;
	TOptional<TMap<FString, FString>> Disk;
