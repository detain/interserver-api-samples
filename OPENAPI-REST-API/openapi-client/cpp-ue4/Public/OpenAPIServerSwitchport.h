...
/*
 * OpenAPIServerSwitchport
 *
 * 
 */
class OPENAPI_API OpenAPIServerSwitchport : public Model
{
public:
    virtual ~OpenAPIServerSwitchport() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	/* Unique identifier for the switchport. */
	int32 SwitchportId = 0;
	...
	TOptional<TArray<FString>> Vlans;
	/* List of IPv6 VLANs associated with the switchport. */
	TOptional<TArray<FString>> Vlans6;
};
