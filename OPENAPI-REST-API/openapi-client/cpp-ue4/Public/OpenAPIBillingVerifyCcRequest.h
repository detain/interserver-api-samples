...
/*
 * OpenAPIBillingVerifyCcRequest
 *
 * Payload for verifying a credit card through the verification flow.
 */
class OPENAPI_API OpenAPIBillingVerifyCcRequest : public Model
{
public:
    virtual ~OpenAPIBillingVerifyCcRequest() {}
