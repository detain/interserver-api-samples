...
/*
 * OpenAPIMailExtraInfoTable
 *
 * A supplementary information table for a mail service (e.g., connection details).
 */
class OPENAPI_API OpenAPIMailExtraInfoTable : public Model
{
public:
    virtual ~OpenAPIMailExtraInfoTable() {}
	...
	TOptional<TArray<OpenAPIMailExtraInfoTableRow>> Rows;
};
