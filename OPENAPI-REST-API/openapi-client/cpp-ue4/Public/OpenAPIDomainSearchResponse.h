...
/*
 * OpenAPIDomainSearchResponse
 *
 * Lookup and suggestion results returned for a domain search.
 */
class OPENAPI_API OpenAPIDomainSearchResponse : public Model
{
public:
    virtual ~OpenAPIDomainSearchResponse() {}
	...
	TOptional<FString> ResponseTime;
	/* Availability lookup results for queried domains. */
	TOptional<TArray<TSharedPtr<FJsonObject>>> Lookup;
	/* Suggested alternative domains and availability data. */
	TOptional<TArray<TSharedPtr<FJsonObject>>> Suggest;
	/* TLDs evaluated during the search. */
	TOptional<TArray<FString>> Tlds;
};
