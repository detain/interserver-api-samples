...
{
public:
    virtual ~OpenAPIServerIpmiLiveInfo() {}
	bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) final;
	void WriteJson(JsonWriter& Writer) const final;

	TOptional<FString> Text;
	TOptional<FString> PublicIp;
	TOptional<FString> AllowedIp;
	TOptional<FString> ClientUsername;
	TOptional<FString> ClientPassword;
};
