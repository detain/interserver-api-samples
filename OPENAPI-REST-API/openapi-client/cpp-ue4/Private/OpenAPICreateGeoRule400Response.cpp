...
void OpenAPICreateGeoRule400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateGeoRule400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
