...
void OpenAPICancelBackup200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICancelBackup200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
