...
void OpenAPIDisableScrub400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDisableScrub400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
