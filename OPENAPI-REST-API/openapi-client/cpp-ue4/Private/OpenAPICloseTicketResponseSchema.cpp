...
void OpenAPICloseTicketResponseSchema::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICloseTicketResponseSchema::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
