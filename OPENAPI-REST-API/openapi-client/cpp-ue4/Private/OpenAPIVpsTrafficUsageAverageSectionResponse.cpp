...
void OpenAPIVpsTrafficUsageAverageSectionResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIVpsTrafficUsageAverageSectionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
