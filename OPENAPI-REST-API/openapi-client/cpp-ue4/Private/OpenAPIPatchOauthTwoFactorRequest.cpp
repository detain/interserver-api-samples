...
void OpenAPIPatchOauthTwoFactorRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPatchOauthTwoFactorRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
