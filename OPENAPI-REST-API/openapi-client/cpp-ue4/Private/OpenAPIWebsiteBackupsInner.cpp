...
#include "OpenAPIWebsiteBackupsInner.h"
...
void OpenAPIWebsiteBackupsInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIWebsiteBackupsInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
