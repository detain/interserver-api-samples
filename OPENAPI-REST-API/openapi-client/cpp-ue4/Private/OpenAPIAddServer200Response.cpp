...
void OpenAPIAddServer200Response::WriteJson(JsonWriter& Writer) const
{
	...
	if (Invoice.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("invoice")); WriteJsonValue(Writer, Invoice.GetValue());
	}
	if (Order.IsSet())
	{
...
bool OpenAPIAddServer200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("invoice"), Invoice);
