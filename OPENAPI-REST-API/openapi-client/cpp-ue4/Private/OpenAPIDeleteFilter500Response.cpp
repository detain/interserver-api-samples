...
void OpenAPIDeleteFilter500Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDeleteFilter500Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
