...
void OpenAPICreateFilter400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateFilter400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
