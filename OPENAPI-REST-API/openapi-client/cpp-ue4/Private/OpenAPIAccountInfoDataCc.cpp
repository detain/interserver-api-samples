...
#include "OpenAPIAccountInfoDataCc.h"
...
void OpenAPIAccountInfoDataCc::WriteJson(JsonWriter& Writer) const
{
	...
	if (MaxmindRiskscore.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("maxmind_riskscore")); WriteJsonValue(Writer, MaxmindRiskscore.GetValue());
	}
	if (Maxmind.IsSet())
	{
...
bool OpenAPIAccountInfoDataCc::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("maxmind_riskscore"), MaxmindRiskscore);
