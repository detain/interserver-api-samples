...
void OpenAPIScrubIpsDeleteRule200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIScrubIpsDeleteRule200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
