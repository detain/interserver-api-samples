...
void OpenAPIPostWebsiteBuyIp200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPostWebsiteBuyIp200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
