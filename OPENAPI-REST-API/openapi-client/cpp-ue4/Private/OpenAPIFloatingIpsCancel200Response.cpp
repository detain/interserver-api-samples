...
void OpenAPIFloatingIpsCancel200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIFloatingIpsCancel200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
