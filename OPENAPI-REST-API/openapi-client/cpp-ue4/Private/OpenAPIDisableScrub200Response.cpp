...
void OpenAPIDisableScrub200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDisableScrub200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
