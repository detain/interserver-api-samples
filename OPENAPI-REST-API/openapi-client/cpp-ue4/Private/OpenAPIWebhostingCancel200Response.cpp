...
void OpenAPIWebhostingCancel200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIWebhostingCancel200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
