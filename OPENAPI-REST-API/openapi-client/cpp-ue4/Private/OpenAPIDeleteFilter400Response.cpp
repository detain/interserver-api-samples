...
void OpenAPIDeleteFilter400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDeleteFilter400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
