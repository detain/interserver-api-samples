...
void OpenAPIDeleteFilter200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDeleteFilter200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
