...
void OpenAPICancelDomain200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICancelDomain200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
