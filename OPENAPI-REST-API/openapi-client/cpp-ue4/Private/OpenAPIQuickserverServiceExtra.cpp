...
void OpenAPIQuickserverServiceExtra::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIQuickserverServiceExtra::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
