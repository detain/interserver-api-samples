...
void OpenAPICancelScrubIp200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICancelScrubIp200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
