...
void OpenAPIUpdateTicketResponseSchema::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateTicketResponseSchema::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
