...
void OpenAPICreateFilter500Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateFilter500Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
