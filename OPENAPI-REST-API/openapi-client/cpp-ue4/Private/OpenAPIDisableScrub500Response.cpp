...
void OpenAPIDisableScrub500Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDisableScrub500Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
