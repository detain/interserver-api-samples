...
void OpenAPIAccountInfoDataFraudrecord::WriteJson(JsonWriter& Writer) const
{
	...
	if (Reliability.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("reliability")); WriteJsonValue(Writer, Reliability.GetValue());
	}
	if (Code.IsSet())
	{
...
bool OpenAPIAccountInfoDataFraudrecord::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("reliability"), Reliability);
