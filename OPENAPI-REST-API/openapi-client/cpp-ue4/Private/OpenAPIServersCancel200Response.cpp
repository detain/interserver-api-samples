...
void OpenAPIServersCancel200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIServersCancel200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
