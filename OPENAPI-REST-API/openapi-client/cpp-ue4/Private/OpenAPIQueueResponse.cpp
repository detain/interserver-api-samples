...
void OpenAPIQueueResponse::WriteJson(JsonWriter& Writer) const
{
	Writer->WriteObjectStart();
	Writer->WriteIdentifierPrefix(TEXT("text")); WriteJsonValue(Writer, Text);
	Writer->WriteIdentifierPrefix(TEXT("queueId")); WriteJsonValue(Writer, QueueId);
	Writer->WriteObjectEnd();
}

bool OpenAPIQueueResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
