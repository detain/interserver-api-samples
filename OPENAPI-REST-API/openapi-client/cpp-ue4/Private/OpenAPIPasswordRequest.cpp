...
#include "OpenAPIPasswordRequest.h"
...
void OpenAPIPasswordRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPasswordRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
