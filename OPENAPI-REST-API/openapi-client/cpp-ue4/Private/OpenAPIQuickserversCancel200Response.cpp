...
void OpenAPIQuickserversCancel200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIQuickserversCancel200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
