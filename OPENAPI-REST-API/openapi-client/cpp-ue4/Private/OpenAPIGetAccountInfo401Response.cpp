...
void OpenAPIGetAccountInfo401Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIGetAccountInfo401Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
