...
void OpenAPIScrubIpsDeleteRule500Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIScrubIpsDeleteRule500Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
