...
void OpenAPIDownloadQsBackup200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIDownloadQsBackup200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
