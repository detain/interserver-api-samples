...
void OpenAPIScrubIpsDeleteRule400Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIScrubIpsDeleteRule400Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
