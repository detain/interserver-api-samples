...
void OpenAPICreateFilter201Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateFilter201Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
