...
export function instanceOfServiceType(value: object): value is ServiceType {
    if (!('st_id' in value) || value['st_id'] === undefined) return false;
    if (!('st_name' in value) || value['st_name'] === undefined) return false;
    if (!('st_category' in value) || value['st_category'] === undefined) return false;
    if (!('st_module' in value) || value['st_module'] === undefined) return false;
    return true;
}
...
export function ServiceTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServiceType {
    ...
    return {
        ...
        'st_category': json['st_category'],
        'st_module': json['st_module'],
    };
}
...
export function ServiceTypeToJSONTyped(value?: ServiceType | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'st_category': value['st_category'],
        'st_module': value['st_module'],
    };
}
