...
/**
 * Check if a given object implements the ServerSwitchport interface.
 */
export function instanceOfServerSwitchport(value: object): value is ServerSwitchport {
    ...
    if (!('graph_id' in value) || value['graph_id'] === undefined) return false;
...
export function ServerSwitchportFromJSON(json: any): ServerSwitchport {
    return ServerSwitchportFromJSONTyped(json, false);
}

export function ServerSwitchportFromJSONTyped(json: any, ignoreDiscriminator: boolean): ServerSwitchport {
    if (json == null) {
        return json;
    }
    return {
        ...
        'vlans6': json['vlans6'] == null ? undefined : json['vlans6'],
    };
}

export function ServerSwitchportToJSON(json: any): ServerSwitchport {
    return ServerSwitchportToJSONTyped(json, false);
}

export function ServerSwitchportToJSONTyped(value?: ServerSwitchport | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
