...
export function SearchAutocompleteResponseToJSON(json: any): SearchAutocompleteResponse {
    return SearchAutocompleteResponseToJSONTyped(json, false);
}

export function SearchAutocompleteResponseToJSONTyped(value?: SearchAutocompleteResponse | null, ignoreDiscriminator: boolean = false): any {
    return value;
}
