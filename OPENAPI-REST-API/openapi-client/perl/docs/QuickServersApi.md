# OpenAPIClient::QuickServersApi

## Load the API package
```perl
use OpenAPIClient::Object::QuickServersApi;
```
...
my $api_instance = OpenAPIClient::QuickServersApi->new(
...
# **delete_qs_backup**
> SuccessTextResponse delete_qs_backup(id => $id, file => $file, all => $all)
...
my $id = 56; # int | QuickServer ID number
my $file = "file_example"; # string | The backup filename to delete.
my $all = "all_example"; # string | Set to `1` to list all backups across all services, not just the ones for the given QuickServer.

eval {
    my $result = $api_instance->delete_qs_backup(id => $id, file => $file, all => $all);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->delete_qs_backup: $@\n";
}
```
...
# **do_qs_block_smtp**
> QueueResponse do_qs_block_smtp(id => $id)
...
eval {
    my $result = $api_instance->do_qs_block_smtp(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_block_smtp: $@\n";
}
```
...
# **do_qs_disable_cd**
> QueueResponse do_qs_disable_cd(id => $id)
...
eval {
    my $result = $api_instance->do_qs_disable_cd(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_disable_cd: $@\n";
}
```
...
# **do_qs_disable_quota**
> QueueResponse do_qs_disable_quota(id => $id)
...
eval {
    my $result = $api_instance->do_qs_disable_quota(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_disable_quota: $@\n";
}
```
...
# **do_qs_eject_cd**
> QueueResponse do_qs_eject_cd(id => $id)
...
eval {
    my $result = $api_instance->do_qs_eject_cd(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_eject_cd: $@\n";
}
```
...
# **do_qs_enable_quota**
> QueueResponse do_qs_enable_quota(id => $id)
...
eval {
    my $result = $api_instance->do_qs_enable_quota(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_enable_quota: $@\n";
}
```
...
# **do_qs_restart**
> QueueResponse do_qs_restart(id => $id)
...
eval {
    my $result = $api_instance->do_qs_restart(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_restart: $@\n";
}
```
...
# **do_qs_start**
> QueueResponse do_qs_start(id => $id)
...
eval {
    my $result = $api_instance->do_qs_start(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_start: $@\n";
}
```
...
# **do_qs_stop**
> QueueResponse do_qs_stop(id => $id)
...
eval {
    my $result = $api_instance->do_qs_stop(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->do_qs_stop: $@\n";
}
```
...
# **download_qs_backup**
> DownloadQsBackup200Response download_qs_backup(id => $id, download_qs_backup_request => $download_qs_backup_request, all => $all)
...
eval {
    my $result = $api_instance->download_qs_backup(id => $id, download_qs_backup_request => $download_qs_backup_request, all => $all);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->download_qs_backup: $@\n";
}
```
...
eval {
    my $result = $api_instance->get_new_qs();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_new_qs: $@\n";
}
```
...
# **get_qs_backups**
> VpsBackupRows get_qs_backups(id => $id, all => $all)
...
eval {
    my $result = $api_instance->get_qs_backups(id => $id, all => $all);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_backups: $@\n";
}
```
...
eval {
    $api_instance->get_qs_change_hostname(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_change_hostname: $@\n";
}
```
...
> get_qs_change_root_password(id => $id)
...
eval {
    $api_instance->get_qs_change_root_password(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_change_root_password: $@\n";
}
```
...
> ARRAY[string] get_qs_change_timezone(id => $id)
...
eval {
    my $result = $api_instance->get_qs_change_timezone(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_change_timezone: $@\n";
}
```
...
> get_qs_change_webuzo_password(id => $id)
...
eval {
    $api_instance->get_qs_change_webuzo_password(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_change_webuzo_password: $@\n";
}
```
...
eval {
    my $result = $api_instance->get_qs_info(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_info: $@\n";
}
```
...
eval {
    $api_instance->get_qs_insert_cd(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_insert_cd: $@\n";
}
```
...
# **get_qs_invoices**
> ChargeInvoiceRows get_qs_invoices(id => $id)
...
eval {
    my $result = $api_instance->get_qs_invoices(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_invoices: $@\n";
}
```
...
eval {
    my $result = $api_instance->get_qs_list();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_list: $@\n";
}
```
...
# **get_qs_reinstall_os**
> VpsTemplatesList get_qs_reinstall_os(id => $id)
...
eval {
    my $result = $api_instance->get_qs_reinstall_os(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_reinstall_os: $@\n";
}
```
...
eval {
    $api_instance->get_qs_reset_password(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_reset_password: $@\n";
}
```
...
# **get_qs_reverse_dns**
> ReverseDnsEntries get_qs_reverse_dns(id => $id)
...
eval {
    my $result = $api_instance->get_qs_reverse_dns(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_reverse_dns: $@\n";
}
```
...
eval {
    $api_instance->get_qs_setup_vnc(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_setup_vnc: $@\n";
}
```
...
eval {
    $api_instance->get_qs_traffic_usage(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_traffic_usage: $@\n";
}
```
...
eval {
    $api_instance->get_qs_view_desktop(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_view_desktop: $@\n";
}
```
...
> TextResponse get_qs_welcome_email(id => $id)
...
my $id = 133123; # string | Quickserver ID

eval {
    my $result = $api_instance->get_qs_welcome_email(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->get_qs_welcome_email: $@\n";
}
```
...
# **post_qs_backup**
> QueueResponse post_qs_backup(id => $id)
...
eval {
    my $result = $api_instance->post_qs_backup(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_backup: $@\n";
}
```
...
> QueueResponse post_qs_change_hostname(id => $id)
...
eval {
    my $result = $api_instance->post_qs_change_hostname(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_change_hostname: $@\n";
}
```
...
> QueueResponse post_qs_change_root_password(id => $id)
...
eval {
    my $result = $api_instance->post_qs_change_root_password(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_change_root_password: $@\n";
}
```
...
> QueueResponse post_qs_change_timezone(id => $id, timezone => $timezone)
...
eval {
    my $result = $api_instance->post_qs_change_timezone(id => $id, timezone => $timezone);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_change_timezone: $@\n";
}
```
...
> QueueResponse post_qs_change_webuzo_password(id => $id)
...
eval {
    my $result = $api_instance->post_qs_change_webuzo_password(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_change_webuzo_password: $@\n";
}
```
...
# **post_qs_insert_cd**
> QueueResponse post_qs_insert_cd(id => $id)
...
eval {
    my $result = $api_instance->post_qs_insert_cd(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_insert_cd: $@\n";
}
```
...
> QueueResponse post_qs_reinstall_os(id => $id)
...
eval {
    my $result = $api_instance->post_qs_reinstall_os(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_reinstall_os: $@\n";
}
```
...
> QueueResponse post_qs_reset_password(id => $id)
...
eval {
    my $result = $api_instance->post_qs_reset_password(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_reset_password: $@\n";
}
```
...
# **post_qs_reverse_dns**
> TextResponse post_qs_reverse_dns(id => $id, reverse_dns_entries => $reverse_dns_entries)
...
eval {
    my $result = $api_instance->post_qs_reverse_dns(id => $id, reverse_dns_entries => $reverse_dns_entries);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_reverse_dns: $@\n";
}
```
...
# **post_qs_setup_vnc**
> QueueResponse post_qs_setup_vnc(id => $id)
...
eval {
    my $result = $api_instance->post_qs_setup_vnc(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_setup_vnc: $@\n";
}
```
...
eval {
    $api_instance->post_qs_traffic_usage(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_traffic_usage: $@\n";
}
```
...
eval {
    $api_instance->post_qs_view_desktop(id => $id);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_qs_view_desktop: $@\n";
}
```
...
> QueueResponse post_quick_server_restore(id => $id, restore_request => $restore_request)
...
my $id = 56; # int | QuickServer ID number
my $restore_request = OpenAPIClient::Object::RestoreRequest->new(); # RestoreRequest | QuickServer Restore request

eval {
    my $result = $api_instance->post_quick_server_restore(id => $id, restore_request => $restore_request);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->post_quick_server_restore: $@\n";
}
```
...
if ($@) {
    warn "Exception when calling QuickServersApi->put_qs: $@\n";
}
```
...
# **quickservers_cancel**
> QuickserversCancel200Response quickservers_cancel(id => $id)
...
eval {
    my $result = $api_instance->quickservers_cancel(id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling QuickServersApi->quickservers_cancel: $@\n";
}
```
