...
#
package OpenAPIClient::Object::ServiceCategory;
...
__PACKAGE__->class_documentation({description => 'A Category of Services.  This is the broadest grouping within a module.',
