...
#
package OpenAPIClient::Object::MailServiceType;
...
__PACKAGE__->class_documentation({description => 'Service type definition for a mail service, including name, pricing, and category.',
