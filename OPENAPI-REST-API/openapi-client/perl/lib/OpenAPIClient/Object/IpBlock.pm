...
#
package OpenAPIClient::Object::IpBlock;
...
__PACKAGE__->class_documentation({description => 'An IP address block option available for a dedicated server configuration.',
                                  class => 'IpBlock',
                                  required => [], # TODO
}                                 );
