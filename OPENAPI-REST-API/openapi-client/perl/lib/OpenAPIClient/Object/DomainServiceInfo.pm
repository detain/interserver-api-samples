...
#
package OpenAPIClient::Object::DomainServiceInfo;
...
__PACKAGE__->class_documentation({description => 'Detailed domain service record for a domain order.',
