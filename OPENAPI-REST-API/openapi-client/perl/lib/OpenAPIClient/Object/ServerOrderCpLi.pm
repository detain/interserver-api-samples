...
#
package OpenAPIClient::Object::ServerOrderCpLi;
...
__PACKAGE__->class_documentation({description => 'Control Panel options for the server order.',
...
__PACKAGE__->method_documentation({
    '_9' => {
        datatype => 'ServerOrderControlPanel',
        base_name => '9',
        description => '',
        format => '',
        read_only => '',
