...
#
package OpenAPIClient::Object::WebsiteClientLink;
...
__PACKAGE__->class_documentation({description => 'A navigation link for webhosting-related actions in the client portal.',
