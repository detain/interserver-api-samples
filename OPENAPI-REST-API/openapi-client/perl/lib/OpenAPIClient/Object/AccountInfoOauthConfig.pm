...
#
package OpenAPIClient::Object::AccountInfoOauthConfig;
...
__PACKAGE__->class_documentation({description => 'OAuth integration configuration including callback URL and available providers.',
...
__PACKAGE__->method_documentation({
    ...
    'providers' => {
        datatype => 'AccountInfoOauthConfigProviders',
        base_name => 'providers',
        description => '',
        format => '',
        read_only => '',
