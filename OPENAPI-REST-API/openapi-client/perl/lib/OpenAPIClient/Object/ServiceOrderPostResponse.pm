...
#
package OpenAPIClient::Object::ServiceOrderPostResponse;
...
__PACKAGE__->class_documentation({description => 'Generic response returned after placing a service order. Contains invoice IDs for payment and the new service ID.',
