...
#
package OpenAPIClient::Object::ServerOrderFieldLabels;
...
__PACKAGE__->class_documentation({description => 'Field labels for the server order.',
...
__PACKAGE__->method_documentation({
    'bandwidth' => {
        datatype => 'ServerOrderFieldLabel',
        base_name => 'bandwidth',
