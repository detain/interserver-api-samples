...
#
package OpenAPIClient::Object::ServerOrderControlPanel;
...
__PACKAGE__->class_documentation({description => 'A control panel option available when ordering a dedicated server.',
