...
#
package OpenAPIClient::Object::BuyItNowRow;
...
__PACKAGE__->class_documentation({description => 'A buy-it-now dedicated server listing from the marketplace, with hardware specs and pricing.',
                                  class => 'BuyItNowRow',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'cpu' => {
        datatype => 'ARRAY[BuyItNowRowCpuInner]',
        base_name => 'cpu',
        description => '',
        format => '',
        read_only => '',
