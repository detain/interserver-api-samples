...
#
package OpenAPIClient::Object::BillingPrepayRequest;
...
__PACKAGE__->class_documentation({description => 'Request payload for creating a new prepay balance.',
