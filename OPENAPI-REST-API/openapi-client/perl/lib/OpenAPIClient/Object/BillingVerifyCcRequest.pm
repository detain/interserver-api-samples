...
#
package OpenAPIClient::Object::BillingVerifyCcRequest;
...
__PACKAGE__->class_documentation({description => 'Payload for verifying a credit card through the verification flow.',
