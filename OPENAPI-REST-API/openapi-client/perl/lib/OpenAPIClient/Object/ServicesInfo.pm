...
#
package OpenAPIClient::Object::ServicesInfo;
...
__PACKAGE__->class_documentation({description => 'Contains the complete catalog of available modules, services, service types, and service categories.',
                                  class => 'ServicesInfo',
                                  required => [], # TODO
}                                 );
