...
#
package OpenAPIClient::Object::DomainNameserverGetResponse;
...
__PACKAGE__->class_documentation({description => 'List of registered nameserver hosts with glue record metadata.',
