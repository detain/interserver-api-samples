...
#
package OpenAPIClient::Object::VpsTrafficUsageResponse;
...
__PACKAGE__->class_documentation({description => 'VPS Traffic Usage Section',
...
__PACKAGE__->method_documentation({
    'current' => {
        datatype => 'VpsTrafficTotalsSectionResponse',
        base_name => 'current',
        description => '',
        format => '',
        read_only => '',
    ...
    'average' => {
        datatype => 'VpsTrafficUsageAverageResponse',
        base_name => 'average',
        description => '',
        format => '',
        read_only => '',
