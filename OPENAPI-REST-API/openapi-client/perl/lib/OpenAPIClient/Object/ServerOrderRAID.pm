...
#
package OpenAPIClient::Object::ServerOrderRAID;
...
__PACKAGE__->class_documentation({description => 'A RAID configuration option available when ordering a dedicated server.',
