...
#
package OpenAPIClient::Object::StatusMonthlyBreakdown;
...
__PACKAGE__->class_documentation({description => 'Monthly mail delivery status breakdown, showing counts per status category.',
