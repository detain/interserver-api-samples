...
#
package OpenAPIClient::Object::ControlPanel;
...
__PACKAGE__->class_documentation({description => 'A hosting control panel option (e.g., cPanel, Plesk) available for server provisioning.',
                                  class => 'ControlPanel',
                                  required => [], # TODO
}                                 );
