...
#
package OpenAPIClient::Object::DomainBillingDetails;
...
__PACKAGE__->class_documentation({description => 'Billing information for a domain service including payment status, dates, and cost.',
...
__PACKAGE__->method_documentation({
    'service_last_invoice_date' => {
        datatype => 'string',
        base_name => 'service_last_invoice_date',
    ...
    'service_payment_status' => {
        datatype => 'string',
        base_name => 'service_payment_status',
    ...
    'service_next_invoice_date' => {
        datatype => 'string',
        base_name => 'service_next_invoice_date',
    ...
    'service_currency_symbol' => {
        datatype => 'string',
        base_name => 'service_currency_symbol',
