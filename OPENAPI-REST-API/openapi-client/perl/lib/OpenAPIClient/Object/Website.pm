...
#
package OpenAPIClient::Object::Website;
...
__PACKAGE__->class_documentation({description => 'Full detail view of a webhosting service including billing, service configuration, and panel access links.',
                                  class => 'Website',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'client_links' => {
        datatype => 'ARRAY[WebsiteClientLink]',
    ...
    'billing_details' => {
        datatype => 'WebsiteBillingDetails',
    ...
    'extra_info_tables' => {
        datatype => 'WebsiteExtraInfoTables',
