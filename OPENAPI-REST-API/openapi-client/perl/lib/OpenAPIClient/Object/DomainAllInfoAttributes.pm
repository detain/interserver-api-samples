...
#
package OpenAPIClient::Object::DomainAllInfoAttributes;
...
__PACKAGE__->method_documentation({
    'contact_set' => {
        datatype => 'DomainAllInfoAttributesContactSet',
        base_name => 'contact_set',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'gdpr_consent_status' => {
        datatype => 'string',
        base_name => 'gdpr_consent_status',
        description => '',
        format => '',
        read_only => '',
            },
    'nameserver_list' => {
        datatype => 'ARRAY[DomainNameServer]',
        base_name => 'nameserver_list',
        description => '',
        format => '',
        read_only => '',
            },
