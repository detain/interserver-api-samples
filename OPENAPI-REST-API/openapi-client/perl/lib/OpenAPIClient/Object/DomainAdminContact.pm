...
#
package OpenAPIClient::Object::DomainAdminContact;
...
__PACKAGE__->class_documentation({description => 'Administrative contact information for a domain registration.',
