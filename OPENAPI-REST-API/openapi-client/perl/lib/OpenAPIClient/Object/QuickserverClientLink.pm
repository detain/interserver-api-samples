...
#
package OpenAPIClient::Object::QuickserverClientLink;
...
__PACKAGE__->class_documentation({description => 'A navigation link for QuickServer-related actions in the client portal.',
