...
#
package OpenAPIClient::Object::DomainLookupResponse;
...
__PACKAGE__->class_documentation({description => 'Availability, pricing, and order-field metadata for a domain lookup.',
