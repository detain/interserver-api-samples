...
#
package OpenAPIClient::Object::DomainDnssecRequest;
...
__PACKAGE__->class_documentation({description => 'Request payload for adding DNSSEC DS records to a domain.',
