...
#
package OpenAPIClient::Object::VpsServiceAddons;
...
__PACKAGE__->class_documentation({description => 'Add-on services and IP address information for a VPS, including control panel licenses and extra IP assignments.',
