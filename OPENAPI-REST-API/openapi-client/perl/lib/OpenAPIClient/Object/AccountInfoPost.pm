...
#
package OpenAPIClient::Object::AccountInfoPost;
...
__PACKAGE__->class_documentation({description => 'Request to update account information.',
...
__PACKAGE__->method_documentation({
    ...
    'disable_server_notifications' => {
        datatype => 'boolean',
        base_name => 'disable_server_notifications',
    ...
    'disable_email_notifications' => {
        datatype => 'boolean',
        base_name => 'disable_email_notifications',
