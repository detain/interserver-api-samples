...
#
package OpenAPIClient::Object::BackupExtraInfoTables;
...
__PACKAGE__->class_documentation({description => 'Supplementary information tables for a backup service (IP info, etc.).',
