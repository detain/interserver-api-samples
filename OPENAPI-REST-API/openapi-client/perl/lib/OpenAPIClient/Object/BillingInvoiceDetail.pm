...
#
package OpenAPIClient::Object::BillingInvoiceDetail;
...
__PACKAGE__->class_documentation({description => 'Detailed invoice data payload returned for a single invoice.',
