...
#
package OpenAPIClient::Object::VpsExtraInfoTables;
...
__PACKAGE__->class_documentation({description => 'Additional informational tables displayed for a VPS service.',
