...
#
package OpenAPIClient::Object::DomainContactDetails;
...
__PACKAGE__->class_documentation({description => 'Contact details used for domain registrant/admin/technical/billing records.',
