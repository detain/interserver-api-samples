...
#
package OpenAPIClient::Object::WebsiteServiceInfo;
...
__PACKAGE__->method_documentation({
    ...
    'website_server_status' => {
        datatype => 'string',
        base_name => 'website_server_status',
