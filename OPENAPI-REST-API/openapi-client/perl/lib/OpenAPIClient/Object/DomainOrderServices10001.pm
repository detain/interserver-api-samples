...
#
package OpenAPIClient::Object::DomainOrderServices10001;
...
__PACKAGE__->class_documentation({description => 'Example schema for a domain service catalog entry.',
