...
#
package OpenAPIClient::Object::ServerBillingDetails;
...
__PACKAGE__->class_documentation({description => 'Billing information for a dedicated server service including payment status, billing cycle, and cost.',
