...
#
package OpenAPIClient::Object::DomainServiceType;
...
__PACKAGE__->class_documentation({description => 'Service type definition for a domain registration, including name, pricing, and category.',
