...
#
package OpenAPIClient::Object::HomeDetailsModules;
...
__PACKAGE__->method_documentation({
    'domains' => {
        datatype => 'HomeDetailsModulesDomains',
        base_name => 'domains',
        description => '',
        format => '',
        read_only => '',
    ...
    'webhosting' => {
        datatype => 'HomeDetailsModulesWebhosting',
    ...
    'vps' => {
        datatype => 'HomeDetailsModulesVps',
        base_name => 'vps',
        description => '',
        format => '',
        read_only => '',
    ...
    'licenses' => {
        datatype => 'HomeDetailsModulesLicenses',
        base_name => 'licenses',
        description => '',
        format => '',
        read_only => '',
    ...
    'backups' => {
        datatype => 'HomeDetailsModulesBackups',
        base_name => 'backups',
        description => '',
        format => '',
        read_only => '',
    ...
    'servers' => {
        datatype => 'HomeDetailsModulesServers',
        base_name => 'servers',
        description => '',
        format => '',
        read_only => '',
    ...
    'quickservers' => {
        datatype => 'HomeDetailsModulesQuickservers',
        base_name => 'quickservers',
        description => '',
        format => '',
        read_only => '',
            },
