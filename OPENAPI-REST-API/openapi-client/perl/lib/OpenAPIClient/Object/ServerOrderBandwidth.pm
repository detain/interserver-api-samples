...
#
package OpenAPIClient::Object::ServerOrderBandwidth;
...
__PACKAGE__->class_documentation({description => 'A bandwidth option available when ordering a dedicated server.',
