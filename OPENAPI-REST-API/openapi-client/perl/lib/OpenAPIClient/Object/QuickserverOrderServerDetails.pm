...
#
package OpenAPIClient::Object::QuickserverOrderServerDetails;
...
__PACKAGE__->class_documentation({description => 'Server details.',
...
__PACKAGE__->method_documentation({
    '_381' => {
        datatype => 'QuickserverOrderServerDetails381',
        base_name => '381',
        description => '',
        format => '',
        read_only => '',
