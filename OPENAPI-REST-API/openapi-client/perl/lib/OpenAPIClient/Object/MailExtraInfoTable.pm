...
#
package OpenAPIClient::Object::MailExtraInfoTable;
...
__PACKAGE__->class_documentation({description => 'A supplementary information table for a mail service (e.g., connection details).',
...
__PACKAGE__->method_documentation({
    ...
    'rows' => {
        datatype => 'ARRAY[MailExtraInfoTableRow]',
        base_name => 'rows',
