...
#
package OpenAPIClient::Object::SearchAutocompleteResponse;
...
__PACKAGE__->class_documentation({description => 'Autocomplete search results for the authenticated account.',
