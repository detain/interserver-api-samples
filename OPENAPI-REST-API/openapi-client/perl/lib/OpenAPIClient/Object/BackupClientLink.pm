...
#
package OpenAPIClient::Object::BackupClientLink;
...
__PACKAGE__->class_documentation({description => 'A navigation link for backup service actions in the client portal.',
