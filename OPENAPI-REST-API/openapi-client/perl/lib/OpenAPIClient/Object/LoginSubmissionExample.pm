...
#
package OpenAPIClient::Object::LoginSubmissionExample;
...
__PACKAGE__->class_documentation({description => 'The data to submit in the login request.',
...
__PACKAGE__->method_documentation({
    ...
    'g_recaptcha_response' => {
        datatype => 'LoginSubmissionExampleGRecaptchaResponse',
        base_name => 'g-recaptcha-response',
        description => '',
        format => '',
        read_only => '',
            },
