...
#
package OpenAPIClient::Object::HomeServicesServersLinks;
...
__PACKAGE__->class_documentation({description => 'Map of dedicated server service IDs to their hostnames for the account dashboard.',
