...
#
package OpenAPIClient::Object::HomeDetailsModulesQuickservers;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for QuickServer services.',
