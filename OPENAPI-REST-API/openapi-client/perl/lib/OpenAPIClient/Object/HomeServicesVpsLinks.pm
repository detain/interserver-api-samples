...
#
package OpenAPIClient::Object::HomeServicesVpsLinks;
...
__PACKAGE__->class_documentation({description => 'Map of VPS service IDs to their hostnames for the account dashboard.',
