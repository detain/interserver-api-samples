...
#
package OpenAPIClient::Object::AssetServer;
...
__PACKAGE__->class_documentation({description => 'A pre-configured asset server available for immediate provisioning.',
                                  class => 'AssetServer',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'cpu' => {
        datatype => 'ARRAY[AssetServerCPUInner]',
        base_name => 'CPU',
        description => '',
        format => '',
        read_only => '',
