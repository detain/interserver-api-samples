...
#
package OpenAPIClient::Object::ServiceType;
...
__PACKAGE__->class_documentation({description => 'A general grouping of services within a category.',
                                  class => 'ServiceType',
                                  required => [], # TODO
}                                 );
