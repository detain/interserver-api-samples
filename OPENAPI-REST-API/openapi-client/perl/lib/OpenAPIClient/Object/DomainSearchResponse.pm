...
#
package OpenAPIClient::Object::DomainSearchResponse;
...
__PACKAGE__->class_documentation({description => 'Lookup and suggestion results returned for a domain search.',
