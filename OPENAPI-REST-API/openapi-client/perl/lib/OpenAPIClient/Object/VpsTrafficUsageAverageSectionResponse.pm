...
#
package OpenAPIClient::Object::VpsTrafficUsageAverageSectionResponse;
...
__PACKAGE__->class_documentation({description => 'VPS Traffic Usage Average Section Response',
