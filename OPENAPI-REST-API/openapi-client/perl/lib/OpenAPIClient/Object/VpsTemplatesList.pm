...
#
package OpenAPIClient::Object::VpsTemplatesList;
...
__PACKAGE__->class_documentation({description => 'A listing of the OS Templates available for use.',
