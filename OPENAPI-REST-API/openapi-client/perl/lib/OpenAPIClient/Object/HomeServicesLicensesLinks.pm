...
#
package OpenAPIClient::Object::HomeServicesLicensesLinks;
...
__PACKAGE__->class_documentation({description => 'Map of license service IDs to their IP addresses for the account dashboard.',
