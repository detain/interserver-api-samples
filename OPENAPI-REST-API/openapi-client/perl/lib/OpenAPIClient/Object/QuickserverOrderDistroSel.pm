...
#
package OpenAPIClient::Object::QuickserverOrderDistroSel;
...
__PACKAGE__->class_documentation({description => 'Distribution selection.',
...
__PACKAGE__->method_documentation({
    'ubuntu' => {
        datatype => 'QuickserverOrderDistroSelUbuntu',
        base_name => 'Ubuntu',
        description => '',
        format => '',
        read_only => '',
