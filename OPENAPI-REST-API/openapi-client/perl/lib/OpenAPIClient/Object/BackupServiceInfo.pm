...
#
package OpenAPIClient::Object::BackupServiceInfo;
...
__PACKAGE__->class_documentation({description => 'Core service record for a backup storage service including ID, status, quota, and billing details.',
...
__PACKAGE__->method_documentation({
    ...
    'backup_server_status' => {
        datatype => 'string',
        base_name => 'backup_server_status',
