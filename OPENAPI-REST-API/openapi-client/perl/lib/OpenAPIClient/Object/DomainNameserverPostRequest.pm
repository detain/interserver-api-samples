...
#
package OpenAPIClient::Object::DomainNameserverPostRequest;
...
__PACKAGE__->class_documentation({description => 'Payload for adding a registered nameserver (glue record).',
