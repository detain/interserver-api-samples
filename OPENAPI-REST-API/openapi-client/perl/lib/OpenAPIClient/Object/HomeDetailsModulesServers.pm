...
#
package OpenAPIClient::Object::HomeDetailsModulesServers;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for dedicated server services.',
