...
#
package OpenAPIClient::Object::HomeServicesDomainsLinks;
...
__PACKAGE__->class_documentation({description => 'Map of domain service IDs to their hostnames for the account dashboard.',
