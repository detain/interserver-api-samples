...
#
package OpenAPIClient::Object::QuickserverServiceInfo;
...
__PACKAGE__->class_documentation({description => 'Core service record for a QuickServer including ID, status, IP, OS, and billing details.',
