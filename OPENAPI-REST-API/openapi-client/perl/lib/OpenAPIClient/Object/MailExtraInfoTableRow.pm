...
#
package OpenAPIClient::Object::MailExtraInfoTableRow;
...
__PACKAGE__->class_documentation({description => 'A single row in the mail service supplementary information table.',
