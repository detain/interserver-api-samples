...
#
package OpenAPIClient::Object::DomainNameserverPutRequest;
...
__PACKAGE__->class_documentation({description => 'Payload for replacing the assigned nameserver list for a domain.',
