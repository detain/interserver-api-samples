...
#
package OpenAPIClient::Object::ServerOrderMemory;
...
__PACKAGE__->class_documentation({description => 'A memory (RAM) option available when ordering a dedicated server.',
