...
#
package OpenAPIClient::Object::HomeDetailsModulesBackups;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for backup storage services.',
