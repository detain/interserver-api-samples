...
#
package OpenAPIClient::Object::ServerOrderOS;
...
__PACKAGE__->class_documentation({description => 'An operating system option available when ordering a dedicated server.',
                                  class => 'ServerOrderOS',
                                  required => [], # TODO
}                                 );
