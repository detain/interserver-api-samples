...
#
package OpenAPIClient::Object::VpsDAData;
...
__PACKAGE__->class_documentation({description => 'DirectAdmin license options available for a VPS.',
                                  class => 'VpsDAData',
                                  required => [], # TODO
}                                 );
