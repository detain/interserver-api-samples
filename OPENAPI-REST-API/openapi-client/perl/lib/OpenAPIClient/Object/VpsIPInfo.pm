...
#
package OpenAPIClient::Object::VpsIPInfo;
...
__PACKAGE__->class_documentation({description => 'IP address information table for a VPS service.',
                                  class => 'VpsIPInfo',
                                  required => [], # TODO
}                                 );
