...
#
package OpenAPIClient::Object::VpsDALicense;
...
__PACKAGE__->class_documentation({description => 'A DirectAdmin license tier option.',
                                  class => 'VpsDALicense',
                                  required => [], # TODO
}                                 );
