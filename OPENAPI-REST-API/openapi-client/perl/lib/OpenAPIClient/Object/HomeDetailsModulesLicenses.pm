...
#
package OpenAPIClient::Object::HomeDetailsModulesLicenses;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for software license services.',
