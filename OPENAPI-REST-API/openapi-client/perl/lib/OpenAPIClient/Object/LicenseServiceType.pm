...
#
package OpenAPIClient::Object::LicenseServiceType;
...
__PACKAGE__->class_documentation({description => 'Service type definition for a software license, including name, pricing, and category.',
