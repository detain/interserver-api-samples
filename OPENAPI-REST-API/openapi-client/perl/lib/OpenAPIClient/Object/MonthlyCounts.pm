...
#
package OpenAPIClient::Object::MonthlyCounts;
...
__PACKAGE__->class_documentation({description => 'A map of month labels (e.g., \&quot;2024-01\&quot;) to counts for a specific mail status.',
                                  class => 'MonthlyCounts',
                                  required => [], # TODO
}                                 );
