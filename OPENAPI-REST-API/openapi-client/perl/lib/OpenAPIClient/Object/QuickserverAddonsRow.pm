...
#
package OpenAPIClient::Object::QuickserverAddonsRow;
...
__PACKAGE__->class_documentation({description => 'A single add-on item associated with a QuickServer service.',
