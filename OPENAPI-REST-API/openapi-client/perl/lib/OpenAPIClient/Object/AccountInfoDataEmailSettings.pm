...
#
package OpenAPIClient::Object::AccountInfoDataEmailSettings;
...
__PACKAGE__->method_documentation({
    'admin/cc_bad_response' => {
        datatype => 'string',
        base_name => 'admin/cc_bad_response',
        description => '',
        format => '',
        read_only => '',
            },
    'admin/mass_communications/tpl' => {
        datatype => 'string',
        base_name => 'admin/mass_communications.tpl',
        description => '',
        format => '',
        read_only => '',
            },
...
__PACKAGE__->attribute_map( {
    'admin/cc_bad_response' => 'admin/cc_bad_response',
    'admin/mass_communications/tpl' => 'admin/mass_communications.tpl'
} );
