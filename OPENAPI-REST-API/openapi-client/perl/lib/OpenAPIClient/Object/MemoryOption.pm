...
#
package OpenAPIClient::Object::MemoryOption;
...
__PACKAGE__->class_documentation({description => 'A memory (RAM) upgrade option available for a dedicated server configuration.',
                                  class => 'MemoryOption',
                                  required => [], # TODO
}                                 );
