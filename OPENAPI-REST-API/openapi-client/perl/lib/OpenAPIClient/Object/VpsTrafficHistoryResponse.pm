...
#
package OpenAPIClient::Object::VpsTrafficHistoryResponse;
...
__PACKAGE__->class_documentation({description => 'VPS Traffic Data History Section',
...
__PACKAGE__->method_documentation({
    'hour' => {
        datatype => 'VpsTrafficHistorySectionResponse',
        base_name => 'hour',
        description => '',
        format => '',
        read_only => '',
