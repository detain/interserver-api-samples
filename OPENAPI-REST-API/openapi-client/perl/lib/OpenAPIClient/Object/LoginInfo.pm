...
#
package OpenAPIClient::Object::LoginInfo;
...
__PACKAGE__->class_documentation({description => 'Basic information useful for rendering a login page.',
                                  class => 'LoginInfo',
                                  required => [], # TODO
}                                 );
