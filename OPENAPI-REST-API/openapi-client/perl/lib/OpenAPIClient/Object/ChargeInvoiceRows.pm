...
#
package OpenAPIClient::Object::ChargeInvoiceRows;
...
__PACKAGE__->class_documentation({description => 'Billing invoices associated with a service, including invoice IDs, descriptions, amounts, and payment status.',
...
__PACKAGE__->method_documentation({
    ...
    'invoices' => {
        datatype => 'HASH[string,ChargeInvoiceRowsInvoicesValue]',
        base_name => 'invoices',
...
__PACKAGE__->openapi_types( {
    'success' => 'boolean',
    'invoices' => 'HASH[string,ChargeInvoiceRowsInvoicesValue]'
} );
