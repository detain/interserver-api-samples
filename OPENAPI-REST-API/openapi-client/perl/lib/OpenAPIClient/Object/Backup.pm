...
#
package OpenAPIClient::Object::Backup;
...
__PACKAGE__->class_documentation({description => 'Full detail view of a backup service including billing, service info, and configuration.',
                                  class => 'Backup',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'client_links' => {
        datatype => 'ARRAY[BackupClientLink]',
