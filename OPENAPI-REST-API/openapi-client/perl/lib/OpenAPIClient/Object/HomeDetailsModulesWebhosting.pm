...
#
package OpenAPIClient::Object::HomeDetailsModulesWebhosting;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for webhosting services.',
