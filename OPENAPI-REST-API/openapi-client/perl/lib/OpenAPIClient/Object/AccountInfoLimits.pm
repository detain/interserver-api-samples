...
#
package OpenAPIClient::Object::AccountInfoLimits;
...
__PACKAGE__->class_documentation({description => 'IP address ranges used to restrict account access to specific IPs.',
