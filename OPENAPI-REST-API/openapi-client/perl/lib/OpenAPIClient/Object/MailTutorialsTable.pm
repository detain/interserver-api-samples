...
#
package OpenAPIClient::Object::MailTutorialsTable;
...
__PACKAGE__->class_documentation({description => 'A table of tutorial links displayed for a mail service.',
...
__PACKAGE__->method_documentation({
    ...
    'rows' => {
        datatype => 'ARRAY[MailTutorialsTableRow]',
        base_name => 'rows',
