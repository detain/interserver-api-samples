...
#
package OpenAPIClient::Object::MailClientLink;
...
__PACKAGE__->class_documentation({description => 'A navigation link for mail service actions in the client portal.',
