...
#
package OpenAPIClient::Object::ModuleSettings;
...
__PACKAGE__->class_documentation({description => 'The settings for a module.',
...
__PACKAGE__->method_documentation({
    ...
    'repeat_billing_method' => {
        datatype => 'int',
        base_name => 'REPEAT_BILLING_METHOD',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'suspend_warning_days' => {
        datatype => 'int',
        base_name => 'SUSPEND_WARNING_DAYS',
        description => '',
        format => '',
        read_only => '',
            },
