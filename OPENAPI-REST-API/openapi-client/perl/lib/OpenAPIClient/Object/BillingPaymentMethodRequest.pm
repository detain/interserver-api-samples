...
#
package OpenAPIClient::Object::BillingPaymentMethodRequest;
...
__PACKAGE__->class_documentation({description => 'Payload for updating the default account payment method.',
