...
#
package OpenAPIClient::Object::HomeServicesWebhostingLinks;
...
__PACKAGE__->class_documentation({description => 'Map of webhosting service IDs to their hostnames for the account dashboard.',
