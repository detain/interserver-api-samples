...
#
package OpenAPIClient::Object::WebsiteExtraInfoTables;
...
__PACKAGE__->class_documentation({description => 'Supplementary information tables displayed for a webhosting service (links, DNS, preview).',
