...
#
package OpenAPIClient::Object::HomeDetailsModulesDomains;
...
__PACKAGE__->class_documentation({description => 'Dashboard module configuration for domain registration services.',
