...
#
package OpenAPIClient::Object::License;
...
__PACKAGE__->method_documentation({
    ...
    'client_links' => {
        datatype => 'ARRAY[LicenseClientLink]',
    ...
    'billing_details' => {
        datatype => 'LicenseBillingDetails',
    ...
    'extra_info_tables' => {
        datatype => 'LicenseExtraInfoTables',
