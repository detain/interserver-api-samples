...
#
package OpenAPIClient::Object::BackupOrderPostResponse;
...
__PACKAGE__->class_documentation({description => 'Backup Order Placement Response',
...
__PACKAGE__->method_documentation({
    ...
    'cj_params' => {
        datatype => 'BackupOrderPostResponseCjParams',
        base_name => 'cj_params',
        description => '',
        format => '',
        read_only => '',
