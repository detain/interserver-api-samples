...
#
package OpenAPIClient::Object::ServersBuyNowError;
...
__PACKAGE__->class_documentation({description => 'Error response when a buy-it-now server order fails validation.',
