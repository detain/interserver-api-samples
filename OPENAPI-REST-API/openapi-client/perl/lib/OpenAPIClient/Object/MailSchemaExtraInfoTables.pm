...
#
package OpenAPIClient::Object::MailSchemaExtraInfoTables;
...
__PACKAGE__->class_documentation({description => 'Additional information tables for the mail service.',
