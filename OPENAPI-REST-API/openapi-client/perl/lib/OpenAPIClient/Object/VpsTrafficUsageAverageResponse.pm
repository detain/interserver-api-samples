...
#
package OpenAPIClient::Object::VpsTrafficUsageAverageResponse;
...
__PACKAGE__->class_documentation({description => 'VPS Traffic Usage Average Section',
...
__PACKAGE__->method_documentation({
    'in' => {
        datatype => 'VpsTrafficUsageAverageSectionResponse',
        base_name => 'in',
        description => '',
        format => '',
        read_only => '',
