...
#
package OpenAPIClient::Object::ViewTicketResponse;
...
__PACKAGE__->class_documentation({description => 'Ticket details',
...
__PACKAGE__->method_documentation({
    ...
    'ticket_custom_fields' => {
        datatype => 'TicketCustomFieldDetails',
        base_name => 'ticket_custom_fields',
        description => '',
        format => '',
        read_only => '',
            },
    'ticket_posts' => {
        datatype => 'TicketPostDetails',
        base_name => 'ticket_posts',
        description => '',
        format => '',
        read_only => '',
            },
