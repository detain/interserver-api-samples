...
| **cpu** | **kotlin.Int** | Number of CPUs for the server order. |  [optional] |
...
| **raidLi** | [**kotlin.collections.List&lt;ServerOrderRAID&gt;**](ServerOrderRAID.md) | RAID options for the server order. |  [optional] |
