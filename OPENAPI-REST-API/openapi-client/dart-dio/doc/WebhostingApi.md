...
try {
    final response = api.getNewWebsite();
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getWebhostingApi();
final int id = 56; // int | The website service ID. Use `website_id` from `GET /websites`.

try {
    final response = api.getWebsiteBuyIp(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getWebsiteInfo(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getWebsiteInvoices(id);
    print(response);
} on DioException catch (e) {
...
# **getWebsiteList**
> BuiltList<WebsiteRow> getWebsiteList()
...
try {
    final response = api.getWebsiteList();
    print(response);
} on DioException catch (e) {
...
[**BuiltList&lt;WebsiteRow&gt;**](WebsiteRow.md)
...
try {
    final response = api.getWebsitesBackups(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getWebsitesLogin(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getWebsitesWelcomeEmail(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.gettWebsiteReverseDns(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postWebsiteBuyIp(id, postWebsiteBuyIpRequest);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postWebsiteMigration(id, postWebsiteMigrationRequest);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postWebsitesReverseDns(id, reverseDnsEntries);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getWebhostingApi();
final String id = 123; // String | The website service ID. Use `website_id` from `GET /websites`.

try {
    final response = api.webhostingCancel(id);
    print(response);
} on DioException catch (e) {
