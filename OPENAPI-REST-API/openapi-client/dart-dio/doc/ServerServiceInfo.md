# openapi.model.ServerServiceInfo
...
**serverDiscount** | [**JsonObject**](.md) | Discount information for the server. | [optional] 
...
**serverLocation** | [**JsonObject**](.md) | The location of the server. | [optional] 
...
**serverDedicatedHd2** | [**JsonObject**](.md) | The size of the second dedicated hard drive. | [optional] 
...
**serverDedicatedCp** | [**JsonObject**](.md) | The control panel of the server. | [optional] 
