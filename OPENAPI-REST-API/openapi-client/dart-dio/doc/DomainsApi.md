...
final api = Openapi().getDomainsApi();
final int id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
final DomainDnssecRequest domainDnssecRequest = ; // DomainDnssecRequest | 

try {
    final response = api.addDomainDnssec(id, domainDnssecRequest);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.addDomainNameserver(id, domainNameserverPostRequest);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.cancelDomain(id);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getDomainsApi();
final int id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
final String action = action_example; // String | Set to `delete` to remove all DNSSEC records.

try {
    final response = api.deleteDomainDnssec(id, action);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getDomainsApi();
final int id = 56; // int | The domain service ID. Use `domain_id` from `GET /domains`.
final int index = 56; // int | The index of the registered nameserver from the registered nameservers list to delete.  

try {
    final response = api.deleteDomainNameserver(id, index);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainContact(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainDnssec(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainInfo(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainInvoices(id);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getDomainsApi();
final String name = name_example; // String | The full domain name to look up (for example `example.com`).

try {
    final response = api.getDomainLookup(name);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainNameservers(id);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getDomainsApi();
final String domain = domain_example; // String | The fully qualified domain name (e.g. `example.com`).
final String regType = regType_example; // String | The registration type. Common values include `register` for new registrations and `transfer` for inbound transfers.
...
final api = Openapi().getDomainsApi();
final String domain = domain_example; // String | The fully qualified domain name to look up (e.g. `example.com`).
...
try {
    final response = api.getDomainRenewal(id);
    print(response);
} on DioException catch (e) {
...
final api = Openapi().getDomainsApi();
final String name = name_example; // String | The base domain name to search (for example `example` or `example.com`).

try {
    final response = api.getDomainSearch(name);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainTransfer(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getDomainWhoisPrivacy(id);
    print(response);
} on DioException catch (e) {
...
# **getDomainsList**
> BuiltList<DomainRow> getDomainsList()
...
try {
    final response = api.getDomainsList();
    print(response);
} on DioException catch (e) {
...
[**BuiltList&lt;DomainRow&gt;**](DomainRow.md)
...
try {
    final response = api.getDomainsWelcomeEmail(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.getNewDomain();
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postDomainRenewal(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postDomainTransfer(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.updateDomainContact(id, domainContactDetails);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.updateDomainNameservers(id, domainNameserverPutRequest);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.updateDomainWhoisPrivacy(id, domainWhoisPrivacyRequest);
    print(response);
} on DioException catch (e) {
