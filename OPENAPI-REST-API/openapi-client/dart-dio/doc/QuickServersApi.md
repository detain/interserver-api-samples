...
try {
    final response = api.downloadQsBackup(id, downloadQsBackupRequest, all);
    print(response);
} on DioException catch (e) {
...
# **getQsChangeTimezone**
> BuiltList<String> getQsChangeTimezone(id)
...
# **getQsList**
> BuiltList<QuickserverRow> getQsList()
...
[**BuiltList&lt;QuickserverRow&gt;**](QuickserverRow.md)
...
try {
    final response = api.postQsBackup(id);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postQsChangeTimezone(id, timezone);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postQsReverseDns(id, reverseDnsEntries);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.postQuickServerRestore(id, restoreRequest);
    print(response);
} on DioException catch (e) {
