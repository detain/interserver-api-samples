...
**service** | [**JsonObject**](.md) | Service catalog details for the domain's TLD. | [optional] 
...
**fields** | [**JsonObject**](.md) | Registrar field requirements for this domain/TLD. | [optional] 
**currencies** | [**JsonObject**](.md) | Pricing information normalized to supported currencies. | [optional] 
