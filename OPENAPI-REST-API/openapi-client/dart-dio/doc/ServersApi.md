...
# **getServerList**
> BuiltList<ServerRow> getServerList()
...
[**BuiltList&lt;ServerRow&gt;**](ServerRow.md)
...
try {
    final response = api.postServerReverseDns(id, reverseDnsEntries);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.serverIpmiLivePost(id, ip, asset);
    print(response);
} on DioException catch (e) {
...
try {
    final response = api.serverIpmiPowerPost(id, action, asset);
    print(response);
} on DioException catch (e) {
