...
class ServersApi {
  ...
  const ServersApi(this._dio, this._serializers);
  ...
  Future<Response<void>> addServer({ 
  ...
  Future<Response<BuyItNowServerOrder200Response>> buyItNowServerOrder({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuyItNowServerOrder200Response),
  ...
  Future<Response<BuyItNowList>> getMPServers({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuyItNowList),
      ) as BuyItNowList;
  ...
  Future<Response<ServerOrder>> getNewServer({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServerOrder),
      ) as ServerOrder;
  ...
  Future<Response<Server>> getServerInfo({ 
    ...
    final _path = r'/servers/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ChargeInvoiceRows>> getServerInvoices({ 
    ...
    final _path = r'/servers/{id}/invoices'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ServerRow>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ServerRow>>> getServerList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<ServerRow>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ServerRow)]),
      ) as BuiltList<ServerRow>;
    ...
    return Response<BuiltList<ServerRow>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ReverseDnsEntries>> getServerReverseDns({ 
    ...
    final _path = r'/servers/{id}/reverse_dns'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<SuccessTextResponse>> getServersWelcomeEmail({ 
    ...
    final _path = r'/servers/{id}/welcome_email'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ServersBuyNowResponse>> placeBuyNowServer({ 
    ...
    try {
      const _type = FullType(PlaceBuyNowServerRequest);
      _bodyData = placeBuyNowServerRequest == null ? null : _serializers.serialize(placeBuyNowServerRequest, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServersBuyNowResponse),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> putServers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  Future<Response<ServerIpmiLiveInfo>> serverIpmiLiveGet({ 
    ...
    final _path = r'/servers/{id}/ipmi_live'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServerIpmiLiveInfo),
  ...
  Future<Response<ServerIpmiLiveInfo>> serverIpmiLivePost({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (asset != null) r'asset': encodeFormParameter(_serializers, asset, const FullType(int)),
  ...
  Future<Response<TextResponse>> serverIpmiPowerGet({ 
    ...
    final _path = r'/servers/{id}/ipmi_power'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<TextResponse>> serverIpmiPowerPost({ 
    ...
    try {
      _bodyData = FormData.fromMap(<String, dynamic>{
        if (asset != null) r'asset': encodeFormParameter(_serializers, asset, const FullType(int)),
        r'action': encodeFormParameter(_serializers, action, const FullType(String)),
      });
  ...
  Future<Response<ServersCancel200Response>> serversCancel({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ServersCancel200Response),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> updateServerInfo({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/servers/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
