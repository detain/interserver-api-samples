...
/// * [servicesBuyable] - Buyable status
/// * [servicesType] - Service type
/// * [servicesField1] - Service field 1
/// * [servicesField2] - Service field 2
/// * [servicesModule] - Service module
@BuiltValue()
abstract class LicenseServiceType implements Built<LicenseServiceType, LicenseServiceTypeBuilder> {
  /// Service ID
  ...
  LicenseServiceType._();

  factory LicenseServiceType([void updates(LicenseServiceTypeBuilder b)]) = _$LicenseServiceType;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LicenseServiceTypeBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LicenseServiceType> get serializer => _$LicenseServiceTypeSerializer();
}

class _$LicenseServiceTypeSerializer implements PrimitiveSerializer<LicenseServiceType> {
  @override
  final Iterable<Type> types = const [LicenseServiceType, _$LicenseServiceType];

  @override
  final String wireName = r'LicenseServiceType';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    LicenseServiceType object, {
  ...
  void _deserializeProperties(
    ...
    required LicenseServiceTypeBuilder result,
  ...
  @override
  LicenseServiceType deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = LicenseServiceTypeBuilder();
