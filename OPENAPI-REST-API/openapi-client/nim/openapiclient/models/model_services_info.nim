...
import model_service_categories
import model_service_types
import model_services

type ServicesInfo* = object
  ## Contains the complete catalog of available modules, services, service types, and service categories.
  modules*: Table[string, ModuleSettings]
  services*: Table[string, Service]
  serviceTypes*: Table[string, ServiceType]
  serviceCategories*: Table[string, ServiceCategory]
