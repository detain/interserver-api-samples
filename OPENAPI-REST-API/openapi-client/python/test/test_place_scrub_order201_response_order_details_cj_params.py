...
class TestPlaceScrubOrder201ResponseOrderDetailsCjParams(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PlaceScrubOrder201ResponseOrderDetailsCjParams:
        ...
        """
        model = PlaceScrubOrder201ResponseOrderDetailsCjParams()
        if include_optional:
    ...
    def testPlaceScrubOrder201ResponseOrderDetailsCjParams(self):
        """Test PlaceScrubOrder201ResponseOrderDetailsCjParams"""
