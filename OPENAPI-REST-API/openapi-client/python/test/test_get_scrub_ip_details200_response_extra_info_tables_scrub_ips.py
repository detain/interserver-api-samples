...
class TestGetScrubIpDetails200ResponseExtraInfoTablesScrubIps(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetScrubIpDetails200ResponseExtraInfoTablesScrubIps:
        ...
        """
        model = GetScrubIpDetails200ResponseExtraInfoTablesScrubIps()
        if include_optional:
    ...
    def testGetScrubIpDetails200ResponseExtraInfoTablesScrubIps(self):
        """Test GetScrubIpDetails200ResponseExtraInfoTablesScrubIps"""
