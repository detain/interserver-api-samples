...
class TestQuickserversCancel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuickserversCancel200Response:
        """Test QuickserversCancel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuickserversCancel200Response`
        """
        model = QuickserversCancel200Response()
        if include_optional:
    ...
    def testQuickserversCancel200Response(self):
        """Test QuickserversCancel200Response"""
