...
class TestCreateRule400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateRule400Response:
        """Test CreateRule400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRule400Response`
        """
        model = CreateRule400Response()
        if include_optional:
    ...
    def testCreateRule400Response(self):
        """Test CreateRule400Response"""
