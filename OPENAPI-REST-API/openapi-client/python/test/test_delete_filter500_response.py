...
class TestDeleteFilter500Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DeleteFilter500Response:
        """Test DeleteFilter500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteFilter500Response`
        """
        model = DeleteFilter500Response()
        if include_optional:
    ...
    def testDeleteFilter500Response(self):
        """Test DeleteFilter500Response"""
