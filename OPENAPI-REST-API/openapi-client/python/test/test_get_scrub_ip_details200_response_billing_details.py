...
class TestGetScrubIpDetails200ResponseBillingDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetScrubIpDetails200ResponseBillingDetails:
        ...
        """
        model = GetScrubIpDetails200ResponseBillingDetails()
        if include_optional:
    ...
    def testGetScrubIpDetails200ResponseBillingDetails(self):
        """Test GetScrubIpDetails200ResponseBillingDetails"""
