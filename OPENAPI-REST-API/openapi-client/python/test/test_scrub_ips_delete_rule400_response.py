...
class TestScrubIpsDeleteRule400Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ScrubIpsDeleteRule400Response:
        """Test ScrubIpsDeleteRule400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrubIpsDeleteRule400Response`
        """
        model = ScrubIpsDeleteRule400Response()
        if include_optional:
    ...
    def testScrubIpsDeleteRule400Response(self):
        """Test ScrubIpsDeleteRule400Response"""
