...
class TestCloseTicketResponseSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CloseTicketResponseSchema:
        """Test CloseTicketResponseSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloseTicketResponseSchema`
        """
        model = CloseTicketResponseSchema()
        if include_optional:
