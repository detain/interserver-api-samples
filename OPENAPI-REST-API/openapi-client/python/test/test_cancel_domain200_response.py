...
class TestCancelDomain200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CancelDomain200Response:
        """Test CancelDomain200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CancelDomain200Response`
        """
        model = CancelDomain200Response()
        if include_optional:
    ...
    def testCancelDomain200Response(self):
        """Test CancelDomain200Response"""
