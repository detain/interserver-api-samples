...
class TestAccountInfoCountryCurrencies(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountInfoCountryCurrencies:
        """Test AccountInfoCountryCurrencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountInfoCountryCurrencies`
        """
        model = AccountInfoCountryCurrencies()
        if include_optional:
