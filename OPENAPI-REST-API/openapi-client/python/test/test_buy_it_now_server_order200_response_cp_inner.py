...
class TestBuyItNowServerOrder200ResponseCpInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BuyItNowServerOrder200ResponseCpInner:
        ...
        """
        model = BuyItNowServerOrder200ResponseCpInner()
        if include_optional:
    ...
    def testBuyItNowServerOrder200ResponseCpInner(self):
        """Test BuyItNowServerOrder200ResponseCpInner"""
