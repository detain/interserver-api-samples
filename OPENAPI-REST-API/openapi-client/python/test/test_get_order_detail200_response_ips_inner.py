...
class TestGetOrderDetail200ResponseIpsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetOrderDetail200ResponseIpsInner:
        ...
        """
        model = GetOrderDetail200ResponseIpsInner()
        if include_optional:
    ...
    def testGetOrderDetail200ResponseIpsInner(self):
        """Test GetOrderDetail200ResponseIpsInner"""
