...
class TestFloatingIpsCancel200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FloatingIpsCancel200Response:
        """Test FloatingIpsCancel200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FloatingIpsCancel200Response`
        """
        model = FloatingIpsCancel200Response()
        if include_optional:
    ...
    def testFloatingIpsCancel200Response(self):
        """Test FloatingIpsCancel200Response"""
