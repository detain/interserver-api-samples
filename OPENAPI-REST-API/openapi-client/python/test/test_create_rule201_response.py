...
class TestCreateRule201Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateRule201Response:
        """Test CreateRule201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateRule201Response`
        """
        model = CreateRule201Response()
        if include_optional:
    ...
    def testCreateRule201Response(self):
        """Test CreateRule201Response"""
