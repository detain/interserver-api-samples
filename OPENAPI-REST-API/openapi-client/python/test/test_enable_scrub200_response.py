...
class TestEnableScrub200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EnableScrub200Response:
        """Test EnableScrub200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnableScrub200Response`
        """
        model = EnableScrub200Response()
        if include_optional:
    ...
    def testEnableScrub200Response(self):
        """Test EnableScrub200Response"""
