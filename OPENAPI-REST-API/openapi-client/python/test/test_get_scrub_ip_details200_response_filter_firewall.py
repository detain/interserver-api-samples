...
class TestGetScrubIpDetails200ResponseFilterFirewall(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetScrubIpDetails200ResponseFilterFirewall:
        ...
        """
        model = GetScrubIpDetails200ResponseFilterFirewall()
        if include_optional:
    ...
    def testGetScrubIpDetails200ResponseFilterFirewall(self):
        """Test GetScrubIpDetails200ResponseFilterFirewall"""
