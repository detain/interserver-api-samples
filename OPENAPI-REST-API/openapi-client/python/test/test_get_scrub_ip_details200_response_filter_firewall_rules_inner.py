...
class TestGetScrubIpDetails200ResponseFilterFirewallRulesInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetScrubIpDetails200ResponseFilterFirewallRulesInner:
        ...
        """
        model = GetScrubIpDetails200ResponseFilterFirewallRulesInner()
        if include_optional:
    ...
    def testGetScrubIpDetails200ResponseFilterFirewallRulesInner(self):
        """Test GetScrubIpDetails200ResponseFilterFirewallRulesInner"""
