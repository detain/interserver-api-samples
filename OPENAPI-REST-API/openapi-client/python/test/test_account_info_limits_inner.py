...
class TestAccountInfoLimitsInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountInfoLimitsInner:
        """Test AccountInfoLimitsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountInfoLimitsInner`
        """
        model = AccountInfoLimitsInner()
        if include_optional:
