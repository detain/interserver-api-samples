...
class TestServerServiceInfo(unittest.TestCase):
    """ServerServiceInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerServiceInfo:
    ...
    def testServerServiceInfo(self):
        """Test ServerServiceInfo"""
