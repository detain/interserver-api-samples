...
class ServerIpmiLiveRequest(BaseModel):
    """
    Request body to setup an IPMI Live connection.
    """ # noqa: E501
    asset: Optional[StrictInt] = Field(default=None, description="Asset ID")
    ip: StrictStr = Field(description="Your IP Address you wish to connect to the IPMI system from.")
