...
class MailSchemaExtraInfoTables(BaseModel):
    """
    Additional information tables for the mail service.
    """ # noqa: E501
    mail: Optional[MailExtraInfoTable] = None
    tutorials: Optional[MailTutorialsTable] = None
    __properties: ClassVar[List[str]] = ["mail", "tutorials"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tutorials
        if self.tutorials:
            _dict['tutorials'] = self.tutorials.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mail": MailExtraInfoTable.from_dict(obj["mail"]) if obj.get("mail") is not None else None,
            "tutorials": MailTutorialsTable.from_dict(obj["tutorials"]) if obj.get("tutorials") is not None else None
        })
        return _obj
