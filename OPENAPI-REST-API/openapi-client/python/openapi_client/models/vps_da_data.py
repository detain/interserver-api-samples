...
class VpsDAData(BaseModel):
    """
    DirectAdmin license options available for a VPS.
    """ # noqa: E501
    free: Optional[VpsDALicense] = None
    __properties: ClassVar[List[str]] = ["free"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "free": VpsDALicense.from_dict(obj["free"]) if obj.get("free") is not None else None
        })
        return _obj
