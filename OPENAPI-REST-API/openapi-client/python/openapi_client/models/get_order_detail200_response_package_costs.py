...
class GetOrderDetail200ResponsePackageCosts(BaseModel):
    """
    GetOrderDetail200ResponsePackageCosts
    """ # noqa: E501
    package_id: Optional[Union[StrictFloat, StrictInt]] = None
    package_cost: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[StrictStr] = None
    currency_symbol: Optional[StrictStr] = Field(default=None, alias="currencySymbol")
    __properties: ClassVar[List[str]] = ["package_id", "package_cost", "currency", "currencySymbol"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "package_cost": obj.get("package_cost"),
