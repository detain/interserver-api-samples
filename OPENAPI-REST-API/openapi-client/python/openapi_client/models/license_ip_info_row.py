...
class LicenseIpInfoRow(BaseModel):
    """
    A single row in the license IP information table.
    """ # noqa: E501
    desc: Optional[StrictStr] = Field(default=None, description="Row description")
    value: Optional[StrictStr] = Field(default=None, description="Row value")
