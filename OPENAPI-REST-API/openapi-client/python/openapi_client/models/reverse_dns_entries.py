...
class ReverseDnsEntries(BaseModel):
    """
    The Reverse DNS entries.
    """ # noqa: E501
    ips: Optional[Dict[str, Any]] = Field(default=None, description="The IPs you have access to and their current reverse dns mapping.")
