...
class WebsiteExtraInfoTables(BaseModel):
    """
    Supplementary information tables displayed for a webhosting service (links, DNS, preview).
    """ # noqa: E501
    links: Optional[WebsiteTable] = None
    preview: Optional[WebsiteTable] = None
    dns: Optional[WebsiteTable] = None
    __properties: ClassVar[List[str]] = ["links", "preview", "dns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": WebsiteTable.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "preview": WebsiteTable.from_dict(obj["preview"]) if obj.get("preview") is not None else None,
            "dns": WebsiteTable.from_dict(obj["dns"]) if obj.get("dns") is not None else None
        })
        return _obj
