...
class QuickserverExtraInfoTables(BaseModel):
    """
    QuickserverExtraInfoTables
    """ # noqa: E501
    ip_info: Optional[QuickserverIpInfo] = None
    addons: Optional[QuickserverAddons] = None
    __properties: ClassVar[List[str]] = ["ip_info", "addons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip_info": QuickserverIpInfo.from_dict(obj["ip_info"]) if obj.get("ip_info") is not None else None,
            "addons": QuickserverAddons.from_dict(obj["addons"]) if obj.get("addons") is not None else None
        })
        return _obj
