...
class VpsServiceExtra(BaseModel):
    """
    VpsServiceExtra
    """ # noqa: E501
    spice: Optional[StrictInt] = Field(default=None, description="Spice")
    snapshots: Optional[List[VpsSnapshot]] = None
    __properties: ClassVar[List[str]] = ["spice", "snapshots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spice": obj.get("spice"),
            "snapshots": [VpsSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
