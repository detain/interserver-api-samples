...
class TemplateRequest(BaseModel):
    ...
    """ # noqa: E501
    template: StrictStr = Field(description="OS Template Filename")
    password: Optional[Annotated[str, Field(min_length=6, strict=True)]] = Field(default=None, description="Password for Root / Administrator Account.")
