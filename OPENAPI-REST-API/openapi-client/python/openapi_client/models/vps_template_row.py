...
class VpsTemplateRow(BaseModel):
    """
    A VPS OS Template.
    """ # noqa: E501
    template_id: Optional[StrictStr] = None
    template_type: Optional[StrictStr] = None
    template_os: Optional[StrictStr] = None
    template_version: Optional[StrictStr] = None
    template_bits: Optional[StrictStr] = None
    template_file: Optional[StrictStr] = None
    template_available: Optional[StrictStr] = None
    template_name: Optional[StrictStr] = None
    template_dir: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["template_id", "template_type", "template_os", "template_version", "template_bits", "template_file", "template_available", "template_name", "template_dir"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "template_os": obj.get("template_os"),
            "template_version": obj.get("template_version"),
            "template_bits": obj.get("template_bits"),
            "template_file": obj.get("template_file"),
            "template_available": obj.get("template_available"),
