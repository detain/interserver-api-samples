...
class DomainOrderResponse(BaseModel):
    ...
    attributes: Optional[DomainOrderResponseAttributes] = None
    response_text: Optional[StrictStr] = None
    object: Optional[StrictStr] = None
    response_code: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_OPS_version", "protocol", "is_success", "action", "attributes", "response_text", "object", "response_code"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": DomainOrderResponseAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
