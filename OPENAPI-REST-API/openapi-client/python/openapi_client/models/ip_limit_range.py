...
class IpLimitRange(BaseModel):
    """
    The lower and upper bounds of an ip range.
    """ # noqa: E501
    start: StrictStr = Field(description="The begining (or first) IP address in the range.")
    end: StrictStr = Field(description="The ending (or last) IP address in the range.")
