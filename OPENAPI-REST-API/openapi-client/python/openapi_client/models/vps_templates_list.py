...
class VpsTemplatesList(BaseModel):
    """
    A listing of the OS Templates available for use.
    """ # noqa: E501
    templates: List[VpsTemplateRow] = Field(description="A listing of the templates.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "templates": [VpsTemplateRow.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None
        })
        return _obj
