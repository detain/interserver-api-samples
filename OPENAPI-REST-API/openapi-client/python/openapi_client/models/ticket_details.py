...
class TicketDetails(BaseModel):
    ...
    """ # noqa: E501
    ticketid: Optional[StrictInt] = None
    ticketmaskid: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["ticketid", "ticketmaskid", "department", "status", "priority", "subject", "created_on", "updated_on"]
