...
class TicketPostDetailsInner(BaseModel):
    """
    ...
    hasattachments: Optional[StrictInt] = None
    attachment_download: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["post_id", "date", "contents", "creator", "creator_email", "creator_name", "hasattachments", "attachment_download"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attachment_download": obj.get("attachment_download")
        })
        return _obj
