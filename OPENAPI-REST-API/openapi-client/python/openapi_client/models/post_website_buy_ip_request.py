...
class PostWebsiteBuyIpRequest(BaseModel):
    """
    PostWebsiteBuyIpRequest
    """ # noqa: E501
    ips: Optional[Dict[str, StrictStr]] = Field(default=None, description="A map of IP addresses to their desired reverse DNS hostnames.")
