...
class LoginInfo(BaseModel):
    ...
    """ # noqa: E501
    logo: Optional[StrictStr] = Field(default=None, description="A logo image url.")
    captcha: StrictStr = Field(description="A base64 encoded image to use for rendering the alternateive captcha.")
    language: Optional[StrictStr] = Field(default=None, description="The desired langauge to render the site with.")
