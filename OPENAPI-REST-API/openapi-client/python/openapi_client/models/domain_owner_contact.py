...
class DomainOwnerContact(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["postal_code", "org_name", "country", "status", "state", "first_name", "last_name", "address3", "fax", "address2", "email", "city", "phone", "address1"]
