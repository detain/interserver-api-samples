...
class VpsTrafficHistoryResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hour": VpsTrafficHistorySectionResponse.from_dict(obj["hour"]) if obj.get("hour") is not None else None,
            "day": VpsTrafficHistorySectionResponse.from_dict(obj["day"]) if obj.get("day") is not None else None
        })
        return _obj
