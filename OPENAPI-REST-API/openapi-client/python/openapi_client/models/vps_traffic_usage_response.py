...
class VpsTrafficUsageResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["current", "peak", "average"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current": VpsTrafficTotalsSectionResponse.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "peak": VpsTrafficTotalsSectionResponse.from_dict(obj["peak"]) if obj.get("peak") is not None else None,
            "average": VpsTrafficUsageAverageResponse.from_dict(obj["average"]) if obj.get("average") is not None else None
        })
        return _obj
