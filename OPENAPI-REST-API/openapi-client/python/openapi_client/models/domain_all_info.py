...
class DomainAllInfo(BaseModel):
    ...
    attributes: Optional[DomainAllInfoAttributes] = None
    ...
    __properties: ClassVar[List[str]] = ["_OPS_version", "attributes", "object", "protocol", "response_text", "response_code", "action", "is_success"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": DomainAllInfoAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
