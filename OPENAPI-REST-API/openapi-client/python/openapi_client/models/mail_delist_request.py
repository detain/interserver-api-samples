...
class MailDelistRequest(BaseModel):
    """
    Payload for removing a sender from mail blocklists.
    """ # noqa: E501
    unblock: Optional[StrictStr] = Field(default=None, description="Email address to delist.")
    __properties: ClassVar[List[str]] = ["unblock"]
