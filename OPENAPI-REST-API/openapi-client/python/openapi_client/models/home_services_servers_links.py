...
class HomeServicesServersLinks(BaseModel):
    """
    Map of dedicated server service IDs to their hostnames for the account dashboard.
    """ # noqa: E501
    var_16058: Optional[StrictStr] = Field(default=None, description="Link to a server.", alias="16058")
    __properties: ClassVar[List[str]] = ["16058"]
