...
class VpsSnapshot(BaseModel):
    ...
    used: Optional[StrictInt] = Field(default=None, description="Disk space used by this snapshot in bytes.")
    var_date: Optional[StrictInt] = Field(default=None, description="Unix timestamp of when the snapshot was created.", alias="date")
    __properties: ClassVar[List[str]] = ["name", "used", "date"]
