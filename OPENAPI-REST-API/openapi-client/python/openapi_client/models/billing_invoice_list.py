...
class BillingInvoiceList(BaseModel):
    ...
    """ # noqa: E501
    rows: Optional[List[Dict[str, Any]]] = Field(default=None, description="Invoice rows returned for the account.")
    summary: Optional[Dict[str, Any]] = Field(default=None, description="Totals and summary data for the invoices list.")
