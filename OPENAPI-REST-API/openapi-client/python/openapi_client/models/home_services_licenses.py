...
class HomeServicesLicenses(BaseModel):
    """
    HomeServicesLicenses
    """ # noqa: E501
    links: Optional[HomeServicesLicensesLinks] = None
    count: Optional[StrictInt] = Field(default=None, description="Number of licenses.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": HomeServicesLicensesLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "count": obj.get("count")
        })
        return _obj
