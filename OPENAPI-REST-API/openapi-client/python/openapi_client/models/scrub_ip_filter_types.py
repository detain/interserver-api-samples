...
class ScrubIpFilterTypes(BaseModel):
    """
    Available scrub filter types for building firewall rules.
    """ # noqa: E501
    success: Optional[StrictBool] = None
    filters: Optional[Dict[str, ScrubIpFilterTypesFiltersValue]] = None
    __properties: ClassVar[List[str]] = ["success", "filters"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "filters": dict(
                (_k, ScrubIpFilterTypesFiltersValue.from_dict(_v))
