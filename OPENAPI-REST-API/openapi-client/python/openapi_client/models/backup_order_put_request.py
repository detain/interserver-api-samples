...
class BackupOrderPutRequest(BaseModel):
    """
    Parameters to submit to validate your backup order
    """ # noqa: E501
    validate_only: Optional[StrictBool] = Field(default=None, alias="validateOnly")
    service_type: Optional[StrictInt] = Field(default=None, alias="serviceType")
    coupon: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["validateOnly", "serviceType", "coupon"]
