...
class ServerIpmiPowerRequest(BaseModel):
    """
    IPMI Power command for servers
    """ # noqa: E501
    asset: Optional[StrictInt] = Field(default=None, description="The Asset ID")
    action: StrictStr = Field(description="The power action to send to the ipmi controller.")
