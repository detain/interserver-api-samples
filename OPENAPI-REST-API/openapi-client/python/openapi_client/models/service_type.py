...
class ServiceType(BaseModel):
    ...
    st_id: StrictInt
    st_name: StrictStr
    st_category: StrictInt
    st_module: StrictStr
    __properties: ClassVar[List[str]] = ["st_id", "st_name", "st_category", "st_module"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "st_id": obj.get("st_id"),
            "st_name": obj.get("st_name"),
            "st_category": obj.get("st_category"),
            "st_module": obj.get("st_module")
        })
        return _obj
