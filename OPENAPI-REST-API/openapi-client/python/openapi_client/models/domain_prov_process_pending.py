...
class DomainProvProcessPending(BaseModel):
    """
    Provisioning status data for a pending domain order.
    """ # noqa: E501
    ops_version: Optional[StrictStr] = Field(default=None, alias="_OPS_version")
    response_text: Optional[StrictStr] = None
    protocol: Optional[StrictStr] = None
    response_code: Optional[StrictStr] = None
    action: Optional[StrictStr] = None
    object: Optional[StrictStr] = None
    is_success: Optional[StrictStr] = None
    attributes: Optional[DomainProvProcessPendingAttributes] = None
    __properties: ClassVar[List[str]] = ["_OPS_version", "response_text", "protocol", "response_code", "action", "object", "is_success", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_OPS_version": obj.get("_OPS_version"),
            ...
            "attributes": DomainProvProcessPendingAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
