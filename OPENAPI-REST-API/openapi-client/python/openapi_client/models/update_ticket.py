...
class UpdateTicket(BaseModel):
    ...
    customer_server_access: Optional[StrictStr] = None
    root_password: Optional[StrictStr] = None
    sudo_username: Optional[StrictStr] = None
    sudo_password: Optional[StrictStr] = None
    port: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["ip", "ip_address", "customer_server_access", "root_password", "sudo_username", "sudo_password", "port"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customer_server_access": obj.get("customer_server_access"),
            "root_password": obj.get("root_password"),
            "sudo_username": obj.get("sudo_username"),
