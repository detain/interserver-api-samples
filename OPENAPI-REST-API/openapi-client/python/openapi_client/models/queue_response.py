...
class QueueResponse(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr = Field(description="Response text")
    queue_id: StrictInt = Field(description="The Queue ID attached to the action.", alias="queueId")
    __properties: ClassVar[List[str]] = ["text", "queueId"]
