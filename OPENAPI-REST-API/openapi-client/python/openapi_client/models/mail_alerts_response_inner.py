...
class MailAlertsResponseInner(BaseModel):
    """
    MailAlertsResponseInner
    """ # noqa: E501
    alert_id: Optional[StrictInt] = None
    alert_type: Optional[StrictStr] = None
    alert_value: Optional[StrictStr] = None
    alert_to: Optional[StrictStr] = None
    alert_enabled: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["alert_id", "alert_type", "alert_value", "alert_to", "alert_enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "alert_value": obj.get("alert_value"),
            "alert_to": obj.get("alert_to"),
