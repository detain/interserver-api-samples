...
class GetScrubIpDetails200ResponseFilterFirewallFiltersInner(BaseModel):
    """
    GetScrubIpDetails200ResponseFilterFirewallFiltersInner
    """ # noqa: E501
    daddr: Optional[StrictStr] = None
    dest: Optional[StrictStr] = None
    filter_name: Optional[StrictStr] = None
    destination_ip: Optional[StrictStr] = None
    filter: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["daddr", "dest", "filter_name", "destination_ip", "filter"]
