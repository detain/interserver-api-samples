...
class DomainBillingExtra(BaseModel):
    """
    Extended billing context for a domain including registrar order details and contact info.
    """ # noqa: E501
    order: Optional[DomainOrderResponse] = None
    order_id: Optional[StrictStr] = None
    domain_id: Optional[StrictStr] = None
    prov_process_pending: Optional[DomainProvProcessPending] = Field(default=None, alias="provProcessPending")
    ...
    __properties: ClassVar[List[str]] = ["order", "order_id", "domain_id", "provProcessPending", "email", "firstname", "lastname", "company", "address", "address2", "address3", "city", "state", "zip", "country", "phone", "fax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of prov_process_pending
        if self.prov_process_pending:
            _dict['provProcessPending'] = self.prov_process_pending.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": DomainOrderResponse.from_dict(obj["order"]) if obj.get("order") is not None else None,
            "order_id": obj.get("order_id"),
            "domain_id": obj.get("domain_id"),
            "provProcessPending": DomainProvProcessPending.from_dict(obj["provProcessPending"]) if obj.get("provProcessPending") is not None else None,
            "email": obj.get("email"),
