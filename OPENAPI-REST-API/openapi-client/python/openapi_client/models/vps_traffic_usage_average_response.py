...
class VpsTrafficUsageAverageResponse(BaseModel):
    """
    VPS Traffic Usage Average Section
    """ # noqa: E501
    var_in: VpsTrafficUsageAverageSectionResponse = Field(alias="in")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of out
        if self.out:
            _dict['out'] = self.out.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "in": VpsTrafficUsageAverageSectionResponse.from_dict(obj["in"]) if obj.get("in") is not None else None,
            "out": VpsTrafficUsageAverageSectionResponse.from_dict(obj["out"]) if obj.get("out") is not None else None
        })
        return _obj
