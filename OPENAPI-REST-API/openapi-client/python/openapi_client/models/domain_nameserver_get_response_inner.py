...
class DomainNameserverGetResponseInner(BaseModel):
    """
    DomainNameserverGetResponseInner
    """ # noqa: E501
    name: StrictStr
    ipaddress: StrictStr
    can_delete: StrictStr = Field(description="Whether the registrar allows deletion of this nameserver entry.")
    __properties: ClassVar[List[str]] = ["name", "ipaddress", "can_delete"]
