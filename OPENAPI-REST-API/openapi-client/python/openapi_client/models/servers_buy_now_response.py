...
class ServersBuyNowResponse(BaseModel):
    """
    Success response after placing a buy-it-now dedicated server order.
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Whether the order was placed successfully.")
    text: Optional[StrictStr] = Field(default=None, description="Human-readable status message.")
    order_details: Optional[ServersBuyNowResponseOrderDetails] = None
    __properties: ClassVar[List[str]] = ["success", "text", "order_details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "order_details": ServersBuyNowResponseOrderDetails.from_dict(obj["order_details"]) if obj.get("order_details") is not None else None
        })
        return _obj
