...
class ServersBuyNowError(BaseModel):
    """
    ...
    text: Optional[StrictStr] = Field(default=None, description="Human-readable error summary.")
    errors: Optional[List[StrictStr]] = Field(default=None, description="List of specific validation error messages.")
    __properties: ClassVar[List[str]] = ["success", "text", "errors"]
