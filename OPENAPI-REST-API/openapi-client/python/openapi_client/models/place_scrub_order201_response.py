...
class PlaceScrubOrder201Response(BaseModel):
    """
    PlaceScrubOrder201Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    text: Optional[StrictStr] = None
    order_details: Optional[PlaceScrubOrder201ResponseOrderDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text": obj.get("text"),
            "order_details": PlaceScrubOrder201ResponseOrderDetails.from_dict(obj["order_details"]) if obj.get("order_details") is not None else None
        })
        return _obj
