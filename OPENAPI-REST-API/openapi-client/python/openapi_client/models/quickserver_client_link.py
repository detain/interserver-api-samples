...
class QuickserverClientLink(BaseModel):
    """
    ...
    icon: Optional[StrictStr] = Field(default=None, description="Icon class")
    icon_text: Optional[StrictStr] = Field(default=None, description="Icon text")
    help_text: Optional[StrictStr] = Field(default=None, description="Help text")
    other_attr: Optional[StrictStr] = Field(default=None, description="Other attribute")
