...
class GetWebsiteBuyIp200Response(BaseModel):
    """
    GetWebsiteBuyIp200Response
    """ # noqa: E501
    ips: Optional[Dict[str, StrictStr]] = Field(default=None, description="A map of IP addresses to their current reverse DNS hostnames.")
