...
class BackupExtraInfoTables(BaseModel):
    """
    Supplementary information tables for a backup service (IP info, etc.).
    """ # noqa: E501
    ip_info: Optional[BackupIPInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip_info": BackupIPInfo.from_dict(obj["ip_info"]) if obj.get("ip_info") is not None else None
        })
        return _obj
