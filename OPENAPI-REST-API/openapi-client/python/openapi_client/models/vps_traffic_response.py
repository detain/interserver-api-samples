...
class VpsTrafficResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "target", "interval", "history", "last", "times", "totals", "usage", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "history": VpsTrafficHistoryResponse.from_dict(obj["history"]) if obj.get("history") is not None else None,
            "last": obj.get("last"),
            "times": obj.get("times"),
            "totals": VpsTrafficTotalsResposne.from_dict(obj["totals"]) if obj.get("totals") is not None else None,
            "usage": VpsTrafficUsageResponse.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
            "data": [VpsTrafficDataSectionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
