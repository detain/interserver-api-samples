...
class DomainTechContact(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["state", "status", "org_name", "country", "postal_code", "fax", "email", "address2", "address3", "address1", "city", "phone", "first_name", "last_name"]
