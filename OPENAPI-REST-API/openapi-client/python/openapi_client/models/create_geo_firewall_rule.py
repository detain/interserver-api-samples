...
class CreateGeoFirewallRule(BaseModel):
    """
    Create firewall rule for your ip
    """ # noqa: E501
    destination_port: Optional[StrictInt] = 80
    country_code: Optional[StrictInt] = Field(default=None, description="To get country code refer our countries api - https://my.interserver.net/apiv2/account/countries?fetch_by=numcode")
