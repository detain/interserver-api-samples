...
class PatchOauthTwoFactor200Response(BaseModel):
    """
    PatchOauthTwoFactor200Response
    """ # noqa: E501
    login: Optional[StrictBool] = Field(default=None, description="Whether the 2FA verification succeeded and the user is now logged in.")
