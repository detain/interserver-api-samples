...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "sessionIdHeaderAuth": APIKeyAuthSetting,
        "sessionIdCookieAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = openapi_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://my.interserver.net/apiv2" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'sessionIdHeaderAuth' in self.api_key:
            auth['sessionIdHeaderAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'sessionid',
                'value': self.get_api_key_with_prefix(
        ...
        if 'sessionIdCookieAuth' in self.api_key:
            auth['sessionIdCookieAuth'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'sessionid',
                'value': self.get_api_key_with_prefix(
