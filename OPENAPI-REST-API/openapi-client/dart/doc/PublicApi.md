...
try {
    final result = api_instance.getCaptcha();
    print(result);
} catch (e) {
...
final api_instance = PublicApi();
final fetchBy = fetchBy_example; // String | Get countries by iso2 or iso3 or numcode

try {
    final result = api_instance.getCountries(fetchBy);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getLoginInfo();
    print(result);
} catch (e) {
...
final api_instance = PublicApi();
final provider = provider_example; // String | The OAuth provider name (e.g. `Google`).

try {
    final result = api_instance.getOauthRedirect(provider);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getTimezones();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.patchOauthTwoFactor(patchOauthTwoFactorRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postOauthCallback(provider, postOauthCallbackRequest);
    print(result);
} catch (e) {
...
final api_instance = PublicApi();
final login = login_example; // String | 
final passwd = passwd_example; // String | 
final remember = remember_example; // String | 
final gRecaptchaResponse = ; // LoginSubmissionExampleGRecaptchaResponse | 
final tfa = tfa_example; // String | Two Factor Authentication Response.

try {
    final result = api_instance.submitLogin(login, passwd, remember, gRecaptchaResponse, tfa);
    print(result);
} catch (e) {
...
final api_instance = PublicApi();
final loginSubmissionExample = LoginSubmissionExample(); // LoginSubmissionExample | 

try {
    api_instance.submitSignup(loginSubmissionExample);
} catch (e) {
