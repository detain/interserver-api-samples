...
final zip = zip_example; // String | 
final cc = cc_example; // String | 
final ccExp = ccExp_example; // String | 
final ccCcv2 = ccCcv2_example; // String | 

try {
    final result = api_instance.addAccountCreditCard(name, address, city, state, country, zip, cc, ccExp, ccCcv2);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.addBillingCreditCard(billingAddCcRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.addBillingPrepay(billingPrepayRequest);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The credit card ID to remove. Use IDs from `GET /billing/creditcards`.

try {
    final result = api_instance.deleteBillingCreditCard(id);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The invoice ID to delete. Only unpaid invoices can be deleted.

try {
    final result = api_instance.deleteBillingInvoice(id);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The prepay balance ID to delete.

try {
    final result = api_instance.deleteBillingPrepay(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAffiliateBanners();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAffiliateRichReport();
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final days = 56; // int | Number of days of sales history to include in the graph data. Determines the time window for the returned data points.

try {
    final result = api_instance.getAffiliateSalesGraph(days);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAffiliateSalesReport();
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final days = 56; // int | Number of days of traffic history to include in the graph data. Determines the time window for the returned data points.

try {
    final result = api_instance.getAffiliateTrafficGraph(days);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAffiliateWebTraffic();
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The credit card ID to verify. Use the ID returned from `POST /billing/creditcards`.

try {
    final result = api_instance.getBillingCreditCardVerify(id);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The invoice ID. Use IDs from `GET /billing/invoices` or from order responses.

try {
    final result = api_instance.getBillingInvoice(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getBillingInvoices();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getInvoices(searchString, skip, limit);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final method = method_example; // String | The payment method to use. Valid values: `cc` (credit card), `paypal`, `prepay`, `payssion`, `payu`, `ccavenue`, `cashfree`, `coinbase`, `btcpay`.
final invoices = invoices_example; // String | A comma-separated list of invoice IDs to pay. These IDs are returned by order endpoints (e.g. `/backups/order`, `/vps/order`) and by `/billing/invoices`.

try {
    final result = api_instance.initiatePayment(method, invoices);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postBillingCreditCardVerify(id, billingVerifyCcRequest);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final affiliateDockTitle = affiliateDockTitle_example; // String | 
final affiliateDockDescription = affiliateDockDescription_example; // String | 
final referrerCoupon = referrerCoupon_example; // String | 

try {
    final result = api_instance.updateAffiliateDockSetup(affiliateDockTitle, affiliateDockDescription, referrerCoupon);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateAffiliateLandingPage(affiliateDockTitle, affiliateDockDescription, referrerCoupon);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final affiliatePaypal = affiliatePaypal_example; // String | 
final affiliatePaymentMethod = affiliatePaymentMethod_example; // String | 

try {
    final result = api_instance.updateAffiliatePaymentSetup(affiliatePaypal, affiliatePaymentMethod);
    print(result);
} catch (e) {
...
final api_instance = BillingApi();
final id = 56; // int | The credit card ID. Use IDs from `GET /billing/creditcards` or the response from `POST /billing/creditcards`.

try {
    final result = api_instance.updateBillingCreditCard(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.updateBillingPaymentMethod(billingPaymentMethodRequest);
    print(result);
} catch (e) {
