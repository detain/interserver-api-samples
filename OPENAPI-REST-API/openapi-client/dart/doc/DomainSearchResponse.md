...
**lookup** | **List<Object>** | Availability lookup results for queried domains. | [optional] [default to const []]
**suggest** | **List<Object>** | Suggested alternative domains and availability data. | [optional] [default to const []]
