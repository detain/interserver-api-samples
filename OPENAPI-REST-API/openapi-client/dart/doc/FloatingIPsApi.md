...
try {
    final result = api_instance.addFloatingIp();
    print(result);
} catch (e) {
...
final api_instance = FloatingIPsApi();
final id = 56; // int | The Floating IP service ID. Use the ID from `GET /floating_ips`.

try {
    final result = api_instance.floatingIpsCancel(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getFloatingIpInfo(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getFloatingIpInvoices(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getFloatingIpsWelcomeEmail(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getNewFloatingIp();
    print(result);
} catch (e) {
...
final api_instance = FloatingIPsApi();
final id = 56; // int | The Floating IP service ID. Use the ID from `GET /floating_ips`.
final ip = ip_example; // String | IP Address

try {
    final result = api_instance.postFloatingIpsChangeIp(id, ip);
    print(result);
} catch (e) {
...
final api_instance = FloatingIPsApi();
final id = id_example; // String | The Floating IP service ID. Use the ID from `GET /floating_ips`.

try {
    final result = api_instance.updateFloatingIpInfo(id);
    print(result);
} catch (e) {
