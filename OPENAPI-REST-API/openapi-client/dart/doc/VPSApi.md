...
final api_instance = VPSApi();
final vpsOrderPostRequest = VpsOrderPostRequest(); // VpsOrderPostRequest | 

try {
    final result = api_instance.addVps(vpsOrderPostRequest);
    print(result);
} catch (e) {
...
final api_instance = VPSApi();
final id = 56; // int | VPS ID number
final file = file_example; // String | The backup filename to delete.
final all = all_example; // String | Set to `1` to list all backups across all services, not just the ones for the given VPS.

try {
    final result = api_instance.deleteVpsBackup(id, file, all);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsBlockSmtp(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsDisableCd(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsDisableQuota(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsEjectCd(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsEnableQuota(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsRestart(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsStart(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.doVpsStop(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.downloadVpsBackup(id, downloadQsBackupRequest, all);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getNewVps();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsBackups(id, all);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsChangeTimezone(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsInfo(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsInvoices(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsList();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsReinstallOs(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsReverseDns(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getVpsTrafficUsage(id);
    print(result);
} catch (e) {
...
final api_instance = VPSApi();
final id = 4813; // String | VPS ID

try {
    final result = api_instance.getVpsWelcomeEmail(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsBackup(id);
    print(result);
} catch (e) {
...
final api_instance = VPSApi();
final id = 56; // int | VPS ID number
final hostname = hostname_example; // String | 

try {
    final result = api_instance.postVpsChangeHostname(id, hostname);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsChangeRootPassword(id, password);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsChangeTimezone(id, timezone);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsChangeWebuzoPassword(id, password);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsInsertCd(id, url);
    print(result);
} catch (e) {
...
final api_instance = VPSApi();
final id = 56; // int | VPS ID number
final template = template_example; // String | OS Template Filename
final localPassword = localPassword_example; // String | Password for this account.
final password = password_example; // String | Password for Root / Administrator Account.

try {
    final result = api_instance.postVpsReinstallOs(id, template, localPassword, password);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsResetPassword(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsRestore(id, restoreRequest);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsReverseDns(id, reverseDnsEntries);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.postVpsSetupVnc(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.putVps(vpsOrderPutRequest);
    print(result);
} catch (e) {
...
final api_instance = VPSApi();
final id = id_example; // String | VPS ID number.

try {
    final result = api_instance.updateVpsInfo(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.vPSCancel(id);
    print(result);
} catch (e) {
