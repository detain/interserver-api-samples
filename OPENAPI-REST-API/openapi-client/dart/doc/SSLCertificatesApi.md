...
final api_instance = SSLCertificatesApi();

try {
    final result = api_instance.addSsl();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getNewSsl();
    print(result);
} catch (e) {
...
final api_instance = SSLCertificatesApi();
final id = 56; // int | SSL certificate ID number.

try {
    final result = api_instance.getSslInfo(id);
    print(result);
} catch (e) {
...
final api_instance = SSLCertificatesApi();
final id = 56; // int | SSL Cert ID number

try {
    final result = api_instance.getSslInvoices(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getSslWelcomeEmail(id);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.sslCancel(id);
    print(result);
} catch (e) {
...
final api_instance = SSLCertificatesApi();
final id = id_example; // String | SSL certificate ID number.

try {
    final result = api_instance.updateSslInfo(id);
    print(result);
} catch (e) {
