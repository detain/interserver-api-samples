...
// tests for CpuWithDefaults
void main() {
  // final instance = CpuWithDefaults();

  group('test CpuWithDefaults', () {
    // int id
    ...
    test('to test the property `memoryDet`', () async {
      // TODO
    });

    // HardDrive hdDet
    test('to test the property `hdDet`', () async {
      // TODO
    });

    // String monthlyFee
    test('to test the property `monthlyFee`', () async {
      // TODO
    });
