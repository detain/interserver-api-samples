...
void main() {
  // final instance = ChargeInvoiceRowsInvoicesValuePaidInvoicesValueRefundInvoicesValue();

  group('test ChargeInvoiceRowsInvoicesValuePaidInvoicesValueRefundInvoicesValue', () {
    // num invoicesId
