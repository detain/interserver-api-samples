    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LicensesOrderServiceCategories509[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LicensesOrderServiceCategories509[$key]" has a null value in JSON.');
        });
        return true;
      }());
