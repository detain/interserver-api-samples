...
class VpsBillingDetails {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VpsBillingDetails &&
  ...
  @override
  String toString() => 'VpsBillingDetails[serviceLastInvoiceDate=$serviceLastInvoiceDate, servicePaymentStatus=$servicePaymentStatus, serviceFrequency=$serviceFrequency, nextDate=$nextDate, serviceNextInvoiceDate=$serviceNextInvoiceDate, serviceCurrency=$serviceCurrency, serviceCurrencySymbol=$serviceCurrencySymbol, serviceCoupon=$serviceCoupon, serviceCostInfo=$serviceCostInfo, serviceExtra=$serviceExtra, serviceExtraJson=$serviceExtraJson]';
  ...
  /// Returns a new [VpsBillingDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VpsBillingDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VpsBillingDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VpsBillingDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return VpsBillingDetails(
        ...
        serviceExtra: VpsServiceExtra.fromJson(json[r'service_extra']),
  ...
  static List<VpsBillingDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VpsBillingDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VpsBillingDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, VpsBillingDetails> mapFromJson(dynamic json) {
    final map = <String, VpsBillingDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = VpsBillingDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of VpsBillingDetails-objects as value to a dart map
  static Map<String, List<VpsBillingDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VpsBillingDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VpsBillingDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
