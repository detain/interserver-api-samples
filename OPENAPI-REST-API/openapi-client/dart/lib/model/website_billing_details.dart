...
class WebsiteBillingDetails {
  /// Returns a new [WebsiteBillingDetails] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is WebsiteBillingDetails &&
  ...
  @override
  String toString() => 'WebsiteBillingDetails[serviceLastInvoiceDate=$serviceLastInvoiceDate, servicePaymentStatus=$servicePaymentStatus, serviceFrequency=$serviceFrequency, nextDate=$nextDate, serviceNextInvoiceDate=$serviceNextInvoiceDate, serviceCurrency=$serviceCurrency, serviceCurrencySymbol=$serviceCurrencySymbol, serviceCoupon=$serviceCoupon, serviceCostInfo=$serviceCostInfo, serviceExtra=$serviceExtra, serviceExtraJson=$serviceExtraJson]';
  ...
  /// Returns a new [WebsiteBillingDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static WebsiteBillingDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "WebsiteBillingDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "WebsiteBillingDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return WebsiteBillingDetails(
        ...
        serviceExtra: mapValueOfType<Object>(json, r'service_extra'),
  ...
  static List<WebsiteBillingDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <WebsiteBillingDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = WebsiteBillingDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, WebsiteBillingDetails> mapFromJson(dynamic json) {
    final map = <String, WebsiteBillingDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = WebsiteBillingDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of WebsiteBillingDetails-objects as value to a dart map
  static Map<String, List<WebsiteBillingDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<WebsiteBillingDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = WebsiteBillingDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
