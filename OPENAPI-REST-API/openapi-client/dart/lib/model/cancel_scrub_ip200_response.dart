...
class CancelScrubIp200Response {
  ...
  static CancelScrubIp200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'success'), 'Required key "CancelScrubIp200Response[success]" is missing from JSON.');
        assert(json[r'success'] != null, 'Required key "CancelScrubIp200Response[success]" has a null value in JSON.');
        assert(json.containsKey(r'text'), 'Required key "CancelScrubIp200Response[text]" is missing from JSON.');
        assert(json[r'text'] != null, 'Required key "CancelScrubIp200Response[text]" has a null value in JSON.');
        return true;
      }());
