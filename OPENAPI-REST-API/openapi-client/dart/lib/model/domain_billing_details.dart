...
class DomainBillingDetails {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is DomainBillingDetails &&
  ...
  @override
  String toString() => 'DomainBillingDetails[serviceLastInvoiceDate=$serviceLastInvoiceDate, servicePaymentStatus=$servicePaymentStatus, serviceFrequency=$serviceFrequency, nextDate=$nextDate, serviceNextInvoiceDate=$serviceNextInvoiceDate, serviceCurrency=$serviceCurrency, serviceCurrencySymbol=$serviceCurrencySymbol, serviceCostInfo=$serviceCostInfo, serviceExtra=$serviceExtra, serviceExtraJson=$serviceExtraJson]';
  ...
  /// Returns a new [DomainBillingDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static DomainBillingDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DomainBillingDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DomainBillingDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return DomainBillingDetails(
        ...
        serviceExtra: DomainBillingExtra.fromJson(json[r'service_extra']),
  ...
  static List<DomainBillingDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <DomainBillingDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = DomainBillingDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, DomainBillingDetails> mapFromJson(dynamic json) {
    final map = <String, DomainBillingDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = DomainBillingDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of DomainBillingDetails-objects as value to a dart map
  static Map<String, List<DomainBillingDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<DomainBillingDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = DomainBillingDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
