...
class VpsTrafficTotalsSectionResponse {
  ...
  static VpsTrafficTotalsSectionResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        assert(json.containsKey(r'in'), 'Required key "VpsTrafficTotalsSectionResponse[in]" is missing from JSON.');
        assert(json[r'in'] != null, 'Required key "VpsTrafficTotalsSectionResponse[in]" has a null value in JSON.');
        assert(json.containsKey(r'out'), 'Required key "VpsTrafficTotalsSectionResponse[out]" is missing from JSON.');
        assert(json[r'out'] != null, 'Required key "VpsTrafficTotalsSectionResponse[out]" has a null value in JSON.');
        return true;
      }());
