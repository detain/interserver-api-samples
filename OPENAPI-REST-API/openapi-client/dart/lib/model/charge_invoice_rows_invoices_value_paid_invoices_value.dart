...
class ChargeInvoiceRowsInvoicesValuePaidInvoicesValue {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ChargeInvoiceRowsInvoicesValuePaidInvoicesValue &&
    ...
    _deepEquality.equals(other.refundInvoices, refundInvoices);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.paymentType != null) {
      ...
      json[r'refund_invoices'] = this.refundInvoices;
    return json;
  }

  /// Returns a new [ChargeInvoiceRowsInvoicesValuePaidInvoicesValue] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ChargeInvoiceRowsInvoicesValuePaidInvoicesValue? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ChargeInvoiceRowsInvoicesValuePaidInvoicesValue[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ChargeInvoiceRowsInvoicesValuePaidInvoicesValue[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ChargeInvoiceRowsInvoicesValuePaidInvoicesValue(
        invoicesId: mapValueOfType<String>(json, r'invoices_id'),
        ...
        refundInvoices: ChargeInvoiceRowsInvoicesValuePaidInvoicesValueRefundInvoicesValue.mapFromJson(json[r'refund_invoices']),
      );
    }
    return null;
  }

  static List<ChargeInvoiceRowsInvoicesValuePaidInvoicesValue> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ChargeInvoiceRowsInvoicesValuePaidInvoicesValue>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ChargeInvoiceRowsInvoicesValuePaidInvoicesValue.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ChargeInvoiceRowsInvoicesValuePaidInvoicesValue> mapFromJson(dynamic json) {
    final map = <String, ChargeInvoiceRowsInvoicesValuePaidInvoicesValue>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ChargeInvoiceRowsInvoicesValuePaidInvoicesValue.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ChargeInvoiceRowsInvoicesValuePaidInvoicesValue-objects as value to a dart map
  static Map<String, List<ChargeInvoiceRowsInvoicesValuePaidInvoicesValue>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ChargeInvoiceRowsInvoicesValuePaidInvoicesValue>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ChargeInvoiceRowsInvoicesValuePaidInvoicesValue.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
