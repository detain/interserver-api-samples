    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PlaceBuyNowServerRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PlaceBuyNowServerRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
