    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UpdateTicketResponseSchema[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UpdateTicketResponseSchema[$key]" has a null value in JSON.');
        });
        return true;
      }());
