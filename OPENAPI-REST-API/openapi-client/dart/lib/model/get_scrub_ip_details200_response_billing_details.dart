...
class GetScrubIpDetails200ResponseBillingDetails {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetScrubIpDetails200ResponseBillingDetails &&
  ...
  @override
  String toString() => 'GetScrubIpDetails200ResponseBillingDetails[serviceLastInvoiceDate=$serviceLastInvoiceDate, servicePaymentStatus=$servicePaymentStatus, serviceFrequency=$serviceFrequency, nextDate=$nextDate, serviceNextInvoiceDate=$serviceNextInvoiceDate, serviceCurrency=$serviceCurrency, serviceCurrencySymbol=$serviceCurrencySymbol, serviceCostInfo=$serviceCostInfo]';
  ...
  /// Returns a new [GetScrubIpDetails200ResponseBillingDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetScrubIpDetails200ResponseBillingDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetScrubIpDetails200ResponseBillingDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetScrubIpDetails200ResponseBillingDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return GetScrubIpDetails200ResponseBillingDetails(
  ...
  static List<GetScrubIpDetails200ResponseBillingDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GetScrubIpDetails200ResponseBillingDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetScrubIpDetails200ResponseBillingDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetScrubIpDetails200ResponseBillingDetails> mapFromJson(dynamic json) {
    final map = <String, GetScrubIpDetails200ResponseBillingDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetScrubIpDetails200ResponseBillingDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GetScrubIpDetails200ResponseBillingDetails-objects as value to a dart map
  static Map<String, List<GetScrubIpDetails200ResponseBillingDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetScrubIpDetails200ResponseBillingDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetScrubIpDetails200ResponseBillingDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
