    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PlaceScrubOrder201ResponseOrderDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PlaceScrubOrder201ResponseOrderDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
