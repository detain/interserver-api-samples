    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VpsTemplatesList[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VpsTemplatesList[$key]" has a null value in JSON.');
        });
        return true;
      }());
