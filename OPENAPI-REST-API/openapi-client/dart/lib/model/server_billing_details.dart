...
class ServerBillingDetails {
  /// Returns a new [ServerBillingDetails] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ServerBillingDetails &&
  ...
  @override
  String toString() => 'ServerBillingDetails[serviceLastInvoiceDate=$serviceLastInvoiceDate, servicePaymentStatus=$servicePaymentStatus, serviceFrequency=$serviceFrequency, nextDate=$nextDate, serviceNextInvoiceDate=$serviceNextInvoiceDate, serviceCurrency=$serviceCurrency, serviceCurrencySymbol=$serviceCurrencySymbol, serviceCostInfo=$serviceCostInfo, serviceExtra=$serviceExtra, serviceExtraJson=$serviceExtraJson]';
  ...
  /// Returns a new [ServerBillingDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ServerBillingDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ServerBillingDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ServerBillingDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ServerBillingDetails(
  ...
  static List<ServerBillingDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ServerBillingDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ServerBillingDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ServerBillingDetails> mapFromJson(dynamic json) {
    final map = <String, ServerBillingDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ServerBillingDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ServerBillingDetails-objects as value to a dart map
  static Map<String, List<ServerBillingDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ServerBillingDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ServerBillingDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
