    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DisableScrub400Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DisableScrub400Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
