...
class CpuWithDefaults {
  /// Returns a new [CpuWithDefaults] instance.
  CpuWithDefaults({
    this.id,
    this.shortDesc,
    this.longDesc,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CpuWithDefaults &&
    other.id == id &&
  ...
  int get hashCode =>
    ...
    (memoryDet == null ? 0 : memoryDet!.hashCode) +
    (hdDet == null ? 0 : hdDet!.hashCode) +
    (monthlyFee == null ? 0 : monthlyFee!.hashCode);

  @override
  String toString() => 'CpuWithDefaults[id=$id, shortDesc=$shortDesc, longDesc=$longDesc, type=$type, speed=$speed, numCores=$numCores, numCpus=$numCpus, benchmark=$benchmark, monthlyPrice=$monthlyPrice, monthlyPriceDisplay=$monthlyPriceDisplay, maxRam=$maxRam, minRam=$minRam, maxLff=$maxLff, maxSff=$maxSff, maxNve=$maxNve, visible=$visible, active=$active, memoryDet=$memoryDet, hdDet=$hdDet, monthlyFee=$monthlyFee]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.memoryDet != null) {
      json[r'memory_det'] = this.memoryDet;
    } else {
      json[r'memory_det'] = null;
    }
    if (this.hdDet != null) {
      json[r'hd_det'] = this.hdDet;
    } else {
      json[r'hd_det'] = null;
    }
    if (this.monthlyFee != null) {
      json[r'monthly_fee'] = this.monthlyFee;
    } else {
      json[r'monthly_fee'] = null;
    }
    return json;
  }

  /// Returns a new [CpuWithDefaults] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CpuWithDefaults? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CpuWithDefaults[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CpuWithDefaults[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return CpuWithDefaults(
        ...
        memoryDet: MemoryOption.fromJson(json[r'memory_det']),
        hdDet: HardDrive.fromJson(json[r'hd_det']),
        monthlyFee: mapValueOfType<String>(json, r'monthly_fee'),
      );
    }
    return null;
  }

  static List<CpuWithDefaults> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CpuWithDefaults>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CpuWithDefaults.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CpuWithDefaults> mapFromJson(dynamic json) {
    final map = <String, CpuWithDefaults>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CpuWithDefaults.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CpuWithDefaults-objects as value to a dart map
  static Map<String, List<CpuWithDefaults>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CpuWithDefaults>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CpuWithDefaults.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
