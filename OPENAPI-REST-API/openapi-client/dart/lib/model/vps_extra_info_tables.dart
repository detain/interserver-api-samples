    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VpsExtraInfoTables[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VpsExtraInfoTables[$key]" has a null value in JSON.');
        });
        return true;
      }());
