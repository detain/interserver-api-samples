    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetScrubIpDetails200ResponseFilterFirewall[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetScrubIpDetails200ResponseFilterFirewall[$key]" has a null value in JSON.');
        });
        return true;
      }());
