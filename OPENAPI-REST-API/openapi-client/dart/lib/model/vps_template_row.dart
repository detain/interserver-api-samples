    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VpsTemplateRow[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VpsTemplateRow[$key]" has a null value in JSON.');
        });
        return true;
      }());
