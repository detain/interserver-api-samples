...
|Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **IpLimitRange** | [**IpLimitRange**](../Models/IpLimitRange.md)|  | [optional] |
...
# **updateAccountInfo**
> SuccessTextResponse updateAccountInfo(name, address, city, state, zip, country, phone, company, address2, locale, email\_invoices, email\_abuse, disable\_reset, disable\_reinstall, disable\_server\_notifications, disable\_email\_notifications, gstin)
