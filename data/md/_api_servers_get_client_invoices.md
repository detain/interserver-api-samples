...
## Servers Get Client Invoices

### About

**API Function Name: api_servers_get_client_invoices**
...
print "got session id ",sid,"\n"
response = client.call(
	:api_servers_get_client_invoices, message: { 
		sid: ARGV[0], 
})
print response.body[:api_servers_get_client_invoices_response][:return],"\n"
